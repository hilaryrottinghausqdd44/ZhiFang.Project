...
namespace ZhiFang.IBLL.ProjectProgressMonitorManage
{
    ...
    public interface IBFFile : IBGenericManager<FFile>
    {
        ...
        /// <returns></returns>
        FFile GetFFileAndAddFFileCopyUser(long longID, int isAddFFileReadingLog, int isAddFFileOperation);
        /// <summary>
        /// 新增文档信息及文档抄送对象信息表
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        BaseResultBool DeleteFFileOfPhysicalById(long id);
        /// <summary>
        /// 查询某一文档的所有修订版本文档信息
        /// </summary>
        ...
        /// <param name="sort"></param>
        /// <returns></returns>
        EntityList<FFile>  SearchReviseFFileListByFileID(long fileId, string where,int limit, int page,string sort);
    }
}