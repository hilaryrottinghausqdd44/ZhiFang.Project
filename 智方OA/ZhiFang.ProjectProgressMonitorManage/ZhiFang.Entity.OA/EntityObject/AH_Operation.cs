...
namespace ZhiFang.Entity.OA
{
    ...
    /// <summary>
    /// AHOperation object for NHibernate mapped table 'AH_Operation'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "授权操作记录", ClassCName = "AHOperation", ShortCode = "AHOperation", Desc = "授权操作记录")]
    public class AHOperation : BaseEntity
    {
        ...
        public AHOperation(long labID, long bobjectID, long type, string typeName, string businessModuleCode, string memo, int dispOrder, bool isUse, long creatorID, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
        {
            this._labID = labID;
        ...
        [DataMember]
        [DataDesc(CName = "业务对象代码", ShortCode = "BusinessModuleCode", Desc = "业务对象代码", ContextType = SysDic.All, Length = 20)]
