...
namespace ZhiFang.Entity.OA
{
	...
	/// <summary>
	/// ATApproveStatus object for NHibernate mapped table 'AT_ApproveStatus'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "审批状态", ClassCName = "ATApproveStatus", ShortCode = "ATApproveStatus", Desc = "审批状态")]
	public class ATApproveStatus : BaseEntityService
	{
		...
		public ATApproveStatus() { }

		public ATApproveStatus( long labID, string name, string sName, string shortcode, string pinYinZiTou, int dispOrder, string comment, bool isUse, DateTime dataAddTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
			this._name = name;
			this._sName = sName;
