...
namespace ZhiFang.Entity.ProjectProgressMonitorManage
{
    ...
    /// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "PContract", ShortCode = "PContract", Desc = "")]
    public class PContract : BaseEntity
    {
