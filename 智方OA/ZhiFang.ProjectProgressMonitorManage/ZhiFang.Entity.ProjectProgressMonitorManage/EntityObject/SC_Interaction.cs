...
namespace ZhiFang.Entity.ProjectProgressMonitorManage
{
    ...
    public class SCInteraction : BaseEntity
    {
        ...
        protected DateTime? _lastReplyDateTime;
        protected long? _replyCount;
        #endregion
        ...
        public SCInteraction(long labID, long bobjectID, string contents, long senderID, string senderName, long receiverID, string receiverName, bool hasAttachment, string memo, bool isUse, DateTime dataAddTime, bool isCommunication, DateTime? lastReplyDateTime, long? replyCount, byte[] dataTimeStamp)
        {
            this._labID = labID;
            ...
            this._isCommunication = isCommunication;
            this._lastReplyDateTime = lastReplyDateTime;
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "最后回复时间", ShortCode = "LastReplyDateTime", Desc = "最后回复时间", ContextType = SysDic.All, Length = 8)]
        public virtual DateTime? LastReplyDateTime
        {
            get { return _lastReplyDateTime; }
            set { _lastReplyDateTime = value; }
        }
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "回复个数", ShortCode = "ReplyCount", Desc = "回复个数", ContextType = SysDic.All, Length = 8)]
        public virtual long? ReplyCount
        {
