...
namespace ZhiFang.Entity.ProjectProgressMonitorManage
{
	...
	/// <summary>
	/// PCustomerServiceOperationLog object for NHibernate mapped table 'P_CustomerServiceOperationLog'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "服务单操作记录表", ClassCName = "PCustomerServiceOperationLog", ShortCode = "PCustomerServiceOperationLog", Desc = "服务单操作记录表")]
	public class PCustomerServiceOperationLog : BaseEntity
	{
		...
		public PCustomerServiceOperationLog() { }

		public PCustomerServiceOperationLog( long labID, long bobjectID, long type, string typeName, string businessModuleCode, string memo, int dispOrder, bool isUse, long creatorID, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
        ...
        [DataDesc(CName = "服务单ID", ShortCode = "BobjectID", Desc = "服务单ID", ContextType = SysDic.All, Length = 8)]
