$(function () {
    ...
    var shell_win = {
        ...
        limit: 5,
        Backpage: function () {
            location.href = "EmpAttendanceEventLog.html";
        },
        ...
        init: function () {
            ...
            $('#iframe_content').attr("src", "EmpATMyApprovaAllLog.html?ATEventType=all");
            ...
            $('#leave').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "EmpATMyApprovaAllLog.html?ATEventType=leave");
                $('#leavel').addClass('active');
            });
            $('#egress').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "EmpATMyApprovaAllLog.html?ATEventType=egress");
                $('#egressl').addClass('active');
            });
            $('#trip').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "EmpATMyApprovaAllLog.html?ATEventType=trip");
                $('#tripl').addClass('active');
            });
            $('#overtime').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "EmpATMyApprovaAllLog.html?ATEventType=overtime");
