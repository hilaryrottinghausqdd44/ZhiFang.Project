...
//                          applyhtml = "<a class='btn btn-success btn-circle btn-xl'>请假</a>";
                            var ATEventSubTypeName=jsona[i].ATEventSubTypeName;
                            if(jsona[i].ATEventSubTypeName.length>2){
                            	ATEventSubTypeName=jsona[i].ATEventSubTypeName.substring(2,0);
                            }
                            applyhtml = "<a class='btn btn-success btn-circle btn-xl'>"+ATEventSubTypeName+"</a>";
                        }
                        ...
                        tmphtml += "<table style='width:100%;border-color:darkgrey' border='0'><tr style='margin:2px;height:29px'><td rowspan='2' width='70' align='center' valign='middle'>" + applyhtml + "</td><td colspan='2' style='background-color: #fff'><table><tr><td valign='middle'><div style='float :left;margin-left:5px;'>时间：</div>" + startdate + "</td><td width='15px' style='padding:0px'>至</td><td align='left'>" + enddate + "</td></tr></table></td></tr><tr style='margin:2px;height:29px'><td colspan='2' style='background-color: #fff'><div style='float :left;margin-left:5px;'>事由：</div>" + memo + "</td></tr><tr style='margin:2px;height:20px' valign='middle'><td width='70' align='center' valign='middle'>" + day + "</td><td width='200' valign='middle'>申请时间：" + applydate + "</td><td align='right'>" + approvestatus + "</td></tr></table></div></div>";
