    ...
    var shell_win = {       
        save_btn_click: function () {
            ...
            Shell.util.Server.ajax({
                type: "post",
                data: JSON.stringify({ entity: data, StartDateTime: $('#datetimepickinput').val() + " " + $('#datetimepickstartinput').val(), EndDateTime: $('#datetimepickinput').val() + " " + $('#datetimepickendinput').val() }),
                url: Shell.util.Path.rootPath + "/WeiXinAppService.svc/ST_UDTO_AddAndCheckATEmpAttendanceEventEgressevent"
            }, function (data) {
        ...
        vailddate: function (ev) {
            ...
            var sd = $('#datetimepickinput').val() + " " + $('#datetimepickstartinput').val();
            var ed = $('#datetimepickinput').val() + " " + $('#datetimepickendinput').val();
            if ($('#datetimepickinput').val() != "" && $('#datetimepickstartinput').val() != "" && $('#datetimepickendinput').val() != "") {
