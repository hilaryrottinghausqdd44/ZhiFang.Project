    ...
    var shell_win = {
        ...
        save_btn_click: function () {
            ...
            var data = {
                ...
                PTask: { Id: shell_win.taskid, DataTimeStamp: [0, 0, 0, 0, 0, 0, 0, 0] }
            };
            ShellComponent.mask.save();
            Shell.util.Server.ajax({
                type: "post",
                data: Shell.util.JSON.encode({ entity: data }),
                url: Shell.util.Path.rootPath + "/ProjectProgressMonitorManageService.svc/ST_UDTO_AddPInteraction"
            }, function (data) {
        ...
        Load: function () {
            ...
            var fields = "PInteraction_DataAddTime,PInteraction_SenderName,PInteraction_Id,PInteraction_SenderID,PInteraction_Contents";
            ShellComponent.mask.loading();
            Shell.util.Server.ajax({
                type: "get",
