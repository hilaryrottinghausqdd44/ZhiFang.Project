$(function () {
    ...
    var shell_win = {
        ...
        Load: function () {
            ...
            Shell.util.Server.ajax({
                type: "get",
                url: Shell.util.Path.rootPath + "/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchTaskWorkDayLogTaskId?limit=" + shell_win.limit + "&page=" + shell_win.pageindex + "&taskid=" + shell_win.taskid
            }, function (data) {
                //alert('A');
                ShellComponent.mask.hide();
                if (data.success) {
                    ...
                    for (var i = 0; i < jsona.length; i++) {
                        ...
                        tmphtml += "<table style='width:100%;border-bottom-style:solid; border-bottom-width:1px; border-color:darkgrey' border='0'><tr style='margin:2px;height:29px'><td rowspan=\"1\" width=\"50\" align=\"center\" valign=\"middle\"><img width=\"50\" src=\"" + picpath + "\"></td><td width='105' valign='middle' colspan=\"3\"><div style=\"margin-left:5px;font-weight:bold\">" + empname + "</div><div style='float :left;margin-left:5px;font-weight:bold'>日期：" + datecode + "</div>" + worklogtype + "</td></tr><tr style='margin:2px;height:5px'><td width='70' align='center' valign='middle'></td></tr><tr style='margin:2px;height:29px'><td width=\"125\" valign='middle' colspan=\"4\"><div style='float :left;margin-left:5px;'>内容：" + content + "</div><br><div style='float :left;margin-left:5px;vertical-align:middle;' class='text-success'>" + copyforemp + "</div></td></tr><tr style='margin:2px;height:29px'><td width=\"125\" valign='middle' colspan=\"4\"><div style='float :left;margin-left:0px;vertical-align:middle;font-weight:bold' class='text-primary'>填报时间：" + adddatetime + "</div><div style='float :right;margin-right:5px;vertical-align:middle;' class='btn-primary'>评论(0)</div></td></tr></table></div></div>";
                        //alert(tmphtml)
