$(function () {
    ...
    var shell_win = {
        ...
        init: function () {
            ...
            $("#worklogdayl").on(Shell.util.Event.touch, function () {
                //alert($(this).attr('data-url'));
                location.href = $(this).attr('data-url');
            });
            $("#worklogweekl").on(Shell.util.Event.touch, function () {
                //alert($(this).attr('data-url'));
                location.href = $(this).attr('data-url');
            });
            $("#worklogmonthl").on(Shell.util.Event.touch, function () {
                //alert($(this).attr('data-url'));
                location.href = $(this).attr('data-url');
            });
            ...
            $("#messagelog").on(Shell.util.Event.touch, function () {
                //alert($(this).attr('data-url'));
                //location.href = $(this).attr('data-url');
            });
            shell_win.Load();
