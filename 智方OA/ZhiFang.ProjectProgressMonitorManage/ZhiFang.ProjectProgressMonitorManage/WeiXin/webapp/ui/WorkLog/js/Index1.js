$(function () {
    ...
    var shell_win = {
        ...
        init: function () {
            ...
            $('#iframe_content').attr("src", "WorkLogAll.html?SendType=all");
            $('#all').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "WorkLogAll.html?SendType=all");
                $('#alll').addClass('active');
            });
            $('#copyforme').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "WorkLogAll.html?SendType=copyforme");
                $('#copyformel').addClass('active');
            });
            $('#sendforme').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "WorkLogAll.html?SendType=sendforme");
                $('#sendformel').addClass('active');
            });
            $('#meown').on('click', function () {
                $(".active").removeClass('active');
                $('#iframe_content').attr("src", "WorkLogAll.html?SendType=meown");
                $('#meownl').addClass('active');
            });
