    ...
    var shell_win = {
        ...
        save_btn_click: function () {
            ...
            Shell.util.Server.ajax({
                ...
                url: Shell.util.Path.rootPath + "/ProjectProgressMonitorManageService.svc/ST_UDTO_AddATEmpAttendanceEventOvertimeevent"
            }, function (data) {
