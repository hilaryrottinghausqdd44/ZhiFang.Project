		...
		if(RiskGrade) {
			RiskGrade.on({
				check: function(p, record) {
					RiskGrade.setValue(record ? record.get('PDict_CName') : '');
//					RiskGradeID.setValue(record ? record.get('PDict_Id') : '');
					p.close();
				}
			});
		}
	...
	initComponent: function() {
		...
		me.buttonToolbarItems = [{
			...
			classConfig: {
				title: '任务风险选择',
				defaultWhere: "pdict.PDictType.DictTypeCode='" + this.RiskGrade + "'"
			}
		},{
