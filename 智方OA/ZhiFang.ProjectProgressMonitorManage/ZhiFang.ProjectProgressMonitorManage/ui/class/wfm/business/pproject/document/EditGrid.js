...
Ext.define('Shell.class.wfm.business.pproject.document.EditGrid', {
    ...
    height: 440,
    /**获取数据服务路径*/
    selectUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchPProjectDocumentByHQL?isPlanish=true',
    /**修改服务地址*/
    editUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_UpdatePProjectDocumentByField',
    /**删除数据服务路径*/
    delUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_DelPProjectDocument',
    
	addUrl:'/ProjectProgressMonitorManageService.svc/ST_UDTO_AddPProjectDocument',
    /**默认加载*/
    defaultLoad: true,
    /**是否启用刷新按钮*/
    hasRefresh: true,
