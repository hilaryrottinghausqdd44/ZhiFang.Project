...
Ext.define('Shell.class.wfm.business.pproject.basic.TaskGrid', {
    ...
    /**删除数据服务路径*/
    delUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_DelPProjectTask',
   ...
   onSaveClick:function(){
	...
	getProjectTask:function(id,callback){
		var me = this;
		var url = JShell.System.Path.ROOT + '/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchPProjectTaskByHQL?isPlanish=true';
...
//          innerIndex1= parseInt(innerIndex1)+1+ parseInt(tasknum);
	...
	onAddStandardTask: function(projectID) {
		var me = this,
			url = '/ProjectProgressMonitorManageService.svc/PM_UDTO_CopyStandardTask';
        if(!projectID){
