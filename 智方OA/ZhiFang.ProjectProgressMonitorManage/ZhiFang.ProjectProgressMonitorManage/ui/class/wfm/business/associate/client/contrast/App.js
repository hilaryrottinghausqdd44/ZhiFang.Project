...
Ext.define('Shell.class.wfm.business.associate.client.contrast.App', {
	...
	editCUserUrl:'/ProjectProgressMonitorManageService.svc/ST_UDTO_UpdateCUserByField',
	/**授权系统客户更新提交实体*/
...
//				
	...
	getCUserInfo:function(UserFWNo,callback){
		var me = this;
		var url = JShell.System.Path.ROOT + '/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchCUserByHQL?isPlanish=false';
