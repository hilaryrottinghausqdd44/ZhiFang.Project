 ...
 * @version 2017-08-07
 */
Ext.define('Shell.class.wfm.business.projecttrack.follow.apply.App', {
	extend: 'Shell.ux.panel.AppPanel',
	title: '项目跟踪',
	/**获取数据服务路径*/
	selectUrl:'/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchPContractFollowInteractionByHQL?isPlanish=true',
	/**新增服务地址*/
    addUrl:'/ProjectProgressMonitorManageService.svc/ST_UDTO_AddPContractFollowInteraction',
    /**附件对象名*/
	...
	createItems: function() {
		var me = this;
		me.Grid = Ext.create('Shell.class.wfm.business.projecttrack.follow.apply.Grid', {
			region: 'center',
			header: false,
			title: '项目跟踪',
			itemId: 'Grid'
