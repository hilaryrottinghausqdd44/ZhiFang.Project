...
Ext.define('Shell.class.wfm.business.receive.finance.Grid', {
	...
	createDefaultButtonToolbarItems:function(){
		...
		var items = {
			...
			items:[{
			    ...
			    classConfig: {
					title: '收入类别选择',
					defaultWhere: "pdict.PDictType.DictTypeCode='" + this.IncomeClass + "'"
				}
			},{
	...
	getPFinanceReceiveTotal:function(callback){
		var me = this;
		var url = JShell.System.Path.ROOT + '/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchPFinanceReceiveTotalByHQL';
