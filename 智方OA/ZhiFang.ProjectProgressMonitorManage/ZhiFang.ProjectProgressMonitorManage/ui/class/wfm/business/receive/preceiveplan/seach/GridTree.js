...
Ext.define('Shell.class.wfm.business.receive.preceiveplan.seach.GridTree', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_AdvSearchPReceivePlanTreeByHQL?isPlanish=true',
	/**默认加载数据*/
	defaultLoad: true,
	features: [{
		ftype: 'summary'
	...
	getReceiveAmountCount: function(callback) {
		var me = this;
		var url = JShell.System.Path.ROOT + '/ProjectProgressMonitorManageService.svc/ST_UDTO_AdvSearchTotalPReceivePlanByHQL';
