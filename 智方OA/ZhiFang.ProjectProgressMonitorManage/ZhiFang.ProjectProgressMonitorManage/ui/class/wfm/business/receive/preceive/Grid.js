...
Ext.define('Shell.class.wfm.business.receive.preceive.Grid',{
    ...
    title: '商务收款记录',
	/**获取数据服务路径*/
	selectUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchPReceiveByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_AddPReceive',
	/**删除数据服务路径*/
	delUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_DelPReceive',
		/**撤回商务收款*/
	backpreceiveUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_AddBackPReceive',
	/**默认排序字段*/
	defaultOrderBy: [{
	...
	getPFReceivenById: function(Id) {
		var me = this,
			SplitAmount = 0;
		if(Id) {
			var url = '/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchPFinanceReceiveByHQL?isPlanish=true&fields=PFinanceReceive_SplitAmount';
