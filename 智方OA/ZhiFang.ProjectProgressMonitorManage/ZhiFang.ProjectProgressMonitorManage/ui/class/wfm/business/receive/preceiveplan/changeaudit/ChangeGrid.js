...
Ext.define('Shell.class.wfm.business.receive.preceiveplan.changeaudit.ChangeGrid', {
	...
	onSaveClick: function(isSubmit) {
		var me = this,
			url = '';
		if(isSubmit) {
			url = '/ProjectProgressMonitorManageService.svc/ST_UDTO_ChangeSubmitPReceivePlan';
		} else {
			url = '/ProjectProgressMonitorManageService.svc/ST_UDTO_UnChangeSubmitPReceivePlan';
		}
