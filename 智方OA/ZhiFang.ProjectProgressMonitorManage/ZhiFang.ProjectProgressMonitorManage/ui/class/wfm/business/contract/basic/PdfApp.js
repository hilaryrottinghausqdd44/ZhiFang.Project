 ...
 * @version 2017-01-06
 */
Ext.define('Shell.class.wfm.business.contract.basic.PdfApp', {
	...
	defaultLoad: false,
	autoScroll: false,
	selectUrl: '/ProjectProgressMonitorManageService.svc/PContract_UDTO_PreviewPdf',
	layout: {
		type: 'border',
		regionWeights: {
			south: 1,
