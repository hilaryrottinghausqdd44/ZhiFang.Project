 ...
 * @version 2015-07-27
 */
Ext.define('Shell.class.wfm.business.expenseaccount.operate.Panel', {
	...
	changeHtml: function(list) {
		...
		for(var i = 0; i < len; i++) {
			...
			if(data.SCOperation_Type) {
				var obj = JShell.System.ClassDict.getClassInfoById('PExpenseAccountStatus', data.SCOperation_Type);
				if(obj) {
					var style = [];
					if(obj.BGColor) {
