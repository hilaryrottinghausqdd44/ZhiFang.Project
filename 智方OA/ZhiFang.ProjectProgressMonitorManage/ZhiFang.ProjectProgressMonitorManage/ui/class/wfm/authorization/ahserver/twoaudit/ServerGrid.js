...
Ext.define('Shell.class.wfm.authorization.ahserver.twoaudit.ServerGrid', {
	...
	hasSearch: false,
	/**获取数据服务路径*/
	selectUrl: '/ProjectProgressMonitorManageService.svc/ST_UDTO_SearchSpecialApprovalAHServerLicenceByHQL',
	...
	initComponent: function() {
		...
		me.defaultWhere = 'ahserverlicence.IsUse=1 and ahserverlicence.IsSpecially=1';
		me.callParent(arguments);
	},
	/**创建数据列*/
		...
		columns.splice(12, 0, {
			...
			items: [{
				...
				handler: function(grid, rowIndex, colIndex) {
					...
					var IsSpecially = rec.get('IsSpecially');
					var info = JShell.System.ClassDict.getClassInfoByName('LicenceStatus', '商务授权通过');
					if(Status == info.Id) {
						var editPanel = 'Shell.class.wfm.authorization.ahserver.twoaudit.EditPanel';
