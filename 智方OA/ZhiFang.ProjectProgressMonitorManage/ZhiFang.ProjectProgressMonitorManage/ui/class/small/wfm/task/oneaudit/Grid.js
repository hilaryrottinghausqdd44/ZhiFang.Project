 ...
 * @version 2016-09-18
 */
Ext.define('Shell.class.small.wfm.task.oneaudit.Grid',{
	...
	afterRender: function() {
  	...
  	initComponent:function(){
		...
		//一审人是我&&状态为申请、一审中、二审退回
		me.defaultWhere += 
		" and ptask.OneAuditID=" + userId + " and ptask.Status.Id in(" +
			JShell.WFM.GUID.TaskStatus.Apply.GUID + "," +
			JShell.WFM.GUID.TaskStatus.OneAuditIng.GUID + "," +
			JShell.WFM.GUID.TaskStatus.TwoAuditBack.GUID +
		")";
