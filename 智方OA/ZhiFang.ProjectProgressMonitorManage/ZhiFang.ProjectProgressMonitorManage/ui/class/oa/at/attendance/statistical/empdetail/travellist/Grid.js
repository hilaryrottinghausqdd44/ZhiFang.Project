 ...
 * @version 2017-1-24
 */
Ext.define('Shell.class.oa.at.attendance.statistical.empdetail.travellist.Grid', {
    ...
    createGridColumns: function () {
        ...
        var columns = [{
            ...
            text: '始发地', dataIndex: 'ATEmpApplyAllLog_EventStatPostion', width: 85,
            sortable: false, defaultRenderer: true
        },{
            text: '目的地', dataIndex: 'ATEmpApplyAllLog_EventDestinationPostion', width: 85,
            sortable: false, defaultRenderer: true
        }, {
            text: '开始日期', dataIndex: 'ATEmpApplyAllLog_StartDateTime', width: 85,
            sortable: false, defaultRenderer: true,isDate: true
        },  {
            text: '结束日期', dataIndex: 'ATEmpApplyAllLog_EndDateTime', width: 85,
            sortable: false, defaultRenderer: true,isDate: true
        }, {
            text: '出差天数', dataIndex: 'ATEmpApplyAllLog_EvenLength', width: 70,
            sortable: false, defaultRenderer: true
        } ,{
            text: '交通工具', dataIndex: 'ATEmpApplyAllLog_TransportationName', width: 70,
            sortable: false, defaultRenderer: true
        },{
            text: '出差事由', dataIndex: 'ATEmpApplyAllLog_Memo', width: 150,
            sortable: false, defaultRenderer: true
        },{
            text: '审核状态', dataIndex: 'ATEmpApplyAllLog_ApproveStatusName', width: 70,
            sortable: false, defaultRenderer: true
        },{
