 ...
 * @version 2017-1-24
 */
Ext.define('Shell.class.oa.at.attendance.statistical.empdetail.leavelist.Grid', {
	...
	createButtontoolbar: function() {
		var me = this,
			items = [];
		return Ext.create('Shell.class.oa.at.attendance.statistical.empdetail.leavelist.SearchToolbar', {
			dock: 'top',
    ...
    createGridColumns: function () {
        ...
        var columns = [{
            ...
            text: '请假天数', dataIndex: 'ATEmpApplyAllLog_EvenLength', width: 60,
            sortable: false, defaultRenderer: true
        },  {
            text: '请假类型', dataIndex: 'ATEmpApplyAllLog_ATEventSubTypeName', width: 70,
            sortable: false, defaultRenderer: true
        }, {
            text: '请假事由', dataIndex: 'ATEmpApplyAllLog_Memo', width: 150,
            sortable: false, defaultRenderer: true
        },{
