 ...
 * @version 2016-09-29
 */
Ext.define('Shell.class.oa.pgm.program.release.template.Form', {
	...
	getAddTableLayoutOfFileNameRow: function(items) {
		...
		me.PGMProgram_OriginalPGMProgram_Title.colspan = 1;
		me.PGMProgram_OriginalPGMProgram_Title.width = me.defaults.width * me.PGMProgram_OriginalPGMProgram_Title.colspan;
		items.push(me.PGMProgram_OriginalPGMProgram_Title);

		me.PGMProgram_File.colspan = 2;
