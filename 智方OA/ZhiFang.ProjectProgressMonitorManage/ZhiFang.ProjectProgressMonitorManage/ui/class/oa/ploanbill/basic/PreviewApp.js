 ...
 * @version 2016-11-16
 */
Ext.define('Shell.class.oa.ploanbill.basic.PreviewApp', {
	...
	defaultLoad: false,
	autoScroll: false,
	selectUrl: '/ProjectProgressMonitorManageService.svc/PLoanBill_UDTO_PreviewPdf',
	layout: {
		type: 'border',
		regionWeights: {
			south: 1,
