 ...
 * @version 2017-05-04
 */
Ext.define('Shell.class.sysbase.rowfilter.precondition.roleright.Grid', {
	...
	getLoadUrl: function() {
		var me = this,
			params = [];
		if(me.preconditionId && me.rowFilterId) {
			params.push("rbacroleright.RBACPreconditions.Id=" + me.preconditionId);
	...
	openAppShowWin: function() {
		...
		JShell.Win.open("Shell.class.sysbase.rowfilter.precondition.roleright.CheckGrid", config).show();
	}
});