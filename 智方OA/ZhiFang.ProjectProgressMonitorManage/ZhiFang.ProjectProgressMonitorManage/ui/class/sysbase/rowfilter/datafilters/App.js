 ...
 * @version 2017-05-02
 */
Ext.define('Shell.class.sysbase.rowfilter.datafilters.App', {
	...
	createItems: function() {
		...
		me.RowFilterTree = Ext.create('Shell.class.sysbase.rowfilter.datafilters.RowFilterTree', {
			itemId: 'RowFilterTree',
			title: '行数据过滤条件(单表)&角色树',
			region: 'center',
			split: true
		});
