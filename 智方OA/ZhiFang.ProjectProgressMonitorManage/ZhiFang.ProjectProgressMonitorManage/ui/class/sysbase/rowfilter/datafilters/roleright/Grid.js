 ...
 * @version 2017-05-04
 */
Ext.define('Shell.class.sysbase.rowfilter.datafilters.roleright.Grid', {
	...
	getLoadUrl: function() {
		var me = this,
			params = [];
		if(me.moduleOperId && me.rowFilterId) {
			params.push("rbacroleright.RBACModuleOper.Id=" + me.moduleOperId);
	...
	openAppShowWin: function() {
		...
		var hqlWhere = 'rbacroleright.RBACModuleOper.Id=' + me.moduleOperId;
		var config = {
			maxWidth: maxWidth,
			width: 320,
			height: maxHeight,
		...
		JShell.Win.open("Shell.class.sysbase.rowfilter.datafilters.roleright.CheckGrid", config).show();
	}
});