 ...
 */
Ext.define('Shell.class.sysbase.rowfilter.basic.CheckGroupSelector', {
			...
			success: function(response, opts) {
				...
				if(result.success) {
					...
					if(result["ResultDataValue"] && result["ResultDataValue"] != "") {
						ResultDataValue = JShell.JSON.decode(result["ResultDataValue"]);
					}
