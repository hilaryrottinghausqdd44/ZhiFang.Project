...
Ext.define('Shell.class.sysbase.dict.Grid',{
	...
	/**删除数据服务路径*/
	delUrl:'/BaseService.svc/ST_UDTO_DelFDict',
...
//	hasEdit:true,
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'编码',dataIndex:'FDict_Shortcode',width:100,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			xtype:'checkcolumn',text:'使用',dataIndex:'FDict_IsUse',
			width:40,align:'center',sortable:false,menuDisabled:true,
			stopSelection:false,type:'boolean'
		},{
			text:'创建时间',dataIndex:'FDict_DataAddTime',width:130,
			isDate:true,hasTime:true
		},{
			text:'备注',dataIndex:'FDict_Memo',width:150,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			text:'次序',dataIndex:'FDict_DispOrder',width:50,
