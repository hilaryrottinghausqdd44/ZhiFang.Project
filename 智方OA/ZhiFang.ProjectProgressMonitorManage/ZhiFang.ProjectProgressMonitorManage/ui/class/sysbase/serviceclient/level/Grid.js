 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.sysbase.serviceclient.level.Grid',{
	...
	height: 500,
  	...
  	/**获取数据服务路径*/
	selectUrl:'/WeiXinAppService.svc/ST_UDTO_SearchSServiceClientlevelByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl:'/WeiXinAppService.svc/ST_UDTO_UpdateSServiceClientlevelByField',
	/**删除数据服务路径*/
	delUrl:'/WeiXinAppService.svc/ST_UDTO_DelSServiceClientlevel',
