 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.sysbase.interaction.umeditor.App',{
	...
	createItems:function(){
		...
		me.Grid = Ext.create('Shell.class.sysbase.interaction.umeditor.List', {
			region: 'center',
			header: false,
			itemId: 'Grid',
			defaultLoad: true,
		...
		me.Form = Ext.create('Shell.class.sysbase.interaction.umeditor.Form', FormConfig);
