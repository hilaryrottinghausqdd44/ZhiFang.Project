...
Ext.define('Shell.class.qms.file.attachment.Upload', {
	...
	width: 600,
	height: 400,
	selectUrl: '/QMSService.svc/QMS_UDTO_SearchFFileAttachmentByHQL?isPlanish=true',
	delUrl: '/QMSService.svc/QMS_UDTO_UpdateFFileAttachmentByField',
	//新增附件文件时保存服务
	...
	/**必须传--更新附件文件时保存服务*/
	editUrl: '/QMSService.svc/QMS_UDTO_UpdateFFileAttachmentByField',
	//新增文件所保存的数据对象名称
