...
Ext.define('Shell.class.qms.file.basic.Grid', {
	...
	delUrl: '/QMSService.svc/QMS_UDTO_DeleleFFileByIds',
	/**默认排序字段*/
	defaultOrderBy: [{
	...
	getStatusListData: function(callback) {
		var me = this,
			url = JShell.System.Path.getRootUrl('/SystemCommonService.svc/GetClassDic');
		url = url + "?classname=FFileStatus&classnamespace=ZhiFang.Entity.ProjectProgressMonitorManage";
	...
	WeiXinMessagePush: function(id) {
		var me = this;
		var url = JShell.System.Path.getRootUrl('/QMSService.svc/QMS_FFileWeiXinMessagePushById?id=' + id);
		//根据新闻ID进行微信消息推送
