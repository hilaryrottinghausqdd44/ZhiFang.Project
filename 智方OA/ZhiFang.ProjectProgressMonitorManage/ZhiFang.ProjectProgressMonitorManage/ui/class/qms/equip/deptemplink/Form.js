 ...
 * @version 2020-04-07
 */
Ext.define('Shell.class.qms.equip.deptemplink.Form', {
	...
	//获取数据服务路径
    selectUrl:'/RBACService.svc/RBAC_UDTO_SearchHRDeptEmpById?isPlanish=true',
	//新增服务地址
    addUrl:'/RBACService.svc/RBAC_UDTO_AddHRDeptEmp',
    //修改服务地址
    editUrl:'/RBACService.svc/RBAC_UDTO_UpdateHRDeptEmpByField',
	/**获取数据服务路径*/
	selectUrl2: '/RBACService.svc/RBAC_UDTO_SearchHRDeptEmpByHQL?isPlanish=true',
	//是否启用保存按钮
	hasSave:true,
	//是否重置按钮
	hasReset:true,
	...
	createItems:function(){
		...
		var items = [
			...
			{fieldLabel: '部门',xtype: 'uxCheckTrigger1',
