 ...
 * @version 2016-08-12
 */
Ext.define('Shell.class.qms.equip.register.Form', {
	 ...
	 * 数据保存
	 */
	SaveMaintenanceData: function(obj2, TempletID,type,operatedate,ItemMemo,isTbAdd,BatchNumber,TempletBatNo,IsAdd) {
...
//      var OperateTime = JcallShell.Date.toString(operatedate);
		...
		var Sysdate = JcallShell.System.Date.getDate();
		var OperateTime= JcallShell.Date.toString(Sysdate);
