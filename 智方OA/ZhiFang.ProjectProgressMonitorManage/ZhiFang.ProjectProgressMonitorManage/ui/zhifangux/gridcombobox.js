 ...
 * 
 * Example:
 * var com2 = Ext.create('Ext.zhifangux.gridcombobox',{
 *  	store:store,
 *  	columns:[
 *			{text:'值',dataIndex:'value',width:60},
 *			{text:'名称',dataIndex:'text',width:120},
 *			{text:'类别',dataIndex:'type',width:80}
 *		],
 *		valueField:'value',//值
 *		displayField:'text',//显示文字
 *		minWidth:300,
 *		maxHeight:200,
 *		queryFields:['value','text','type'],
 *		forceSelection:false//true:所选的值必须存在于列表中;false:允许设置任意文本
 *	});
 */
Ext.ns('Ext.zhifangux');
Ext.define('Ext.zhifangux.gridcombobox',{
