...
Ext.onReady(function(){	
	...
	Ext.define("Ext.data.Connection", {
        ...
        request : function(options) {
        	...
        	var ServerCurrentTimeKey = JShell.System.Cookie.get(JShell.System.Cookie.map.SERVERCURRENTTIMEKEY);
        	if(userId && ServerCurrentTimeKey){
	        	...
	        	for(var i=0;i<MD5Count;i++){
	        		keyValue = JShell.MD5.encode(keyValue);
	        	}
	        	options.headers['User-Agent-ZF'] = keyValue;
        	}
