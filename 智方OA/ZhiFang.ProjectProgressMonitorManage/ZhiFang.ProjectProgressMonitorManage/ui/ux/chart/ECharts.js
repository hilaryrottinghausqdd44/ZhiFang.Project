...
Ext.define('Shell.ux.chart.ECharts',{
	...
	createChart:function(config){
		...
		require.config({
		    paths:{
		        'echarts':JShell.System.Path.UI+'/echarts/' + me.fileName,
		        'echarts/theme/macarons':JShell.System.Path.UI+'/echarts/theme/macarons',
		        'echarts/chart/line':JShell.System.Path.UI+'/echarts/' + me.fileName,
		        'echarts/chart/bar':JShell.System.Path.UI+'/echarts/' + me.fileName,
		        'echarts/chart/pie':JShell.System.Path.UI+'/echarts/' + me.fileName,
		        'echarts/chart/funnel':JShell.System.Path.UI+'/echarts/' + me.fileName
		    }
		});
		
		require(requireId,function(ec,theme){
