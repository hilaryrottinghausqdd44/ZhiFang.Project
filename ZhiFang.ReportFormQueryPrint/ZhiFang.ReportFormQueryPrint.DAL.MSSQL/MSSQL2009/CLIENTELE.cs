...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL2009
{
	...
	public class CLIENTELE:IDCLIENTELE
	{
		...
		public int Add(Model.CLIENTELE model)
		{
			...
			{
				strSql1.Append("ClientReportTitle,");
				strSql2.Append("'"+model.ClientReportTitle+"',");
			}
			if (model.IsPrintItem != null)
			{
				strSql1.Append("IsPrintItem,");
				strSql2.Append(""+model.IsPrintItem+",");
			}
			if (model.CZDY1 != null)
			{
		...
		public int Update(Model.CLIENTELE model)
		{
			...
			if (model.ClientReportTitle != null)
			{
				strSql.Append("ClientReportTitle='"+model.ClientReportTitle+"',");
			}
			if (model.IsPrintItem != null)
			{
				strSql.Append("IsPrintItem="+model.IsPrintItem+",");
			}
			if (model.CZDY1 != null)
			{
		...
		public Model.CLIENTELE GetModel(int ClIENTNO)
		{
			...
			strSql.Append(" ClIENTNO,CNAME,ENAME,SHORTCODE,ISUSE,LINKMAN,PHONENUM1,ADDRESS,MAILNO,EMAIL,PRINCIPAL,PHONENUM2,CLIENTTYPE,bmanno,romark,titletype,uploadtype,tstamp,printtype,InputDataType,reportpagetype,clientarea,clientstyle,FaxNo,AutoFax,ClientReportTitle,IsPrintItem,CZDY1,CZDY2,CZDY3,CZDY4,CZDY5,CZDY6 ");
