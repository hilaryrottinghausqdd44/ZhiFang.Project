...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL2009
{
	...
	public class TestItem:IDTestItem
	{
		...
		public Model.TestItem GetModel(int ItemNo)
		{
			...
			strSql.Append(" ItemNo,CName,EName,ShortName,ShortCode,DiagMethod,Unit,IsCalc,Visible,DispOrder,Prec,IsProfile,OrderNo,StandardCode,ItemDesc,FWorkLoad,Secretgrade,Cuegrade,IsDoctorItem,IschargeItem,tstamp,HisDispOrder,Price,SuperGroupNo ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ItemNo,CName,EName,ShortName,ShortCode,DiagMethod,Unit,IsCalc,Visible,DispOrder,Prec,IsProfile,OrderNo,StandardCode,ItemDesc,FWorkLoad,Secretgrade,Cuegrade,IsDoctorItem,IschargeItem,tstamp,HisDispOrder,Price,SuperGroupNo ");
            strSql.Append(" FROM TestItem ");
            if (strWhere.Trim() != "")
            {
