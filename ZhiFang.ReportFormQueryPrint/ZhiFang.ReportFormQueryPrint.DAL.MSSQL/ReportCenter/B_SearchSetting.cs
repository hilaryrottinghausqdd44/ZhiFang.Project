...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.ReportCenter
{
    ...
    public class BSearchSetting : IDBSearchSetting
    {
        ...
        public int Update(Model.BSearchSetting t)
        {
            ...
            {
                builder.Append(",JsCode=" +"'"+ t.JsCode.Replace("'", "''") + "'");
            }
            ...
            {
                builder.Append(",Listeners=" + "'" + t.Listeners.Replace("'", "''") + "'");
            }
            ...
            ZhiFang.Common.Log.Log.Debug("B_SearchSetting.Update sql:"+builder.ToString());
