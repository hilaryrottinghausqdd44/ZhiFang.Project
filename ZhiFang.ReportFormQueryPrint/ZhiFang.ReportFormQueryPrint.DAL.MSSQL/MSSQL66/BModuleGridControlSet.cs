...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66
{
    public class BModuleGridControlSet : IDBModuleGridControlSet
    {
        public int Add(Model.BModuleGridControlSet t)
        {
            ...
            strSql.Append(")");
            ZhiFang.Common.Log.Log.Debug("ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66.B_Module_GridControlSet.Add sql = " + strSql.ToString());
        ...
        public int deleteById(long id)
        {
            ...
            ZhiFang.Common.Log.Log.Debug("ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66.B_Module_GridControlSet.deleteById sql = " + sql);
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Debug("BModuleGridControlSet_GetList:条件不符合规范 strWhere=" + strWhere);
                return ds;
            }

            string sql = "select * from B_Module_GridControlSet where " + strWhere;
            ZhiFang.Common.Log.Log.Debug("ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66.BModuleGridControlSet_GetList:sql=" + sql);
        ...
        public DataSet GetListSort(string strWhere, string sortFields)
        {
            ...
            if (strWhere == null || strWhere.Length < 1)
            {
                ZhiFang.Common.Log.Log.Debug("ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66.BModuleGridControlSet_GetListSort:条件不符合规范 strWhere=" + strWhere);
                return ds;
            }
            ...
            ZhiFang.Common.Log.Log.Debug("ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66.BModuleGridControlSet_GetListSort:sql=" + sql);
            return DbHelperSQL.Query(sql);
        }
        ...
        public int Update(Model.BModuleGridControlSet t)
        {
            ...
            ZhiFang.Common.Log.Log.Debug("ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66.BModuleGridControlSet.Update" + builder.ToString());
