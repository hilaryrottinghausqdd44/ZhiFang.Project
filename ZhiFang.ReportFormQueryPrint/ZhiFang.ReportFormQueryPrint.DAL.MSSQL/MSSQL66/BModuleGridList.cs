...
{
    public class BModuleGridList : IDBModuleGridList
    {
        public int Add(Model.BModuleGridList t)
        {
            ...
            strSql.Append("insert into B_Module_GridList(");
            strSql.Append(strSql1.ToString());
            strSql.Append(")");
            strSql.Append(" values (");
            strSql.Append(strSql2.ToString());
            strSql.Append(")");
            ZhiFang.Common.Log.Log.Debug("B_Module_GridList.Add sql = " + strSql.ToString());
        ...
        {
            int i = 0;
            string sql = "delete from B_Module_GridList where GridID=" + id;
            ZhiFang.Common.Log.Log.Debug("B_Module_GridList.deleteById sql = " + sql);
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Debug("BModuleGridList_GetList:条件不符合规范 strWhere=" + strWhere);
                return ds;
            }

            string sql = "select * from B_Module_GridList where " + strWhere;
            ZhiFang.Common.Log.Log.Debug("BModuleGridList_GetList:sql=" + sql);
        ...
        public int Update(Model.BModuleGridList t)
        {
            ...
            builder.Append("UPDATE B_Module_GridList SET ");
            ...
            builder.Append(" WHERE GridID=" + t.GridID);
