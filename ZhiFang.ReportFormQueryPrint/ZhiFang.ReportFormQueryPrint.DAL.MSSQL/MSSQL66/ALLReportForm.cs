...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.MSSQL66
{
    public class ALLReportForm : IDAL.IDALLReportForm
    {
        ...
        public DataTable GetFromGraphList(string FormNo)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Debug("GetFromGraphList.异常：" + ex.Message);
                return new DataTable();
            }
        }
        ...
        public DataSet SampleStateTailAfter(string ReportFormID)
        {
            ...
            if (ReportFormID.Trim() != "")
            {
                ...
                strSql.Append(" and ReceiveDate = '" + receivedate + "' and SectionNo = " + sectionno + " and TestTypeNo = " + testtypeno + " and SampleNo = '" + sampleno + "' ");
            }
            else
            {
