...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.Backups
{
	...
	/// 数据访问类ReportItem。
	/// </summary>
    public class BackupsReportItem
    {
        ...
        #region  成员方法
        public int Add(Model.ReportItem t)
        {
            throw new NotImplementedException();
        }

        public DataSet GetList(Model.ReportItem t)
        {
            throw new NotImplementedException();
        }
        ...
        public int Update(Model.ReportItem t)
        {
            throw new NotImplementedException();
        }
        #endregion
        ...
        public DataTable GetReportItemFullListByReportTemp(string FormNo)
        {
            try
            {
                #region 执行拼接脚本
