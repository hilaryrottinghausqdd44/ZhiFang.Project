...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.Backups
{
    ...
    /// 数据访问类ReportMicro。
    /// </summary>
    public class BackupsReportMicro
    {
        ...
        public int Add(Model.ReportMicro t)
        {
            throw new NotImplementedException();
        }

        public DataSet GetList(Model.ReportMicro t)
        {
            throw new NotImplementedException();
        }
        ...
        public int Update(Model.ReportMicro t)
        {
            throw new NotImplementedException();
        }
        ...
        public DataTable GetReportMicroList(string FormNo)
        {
            ...
            try
            {
                ...
                //}
                ZhiFang.Common.Log.Log.Debug("MSSQL.History.ReportMicro.GetReportMicroList:sql=" + strSql.ToString());
