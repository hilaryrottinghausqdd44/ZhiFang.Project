...
namespace ZhiFang.ReportFormQueryPrint.DAL.MSSQL.Backups
{
	...
	/// 数据访问类ReportMarrow。
	/// </summary>
    public class BackupsReportMarrow
    {
        ...
        public DataTable GetReportMarrowItemList(string FormNo)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Debug("MSSQL.Backups.GetReportMarrowItemList:" + e);
                return new DataTable();
            }
        }
        public DataSet GetReportMarrowFullList(string FormNo)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Debug("MSSQL.Backups.GetReportMarrowFullList:" + e);
                return new DataSet();
            }
        }
    }
