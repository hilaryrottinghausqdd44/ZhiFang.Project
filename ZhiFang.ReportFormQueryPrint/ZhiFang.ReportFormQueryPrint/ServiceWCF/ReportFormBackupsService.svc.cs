...
namespace ZhiFang.ReportFormQueryPrint.ServiceWCF
{
    ...
    public class ReportFormBackupsService : IReportFormBackupsService
    {
        private readonly ZhiFang.ReportFormQueryPrint.BLL.BBackupsReportForm barf = new BLL.BBackupsReportForm();
        private readonly ZhiFang.ReportFormQueryPrint.BLL.BNRequestItem bnri = new BLL.BNRequestItem();
        private readonly ZhiFang.ReportFormQueryPrint.BLL.Print.PrintBackupsReportForm bprf = new BLL.Print.PrintBackupsReportForm();
        private readonly ZhiFang.ReportFormQueryPrint.BLL.Print.BBackupsShowFrom bsf = new BLL.Print.BBackupsShowFrom();
        ...
        public BaseResultDataValue SelectReportSort(string Where, string fields, int page, int limit, string SerialNo, string sort)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Debug("ZhiFang.ReportFormQueryPrint.ServiceWCF.ReportFormBackupsService,方法：SelectReportSort");
                ZhiFang.Common.Log.Log.Debug(ex.ToString());
