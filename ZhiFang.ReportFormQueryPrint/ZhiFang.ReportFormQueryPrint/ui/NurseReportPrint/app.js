...
Ext.onReady(function(){	
	...
	if (cookie == null) {
	    window.location.href = Shell.util.Path.uiPath + '/UserSign/index.html';
	} else {
	    cookie = Ext.JSON.decode(cookie)[0];
	    cookie["dept"] = "";
	    if (getCookie("dept") !=null) {
	        cookie["dept"] = " 所属科室:" + getCookie("dept");
	    }
	}

	panel = Ext.create('Shell.NurseReportPrint.class.PrintApp', {
        region:"center",
	    header: false,
	...
	title = Ext.create("Shell.NurseReportPrint.class.title", {
	    region: 'north',
        padding:0,
        height: 30,
        frame: true,
