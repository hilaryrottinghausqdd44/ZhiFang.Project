 ...
 * @version 2014-10-15
 */
Ext.define('Shell.ReportPrint1.class.PrintApp',{
	...
	createApps:function(){
		var me = this;
		var apps = [{
			className:'Shell.ReportPrint1.class.PrintSearch',
			itemId:'PrintSearch',region:'north',
			split: true, collapsible: true,
			headCollapsed: me.headCollapsed,
			DateField: me.DateField
		},{
			className:'Shell.ReportPrint1.class.PrintList',
			...
			className:'Shell.ReportPrint1.class.PrintContent',autoScroll:true,
			...
			className:'Shell.ReportPrint1.class.PrintChart',
