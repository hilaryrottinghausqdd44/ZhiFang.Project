 ...
 * @version 2014-10-15
 */
Ext.define('Shell.ReportPrint.class.PrintPdfWin2', {
    ...
    showProgresstInfo: function () {
        ...
        var html = '<div style="padding:10px;">' + me.progressInfo.join("</br>") + '</div>';
    ...
    isPrinting: function (index) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            arr.push("<a style='margin-left:20px;'>" + row.DATE + " " + row.CNAME +
