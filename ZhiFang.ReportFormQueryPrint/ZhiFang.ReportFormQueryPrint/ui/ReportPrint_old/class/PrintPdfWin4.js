 ...
 * @version 2014-10-15
 */
Ext.define('Shell.ReportPrint.class.PrintPdfWin4', {
    ...
    iframeIsLoded: function (index, iframeId) {
        var me = this;
        ...
        if (pdf.attachEvent) {
            pdf.attachEvent("onload", function () {
                me.pdfIsLoded(pdf);
            });
        } else {
            pdf.onload = function () {
    ...
    initHtml: function (index) {
        ...
        if (iframe.attachEvent) {
            iframe.attachEvent("onload", function () {
                me.iframeIsLoded(index, iframeId);
            });
        } else {
