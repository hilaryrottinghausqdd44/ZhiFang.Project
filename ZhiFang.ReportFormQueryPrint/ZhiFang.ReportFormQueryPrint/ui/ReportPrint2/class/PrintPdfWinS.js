 ...
 * @version 2018-05-17
 */
Ext.define('Shell.ReportPrint2.class.PrintPdfWinS', {
	...
	onCreateProgressbarChange:function(num,count){
		var me = this,
			createProgressbar = me.progressInfoWin.getComponent('toolbar').getComponent('createProgressbar');
	...
	onPrintProgressbarChange:function(num,count){
		var me = this,
			printProgressbar = me.progressInfoWin.getComponent('toolbar2').getComponent('printProgressbar');
