Ext.define('Shell.ReportPrint2.class.PrintSearch',{
	...
	initComponent: function () {
	    ...
	    me.items = [[
            ...
            },
            {
                ...
                listeners: {
                    click: function () {
                        Shell.util.Win.open("Shell.reportSetting.setting", {
                            paramCodeNo:me.paramCodeNo,
	        ...
	        className: 'Shell.ReportPrint2.class.dept',
	        listeners: {
	    ...
	    },
            {
                ...
                labelAlign: 'right',
                itemId: 'secname',
                className: 'Shell.ReportPrint2.class.section',
                listeners: {
                    check: function (p, record) {
                        if (record == null) {
