Ext.define('Shell.reportSetting.class.PrintSetting.class.grid',{
	...
	createDockedItems: function () {
        ...
        var tooblar = Ext.create('Ext.toolbar.Toolbar', {
            ...
            { type: 'search', xtype: 'textfield', mark: 'in',itemId:"SECTIONNO", name: 'SECTIONNO', width: 130,hidden:true },
            {
                ...
                labelAlign: 'right',
                itemId: 'secname',
                className: 'Shell.reportSetting.class.PrintSetting.class.section',
                listeners: {
	                ...
	                console.log(record.get("SectionNo"));
	               	me.load();
	                p.close();
                    }
                }
            },
            {
                ...
                listeners: {
                    click: function () {
                        Shell.util.Win.open("Shell.reportSetting.class.PrintSetting.class.form", {
                        	title:"添加",
                        	width:400,
                        	formType:'add',
                        	height:330,
    ...
    deleteTemplate: function (records,store) {
        ...
        for (var i = 0; i < records.length; i++) {
        	console.log(records[i].data.SPID);
