 ...
 * @version 2014-10-15
 */
Ext.define('Shell.tiaoshi.class.PrintApp',{
		...
		PrintList && PrintList.on({
			...
			itemclick: function (view, record) {
			        ...
			        Shell.util.Action.delay(function () {
			            ...
			            PrintContent.GetNext(record.get("ReportFormID"), 1);
			        }, null, 200);
			},
			nodata:function(){
	...
	createApps:function(){
		...
		var apps = [{
		    ...
		    className: 'Shell.tiaoshi.class.PrintContent', autoScroll: true,
		    ...
		    className: 'Shell.tiaoshi.class.PrintChart',
