...
Ext.onReady(function(){	
	...
	Ext.Ajax.request({
	    url: Shell.util.Path.rootPath + '/ServiceWCF/DictionaryService.svc/GetAllPublicSetting?pageType=' + appType,
	    async: false,
	    method: 'get',
	...
	panel = Ext.create('Shell.TestReportPrint.class.PrintApp', Ext.apply(config, {
	    appType: appType,
	    //header: false,
