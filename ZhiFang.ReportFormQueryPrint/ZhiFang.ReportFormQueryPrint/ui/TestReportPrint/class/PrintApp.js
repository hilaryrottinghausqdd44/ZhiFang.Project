 ...
 * @version 2014-10-15
 */
Ext.define('Shell.TestReportPrint.class.PrintApp', {
	...
	showLoginWin: function (noCloseBtn, account) {
	    var me = this;
	    Shell.util.Win.open('Shell.login.Panel4', {
	        formtype: 'add',
	        resizable: false,
	...
	createApps:function(){
		var me = this;
		var apps = [{
		    className: 'Shell.TestReportPrint.class.PrintSearch',
		...
		//	DateField: me.DateField
		    ...
		    className: 'Shell.TestReportPrint.class.PrintList',
		    ...
		    className: 'Shell.TestReportPrint.class.PrintContent', autoScroll: true,
		    ...
		    className: 'Shell.TestReportPrint.class.PrintChart',
