...
Ext.define('Shell.login.Panel', {
    ...
    Account:'',
	/**登录服务地址*/
	loginUrl: '/ServiceWCF/DictionaryService.svc/UserLogin',
	...
	initComponent:function(){
		...
		me.icon = Shell.util.Path.uiPath + '/css/logo-16.png';
		me.title = "登录";
		var LogoSrc = Shell.util.Path.uiPath + '/css/LoginTop.jpg';
		me.dockedItems = [{
		    xtype: 'toolbar',
		    dock: 'top',
		    height: 156,
