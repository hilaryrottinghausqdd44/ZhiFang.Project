--郭海祥 2019-4-26
--6.6库试图新增字段RequestItemQueryDataSource，ReportFormQueryDataSource，ReportItemQueryDataSource，ReportMarrowQueryDataSource，ReportMicroQueryDataSource

--RequestItemQueryDataSource试图增加字段ReportTemp
ALTER VIEW [dbo].[RequestItemQueryDataSource]
AS
...
--ReportFormQueryDataSource试图增加字段
...
SELECT  (SELECT  ParaValue
                   ...
                   dgs.CName AS DiagName, '' AS LabID, '' AS MainTesterId, '' AS ActiveFlag
...
---ReportItemQueryDataSource试图新增字段
...
--ReportMarrowQueryDataSource试图新增字段
...
--ReportMicroQueryDataSource试图新增字段
