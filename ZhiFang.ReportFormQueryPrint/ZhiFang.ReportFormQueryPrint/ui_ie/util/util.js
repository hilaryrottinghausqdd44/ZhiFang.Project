...
Shell.util.Path = {
	...
	init:function(){
		...
		this.uiPath = this.rootPath + '/ui_ie';
...
Shell.util.Msg = {
	...
	showMsg:function(config,scope){
		...
		if(!backDiv){
			...
			msgDiv.style="background:red;opacity:1;border:solid 1px;margin:5px auto;";
			
			backDiv.appendChild(msgDiv);
		...
		msgDiv.style.height = height + "px";
		
		msgDiv.innerHTML = msg + '<input type="button" value="关闭" onclick="this.parentNode.parentNode.style.display=\'none\';"></input>';
...
//        		Shell.util.Path.uiPath + '/util/print/resources/install_lodop32.exe"></embed>' +
//    	'</object>';
    	...
    	embed.width = "0";
    	embed.height = "0";
    	//embed.pluginspage = Shell.util.Path.uiPath + "/util/print/resources/install_lodop32.exe";
