 ...
 * @version 2020-04-20
 */
Ext.define('Shell.class.labStar.basic.List',{
	...
	createGridColumns: function () {
	    ...
	    if(isAddPatNo){
	    	me.columns.push({dataIndex: 'PatNo', text: '病历号', width: 130, hideable: true, hidden: false});
	    }
	    //me.columns.push({dataIndex: 'CNAME', text: '姓名', width: 100, hideable: true, hidden: false});
	    //me.columns.push({dataIndex: 'SECTIONNO', text: '小组号', width: 130, hideable: true, hidden: false});
