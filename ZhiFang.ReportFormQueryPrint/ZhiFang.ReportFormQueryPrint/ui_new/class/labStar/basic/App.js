 ...
 * @version 2020-04-20
 */
Ext.define('Shell.class.labStar.basic.App',{
	...
	ListClassName:'Shell.class.labStar.basic.List',
	/**获取定义参数*/
	getParamsArray:function(){
		//定义标准的参数列表,自动过滤掉非标准的参数
		//住院：病历号、姓名、核收日期
		//门诊：卡号(自定义3)、姓名、核收日期
	    return ['PATNO', 'ZDY3', 'CNAME', 'RECEIVEDATE'];
	},
	...
	createApps:function(){
		var me = this;
		var apps = [{
			className:'Shell.class.labStar.basic.QueryPanel',
		...
		//	DateField: me.DateField
			...
			className:'Shell.class.labStar.basic.List',
			...
			className:'Shell.class.labStar.basic.Content',autoScroll:true,
