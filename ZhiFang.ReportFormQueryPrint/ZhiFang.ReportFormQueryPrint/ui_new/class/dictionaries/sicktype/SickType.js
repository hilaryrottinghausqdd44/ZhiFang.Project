Ext.define("Shell.class.dictionaries.sicktype.SickType", {
    ...
    checkOne: true,
    /**获取数据服务路径*/
    selectUrl: '/ServiceWCF/DictionaryService.svc/GetSickType?fields=SickTypeNo,CName',
    /**默认加载数据*/
    defaultLoad: true,
    /**带分页栏*/
        ...
        var columns = [{ xtype: 'rownumberer', text: '序号', width: 40, align: 'center' },
            {
                ...
                dataIndex: 'SickTypeNo', text: '主键ID', hidden: true, hideable: false, isKey: true, defaultRenderer: true
            }];
        return columns;
    },
    createtolb: function () {
