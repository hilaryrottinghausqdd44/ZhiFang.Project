Ext.define("Shell.class.dictionaries.higquery.operator", {
    ...
    checkOne: true,
    /**获取数据服务路径*/
    selectUrl: '/ServiceWCF/DictionaryService.svc/GetOperatorChecker',
        ...
        me.toolbars = me.toolbars || [{
            ...
            listeners: {
                search: function (m, v) {
                    ...
                    me.onSearch();
                    me.selectUrl = "/ServiceWCF/DictionaryService.svc/GetOperatorChecker";
                }
            }
        }];
