Ext.define("Shell.class.dictionaries.higquery.district", {
    ...
    checkOne: true,
    /**获取数据服务路径*/
    selectUrl: '/ServiceWCF/DictionaryService.svc/GetDistrict',
    /**默认加载数据*/
    defaultLoad: true,
    /**带分页栏*/
        ...
        var columns = [{ xtype: 'rownumberer', text: '序号', width: 40, align: 'center' },
            {
                ...
                dataIndex: 'DistrictNo', text: '主键ID', hidden: true, hideable: false, isKey: true, defaultRenderer: true
            }];
        return columns;
    },
    createtolb: function () {
        ...
        me.toolbars = me.toolbars || [{
            ...
            listeners: {
                search: function (m, v) {
                	console.log(v);
                    me.selectUrl += "?Where="+encodeURI("CName like '%" + v.value + "%'");
                    me.onSearch();
                    me.selectUrl = "/ServiceWCF/DictionaryService.svc/GetDistrict";
                }
            }
        }];
