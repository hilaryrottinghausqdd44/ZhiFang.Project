Ext.define("Shell.class.dictionaries.higquery.wardNo", {
    ...
    checkOne: true,
    /**获取数据服务路径*/
    selectUrl: '/ServiceWCF/DictionaryService.svc/GetWardType',
    /**默认加载数据*/
    defaultLoad: true,
    /**带分页栏*/
        ...
        var columns = [{ xtype: 'rownumberer', text: '序号', width: 40, align: 'center' },
            {
                ...
                dataIndex: 'WardNo', text: '主键ID',  hideable: false, isKey: true, defaultRenderer: true
            }];
        return columns;
    },
    createtolb: function () {
        ...
        me.toolbars = me.toolbars || [{
            ...
            listeners: {
                search: function (m, v) {
                    ...
                    me.onSearch();
                    me.selectUrl = "/ServiceWCF/DictionaryService.svc/GetWardType";
                }
            }
        }];
