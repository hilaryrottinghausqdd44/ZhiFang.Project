...
Ext.onReady(function(){	
	...
	var UserNo = getCookie("ULUserNo");
	var UserCName = getCookie("ULUserCName");
	var ShortCode = getCookie("ULShortCode");
  	var cookie = {UserNo:UserNo,CName:UserCName,ShortCode:ShortCode,dept:""};
	
	if (UserNo == null|| UserNo == "") {
	    window.location.href = Shell.util.Path.uiPath + '/class/userSign/index.html';
	} else {
		dept = getCookie("ULdept");
	    if (dept && dept != null && dept !="") {
	        cookie.dept = " 所属科室:" + dept;
	    }
	}
	...
	panel = Ext.create('Shell.class.basic.App', Ext.apply(config, {
	    appType: appType,
	    region: "center",
	    title:'护士站',
	...
	title = Ext.create("Shell.class.nurse.Title", {
        region: 'north',
        padding: 0,
        height: 30,
        frame: true,
