 ...
 * @version 2018-09-20
 */
Ext.define('Shell.class.jianyanzhixingdiaoyong.PdfWins', {
	...
	//每次生成的数量
	createCount:5,
    selectUrl: Shell.util.Path.rootPath + '/ServiceWCF/ReportFormService.svc/GetReportFromByReportFormID',
    
    ReportFormIdList:'',
    ReportFormPrintResult:[],
    //是否使用clodop方式打印
	IsUseClodopPrint:'true',
