Ext.define('Shell.class.lis.basic.ProjectContrast',{
				...
				handler:function(){
					...
					if(DateTime){
						...
						if(me.QueryType == 'REQUEST'){
							questURl = '/ServiceWCF/ReportFormService.svc/RequestResultDataTimeMhistory';
						}else{
							questURl = '/ServiceWCF/ReportFormService.svc/ResultDataTimeMhistory';
						}
						...
						Ext.Ajax.request({
							method: 'POST',
							async: false,
						    url: Shell.util.Path.rootPath + questURl,
