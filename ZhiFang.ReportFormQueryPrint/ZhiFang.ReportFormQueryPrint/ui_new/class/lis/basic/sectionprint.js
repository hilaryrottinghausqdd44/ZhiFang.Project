Ext.define("Shell.class.lis.basic.sectionprint", {
    ...
    sectionNo:'',
    /**获取数据服务路径*/
    selectUrl: '/ServiceWCF/DictionaryService.svc/GetSectionPrintListBySectionNo',
    ...
    onBeforeLoad:function(){
		var me = this;
		me.selectUrl += '?SectionNo='+me.sectionNo;
    ...
    createGridColumns: function () {
        ...
        var columns = [{ xtype: 'rownumberer', text: '序号', width: 40, align: 'center' },
            ...
            {
                dataIndex: 'PrintProgram', text: '模板名称', flex: 1, minWidth: 100, defaultRenderer: true
            },
            {
                dataIndex: 'SectionNo', text: '小组号', hidden: true, hideable: false, isKey: true, defaultRenderer: true
            },
        	{
                dataIndex: 'SPID', text: '主键ID', hidden: true, hideable: false, isKey: true, defaultRenderer: true
            }];
        return columns;
    },
    createtolb: function () {
        ...
        me.toolbars = me.toolbars || [{
            ...
            listeners: {
                search: function (m, v) {
                    ...
                    me.onSearch();
                    me.selectUrl = "/ServiceWCF/DictionaryService.svc/GetPGroupPaging?fields=SectionNo,CName";
                }
            }
        }];
