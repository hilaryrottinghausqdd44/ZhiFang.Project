 ...
 * @version 2018-09-20
 */
Ext.define('Shell.class.siteQuery.basic.List',{
	...
	Mhistor:function(store,record,response){
		...
		Shell.util.Win.open('Shell.class.siteQuery.basic.ProjectContrast', {   
	...
	createDockedItems: function () {
	    ...
	    dockedItems.push(Ext.create('Shell.class.siteQuery.basic.PdfWinS', {
	        itemId: 'PdfWin',
	        header: false,
	        height: 0,
	        width: 0,
