 ...
 * @version 2018-09-20
 */
Ext.define('Shell.class.siteQuery.basic.App',{
	...
	afterRender:function(){
		...
		var  ClienteleName= QueryPanel.getItem('ClienteleName');
		var DeptNo = "";
		for(var i=0; i<me.dept.length;i++){
			if(i==0){
				DeptNo += me.dept[i].DeptNo;
			}else{
				DeptNo += ","+me.dept[i].DeptNo;
			}
		}
		...
		if(ClienteleName == null || ClienteleName == ""){
			QueryPanel.getItem('DeptNo').setValue("("+DeptNo+")");
		}
	},
	...
	createApps:function(){
		...
		var apps = [{
			className:'Shell.class.siteQuery.basic.QueryPanel',
		...
		//	DateField: me.DateField
			...
			className:'Shell.class.siteQuery.basic.List',
			...
			className:'Shell.class.siteQuery.basic.Content',autoScroll:true,
			...
			className:'Shell.class.siteQuery.basic.HistoryCompare',
