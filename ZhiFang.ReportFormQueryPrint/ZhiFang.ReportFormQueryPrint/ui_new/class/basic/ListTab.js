 ...
 * @version 2019-7-24
 */
Ext.define('Shell.class.basic.ListTab', {
    ...
    createItems:function () {
        var me = this;
        me.Report = Ext.create("Shell.class.basic.ReportList", {
            title: '已出报告',
            itemId:'ReportList',
			...
			MaxDownLoadNum:me.MaxDownLoadNum,
			IsUseClodopPrint:me.IsUseClodopPrint
        });
        me.Request = Ext.create("Shell.class.basic.RequestList", {
            title: '未出报告',
            itemId:'RequestList',
            printCountSetting:me.printCountSetting,
            header: false,
