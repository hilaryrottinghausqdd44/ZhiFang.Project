 ...
 * @version 2020-01-08
 */
Ext.define('Shell.class.historyAndBackups.backupsBasic.Content', {
    ...
    /**获取数据服务路径*/
    getImgeSrcUrl: '/ServiceWCF/ReportFormBackupsService.svc/PreviewReport',
    /**返回数据类型,1:报告;2:结果*/
    resultType: 1,
    ...
    initComponent: function () {
        ...
        me.toolbars = [{
            dock: 'top', itemId: 'toptoolbar', buttons: ['->', {
                xtype: 'uxradiogroup', itemId: 'type1', defaultSelect: 1, margin: '0 10 0 0',
                data: radioDataArr,
    ...
    getResultTypeValue: function () {
        var me = this,
			type = me.getComponent('toptoolbar').getComponent('type1'),
    ...
    getContent: function (params, callback) {
        ...
        if (ModelType == "report") {
		    ...
		    var url = "/ServiceWCF/ReportFormBackupsService.svc/GetReportFormPDFByReportFormID";
        ...
        if (me.hasLoadMask) { me.body.mask(me.loadingText); }//显示遮罩层
        	me.getImgeSrcUrl = "/ServiceWCF/ReportFormBackupsService.svc/PreviewReport";
