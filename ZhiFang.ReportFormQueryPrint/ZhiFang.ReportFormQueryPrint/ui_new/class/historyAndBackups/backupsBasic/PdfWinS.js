 ...
 * @version 2020-01-08
 */
Ext.define('Shell.class.historyAndBackups.backupsBasic.PdfWinS', {
	...
	/**增加打印次数服务路径*/
	addPrintTimesUrl: Shell.util.Path.rootPath + '/ServiceWCF/ReportFormBackupsService.svc/ReportFormAddUpdatePrintTimes',
	//生成报告服务
    createReportUrl:'/ServiceWCF/ReportFormBackupsService.svc/GetReportFormPDFByReportFormID',
    //合并打印生成报告服务
    MergeCreateReportUrl: '/ServiceWCF/ReportFormBackupsService.svc/GetMergReportFromByReportFormIdList',
    //是否和并打印
    isMerg: false,
	/**是否浏览打印*/
	isView: false,
