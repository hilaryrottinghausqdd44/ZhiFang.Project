 ...
 * @version 2020-01-08
 */
Ext.define('Shell.class.historyAndBackups.basic.App',{
	...
	ListClassName:'Shell.class.historyAndBackups.basic.List',
	//是否使用c_lodop打印
	...
	initComponent:function(){
		var me = this;
		if(me.IsQueryRequest+"" == "true" ){
			me.ListClassName = 'Shell.class.historyAndBackups.basic.ListTab';
		}else{
			me.ListClassName = 'Shell.class.historyAndBackups.basic.List';
		}
	...
	createApps:function(){
		...
		me.IsUseClodopPrint+="";
		var apps = [{
			className:'Shell.class.historyAndBackups.basic.QueryPanel',
		...
		//	DateField: me.DateField
			...
			className:'Shell.class.historyAndBackups.basic.Content',autoScroll:true,
			...
			className:'Shell.class.historyAndBackups.basic.HistoryCompare',
