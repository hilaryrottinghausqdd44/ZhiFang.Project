 ...
 * @version 2020-01-08
 */
Ext.define('Shell.class.historyAndBackups.basic.ListTab', {
    ...
    createItems:function () {
        var me = this;
        me.Report = Ext.create("Shell.class.historyAndBackups.basic.ReportList", {
            title: '已出报告',
            itemId:'ReportList',
        ...
        me.Request = Ext.create("Shell.class.historyAndBackups.basic.RequestList", {
            title: '未出报告',
            itemId:'RequestList',
            printCountSetting:me.printCountSetting,
            header: false,
