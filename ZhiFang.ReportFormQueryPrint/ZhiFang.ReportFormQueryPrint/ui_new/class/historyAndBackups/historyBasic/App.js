 ...
 * @version 2020-01-08
 */
Ext.define('Shell.class.historyAndBackups.historyBasic.App',{
	...
	ListClassName:'Shell.class.historyAndBackups.historyBasic.List',
	//是否使用c_lodop打印
	...
	initComponent:function(){
		var me = this;
		if(me.IsQueryRequest+"" == "true" ){
			me.ListClassName = 'Shell.class.historyAndBackups.historyBasic.ListTab';
		}else{
			me.ListClassName = 'Shell.class.historyAndBackups.historyBasic.List';
		}
	...
	createApps:function(){
		...
		me.IsUseClodopPrint+="";
		var apps = [{
			className:'Shell.class.historyAndBackups.historyBasic.QueryPanel',
		...
		//	DateField: me.DateField
			...
			className:'Shell.class.historyAndBackups.historyBasic.Content',autoScroll:true,
			...
			className:'Shell.class.historyAndBackups.historyBasic.HistoryCompare',
