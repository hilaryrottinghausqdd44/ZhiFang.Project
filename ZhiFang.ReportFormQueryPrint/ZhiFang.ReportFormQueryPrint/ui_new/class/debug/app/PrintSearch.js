 ...
 * @version 2014-10-15
 */
Ext.define('Shell.class.debug.app.PrintSearch',{
	...
	initComponent: function () {
	    ...
	    me.items = [[
            ...
            store: Ext.create('Ext.data.Store', {
            	...
            	change:function(m,v){
            		me.items.items[1].getComponent(me.DateField).name = v;
            	}
            }
            },
//		    {
...
//		    },
	        ...
	        className: 'Shell.tiaoshi.class.dept',
	        listeners: {
	    ...
	    },
            {
                ...
                labelAlign: 'right',
                itemId: 'secname',
                className: 'Shell.tiaoshi.class.section',
                listeners: {
                    check: function (p, record) {
                        if (record == null) {
