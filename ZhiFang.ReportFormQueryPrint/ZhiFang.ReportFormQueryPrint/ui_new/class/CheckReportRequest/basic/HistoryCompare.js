 ...
 * @version 2020-09-04
 */
Ext.define('Shell.class.CheckReportRequest.basic.HistoryCompare',{
	extend:'Shell.ux.panel.Panel',
	
	requires:[
		'Shell.ux.form.field.DateArea',
		'Shell.ux.chart.LineChartNew'
	],
	...
	getOptionData:function(list){
			...
			option = {
				tooltip:{
                    ...
                    formatter: function(params){
						var info = me.getInfoByX(params[0].name);
				...
				yAxis:[{type:'value'}],
				series: [{ type: 'value', name: lineName, data: [], RefRange:[]}],
				toolbox:{
			        show:true,
			        feature:{
			            mark:{show:true},
		...
		for (var i = 0; i < len; i++){
			...
			option.series[0].RefRange.push(list[i].RefRange);
		}
