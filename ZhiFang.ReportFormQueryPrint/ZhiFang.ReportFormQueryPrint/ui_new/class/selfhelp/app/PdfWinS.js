 ...
 * @version 2018-09-20
 */
Ext.define('Shell.class.selfhelp.app.PdfWinS', {
	...
	/**增加打印次数服务路径*/
	addPrintTimesUrl: Shell.util.Path.rootPath + '/ServiceWCF/ReportFormService.svc/ReportFormAddUpdateClientPrintTimes',
	//生成报告服务
	...
	ClodopPrint:function(index){
		...
		if(me.clodopPreviewPrint){
			...
			//直接打印
			index++;
			ZFPrint.pdf.print(urlList,'正在打印'+url,function() {
