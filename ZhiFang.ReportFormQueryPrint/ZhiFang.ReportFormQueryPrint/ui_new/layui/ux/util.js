...
layui.define('jquery', function (exports) {
    ...
    var uxutil = {
        ...
        path: {
            ...
            init: function () {
                ...
                //this.getLabStarRootPath(function (p) { uxutil.path.LABSTARPATH = p; });
            },
            getLocal: function () {
            ...
            getLabStarRootPath: function (callback) {
                var url = this.ROOT + '/ServiceWCF/DictionaryService.svc/GetConfigLabStarUrl',
                    p = this.LOCAL + '/ZhiFang.LabStar.TechnicianStation';
        ...
        server: {
            ...
            date: {
                ...
                getTimes: function () {
                    if(top.layui.system){
                    	return top.layui.system.date.getTimes();
                	}else{
                		console && console.log("请引入system插件，位置：ux/zf/system");
                	}
                },
        ...
        Adobe: {
            //地址
            Url: ROOT + '/web_src/adobe/Adobe Reader XI_11.0.0.379.exe',
            //IE8下载地址
            IE8Url: ROOT + '/web_src/ie/IE8-WindowsXP-x86-CHS.exe',
            //下载HTML内容
    ...
    //uxutil.path.init();
    uxutil.path.getLabStarRootPath(function (p) { uxutil.path.LABSTARPATH = p; });
    //暴露接口
