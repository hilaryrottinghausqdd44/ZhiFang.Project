...
layui.extend({
	...
	app.url = {
		//小组模板
		selectUrl: uxutil.path.ROOT + '/ServiceWCF/DictionaryService.svc/GetSectionPrintList',
		//小组
		...
		//就诊类型
		sickTypeselectUrl: uxutil.path.ROOT +'/ServiceWCF/DictionaryService.svc/GetSickType?fields=SickTypeNo,CName',
		//添加小组打印
