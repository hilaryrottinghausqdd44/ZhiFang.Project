...
layui.extend({
    uxutil: 'ux/util',
    mainTable: 'class/setting/public/tableColumn_client/mainTable'
    ...
    function init() {
        ...
        setTimeout(function () {
            ...
            var IUrl = uxutil.path.ROOT + '/ui_new/layui/class/setting/public/tableColumn_client/main/app.html';
    ...
    function initGroupListeners() {
        ...
        layui.onevent('rightTableOnSearch', 'search', function (obj) {
            ...
            if (IFrame.layui.mainTable)
                IFrame.layui.mainTable.onSearch('mainTable', { GridCode: obj["GridCode"] });
            else
                setTimeout(function () {
                    IFrame.layui.mainTable.onSearch('mainTable', { GridCode: obj["GridCode"] });
                }, 500);
        ...
        layui.onevent('noData', 'noData', function (obj) {
            var IFrame = $("#rightTableIframe")[0].contentWindow;
            if (IFrame.layui.mainTable)
                IFrame.layui.mainTable.onSearch('mainTable', { GridCode: '1' });
            else
                setTimeout(function () {
                    IFrame.layui.mainTable.onSearch('mainTable', { GridCode: '1' });
                }, 500);
