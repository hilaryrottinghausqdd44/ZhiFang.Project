 ...
 * echart图包含项目的范围直线
 */
Ext.define('Shell.ux.chart.EChartsNew',{
	...
	createChart:function(config){
		...
		require.config({
		    paths:{
		  //      'echarts':Shell.util.Path.rootPath+'/web_src/echarts/echarts',
				//'echarts/chart/bar':Shell.util.Path.rootPath+'/web_src/echarts/echarts'
				
				'echarts': Shell.util.Path.rootPath +'/web_src/echarts/new/4.4.0/echarts',
				'echarts/chart/bar': Shell.util.Path.rootPath +'/web_src/echarts/new/4.4.0/echarts'
		    }
		});
