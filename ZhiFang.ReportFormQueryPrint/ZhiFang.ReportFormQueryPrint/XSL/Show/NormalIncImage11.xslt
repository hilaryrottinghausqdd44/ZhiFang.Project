  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="margin-bottom:10px;border-top:#000000 solid 1px; border-bottom:#000000 solid 1px;">
        <tr>
          <td width="10%" colspan="2" style="border-bottom:#000000 solid 1px;">项目代号</td>
          <td style="border-bottom:#000000 solid 1px;" width="40%">项目名称</td>
          <td width="15%" colspan="2" style="border-bottom:#000000 solid 1px;">结果</td>
          <td width="15%" style="border-bottom:#000000 solid 1px;">单位</td>
          <td style="border-bottom:#000000 solid 1px;" width="20%">参考值</td>
        </tr>
		<xsl:for-each select="WebReportFile/ReportItem">
        <tr>
          <td style=" padding-left:1em;"><xsl:value-of select="DISPLAYID"/></td>
          <td><xsl:value-of select="ItemEName"/></td>
          <td><xsl:value-of select="TESTITEMNAME"/></td>
          <td width="5%"><xsl:value-of select="REPORTVALUE"/></td>
