            ...
            <td style="border-top:2px solid #e0e0e0;">
              <table id="normalxsl" class="normitem" style="width:100%;">
                ...
                <xsl:for-each select="WebReportFile/ReportItem">
                  <tr id="tr_{position()}"
									onclick="parent.printResult(document.getElementById('hidden_patno').value,'{ITEMNO}','item','{RECEIVEDATE}');

(document.getElementById('tmptrid').value=='tr_{position()}')?document.getElementById(document.getElementById('tmptrid').value).style.background='#e0e0e0':document.getElementById

(document.getElementById('tmptrid').value).style.background='#ffffff';document.getElementById('tmptrid').value='tr_{position()}';">
                      ...
                      <xsl:if test="position() =1 ">
                        <table>
                          <tr style="display:none;" >
                            <td  id="aaa" onclick="parent.printResult

('{PATNO}','{ITEMNO}','item','{RECEIVEDATE}');document.getElementById('tr_{position()}').style.background='#2394af';document.getElementById('tmptrid').value='tr_{position()}'" >111</td>
                          </tr>
                        </table>
                      </xsl:if>
                    </td>
          ...
          <xsl:for-each select="WebReportFile/ReportGraph">
            <xsl:choose>
              <xsl:when test="position()=1">
                <div style="height:200px; width:200px; margin:5px;line-height:24px;background:#ffffff;" id="tr_{position()}"  >
