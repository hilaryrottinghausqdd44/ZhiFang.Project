...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:13px;text-align:left; ">
  <tr>
	...
	<table id="normalxsl" class="normitem" width="100%" border="0" cellspacing="1" cellpadding="0" style="">
        <tr style=" font-size:13px; font-weight:bold;background-color:#93c6ec;padding-left:0.5em; padding-right:0.5em;">
		...
		<!--<td style="padding-left:0.5em; padding-right:0.5em;white-space:nowrap">操作</td>this.style.background='#ffff99';-->
      </tr>
      <xsl:for-each select="WebReportFile/ReportItem">
        <tr style="height:22px; line-height:22px;background:#caecf4;" onclick="parent.printResult('{PATNO}','{ITEMNO}','item','{RECEIVEDATE}');" onmouseover="this.style.background='#2394af'" onmouseout="this.style.background='#caecf4'" >
			<td style="text-align:center;">
				<xsl:value-of select="position()"/>
				<xsl:if test="position() =1 ">
					<table>
						<tr style="display:none;" >
							<td  id="aaa" onclick="parent.printResult('{PATNO}','{ITEMNO}','item','{RECEIVEDATE}');" >111</td>
						</tr>
					</table>
				</xsl:if>
			</td>
          <td style="padding-left:0.5em; padding-right:0.5em;"><xsl:value-of select="TESTITEMNAME"/></td>
          <td style="padding-left:0.5em; padding-right:0.5em;"><xsl:value-of select="TESTITEMENAME"/>
    ...
    <td align="LEFT" valign="TOP" width="160">
	  ...
	  <table id="yishu" width="158" border="0" cellspacing="0" cellpadding="0" style="font-size:13px;height:22px; line-height:22px;border:#eae7de solid 2px; text-align:left; text-indent:0.5em;">
	    <tr>
          <td width="154" bgcolor="#93c6ec" style=" font-weight:bold">医嘱信息</td>
        </tr>
