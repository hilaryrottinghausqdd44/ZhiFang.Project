...
<xsl:value-of select="WebReportFile/ReportMicro/ITEMNAME"/></td></tr>
	<tr>
	  <td style="padding-left:14px;"><xsl:value-of select="WebReportFile/ReportMicro/DESCNAME"/></td>
	</tr>
	<tr>
	  <td style="font-size:14px; ">细菌鉴定与药敏</td>
	</tr>
	<tr>
	  <td style="padding-left:14px;"><xsl:value-of select="WebReportFile/ReportMicro/MICRONAME"/></td>
	</tr>

	</table>
	<table width="100%" border="0" cellspacing="1" cellpadding="0" style="">
        <tr style=" font-size:13px; font-weight:bold;background-color:#8fd9fe;padding-left:0.5em; padding-right:0.5em;">
        <td style="padding-left:0.5em; padding-right:0.5em;white-space:nowrap">抗生素</td>
      ...
      <xsl:for-each select="WebReportFile/ReportMicro">
        <tr style="height:22px; line-height:22px;background:#CCFFFF;" onmouseover="this.style.background='#ffffcc'" onmouseout="this.style.background='#CCFFFF'" onclick="this.style.background='#ffff99'">
          ...
          <td style="padding-left:0.5em; padding-right:0.5em;"><xsl:value-of select="SUSCEPT"/></td>
        </tr>
      </xsl:for-each>
    </table></td>
