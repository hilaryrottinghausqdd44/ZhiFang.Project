      ...
      , c = function(e, t) {
        ...
        var L = !1
          , A = function(e) {
            ...
            v ? (x(),
            e && t.onPaste(e),
            v = !1) : e == h.substr(0) && c.selectionStart === 4 ? L ? t.execCommand("del", {
                source: "ace"
            }) : t.execCommand("backspace", {
                source: "ace"
            }) : p || (e.substring(0, 9) == h && e.length > h.length ? e = e.substr(9) : e.substr(0, 4) == h.substr(0, 4) ? e = e.substr(4, e.length - h.length + 1) : e.charAt(e.length - 1) == h.charAt(0) && (e = e.slice(0, -1)),
          ...
          , _ = function(e, n) {
            ...
            n ? t.onCut() : t.onCopy(),
            i.isIOS || r.preventDefault(e)) : (p = !0,
            c.value = s,
            c.select(),
            setTimeout(function() {
                p = !1,
          ...
          , H = function(e) {
            var n = M(e);
            typeof n == "string" ? (n && t.onPaste(n, e),
            i.isIE && setTimeout(x),
            r.preventDefault(e)) : (c.value = "",
            v = !0)
        };
        ...
        var B = function(e) {
          ...
          , F = function(e) {
            ...
            var r = setTimeout(function() {
                ...
                if (m)
                    return;
                e == n.lastValue ? T() : !n.lastValue && e && (T(),
                A(e))
            });
            k = function(i) {
                return r && clearTimeout(r),
                i = i.replace(/\x01/g, ""),
                i == n.lastValue ? "" : (n.lastValue && r && t.undo(),
                i)
            }
            ,
            t.onCompositionEnd(),
    ...
    var r = e("../lib/event")
      ...
      , c = function(e, t) {
        ...
        var C = function(e) {
          ...
          , k = function(e) {
            p ? p = !1 : C(n) ? (t.selectAll(),
            T()) : L && T(t.selection.isEmpty())
        }
          , L = null;
        this.setInputHandler = function(e) {
            L = e
        ...
        var A = !1
          , O = function(e) {
            ...
            d ? (T(),
            e && t.onPaste(e),
            d = !1) : e == c.charAt(0) ? A ? t.execCommand("del", {
                source: "ace"
            }) : t.execCommand("backspace", {
                source: "ace"
            }) : (e.substring(0, 2) == c ? e = e.substr(2) : e.charAt(0) == c.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == c.charAt(0) && (e = e.slice(0, -1)),
          ...
          , D = function(e, i) {
            ...
            if (!s)
                return r.preventDefault(e);
            _(e, s) ? (i ? t.onCut() : t.onCopy(),
            r.preventDefault(e)) : (p = !0,
            n.value = s,
            n.select(),
            setTimeout(function() {
                p = !1,
        ...
        var j = function(e) {
            if (v || !t.onCompositionStart || t.$readOnly)
                return;
            v = {},
            ...
            setTimeout(F, 0),
            t.on("mousedown", I),
            v.canUndo && !t.selection.isEmpty() && (t.insert(""),
            t.session.markUndoGroup(),
            t.selection.clearSelection()),
            t.session.markUndoGroup()
        }
          ...
          , I = function(e) {
            ...
            var s = setTimeout(function() {
                ...
                if (v)
                    return;
                e == r.lastValue ? N() : !r.lastValue && e && (N(),
                O(e))
            });
            L = function(n) {
                return s && clearTimeout(s),
                n = n.replace(h, ""),
                n == r.lastValue ? "" : (r.lastValue && s && t.undo(),
                n)
            }
            ,
            t.onCompositionEnd(),
    ...
    (function() {
        ...
        this.updateRowLine = function(e, t) {
            ...
            if (this.session.$useWrapMode) {
                ...
                n && (t === undefined && (t = this.getSplitIndex()),
            ...
            this.line = this.line.replace(/\t|[\u1100-\u2029, \u202F-\uFFE6]/g, function(e, t) {
                return e === "	" || s.isFullWidth(e.charCodeAt(0)) ? (u = e === "	" ? s.getScreenTabSize(t + o) : 2,
                o += u - 1,
                i.stringRepeat(r.DOT, u)) : e
            })
        }
        ,
        ...
        this.updateCharacterWidths = function(e) {
            ...
            this.charWidths[r.R_H] = s.isChrome ? n : n * .45,
        ...
        this.getPosLeft = function(e) {
            ...
            e === 0 && n[t] % 2 !== 0 && t++;
            for (var s = 0; s < t; s++)
                i += this.charWidths[n[s]];
            return e !== 0 && n[t] % 2 === 0 && (i += this.charWidths[n[t]]),
            this.wrapIndent && (i += this.wrapIndent * this.charWidths[r.L]),
            i
        }
        ,
        this.getSelections = function(e, t) {
            var n = this.bidiMap, i = n.bidiLevels, s, o = this.wrapIndent * this.charWidths[r.L], u = [], a = Math.min(e, t) - this.wrapIndent, f = Math.max(e, t) - this.wrapIndent, l = !1, c = !1, h = 0;
        ...
        this.offsetToCol = function(e) {
            ...
            return i > 0 && s[i - 1] % 2 !== 0 && s[i] % 2 === 0 ? (e < n && i--,
            t = this.bidiMap.logicalFromVisual[i]) : i > 0 && s[i - 1] % 2 === 0 && s[i] % 2 !== 0 ? t = 1 + (e > n ? this.bidiMap.logicalFromVisual[i] : this.bidiMap.logicalFromVisual[i - 1]) : this.isRtlDir && i === s.length - 1 && o === 0 && s[i - 1] % 2 === 0 || !this.isRtlDir && i === 0 && s[i] % 2 !== 0 ? t = 1 + this.bidiMap.logicalFromVisual[i] : (i > 0 && s[i - 1] % 2 !== 0 && o !== 0 && i--,
    ...
    (function() {
        ...
        this.drawTextMarker = function(t, n, i, s, o) {
            ...
            for (; l <= f; l++)
                ...
                d = i + (l == a ? " ace_start" : "") + " ace_br" + e(l == a || l == a + 1 && n.start.column, c < h, h > p, l == f),
                this.session.$bidiHandler.isBidiRow(l) ? this.drawBidiSingleLineMarker(t, v, d, s, l == f ? 0 : 1, o) : this.drawSingleLineMarker(t, v, d, s, l == f ? 0 : 1, o)
        }
        ,
        this.drawMultiLineMarker = function(e, t, n, r, i) {
            ...
            if (this.session.$bidiHandler.isBidiRow(t.end.row)) {
                ...
                e.push("<div class='", n, " ace_br12' style='", "height:", o, "px;", "width:", l, "px;", "top:", u, "px;", "left:", s, "px;", i, "'></div>")
            }
...
define("ace/layer/text", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/lib/event_emitter"], function(e, t, n) {
    ...
    (function() {
        ...
        this.$renderOverflowMessage = function(e, t, n, r) {
            ...
            e.push("<span style='position:absolute;right:0' class='ace_inline_button ace_keyword ace_toggle_wrap'>&lt;click to see more...&gt;</span>")
        }
        ,
