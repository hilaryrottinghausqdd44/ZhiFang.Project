...
{
    public class BHistoryReportForm
    {
        private readonly HistoryReportForm dal = new HistoryReportForm();
        private readonly HistoryReportItem drqi = new HistoryReportItem();
        private readonly HistoryReportMicro drqmi = new HistoryReportMicro();
