...
{
    public class BRequestForm
    {
        private readonly RequestForm dal = new RequestForm();
        private readonly RequestItem drqi = new RequestItem();
        private readonly RequestMicro drqmi = new RequestMicro();
        ...
        {
            return dal.GetRequestFormFullList(FormNo);
        }
        ...
        public bool RequestIsPrintNullValues(string ReportFormID, string st) {
            ...
            if (dtrf != null && dtrf.Rows.Count > 0)
            {
                ...
                switch ((SectionType)Convert.ToInt32(sectiontype))
                {
                    case SectionType.Normal:
                        ...
                        {
                            dt1 = drqi.GetRequestItemFullList(ReportFormID);
                        }
                    ...
                    case SectionType.Micro:
                        #region Micro                         
                        dt1 = drqmi.GetRequestMicroList(ReportFormID);
                        break;
                    #endregion
                ...
                switch ((SectionType)Convert.ToInt32(sectiontype))
                {
                    case SectionType.Normal:
                        ...
                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            {
                                dt1 = drqi.GetRequestItemFullList(b);
                            }
                    ...
                    case SectionType.Micro:
                        ...
                        {
                            string b = ds.Tables[0].Rows[i]["ReportFormID"].ToString();
                            DataTable dt3 = drqmi.GetRequestMicroList(b);
                    ...
                    case SectionType.MicroIncImage:
                        ...
                        {
                            string b = ds.Tables[0].Rows[i]["ReportFormID"].ToString();
                            DataTable dt4 = drqmi.GetRequestMicroList(b);
                    ...
                    default:
                        ...
                        {
                            string b = ds.Tables[0].Rows[i]["ReportFormID"].ToString();
                            DataTable dt6 = drqi.GetRequestItemFullList(b);
        ...
        {
            return dal.GetRequestFromByReportFormID(IdList, fields, strWhere);
