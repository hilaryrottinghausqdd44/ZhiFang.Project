...
{
    public class PrintRequestFormCommon
    {
        ...
        /// <returns></returns>
        /// 
        public List<ReportFormFilesVO> CreatRequestFormFilesByFRX(DataRow reportform, DataTable reportitem, DataTable reportgraph, string templatefullpath, ReportFormTitle rft)
        {
            ...
            if (ZhiFang.ReportFormQueryPrint.Common.FilesHelper.CheckAndCreatDir(savepath))
            {
                switch (reportformfiletype)
                {
                    ...
                    case "PDF":
                        #region PDF
                        RequestFormPDFExport tmppdf = new RequestFormPDFExport();
    ...
    public class RequestFormPDFExport : FastReport.Export.Pdf.PDFExport
    {
