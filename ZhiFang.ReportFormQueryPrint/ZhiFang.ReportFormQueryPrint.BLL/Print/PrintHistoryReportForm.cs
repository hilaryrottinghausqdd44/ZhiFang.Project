...
{
    public class PrintHistoryReportForm
    {
        ...
        {
            ZhiFang.ReportFormQueryPrint.DAL.MSSQL.History.RFGraphData bgd = new DAL.MSSQL.History.RFGraphData();
        ...
        {
            ZhiFang.ReportFormQueryPrint.BLL.BHistoryReportForm brf = new BHistoryReportForm();
            Model.HistoryReportForm brf_m = new Model.HistoryReportForm();
            List<ReportFormFilesVO> reportformfileslist = new List<ReportFormFilesVO>();
            BHistoryReportMicro rmfb = new BHistoryReportMicro();
            PrintHistoryReportFormCommon prfc = new PrintHistoryReportFormCommon();
