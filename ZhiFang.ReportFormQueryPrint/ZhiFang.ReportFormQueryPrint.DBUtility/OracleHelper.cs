...
namespace ZhiFang.ReportFormQueryPrint.DBUtility
{
    ...
    public abstract class OracleHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction = ZhiFang.ReportFormQueryPrint.Common.ConfigHelper.GetConfigString("OraConnString1");
        public static readonly string ConnectionStringInventoryDistributedTransaction = ZhiFang.ReportFormQueryPrint.Common.ConfigHelper.GetConfigString("OraConnString2");
        public static readonly string ConnectionStringOrderDistributedTransaction = ZhiFang.ReportFormQueryPrint.Common.ConfigHelper.GetConfigString("OraConnString3");
        public static readonly string ConnectionStringProfile =ZhiFang.ReportFormQueryPrint.Common.ConfigHelper.GetConfigString("OraProfileConnString");
        public static readonly string ConnectionStringMembership = ZhiFang.ReportFormQueryPrint.Common.ConfigHelper.GetConfigString("OraMembershipConnString");
