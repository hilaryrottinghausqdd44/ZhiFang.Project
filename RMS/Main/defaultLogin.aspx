<%@ Page language="c#" Codebehind="defaultLogin.aspx.cs" AutoEventWireup="false" Inherits="OA.Main._defaultLogin" %>
...
<HTML>
	<HEAD>
		...
		
		{
			...
			{
				//alert(window.document.all["textUserid"].value + ":" + window.document.all["textPassword"].value);
				//window.document.all["Label1"].innerHTML="正在登录....";
				var returnValue = OA.Main._defaultLogin.LoginHere('1','1','lizj','lizj');  
	...
	<body bgColor="#999999" onload="applyTransition()">
		...
		<form id="Form1" method="post" runat="server" onsubmit="return checked()">
