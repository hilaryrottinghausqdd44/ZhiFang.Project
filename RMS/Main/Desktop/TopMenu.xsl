  ...
  <xsl:template match="/TREENODES/treenode[@NodeData='Topmenu']">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <HEAD>
        ...
        <LINK rel="stylesheet" type="text/css" href="/RMS/images/images2008-12/css.css"/>
      </HEAD>
      <body bottomMargin="0" leftMargin="2" topMargin="5" rightMargin="1" bgcolor="#E3E3E3">
        <table width="100%" height="100" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="78" colspan="3" background="/RMS/images/images2008-12/nav-bg.gif">
                    ...
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="68" align="center">
                          <img src="/RMS/images/images2008-12/man.jpg" width="46" height="44" />                        
                          <a href="#"></a></td>
                        <td width="122">
                        ...
                        <td width="20" align="right">
                          <img src="/RMS/images/images2008-12/line.gif" width="9" height="70" />                        </td>
                      </tr>
                    </table>
                  </td>
