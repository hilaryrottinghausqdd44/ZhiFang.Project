<%@ Page Language="c#" AutoEventWireup="True" Inherits="OA.library.desktop.company_files" Codebehind="company_files.aspx.cs" %>
...
<table border="0" width="95%" cellspacing="0" align="center">
    ...
    <tr id="trContent_<%=ID%>">
        <td valign="top">
            <%
                ArrayList priNews;
                priNews = nm.ListNewsByType(10, "document");
                ...
                else
                {
                    ...
                    for (int i = 0; i < priNews.Count && i < 5; i++)
                    {
                        ...
                        Response.Write("<tr style=\"cursor:hand\" onmouseover=\"this.bgColor='#ffff66'\" onmouseout=\"this.bgColor=''\" onclick=\"javascript:ViewFiles(" + n.NewsID + ")\">");
            ...
            %>
            <div align="right">
                <a href="/info/default.aspx?Node=0.1&Url=../news/NewsList.aspx?type=document">
