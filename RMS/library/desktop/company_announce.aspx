<%@ Page Language="c#" AutoEventWireup="True"
    Inherits="OA.library.desktop.company_announce" Codebehind="company_announce.aspx.cs" %>
...
<table border="0" width="95%" cellspacing="0" align="center">
    ...
    <tr id="trContent_<%=ID%>">
        <td valign="top">
            <%
                ArrayList priNews;
                priNews = nm.ListNewsByType(10, "announce");
                ...
                else
                {
                    ...
                    for (int i = 0; i < priNews.Count && i < 5; i++)
                    {
                        ...
                        Response.Write("<tr style=\"cursor:hand\" onmouseover=\"this.bgColor='#ffff66'\" onmouseout=\"this.bgColor=''\" onclick=\"javascript:ViewAnnounce(" + n.NewsID + ")\">");
            ...
            %>
            <div align="right">
                <a href="/info/default.aspx?Node=0.0&Url=../news/NewsList.aspx?type=announce">
