$(function() {
	...
	function createInfo(data){
		...
		html.push('<div class="list-group-item-text">订货单号: ' + data.BmsCenOrderDoc_OrderDocNo + '</div>');
		...
		html.push('<div class="list-group-item-text">供货方备注: <span style="color:red;">' + (data.BmsCenOrderDoc_CompMemo || '') + '</span></div>');
		html.push('<div class="list-group-item-text">订货方备注: <span style="color:red;">' + (data.BmsCenOrderDoc_LabMemo || '') + '</span></div>');
