...
Ext.define('Ext.manage.datafilters.setForm', {
   ...
   setboolValue:function(boolValue){
    ...
    numberOperationType:[
        ...
        {'value':'>= and <=', 'text':'区间(包含边界)(输入2项)'},
        {'value':'<= or >=', 'text':'区间外(包含边界)(输入2项)'},
        {'value':'> and <', 'text':'区间(不包含边界)(输入2项)'},
        {'value':'< or >','text': '区间外(不包含边界)(输入2项)'}
    ],
    ...
    stringOperationType:[
        ...
        {'value':'like A%','text':'开始于(A*)'},
        {'value':'like %A','text':'结束于(*A)'},
        
        {'value':'like A%B','text':'字符之间(A*B) (输入2项)'},
        
        {'value':'= or = or =','text': '等于其中一项(输入多项)'},
        {'value':'not (= or = or =)','text': '不等于任何一项(输入多项)'},
        {'value':'like %A% or like %B%','text': '包含(可输入多个)'},
        {'value':'not (like %A% or like %B%)','text': '不包含(可输入多个)'}
    ],
    /**
     * 日期时间关系运算关系
     * @type 
    ...
    columnTypeList:[
    {'value':'date','text':'日期型'},
    {'value':'boolean','text':'布尔勾选'},
    {'value':'number','text':'数值型'},
    {'value':'string','text':'字符串'},
    {'value':'macros','text':'宏命令'},
    {'value':'relation','text':'关联'},
    {'value':'contrast','text':'对比属性'}
    ],
    /**
     * 日期列属性类型
     * @type 
