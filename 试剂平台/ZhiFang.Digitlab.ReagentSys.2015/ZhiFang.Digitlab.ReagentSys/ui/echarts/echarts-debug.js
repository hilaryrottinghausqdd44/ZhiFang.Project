...
define("echarts/config", [], function() {
	...
	var r = typeof window.addEventListener == "function" ?
	function(e) {
	...
	function y(e, t) {
		...
		else if (r > 1) for (var i = 0, s = r - 1; i < s; i++) {
			var o = g(e[i], e[i + 1], t);
	...
	return l.prototype.render = function(e) {
		...
		for (var c = 0, h = e.length; c < h; c++) {
			...
			if ((s.dirty || n) && !p.invisible) if (!p.onbrush || p.onbrush && !p.onbrush(a, !1)) if (t.catchBrushException) try {
	...
	function c(e, t, n, r, i) {
		var s = e.length;
		if (i == 1) for (var o = 0; o < s; o++) r[o] = l(e[o], t[o], n);
		else {
			var u = e[0].length;
	...
	function p(e, t, n, r, i, s, o, u, a) {
		var f = e.length;
		if (a == 1) for (var l = 0; l < f; l++) u[l] = d(e[l], t[l], n[l], r[l], i, s, o);
		else {
			var c = e[0].length;
	...
	var t = e("./Clip"),
		...
		s = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame ||
	function(e) {
		setTimeout(e, 16)
	...
	function s(e, t, n, r, i) {
		...
		s.hoverConnect = function(e) {
			...
			if (t) {
				var n = 10,
					r;
				if (t instanceof Array) for (var i = 0, o = t.length; i < o; i++) r = s.getShapeById(t[i]), s.zr.addHoverShape(r), n = Math.min(n, r.zlevel);
	...
	return h.prototype = {
		...
		_buildMarkLine: function(e) {
			...
			for (var a = 0, f = u.data.length; a < f; a++) i = u.data[a], !i.type || i.type != "max" && i.type != "min" && i.type != "average" ? o = [this.getMarkCoord(e, i[0]), this.getMarkCoord(e, i[1])] : (o = this.getMarkCoord(e, i), u.data[a] = [l.clone(i),
			{}], u.data[a][0].name = i.name || i.type, u.data[a][0].value = o[3], o = o[2], i = [{}, {}]), u.data[a][0].x = typeof i[0].x != "undefined" ? i[0].x : o[0][0], u.data[a][0].y = typeof i[0].y != "undefined" ? i[0].y : o[0][1], u.data[a][1].x = typeof i[1].x != "undefined" ? i[1].x : o[1][0], u.data[a][1].y = typeof i[1].y != "undefined" ? i[1].y : o[1][1];
	...
	return i.prototype = {
		...
		_contentToOption: function(e) {
			...
			for (t = 0, s = c.length; t < s; t++) {
				a++;
				if (c[t].type == n.CHART_TYPE_SCATTER) for (var r = 0, i = c[t].data.length; r < i; r++) f = e[a], l = f.replace(" ", "").split(","), typeof c[t].data[r].value != "undefined" ? c[t].data[r].value = l : c[t].data[r] = l, a++;
				else {
					f = e[a].split(",");
	...
	function l(e, t) {
		...
		else if (a == "play") if (t.status == "stop") e.moveTo(i + 2, s), e.lineTo(i + o - 2, s + u / 2), e.lineTo(i + 2, s + u), e.lineTo(i + 2, s);
		else {
	...
	return l.prototype = {
		...
		connect: function(e) {
			...
			if (e instanceof Array) for (var t = 0, n = e.length; t < n; t++) this._connected[e[t].id] = e[t];
			else this._connected[e.id] = e;
			return this
		},
		disConnect: function(e) {
			if (!e || !this._connected) return this;
			if (e instanceof Array) for (var t = 0, n = e.length; t < n; t++) delete this._connected[e[t].id];
	...
	return u.prototype = {
		...
		_reformLabelData: function() {
			...
			if (e) for (var t = 0, n = this._valueList.length; t < n; t++) typeof e == "function" ? this._valueLabel.push(e.call(this.myChart, this._valueList[t])) : typeof e == "string" && this._valueLabel.push(e.replace("{value}", this._valueList[t]));
			else for (var t = 0, n = this._valueList.length; t < n; t++) this._valueLabel.push(this.numAddCommas(this._valueList[t]))
		},
	...
	return l.prototype = {
		...
		_addSplitArea: function(e, t, n, r, i, s) {
			...
			if (d == "polygon") for (var v = 0; v < o; v++) h = [], l = e[v].vector, c = e[(v + 1) % o].vector, h.push(this._mapVector(l, i, n)), h.push(this._mapVector(l, i, r)), h.push(this._mapVector(c, i, r)), h.push(this._mapVector(c, i, n)), p = this._getShape(h, "fill", u, "", 1), this.shapeList.push(p);
		...
		_findValue: function(e, t, n, r, i, s, o) {
			...
			e.length == 1 && (a = 0);
			if (e.length != 1) for (var g = 0; g < e.length; g++) f = typeof e[g].value[t].value != "undefined" ? e[g].value[t].value : e[g].value[t], m(f);
			else {
				v = e[0];
			...
			for (var N = e.length - 1; N >= 0; N--) {
				...
				if (g.type == this.type && typeof b != "undefined") {
					...
					for (var C = 0, k = b.length; C < k; C++) {
						...
						if (!x) for (var L = 0, A = w.length; L < A; L++) y = g.data[w[L][2]], (this.deepQuery([y, g], "showAllSymbol") || n.isMainAxis(w[L][2]) && this.deepQuery([y, g], "symbol") != "none" || this.deepQuery([y, g, this.option], "calculable")) && this.shapeList.push(this._getSymbol(T, w[L][2], w[L][3], w[L][0], w[L][1], i));
