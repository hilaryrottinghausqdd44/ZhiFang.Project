...
Ext.onReady(function(){	
	...
	var _PARAMS = {
		type:{
			...
			//实验室-资质查询
			'7':'Shell.class.rea.cenorg.qualification.search.App',
			//实验室-订货单查询
			'8':'Shell.class.rea.order.lab.show.App',
			//实验室-供货单管理
			'9':'Shell.class.rea.sale.lab.manage.App',
			//实验室-订货单确认
			'10':'Shell.class.rea.order.lab.check.App',
			//实验室-资质查询
			'11':'Shell.class.rea.cenorg.qualification.search.App',
			//实验室-入账管理
			'12':'Shell.class.rea.recorded.lab.Grid'
		}
	};
