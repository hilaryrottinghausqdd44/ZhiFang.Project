 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.pki.dealer.CheckGrid',{
	...
	initComponent:function(){
		var me = this;
		//查询框信息
		me.searchInfo = {width:310,emptyText:'经销商名称/代码',isLike:true,fields:['bdealer.Name','bdealer.UseCode']};
		//数据列
		me.columns = [{
			dataIndex:'BDealer_UseCode',text:'代码',width:60,defaultRenderer:true
		},{
