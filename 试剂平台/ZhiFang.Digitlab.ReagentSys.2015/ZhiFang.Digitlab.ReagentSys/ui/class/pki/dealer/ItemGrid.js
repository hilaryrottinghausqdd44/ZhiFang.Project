...
Ext.define('Shell.class.pki.dealer.ItemGrid',{
	...
	initComponent:function(){
		var me = this;
		//查询框信息
		me.searchInfo = {width:'100%',emptyText:'项目名称',isLike:true,fields:['dunititem.BTestItem.CName']};
		//自定义按钮功能栏
		...
		if(!me.readOnly){
			me.columns.push({
				dataIndex:'DUnitItem_IsStepPrice',text:'<b style="color:blue;">阶梯价</b>',
				width:50,isBool:true,align:'center',type:'bool',
				editor:{xtype:'uxBoolComboBox'},
			});
		}else{
			me.columns.push({
				dataIndex:'DUnitItem_IsStepPrice',text:'阶梯价',
				width:50,isBool:true,align:'center',type:'bool'
			});
		}
	...
	updateOneByIsStepPrice:function(id,isStepPrice){
		...
		var params = Ext.JSON.encode({
			entity:{Id:id,IsStepPrice:isStepPrice},
