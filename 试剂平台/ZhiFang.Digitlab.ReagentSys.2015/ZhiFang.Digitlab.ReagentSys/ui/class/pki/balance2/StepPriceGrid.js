...
Ext.define('Shell.class.pki.balance2.StepPriceGrid', {
	...
	getLoadUrl: function() {
		...
		//dateType={dateType}&startDate={startDate}&endDate={endDate}&labID={labID}&
		//itemID={itemID}&deptID={deptID}&dealerID={dealerID}&billingUnitID={billingUnitID}&
		//strWhere={strWhere}&fields={fields}&isPlanish={isPlanish}
		//做处理
...
//		operateType={OPERATETYPE}
		...
		params.push("startDate=" + me.params.StartDate);
