 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.pki.ContractPriceForm',{
	...
	createItems:function(){
		...
		//经销商
		items.push({
			x:0,y:40,fieldLabel:'经销商',allowBlank:false,
		...
		//检验项目
		items.push({
			x:210,y:40,fieldLabel:'检验项目',allowBlank:false,
		...
		//开票类型-可以为空
		items.push({
			x:0,y:100,fieldLabel:'开票类型',xtype:'uxSimpleComboBox',
		...
		//开票方
		items.push({
			x:210,y:100,fieldLabel:'开票方',allowBlank:false,
	...
	onBillingUnitTypeChange:function(value){
		...
		switch(value){
			case '0' ://没有开票方
				me.changeBillingUnit(null,null,null);break;
			case '1' ://经销商
	...
	/**更改检验项目信息*/
	changeBTestItem:function(Id,Name,DataTimeStamp){
		var me = this;
	...
	openBtestItemCheckGrid:function(){
		...
		//经销商和送检单位的项目
		var where = '(dunititem.UnitType=1 and dunititem.UnitID=' + Id + 
			') or (dunititem.UnitType=2 and dunititem.UnitID=' + me.LaboratoryId + ')';
		
		JShell.Win.open('Shell.class.pki.UnitItemCheckGrid',{
			resizable:false,
			defaultWhere:where,
			listeners:{
	...
	getAddParams:function(){
		...
		var entity = {
			...
			BLaboratory:{
				Id:me.LaboratoryId,
				DataTimeStamp:me.LaboratoryDataTimeStamp
			},
			BDealer:{
	...
	getEditParams:function(){
		...
		entity.fields += ',BLaboratory_Id,BDealer_Id,BTestItem_Id,BBillingUnit_Id,BDept_Id';
