...
Ext.define('Shell.class.pki.contractprice.Form',{
    ...
    /**新增服务地址*/
    addUrl:'/StatService.svc/ST_UDTO_AddDContractPrice',
    /**修改服务地址*/
	...
	createItems:function(){
		...
		items.push({fieldLabel:'主键ID',name:'DContractPrice_Id',hidden:true,type:'key'});
