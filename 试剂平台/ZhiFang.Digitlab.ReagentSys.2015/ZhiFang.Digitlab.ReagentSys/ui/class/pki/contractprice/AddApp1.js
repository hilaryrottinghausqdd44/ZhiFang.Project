...
Ext.define('Shell.class.pki.contractprice.AddApp1',{
    ...
    /**新增服务地址*/
    saveUrl:'/StatService.svc/ST_UDTO_AddDContractPrice',
	...
	afterRender:function(){
		...
		DContractPrice_BDealer_Id.on({
			change:function(field,newValue){
				var where = 'dunititem.UnitType=2 and dunititem.UnitID=' + newValue;
	...
	createItems:function(){
		...
		items.push(Ext.create('Shell.class.pki.unititem.CheckGrid',{
			region:'center',header:false,checkOne:false,defaultLoad:false,
		...
		items.push(Ext.create('Shell.class.pki.contractprice.AddForm',{
			region:'west',header:false,formtype:'add',
	...
	getEntity:function(){
		...
		if(values.DContractPrice_CoopLevel){
			entity.CoopLevel = values.DContractPrice_CoopLevel;
		}
