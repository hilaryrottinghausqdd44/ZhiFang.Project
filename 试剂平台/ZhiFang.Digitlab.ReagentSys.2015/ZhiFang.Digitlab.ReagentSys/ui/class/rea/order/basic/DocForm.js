 ...
 * @version 2017-03-06
 */
Ext.define('Shell.class.rea.order.basic.DocForm', {
	...
	createItems:function(){
		...
		//提交日期
		items.push({
			xtype:'datefield',fieldLabel:'订购日期',format:'Y-m-d H:m:s',
		...
		//订货方备注
		items.push({
			xtype:'textarea',fieldLabel:'订货方备注',
			name:'BmsCenOrderDoc_LabMemo',
			itemId:'BmsCenOrderDoc_LabMemo',
			height:60
		});
		//供货方备注
		items.push({
			xtype:'textarea',fieldLabel:'供货方备注',
			name:'BmsCenOrderDoc_CompMemo',
			itemId:'BmsCenOrderDoc_CompMemo',
			height:60
		});
		//供货单备注
		items.push({
			xtype:'textarea',fieldLabel:'供货单备注',
	...
	getAddParams:function(){
		...
		var entity = {
			...
			LabMemo:values.BmsCenOrderDoc_LabMemo,
	...
	getEditParams:function(){
		...
		var fields = [
			'Id','OrderDocNo','UserID','UserName','CompanyName','LabMemo','CompMemo','Memo',
