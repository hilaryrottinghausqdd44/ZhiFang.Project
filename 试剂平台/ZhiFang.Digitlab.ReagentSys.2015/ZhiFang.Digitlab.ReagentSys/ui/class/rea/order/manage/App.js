 ...
 * @version 2017-07-17
 */
Ext.define('Shell.class.rea.order.manage.App', {
	...
	createItems:function(){
		...
		//主单列表
		me.DocGrid = Ext.create('Shell.class.rea.order.manage.DocGrid',{
		...
		//明细列表
		me.DtlGrid = Ext.create('Shell.class.rea.order.manage.DtlGridMemo',{
