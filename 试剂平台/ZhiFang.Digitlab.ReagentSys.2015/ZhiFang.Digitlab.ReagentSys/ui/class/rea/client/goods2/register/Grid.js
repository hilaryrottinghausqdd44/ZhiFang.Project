...
Ext.define('Shell.class.rea.client.goods2.register.Grid', {
	...
	createGridColumns: function() {
		...
		var columns = [{dataIndex: 'ReaGoodsRegister_GoodsNo',text: '产品编号',width: 95,editor:{}
		},{
			dataIndex: 'ReaGoodsRegister_GoodsLotNo',text: '产品批号',width: 95,editor:{}
		},{
		...
		}, 
		{
			...
			dataIndex: 'ReaGoodsRegister_ShortCode',text: '产品代码',width: 100,editor:{}
		},{
	...
	isValid:function(records){
		...
		for(var i=0;i<records.length;i++){
            ...
            if(!GoodsNo || !RegisterDate || !RegisterInvalidDate || !GoodsLotNo || !RegisterNo || !EName){
            	isExect=false;
            	JShell.Msg.error("英文名称,产品编号,产品批号,注册证编号,注册日期,有效期都不能为空!");
            	break;
            }
