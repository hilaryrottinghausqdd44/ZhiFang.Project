 ...
 * @version 2017-12-05
 */
Ext.define('Shell.class.rea.client.confirm.manualinput.GoodsOrgLinkCheck', {
	...
	initComponent: function() {
		...
		me.searchInfo = {
			...
			isLike: true,
			itemId: 'Search',
			emptyText: '产品名称/英文名/简称/产品编号',
			fields: ['reagoodsorglink.ReaGoods.CName', 'reagoodsorglink.ReaGoods.EName', 'reagoodsorglink.ReaGoods.SName', 'reagoodsorglink.ReaGoods.ProdGoodsNo']
		};
		//数据列
	...
	getLoadUrl: function() {
		...
		if(barCodeMgr) {
			var barCodeMgrValue = barCodeMgr.getValue();
			if(barCodeMgrValue) {
				where.push("reagoodsorglink.ReaGoods.BarCodeMgr=" + barCodeMgrValue);
			}
		}
		if(search) {
