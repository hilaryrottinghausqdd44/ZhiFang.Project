...
Ext.define('Shell.class.rea.client.stock.confirm.LotCheckGrid', {
	...
	createGridColumns: function() {
		...
		var columns = [{
			...
			xtype: 'checkcolumn',dataIndex: 'ReaGoodsLot_Visible',text: '启用',
			width: 40,align: 'center',sortable: false,menuDisabled: true,
			stopSelection: false,type: 'boolean',defaultRenderer: true
		}, {
			dataIndex: 'ReaGoodsLot_DispOrder',
			text: '显示次序',width: 70,
			align: 'center',defaultRenderer: true
		}, {
			dataIndex: 'ReaGoodsLot_Id',text: '主键ID',hidden: true,
			hideable: false,isKey: true,defaultRenderer: true
		}, {
			dataIndex: 'ReaGoodsLot_ReaGoods_Id',
			text: '货品主键ID',hidden: true,hideable: false,defaultRenderer: true
		}, {
			xtype: 'actioncolumn',
			text: '删除',
			align: 'center',
