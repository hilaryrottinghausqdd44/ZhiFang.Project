 ...
 * @version 2017-09-11
 */
Ext.define('Shell.class.rea.client.goodsorglink.cenorg.order.App', {
	...
	createItems: function() {
		var me = this;
		me.CenOrgGrid = Ext.create('Shell.class.rea.client.goodsorglink.cenorg.order.CenOrgGrid', {
			header: false,
			itemId: 'CenOrgGrid',
			region: 'west',
			width: 360,
		...
		me.OrderGoodsGrid = Ext.create('Shell.class.rea.client.goodsorglink.cenorg.order.OrderGoodsGrid', {
			header: false,
