 ...
 * @version 2017-09-12
 */
Ext.define('Shell.class.rea.client.goodsorglink.admin.basic.Form', {
	...
	createItems: function() {
		...
		items.push({
			...
			className: 'Shell.class.rea.client.goodsorglink.basic.CenOrgCheck',
		...
		items.push({
			...
			className: 'Shell.class.rea.client.goodsorglink.basic.GoodsCheck',
			readOnly: me.appType == "goods" ? true : false,
			locked: me.appType == "goods" ? true : false,
			colspan: 2,
			width: me.defaults.width * 2
		}, {
			fieldLabel: '产品主键ID',
	...
	onSaveClick: function() {
		...
		if(!values.ReaGoodsOrgLink_ReaGoods_Id) {
			JShell.Msg.alert("产品信息为空!", null, 1000);
			return;
		}
	...
	getAddParams: function() {
		...
		var entity = {
			...
			Memo: values.ReaGoodsOrgLink_Memo
		};
