...
Ext.define('Shell.class.rea.client.apply.basic.ApplyForm', {
	...
	/**修改服务地址*/
	editUrl: '/ReaSysManageService.svc/ST_UDTO_UpdateReaBmsReqDocAndDt',
	...
	createItems: function() {
		...
		items.push({
			...
			className: 'Shell.class.rea.client.apply.basic.HRDeptCheck'
		}, {
			fieldLabel: '部门主键ID',
			hidden: true,
	...
	initFilterListeners: function() {
		var me = this;
		var HRDept_CName = me.getComponent('ReaBmsReqDoc_DeptName'),
			HRDept_Id = me.getComponent('ReaBmsReqDoc_DeptID');
		HRDept_CName.on({
			check: function(p, record) {
				HRDept_CName.setValue(record ? record.get('HRDept_CName') : '');
				HRDept_Id.setValue(record ? record.get('HRDept_Id') : '');
				p.close();
