	...
	createButtonToolbarItems: function() {
		...
		var items = [{
			...
			menu:[{
				...
				text: '试剂导入',iconCls: 'file-excel',tooltip: 'EXCEL导入实验室试剂',
				handler: function() {me.onGoodsImportExcel('Lab');}
			}, {
				text: '多厂家试剂导入',iconCls: 'file-excel',tooltip: 'EXCEL导入实验室试剂，多个厂家试剂一起导入',
				handler: function() {me.onGoodsImportExcel('Lab',true);}
			}, '-',{
