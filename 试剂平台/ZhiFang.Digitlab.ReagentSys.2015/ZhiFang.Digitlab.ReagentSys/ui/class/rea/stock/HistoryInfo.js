 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.rea.stock.HistoryInfo', {
	...
	TestEquipNameFormat: '<div style="width:100%;text-align:center;margin-top:10px;' +
		'font-size:24px;color:red;">{msg}</div>',
	...
	initData: function(data) {
		var me = this,
			TestEquipName = me.getComponent('TestEquipName'),
		...
		var TestEquipNameValue = me.TestEquipNameFormat.replace(/{msg}/g, (data.TestEquipName || ''));
		TestEquipName.setText(TestEquipNameValue, false);
