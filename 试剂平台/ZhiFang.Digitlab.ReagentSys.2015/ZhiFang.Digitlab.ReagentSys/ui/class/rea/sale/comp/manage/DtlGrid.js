 ...
 * @version 2017-07-25
 */
Ext.define('Shell.class.rea.sale.comp.manage.DtlGrid', {
	extend: 'Shell.ux.grid.Panel',
	title: '供货单管理-明细列表-供应商专用',
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			dataIndex: 'BmsCenSaleDtl_Goods_ShortCode',
			...
			text: '提取数量',width:60,type:'int',align:'right',hidden:true,
			...
			dataIndex: 'BmsCenSaleDtl_Memo',sortable: false,
			text: '备注',width: 200
		}];
...
//		}
	...
	onAfterLoad:function(records,successful){
		...
		if(records && records.length > 0){
			var merger = me.getComponent('buttonsToolbar').getComponent('merger');
			if(merger){
				var bo = merger.getValue();
				me.mergerData(bo);
			}
		}
