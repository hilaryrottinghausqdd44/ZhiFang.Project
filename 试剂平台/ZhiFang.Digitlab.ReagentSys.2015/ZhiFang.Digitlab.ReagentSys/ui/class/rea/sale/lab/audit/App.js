 ...
 * @version 2017-03-06
 */
Ext.define('Shell.class.rea.sale.lab.audit.App', {
	...
	createItems:function(){
		...
		//主单列表
		me.DocGrid = Ext.create('Shell.class.rea.sale.lab.audit.DocGrid',{
		...
		//明细列表
		me.DtlGrid = Ext.create('Shell.class.rea.sale.lab.audit.DtlGrid',{
