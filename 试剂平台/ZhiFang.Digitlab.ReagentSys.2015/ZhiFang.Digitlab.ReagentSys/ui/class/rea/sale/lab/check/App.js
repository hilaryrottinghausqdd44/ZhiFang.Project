 ...
 * @version 2017-02-17
 */
Ext.define('Shell.class.rea.sale.lab.check.App', {
	...
	createItems:function(){
		...
		//主单列表
		me.DocGrid = Ext.create('Shell.class.rea.sale.lab.check.DocGrid',{
		...
		//明细列表
		me.DtlGrid = Ext.create('Shell.class.rea.sale.lab.check.DtlGrid',{
