 ...
 * @version 2017-02-17
 */
Ext.define('Shell.class.rea.sale.lab.show.App', {
	...
	createItems:function(){
		...
		//供货单的实验室=本机构  and 供货单状态=双方确认
		var cenOrgId = JShell.REA.System.CENORG_ID;
		var defaultWhere = me.defaultWhere;
		if(defaultWhere){
			defaultWhere += ' and ';
		}
		defaultWhere += 'bmscensaledoc.Status=1 and bmscensaledoc.Lab.Id=' + cenOrgId;
		
		//主单列表
		me.DocGrid = Ext.create('Shell.class.rea.sale.lab.show.DocGrid',{
