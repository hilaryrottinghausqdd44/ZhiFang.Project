...
Ext.define('Shell.class.rea.sale.BarcodeModel', {
	...
	_Model_1:{
		...
		Content:'LODOP.NEWPAGE();'+
			...
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			'LODOP.ADD_PRINT_TEXT("17mm","12mm","30mm","3mm","{UnitMemo}");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",8);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			//厂家产品编号
			...
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",8);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			'LODOP.ADD_PRINT_TEXT("20mm","12mm","30mm","3mm","{ProdGoodsNo}");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",8);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			//效期
			...
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",8);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			'LODOP.ADD_PRINT_TEXT("23mm","12mm","34mm","3mm","{InvalidDate}");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",8);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			//批号
			...
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",8);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			'LODOP.ADD_PRINT_TEXT("26mm","12mm","30mm","6mm","{LotNo}");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",8);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			//条码打印日期
			'LODOP.ADD_PRINT_TEXT("32mm","5mm","34mm","5mm","{BarcodeDate}");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
	...
	_Model_3:{
		...
		Content:'LODOP.NEWPAGE();'+
			...
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			//效期
			'LODOP.ADD_PRINT_TEXT("15mm","2mm","8mm","3mm","效期:");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",6);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			'LODOP.ADD_PRINT_TEXT("15mm","7mm","20mm","3mm","{InvalidDate}");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",6);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			//批号
			'LODOP.ADD_PRINT_TEXT("18mm","2mm","8mm","6mm","批号:");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",6);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			'LODOP.ADD_PRINT_TEXT("18mm","7mm","20mm","6mm","{LotNo}");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontName","微软雅黑");'+
			'LODOP.SET_PRINT_STYLEA(0,"FontSize",6);'+
			'LODOP.SET_PRINT_STYLEA(0,"Bold",1);'+
			//条码打印日期
