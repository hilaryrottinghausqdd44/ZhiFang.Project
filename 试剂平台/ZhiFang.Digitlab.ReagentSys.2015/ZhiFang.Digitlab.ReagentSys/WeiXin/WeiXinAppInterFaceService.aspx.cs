                        ...
                        try
                        {
                            ...
                            switch (requestxmlobject.MsgType)
                            {
                                case "text":
                                    ...
                                    //resxml = WeiXinResponseHelp.ResponseHandle(requestxmlobject);
                                    break;
                                case "image":
                                ...
                                case "event":
                                    ...
                                    if (rootElement.SelectSingleNode("Event").InnerText.ToLower() == "location")
                                    {
                                        ZhiFang.Common.Log.Log.Debug("Event.rootElement:" + rootElement.InnerXml);
                                    }
                                    else
                                    {
