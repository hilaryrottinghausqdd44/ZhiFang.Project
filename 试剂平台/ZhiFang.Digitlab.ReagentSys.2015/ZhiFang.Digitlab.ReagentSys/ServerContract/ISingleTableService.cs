...
namespace ZhiFang.Digitlab.ReagentSys.ServerContract
{
    ...
    public interface ISingleTableService
    {
        ...
        [ServiceContractDescription(Name = "通过主键ID查询参数表", Desc = "通过主键ID查询参数表", Url = "SingleTableService.svc/ST_UDTO_SearchBParameterByByParaNo?paraNo={paraNo}&groupNo={groupNo}&nodeName={nodeName}", Get = "paraNo={paraNo}&groupNo={groupNo}&nodeName={nodeName}", Post = "", Return = "BaseResultList<BParameter>", ReturnType = "BParameter")]
