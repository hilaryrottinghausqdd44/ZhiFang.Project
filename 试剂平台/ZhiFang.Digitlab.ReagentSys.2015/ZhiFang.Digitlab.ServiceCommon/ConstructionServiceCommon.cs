...
namespace ZhiFang.Digitlab.ServiceCommon
{
    public class ConstructionServiceCommon
    {
        ...
        public virtual ZhiFang.Digitlab.IBLL.Construction.IBBTDAppComponents IBBTDAppComponents { get; set; }
        public virtual ZhiFang.Digitlab.IBLL.Construction.IBBTDPictureTypeCon IBBTDPictureTypeCon { get; set; }
        public virtual ZhiFang.Digitlab.IBLL.Construction.IBBTDPictureType IBBTDPictureType { get; set; }
        public virtual ZhiFang.Digitlab.IBLL.Construction.IBBTDModuleType IBBTDModuleType { get; set; }
        public virtual ZhiFang.Digitlab.IBLL.Construction.IBBTDAppPicture IBBTDAppPicture { get; set; }
        public virtual ZhiFang.Digitlab.IBLL.Construction.IBBTDMacroCommand IBBTDMacroCommand { get; set; }
        public virtual ZhiFang.Digitlab.IBLL.Construction.IBBTDAppComponentsOperate IBBTDAppComponentsOperate { get; set; }
        ...
        public Entity.BaseResultDataValue CS_BA_GetEntityList()
        {
            Entity.BaseResultDataValue brdv = new Entity.BaseResultDataValue();
            try
            {
                ...
                foreach (var a in Assembly.Load("ZhiFang.Digitlab.Entity").GetTypes())
                {
        ...
        public Entity.BaseResultDataValue CS_BA_GetEntityFrameTree(string EntityName)
        {
            Entity.BaseResultDataValue brdv = new Entity.BaseResultDataValue();
        ...
        /// <param name="EntityName">数据对象类型名</param>
        /// <returns>数据对象树(EntityFrameTree)的Json字符串</returns>
        public Entity.BaseResultDataValue CS_BA_GetEntityFrameTreeByModuleOperID(long ModuleOperID, string EntityName)
        {
            Entity.BaseResultDataValue brdv = new Entity.BaseResultDataValue();
            string tmpEntityName = EntityName;
            try
            {
                Entity.RBACModuleOper tmpRBACModuleOper = IBRBACModuleOper.Get(ModuleOperID);
        ...
        /// <returns></returns>
        public Entity.BaseResultDataValue CS_BA_SearchReturnEntityServiceListByEntityName(string EntityName)
        {
            Entity.BaseResultDataValue brdv = new Entity.BaseResultDataValue();
            try
            {
        ...
        public List<ServiceContractnfo> GetReturnEntityServiceList(string EntityName)
        {
            ...
            if (EntityName.IndexOf('_') > 0)
            {
                ...
                string entitynamespace = "ZhiFang.Digitlab.Entity";
                ...
                if (t == null)
                {
                    t = Assembly.Load("ZhiFang.Digitlab.Entity").GetType("ZhiFang.Digitlab.Entity." + entity[0]);
                }
        ...
        public Entity.BaseResultDataValue CS_BA_SearchReturnEntityDictionaryServiceListByEntityPropertynName(string EntityPropertynName)
        {
            try
            {
        ...
        /// <param name="EntityName">数据对象类型名称</param>
        /// <returns></returns>
        public Entity.BaseResultDataValue CS_BA_SearchParaEntityServiceListByEntityName(string EntityName)
        {
            Entity.BaseResultDataValue brdv = new Entity.BaseResultDataValue();
            try
            {
        ...
        private List<ServiceContractnfo> SearchParaEntityServiceListByEntityName(string EntityName)
        {
            ...
            if (EntityName.IndexOf('_') > 0)
            {
                ...
                if (t == null)
                {
                    t = Assembly.Load("ZhiFang.Digitlab.Entity").GetType(entity[0]);
                }
                for (int i = 1; i < entity.Length; i++)
                {
                    t = t.GetProperty(entity[i]).PropertyType;
        ...
        /// </summary>
        /// <returns>数据对象(BaseResultEntityClassInfo)列表的Json字符串</returns>
        public Entity.BaseResultDataValue CS_BA_GetCRUDAndFrameByEntityName(string EntityName)
        {
            Entity.BaseResultDataValue brdv = new Entity.BaseResultDataValue();
        ...
        public BaseResultDataValue GetPinYin(string chinese)
        {
            BaseResultDataValue brdv = new BaseResultDataValue();
            try
            {
                if (chinese != null && chinese.Length > 0)
                {
                    ...
                    {
                        string str = ZhiFang.Common.Public.StringPlus.Chinese2Spell.SingleChs2Spell(a.ToString());
                        if (!string.IsNullOrWhiteSpace(str))
                            brdv.ResultDataValue += str.Substring(0, 1);
                    }
                    brdv.success = true;
                    return brdv;
                }
        ...
        public List<EntityFrameTree> GetEntityFrameTree(string EntityName)
        {
            ...
            if (!string.IsNullOrEmpty(EntityName))
            {
                if (EntityName.IndexOf('_') > 0)
                {
                    ...
                    if (tmpt == null)
                    {
                        tmpt = Assembly.Load("ZhiFang.Digitlab.Entity").GetType("ZhiFang.Digitlab.Entity." + entity[0]);
                    }
                    for (int i = 1; i < entity.Length; i++)
                    {
                ...
                if (t == null)
                {
                    t = Assembly.Load("ZhiFang.Digitlab.Entity").GetType("ZhiFang.Digitlab.Entity." + EntityName);
                }
                Type[] ta = Assembly.Load("ZhiFang.Digitlab.Entity").GetTypes();
                ...
                if (t.GetCustomAttributes(false).Count(a => a.GetType() == typeof(DataContractAttribute)) > 0 && t.GetCustomAttributes(false).Count(a => a.GetType() == typeof(DataDescAttribute)) > 0)
                {
                    ...
                    foreach (var p in pia)
                    {
                        ...
                        {
                            if (pattribute.ToString() == "ZhiFang.Digitlab.Entity.DataDescAttribute")
                            {
