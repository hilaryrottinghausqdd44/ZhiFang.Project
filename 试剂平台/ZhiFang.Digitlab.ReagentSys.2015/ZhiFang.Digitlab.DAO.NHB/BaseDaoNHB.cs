...
namespace ZhiFang.Digitlab.DAO.NHB
{
    public abstract class BaseDaoNHB<T, T1> : HibernateDaoSupport, IDBaseDao<T, T1> where T : BaseEntity
    {
        ...
        public Entity.EntityList<T> GetListBySQLAndHQL(string strHQL, string strHqlWhere, int start, int count)
        {
            GetDataRowRoleHQLString();
            Dictionary<string, BTDMacroCommand> dicmc = BTDMacroCommandDao.DicBTDMacroCommand;

            Entity.EntityList<T> entityList = new Entity.EntityList<T>();
        ...
        public Entity.EntityList<T> GetListByHQL(string strHqlWhere, int start, int count)
        {
            GetDataRowRoleHQLString();
            Dictionary<string, BTDMacroCommand> dicmc = BTDMacroCommandDao.DicBTDMacroCommand;
        ...
        public Entity.EntityList<T> GetListByHQL(string strHqlWhere, string Order, int start, int count)
        {
            GetDataRowRoleHQLString();
        ...
        public Entity.EntityList<T> GetListByHQL(string strHqlWhere, int start, int count, string strHQL)
        {
            GetDataRowRoleHQLString();
            Dictionary<string, BTDMacroCommand> dicmc = BTDMacroCommandDao.DicBTDMacroCommand;
            Entity.EntityList<T> entityList = new Entity.EntityList<T>();
        ...
        public Entity.EntityList<T> GetListByHQL(string strHqlWhere, string Order, int start, int count, string strHQL)
        {
            GetDataRowRoleHQLString();
            Entity.EntityList<T> entityList = new Entity.EntityList<T>();
            if (!String.IsNullOrEmpty(strHQL))
