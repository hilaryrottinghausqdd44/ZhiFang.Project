...
namespace ZhiFang.Digitlab.Entity.ReagentSys
{
	...
	public class BmsCenOrderDoc : BaseEntity
	{
        ...
        protected IList<BmsCenSaleDoc> _bmsCenSaleDocList;
        protected long? _reaCompID;
        protected string _reaCompName;
        protected string _cenCompNo;
        ...
        [DataMember]
        [DataDesc(CName = "供应商编号", ShortCode = "CompNo", Desc = "供应商编号", ContextType = SysDic.All, Length = 50)]
        public virtual string CompNo { get; set; }

        //预留属性,接口序列化使用，数据库中不存在此字段
        [DataMember]
        [DataDesc(CName = "实验室编号", ShortCode = "LabNo", Desc = "实验室编号", ContextType = SysDic.All, Length = 50)]
        public virtual string LabNo { get; set; }
        ...
        [DataMember]
        [DataDesc(CName = "供货单列表", ShortCode = "BmsCenSaleDocList", Desc = "供货单列表")]
        public virtual IList<BmsCenSaleDoc> BmsCenSaleDocList
        {
            get
            {
                if (_bmsCenSaleDocList == null)
                {
                    _bmsCenSaleDocList = new List<BmsCenSaleDoc>();
                }
                return _bmsCenSaleDocList;
            }
            set { _bmsCenSaleDocList = value; }
        }
        ...
        [DataMember]
        [DataDesc(CName = "本地供应商名称", ShortCode = "ReaCompName", Desc = "供应商名称", ContextType = SysDic.All, Length = 200)]
        ...
        [DataMember]
        [DataDesc(CName = "本地供应商平台构码", ShortCode = "ReaServerCompCode", Desc = "本地供应商平台构码", ContextType = SysDic.All, Length = 200)]
        public virtual string ReaServerCompCode
        {
            get { return _cenCompNo; }
            set
            {
                _cenCompNo = value;
            }
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "本地订单的平台主单记录ID", ShortCode = "CenOrderDocID", Desc = "本地订单的平台主单记录ID", ContextType = SysDic.All, Length = 8)]
