...
namespace ZhiFang.Digitlab.Entity.ReagentSys
{
	...
	public class BmsCenSaleDoc : BaseEntity
	{
        ...
        [DataMember]
        [DataDesc(CName = "订货单号", ShortCode = "OrderDocNo", Desc = "订货单号", ContextType = SysDic.All, Length = 50)]
        ...
        [DataMember]
        [DataDesc(CName = "订货单表", ShortCode = "BmsCenOrderDoc", Desc = "订货单表")]
        ...
        [DataMember]
        [DataDesc(CName = "供应商机平台构码", ShortCode = "ReaServerCompCode", Desc = "供应商机平台构码", ContextType = SysDic.All, Length = 200)]
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "平台主单记录ID", ShortCode = "CenSaleDocID", Desc = "平台主单记录ID", ContextType = SysDic.All, Length = 8)]
