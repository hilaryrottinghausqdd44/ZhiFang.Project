...
namespace ZhiFang.Digitlab.Entity.ReagentSys
{
    ...
    public class BmsCenOrderDtl : BaseEntity
    {
        ...
        public BmsCenOrderDtl(string orderDtlNo, string orderDocNo, string prodGoodsNo, string prodOrgName, string goodsName, string goodsUnit, string unitMemo, int goodsQty, string currentQty, int iOFlag, string zX1, string zX2, string zX3, BmsCenOrderDoc bmsCenOrderDoc, CenOrg prod, Goods goods)
        {
        ...
        public virtual string CurrentQty
        {
