...
namespace ZhiFang.Digitlab.Entity.ReagentSys
{
	...
	public class ReaDeptGoods : BaseEntity
	{
		...
		public ReaDeptGoods( long labID, string goodsCName, string deptName, int dispOrder, string memo, bool visible, long createrID, string createrName, DateTime dataUpdateTime, DateTime dataAddTime, byte[] dataTimeStamp, HRDept hRDept, ReaGoods reaGoods )
		{
			this._labID = labID;
