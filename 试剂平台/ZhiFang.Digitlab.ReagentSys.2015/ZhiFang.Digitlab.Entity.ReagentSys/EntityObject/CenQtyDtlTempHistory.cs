...
namespace ZhiFang.Digitlab.Entity.ReagentSys
{
    ...
    /// <summary>
    /// CenQtyDtlTempHistory object for NHibernate mapped table 'CenQtyDtlTempHistory'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "平台历史库存历史表", ClassCName = "CenQtyDtlTempHistory", ShortCode = "CenQtyDtlTempHistory", Desc = "平台历史库存历史表")]
    public class CenQtyDtlTempHistory : BaseEntity
    {
