...
namespace ZhiFang.Digitlab.Entity.ReagentSys
{
	...
	public class ReaBmsTransferDoc : BaseEntity
	{
		...
		public ReaBmsTransferDoc( long labID, long deptID, string deptName, long transferType, string transferTypeName, int status, string statusName, long sStorageID, string sStorageName, long dStorageID, string dStorageName, long 操作者ID, string 操作者名称, DateTime operDate, int printTimes, string zX1, string zX2, string zX3, int dispOrder, string memo, bool visible, long createrID, string createrName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
			this._deptID = deptID;
