...
namespace ZhiFang.Digitlab.BLL.Business
{
	...
	public  class BBSampleOperate : BaseBLL<BSampleOperate>, IBBSampleOperate
	{
        ...
        {  
            ...
            tempBSampleOperate.BOperateObjectType = IBBOperateObjectType.GetOrAddOperateObjectTypeByCode(objectTypeCode);
            tempBSampleOperate.OperateType = IBBSampleOperateType.GetOrAddSampleOperateTypeByCode(operateTypeCode, operateMemo);
            tempBSampleOperate.OperateObjectTypeCode = objectTypeCode;
            tempBSampleOperate.OperateTypeCode = operateTypeCode;
        ...
        {
            BSampleOperate tempBSampleOperate = new BSampleOperate();
            tempBSampleOperate.LabID = labid;
            tempBSampleOperate.OperateObjectID = id;
            tempBSampleOperate.BOperateObjectType = IBBOperateObjectType.GetOrAddOperateObjectTypeByCode(objectTypeCode);
            tempBSampleOperate.OperateType = IBBSampleOperateType.GetOrAddSampleOperateTypeByCode(operateTypeCode, operateMemo);
            tempBSampleOperate.OperateObjectTypeCode = objectTypeCode;
            tempBSampleOperate.OperateTypeCode = operateTypeCode;
