...
namespace ZhiFang.Digitlab.Entity
{
	...
	public class BSampleOperateType : BaseEntity
	{
		...
		protected IList<BSampleOperate> _operateTypeBSampleOperateList;

		#endregion

		#region Constructors

		public BSampleOperateType() { }

		public BSampleOperateType( long labID, int operateLevel, string name, string sName, string shortcode, string pinYinZiTou, string comment, bool isUse, DateTime dataAddTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
        ...
        [DataMember]
        [DataDesc(CName = "样本操作", ShortCode = "OperateTypeBSampleOperateList", Desc = "样本操作")]
		public virtual IList<BSampleOperate> OperateTypeBSampleOperateList
		{
			get
			{
				if (_operateTypeBSampleOperateList==null)
				{
					_operateTypeBSampleOperateList = new List<BSampleOperate>();
				}
