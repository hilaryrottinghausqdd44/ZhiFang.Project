...
namespace ZhiFang.Digitlab.Entity
{
	...
	/// <summary>
	/// EPEquipTypeOperate object for NHibernate mapped table 'EP_EquipTypeOperate'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "仪器类型操作", ClassCName = "EPEquipTypeOperate", ShortCode = "EPEquipTypeOperate", Desc = "")]
	public class EPEquipTypeOperate : BaseEntity
	{
		...
		public EPEquipTypeOperate() { }

		public EPEquipTypeOperate( long labID, string name, string sName, string shortcode, string pinYinZiTou, string comment, string useCode, string standCode, string deveCode, string rowFilterBase, bool isUse, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, EPEquipType ePEquipType )
		{
			this._labID = labID;
			this._name = name;
			this._sName = sName;
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "EPEquipType", Desc = "")]
