...
{
    public class BHRDept : ZhiFang.Digitlab.BLL.BaseBLL<ZhiFang.Digitlab.Entity.HRDept>, ZhiFang.Digitlab.IBLL.RBAC.IBHRDept
    {
        #region IBHRDept 成员
        ...
        ZhiFang.Digitlab.IBLL.RBAC.IBHREmployee IBHREmployee { get; set; }
        IDAO.IDHREmployeeDao HREmployeeDBDao { get; set; }
        public IList<Entity.HRDept> SearchHRDeptByHREmpID(long longHREmpID)
        {
            return ((IDAO.IDHRDeptDao)base.DBDao).SearchHRDeptByHREmpID(longHREmpID);
        }

        public IList<Entity.HRDept> SearchHRDeptByHRDeptIdentity(long longHRDeptIdentity)
        {
            return ((IDAO.IDHRDeptDao)base.DBDao).SearchHRDeptByHRDeptIdentity(longHRDeptIdentity);
        }
