...
{	
    ...
    /// 
    /// </summary>
    public class BRBACUser : BaseBLL<RBACUser>, IBRBACUser
    {
        ...
        {
            return ((IDAO.IDRBACUserDao)base.DBDao).GetByHQL(entity);
        }
        public IList<RBACUser> SearchRBACUserByUserAccount(string strUserAccount)
        {
            return ((IDAO.IDRBACUserDao)base.DBDao).SearchRBACUserByUserAccount(strUserAccount);
        }
        ...
        {
            IList<RBACUser> list = ((IDAO.IDRBACUserDao)base.DBDao).GetListByHQL("HREmployee.Id=" + strEmpID, 0,0).list;
            return list;
        }
        ...
        public string RJ_ResetAccountPassword(long id)
        {
            ...
            entity.PWD = SecurityHelp.MD5Encrypt(RJ_GetRandomNumber(6), SecurityHelp.PWDMD5Key);
            this.Entity = entity;
            this.Edit();
