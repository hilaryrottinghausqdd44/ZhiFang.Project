...
{	
	public class BRBACEmpRoles : ZhiFang.Digitlab.BLL.BaseBLL<ZhiFang.Digitlab.Entity.RBACEmpRoles>, IBRBACEmpRoles
    {
        ...
        public IList<RBACEmpRoles> SearchRBACEmpRolesByEmpId(string empId)
        {
            ...
            //r.HREmployee.Id
            return ((IDAO.IDRBACEmpRolesDao)DBDao).GetListByHQL("HREmployee.Id=" + empId, 0, 0).list;
        }
        /// <summary>
        /// 为单个员工增加或减少角色
        /// </summary>
