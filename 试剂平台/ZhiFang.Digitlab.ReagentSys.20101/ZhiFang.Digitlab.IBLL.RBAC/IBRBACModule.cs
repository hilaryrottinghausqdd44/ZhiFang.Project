...
{	
	public interface IBRBACModule : IBGenericManager<ZhiFang.Digitlab.Entity.RBACModule>
	{
        //bool Add();
        //bool Edit();
        //bool Remove();
        ...
        BaseResultTree<Entity.RBACModule> SearchRBACModuleToTree(long RBACModuleID, bool IsListTree);
        /// <summary>
        /// 根据模块用户使用编码查询模块
        /// </summary>
