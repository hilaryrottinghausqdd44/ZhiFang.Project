...
{
	#region BAntiClassMethod

	/// <summary>
	/// BAntiClassMethod object for NHibernate mapped table 'B_AntiClassMethod'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "抗生素分类方法", ClassCName = "BAntiClassMethod", ShortCode = "BAntiClassMethod", Desc = "抗生素分类方法")]
	public class BAntiClassMethod : BaseEntity
	{
		...
		protected IList<BAntiClassType> _bAntiClassTypeList; 

		#endregion

		#region Constructors

		public BAntiClassMethod() { }

		public BAntiClassMethod( long labID, string useCode, string standCode, string deveCode, string cName, string eName, string sName, string shortcode, string pinYinZiTou, string comment, bool bUniqueness, bool bDefault, bool isUse, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
        ...
        [DataMember]
        [DataDesc(CName = "抗生素分类类型", ShortCode = "BAntiClassTypeList", Desc = "抗生素分类类型")]
		public virtual IList<BAntiClassType> BAntiClassTypeList
		{
			get
			{
				if (_bAntiClassTypeList==null)
				{
					_bAntiClassTypeList = new List<BAntiClassType>();
				}
				return _bAntiClassTypeList;
			}
			set { _bAntiClassTypeList = value; }
		}
