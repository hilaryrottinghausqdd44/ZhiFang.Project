...
namespace ZhiFang.Digitlab.Entity
{
	...
	/// <summary>
	/// BSampleCharacter object for NHibernate mapped table 'B_SampleCharacter'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "标本性状字典表", ClassCName = "BSampleCharacter", ShortCode = "BSampleCharacter", Desc = "标本性状字典表")]
	public class BSampleCharacter : BaseEntity
	{
		...
		public BSampleCharacter() { }

		public BSampleCharacter( long labID, string cName, string eName, string sName, string shortcode, string pinYinZiTou, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, BSampleType bSampleType )
		{
			this._labID = labID;
			this._cName = cName;
			this._eName = eName;
