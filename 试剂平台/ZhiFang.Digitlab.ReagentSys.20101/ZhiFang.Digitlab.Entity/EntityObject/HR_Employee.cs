...
namespace ZhiFang.Digitlab.Entity
{
	...
	public class HREmployee : BaseEntity
	{
		...
		protected IList<MEPTDefaultItemMode> _mEPTDefaultItemModeList; 
        ...
        [DataMember]
        [DataDesc(CName = "默认项目模板", ShortCode = "MEPTDefaultItemModeList", Desc = "默认项目模板")]
		public virtual IList<MEPTDefaultItemMode> MEPTDefaultItemModeList
		{
			get
			{
				if (_mEPTDefaultItemModeList==null)
				{
					_mEPTDefaultItemModeList = new List<MEPTDefaultItemMode>();
				}
				return _mEPTDefaultItemModeList;
			}
			set { _mEPTDefaultItemModeList = value; }
		}        
