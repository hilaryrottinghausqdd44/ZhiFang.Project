...
namespace ZhiFang.Digitlab.Entity
{
	...
	/// <summary>
	/// BMicro object for NHibernate mapped table 'B_Micro'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "微生物", ClassCName = "BMicro", ShortCode = "BMicro", Desc = "微生物")]
	public class BMicro : BaseEntity
	{
		...
		public BMicro( long labID, string useCode, string standCode, string deveCode, string cName, string eName, string sName, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, BMicroAntiClass bMicroAntiClass )
		{
			this._labID = labID;
