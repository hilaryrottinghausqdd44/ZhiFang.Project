...
namespace ZhiFang.Digitlab.Entity
{
	...
	/// <summary>
	/// BMedicalDepartment object for NHibernate mapped table 'B_MedicalDepartment'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "就诊科室", ClassCName = "BMedicalDepartment", ShortCode = "BMedicalDepartment", Desc = "就诊科室")]
	public class BMedicalDepartment : BaseEntity
	{
		...
		protected IList<BDoctor> _bDoctorList; 
        ...
        [DataMember]
        [DataDesc(CName = "医生", ShortCode = "BDoctorList", Desc = "医生")]
		public virtual IList<BDoctor> BDoctorList
		{
			get
			{
				if (_bDoctorList==null)
				{
					_bDoctorList = new List<BDoctor>();
				}
				return _bDoctorList;
			}
			set { _bDoctorList = value; }
		}
