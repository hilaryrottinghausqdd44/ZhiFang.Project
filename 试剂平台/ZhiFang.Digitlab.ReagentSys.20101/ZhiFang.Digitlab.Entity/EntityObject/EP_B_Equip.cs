...
namespace ZhiFang.Digitlab.Entity
{
    ...
    public class EPBEquip : BaseEntity
    {
        ...
        protected IList<MEEquipSampleForm> _mEEquipSampleFormList;
        ...
        [DataMember]
        [DataDesc(CName = "仪器样本单", ShortCode = "MEEquipSampleFormList", Desc = "仪器样本单")]
        public virtual IList<MEEquipSampleForm> MEEquipSampleFormList
        {
            get
            {
                if (_mEEquipSampleFormList == null)
                {
                    _mEEquipSampleFormList = new List<MEEquipSampleForm>();
                }
                return _mEEquipSampleFormList;
            }
            set { _mEEquipSampleFormList = value; }
        }
