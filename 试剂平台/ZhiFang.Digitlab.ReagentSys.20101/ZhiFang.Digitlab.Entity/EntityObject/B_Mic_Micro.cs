...
namespace ZhiFang.Digitlab.Entity
{
	...
	/// <summary>
	/// BMicMicro object for NHibernate mapped table 'B_Mic_Micro'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "微生物表", ClassCName = "BMicMicro", ShortCode = "BMicMicro", Desc = "微生物表")]
	public class BMicMicro : BaseEntity
	{
		...
		public BMicMicro( long labID, string cName, string eName, string sName, string comment, bool isUse, int dispOrder, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
			this._cName = cName;
			this._eName = eName;
