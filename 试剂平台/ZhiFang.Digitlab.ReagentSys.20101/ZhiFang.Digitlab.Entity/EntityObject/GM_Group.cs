...
namespace ZhiFang.Digitlab.Entity
{
    ...
    public class GMGroup : BaseEntity
    {
        ...
        protected IList<BSampleNumberBuildRuleCondition> _bSampleNumberBuildRuleConditionList;
        ...
        protected IList<MEPTDistributeGroup> _mEPTDistributeGroupList;
        ...
        [DataMember]
        [DataDesc(CName = "样本号生成规则条件", ShortCode = "BSampleNumberBuildRuleConditionList", Desc = "样本号生成规则条件")]
        public virtual IList<BSampleNumberBuildRuleCondition> BSampleNumberBuildRuleConditionList
        {
            get
            {
                if (_bSampleNumberBuildRuleConditionList == null)
                {
                    _bSampleNumberBuildRuleConditionList = new List<BSampleNumberBuildRuleCondition>();
                }
                return _bSampleNumberBuildRuleConditionList;
            }
            set { _bSampleNumberBuildRuleConditionList = value; }
        }
        ...
        [DataMember]
        [DataDesc(CName = "分发小组", ShortCode = "MEPTDistributeGroupList", Desc = "分发小组")]
        public virtual IList<MEPTDistributeGroup> MEPTDistributeGroupList
        {
            get
            {
                if (_mEPTDistributeGroupList == null)
                {
                    _mEPTDistributeGroupList = new List<MEPTDistributeGroup>();
                }
                return _mEPTDistributeGroupList;
            }
            set { _mEPTDistributeGroupList = value; }
        }
