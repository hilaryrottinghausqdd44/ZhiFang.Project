...
{
    #region PMEGroupSampleFormWorkQuantityStatistics小组样本单工作量统计
    /// <summary>
    /// PMEGroupSampleFormSampleQuantityStatistics
    /// </summary>
    [DataContract]
    [DataDesc(CName = "小组样本单工作量统计", ClassCName = "PMEGroupSampleFormWorkQuantityStatistics", ShortCode = "PMEGroupSampleFormWorkQuantityStatistics", Desc = "小组样本单工作量统计")]
    public class PMEGroupSampleFormWorkQuantityStatistics
    {
        ...
        private string _DataAddTime;
        private string _ConfirmeDate;
        private string _ExamineDate;

        #endregion

        #region Constructors

        public PMEGroupSampleFormWorkQuantityStatistics() { }
        ...
        public virtual string DataAddTime
        {
        ...
        [DataMember]
        [DataDesc(CName = "初审时间", ShortCode = "ConfirmeDate", Desc = "初审时间", ContextType = SysDic.Text, Length = 50)]
        public virtual string ConfirmeDate
        {
        ...
        [DataMember]
        [DataDesc(CName = "终审时间", ShortCode = "ExamineDate", Desc = "终审时间", ContextType = SysDic.Text, Length = 50)]
        public virtual string ExamineDate
        {
