...
{
	#region BMicroItemReportItem

	/// <summary>
	/// BMicroItemReportItem object for NHibernate mapped table 'B_MicroItemReportItem'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "微生物项目报告项", ClassCName = "BMicroItemReportItem", ShortCode = "BMicroItemReportItem", Desc = "微生物项目报告项")]
	public class BMicroItemReportItem : BaseEntity
	{
		...
		public BMicroItemReportItem() { }

		public BMicroItemReportItem( long labID, bool isDefault, bool isPrintTitle, bool isPrint, string defaultValue, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, ItemAllItem itemAllItem, BMicroTestItemInfo bMicroTestItemInfo )
		{
			this._labID = labID;
