...
namespace ZhiFang.Digitlab.Entity
{
	...
	/// <summary>
	/// BDiseaseArea object for NHibernate mapped table 'B_DiseaseArea'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "病区", ClassCName = "BDiseaseArea", ShortCode = "BDiseaseArea", Desc = "病区")]
	public class BDiseaseArea : BaseEntity
	{
