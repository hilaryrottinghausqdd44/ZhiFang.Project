...
namespace ZhiFang.Common.Public
{
    ...
    {
        //public static string WebClientHttp()
        //{
        //    string resultString = "";
        //    try
        //    {
        ...
        //            wc.Add("Content-Type", "text/plain");
        //            client.Headers = wc;
        //            var values = new NameValueCollection();
        //            values["string"] = "10030";
        //            values["string1"] = "四川省迈克实业有限公司";
        //            values["string2"] = "XC161133915";
        //            var response = client.UploadValues("https://esb.maccura.com:9088/api/Domain/univereven/mksaleck/saleck?appkey=86087a37977f42e8b236ff2009debd4e", values);
        ...
        //public static string WebRequestHttp(string url, string para, string contenttype)
        //{
        //    string resultString = "";
        //    try
        //    {
        //        var request = (HttpWebRequest)WebRequest.Create("https://esb.maccura.com:9088/api/Domain/univereven/mksaleck/saleck?appkey=86087a37977f42e8b236ff2009debd4e");
        //        var postData = "string=10030&string1=四川省迈克实业有限公司&string2=XC161133915";
        ...
        {
            string resultString = "";
            var request = (HttpWebRequest)WebRequest.Create(url + para);
            para = "";
