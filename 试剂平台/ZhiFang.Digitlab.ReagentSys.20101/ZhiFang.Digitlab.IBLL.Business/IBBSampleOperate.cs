...
namespace ZhiFang.Digitlab.IBLL.Business
{
    ...
    public interface IBBSampleOperate : IBGenericManager<BSampleOperate>
    {
        ...
        /// <returns></returns>
        bool WriteSampleOperLog(BSampleOperate entity);

        bool WriteSampleOperLog();
        ...
        /// <returns></returns>
        BaseResultDataValue AddMEPTSampleOperate(BSampleOperate entity, string objectIDList);
