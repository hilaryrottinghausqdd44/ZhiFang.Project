...
namespace ZhiFang.Digitlab.IDAO
{
    public interface IDBaseDao<T, T1>
    {
        ...
        Entity.EntityList<T> GetListByHQL(string strHqlWhere, int start, int count);
        ...
        /// <param name="count">每页显示记录数</param>
        /// <returns>EntityList&lt;T&gt;</returns>
        Entity.EntityList<T> GetListByHQL(string strHqlWhere, string Order, int start, int count);
