 ...
 */
Ext.ns('Ext.mept');
Ext.define('Ext.mept.SampleDeliveryModule.sendDeliveryList', {
    extend:'Ext.grid.Panel',
    alias : 'widget.sendDeliveryList',
    title : '',
    width : 318,
   ...
   /**默认hql*/
    ...
    fields:[
         ...
         'MEPTSampleDeliveryConditon_MEPTSampleDelivery_SampleDeliveryMan',
         'MEPTSampleDeliveryConditon_MEPTSampleDelivery_PrintCount',
         'MEPTSampleDeliveryConditon_MEPTSampleDelivery_PrintTime',
    ...
    columns:[{
            ...
            text:'打印时间',
            dataIndex:'MEPTSampleDeliveryConditon_MEPTSampleDelivery_PrintTime',
            width:100,
            hideable:true,
            align:'left'
        }, {
