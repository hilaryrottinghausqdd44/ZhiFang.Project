Ext.define('bumenyuangongList', {
    extend:'Ext.grid.Panel',
    alias:'widget.bumenyuangongList',
    title:'部门下属员工列表',
    width:825,
    height:200,
    ...
    initComponent:function() {
        ...
        me.url = getRootPath() + '/RBACService.svc/RBAC_UDTO_GetHREmployeeByHRDeptID?isPlanish=true&fields=HREmployee_CName,HREmployee_HRDept_CName,HREmployee_HRPosition_CName,HREmployee_IsEnabled,HREmployee_MobileTel,HREmployee_OfficeTel,HREmployee_ExtTel,HREmployee_Id,HREmployee_DispOrder,HREmployee_EName';
        me.store = Ext.create('Ext.data.Store', {
            fields:[ 'HREmployee_CName', 'HREmployee_HRDept_CName', 'HREmployee_HRPosition_CName', 'HREmployee_IsEnabled', 'HREmployee_MobileTel', 'HREmployee_OfficeTel', 'HREmployee_ExtTel', 'HREmployee_Id', 'HREmployee_DispOrder', 'HREmployee_EName' ],
            remoteSort:true,
            autoLoad:false,
            sorters:[ {
            ...
            proxy:{
                type:'ajax',
                url:getRootPath() + '/RBACService.svc/RBAC_UDTO_GetHREmployeeByHRDeptID?isPlanish=true&fields=HREmployee_CName,HREmployee_HRDept_CName,HREmployee_HRPosition_CName,HREmployee_IsEnabled,HREmployee_MobileTel,HREmployee_OfficeTel,HREmployee_ExtTel,HREmployee_Id,HREmployee_DispOrder,HREmployee_EName',
                reader:{
                    type:'json',
                    root:'list',
                    totalProperty:'count'
...
//            var where = '';
//            if (value && value != '') {
//                where += '(hremployee.CName like %27%25' + value + '%25%27 or hremployee.HRDept.CName like %27%25' + value + '%25%27)';
//            }
