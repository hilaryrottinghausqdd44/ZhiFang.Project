            ...
            if (me.comNum == length) {
              ...
              allbtn.on({
                    click:function(){
                        ...
                        var url = getRootPath() + "/HITACHIService.svc/ST_UDTO_SearchHITACHIBusinessProjectByHQL?isPlanish=true&&page=1&limit=5000&searchkey=&fields=" + fields
                        var hqlWhere="(hitachibusinessproject.BBusinessStatus.Name like '登记有效')";
                        RLSalesCList.url=url;
                        url=url+"&where"+hqlWhere;
                        
                        //RLSalesCList.internalWhere=hqlWhere;
              ...
              notallBtn.on({
                    click:function(){
                      ...
                      var url = getRootPath() + "/HITACHIService.svc/ST_UDTO_SearchHITACHIBusinessProjectTraceUncompleteByHQL?isPlanish=true&&page=1&limit=1000&searchkey=&fields=" + fields;
                      RLSalesCList.url=url;
