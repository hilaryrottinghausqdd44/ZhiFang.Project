 ...
 * @version 2017-05-8
 */
Ext.define('Shell.class.rea.sale.comp.create.App', {
	...
	createItems:function(){
		...
		//主单列表
		me.DocGrid = Ext.create('Shell.class.rea.sale.comp.create.DocGrid',{
		...
		//明细列表
		me.DtlGrid = Ext.create('Shell.class.rea.sale.comp.create.DtlGrid',{
	...
	onDocGridSelect:function(record){
		...
		if(Status == '0'  ){//临时
            ...
            me.DtlGrid.IsSplit=IsSplit;
            me.DtlGrid.showCheckButton(IsSplit);
		}else{
