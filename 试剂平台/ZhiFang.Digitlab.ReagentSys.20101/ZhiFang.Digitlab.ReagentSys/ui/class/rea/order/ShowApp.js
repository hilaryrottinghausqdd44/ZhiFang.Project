 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.rea.order.ShowApp', {
	...
	afterRender: function() {
		...
		if(cenOrgId){
			...
			me.DocGrid.defaultWhere += 'bmscenorderdoc.Status<>999 and bmscenorderdoc.Comp.Id=' + cenOrgId;
		}
		me.DocGrid.onSearch();
	...
	createItems:function(){
		...
		me.DocForm = Ext.create('Shell.class.rea.order.DocForm',{
			region:'east',itemId:'DocForm',header:false,
			split:true,collapsible:true,openFormType:true
		});
		me.DtlGrid = Ext.create('Shell.class.rea.order.ShowDtlGrid',{
