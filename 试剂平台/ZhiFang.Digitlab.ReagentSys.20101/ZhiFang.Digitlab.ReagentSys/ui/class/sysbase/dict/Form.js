...
Ext.define('Shell.class.sysbase.dict.Form',{
	...
	createItems:function(){
		...
		items.push(
			{fieldLabel:'名称',name:'FDict_CName',
				emptyText:'必填项',allowBlank:false},
			{fieldLabel:'次序',name:'FDict_DispOrder',
				xtype:'numberfield',value:0,
				emptyText:'必填项',allowBlank:false},
			{fieldLabel:'备注',height:85,
				name:'FDict_Memo',xtype:'textarea'},
			{boxLabel:'是否使用',name:'FDict_IsUse',
				xtype:'checkbox',checked:true},
			{fieldLabel:'主键ID',name:'FDict_Id',hidden:true}
		);
