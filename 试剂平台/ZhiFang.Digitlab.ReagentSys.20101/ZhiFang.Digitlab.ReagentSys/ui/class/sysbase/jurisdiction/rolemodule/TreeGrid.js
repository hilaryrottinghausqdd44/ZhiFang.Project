...
Ext.define('Shell.class.sysbase.jurisdiction.rolemodule.TreeGrid',{
    ...
    selectLinkUrl:'/RBACService.svc/RBAC_UDTO_SearchRBACRoleModuleByHQL?isPlanish=true',
    /**新增服务地址*/
	...
	initComponent: function() {
		...
		me.columns = [{
			...
			text:'关系主键ID',dataIndex:'LinkId',isKey:true,hidden:true,hideable:false
		}];
	...
	addLink:function(moduleId){
		...
		var entity = {
			IsUse:true,
			RBACModule:{Id:moduleId,DataTimeStamp:[0,0,0,0,0,0,0,0]},
