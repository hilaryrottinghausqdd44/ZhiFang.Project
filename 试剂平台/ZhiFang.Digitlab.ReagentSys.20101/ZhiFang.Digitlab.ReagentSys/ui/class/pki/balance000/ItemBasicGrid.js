 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.pki.balance.ItemBasicGrid', {
	...
	//selectUrl:JShell.System.Path.UI + '/server/getAccountGrid.js',

	/**显示对账状态下拉框*/
	showIsLockedCombobox: false,
	/**显示价格类型下拉框*/
	showItemPriceTypeCombobox: false,
	/**显示成功信息*/
	...
	createFilterToolbar2: function() {
		...
		if (me.showItemPriceTypeCombobox) {
			items.push({
				width: 110,
				labelWidth: 40,
				fieldLabel: '价格',
