 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.pki.ContractPriceAddApp',{
...
//		});
	...
	createItems:function(){
		...
		items.push(Ext.create('Shell.class.pki.UnitItemCheckGrid',{
			region:'west',header:false,checkOne:false,
			split:true,collapsible:true,width:320,
		...
		items.push(Ext.create('Shell.class.pki.ContractPriceAddForm',{
