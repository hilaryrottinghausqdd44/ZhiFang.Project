...
//	],
	...
	initComponent:function(){
		...
		//查询框信息
		me.searchInfo = {width:'100%',emptyText:'送检单位名称',isLike:true,fields:['blaboratory.CName']};
		if(!me.readOnly){
...
//				handler:function(){me.onItemConfig();}
		...
		//数据列
		me.columns = [{
			dataIndex:'BLaboratory_CName',text:'送检单位名称',width:180,defaultRenderer:true
		},{
			dataIndex:'BLaboratory_BBillingUnit_Name',text:'默认开票方',width:110,defaultRenderer:true
		},{
