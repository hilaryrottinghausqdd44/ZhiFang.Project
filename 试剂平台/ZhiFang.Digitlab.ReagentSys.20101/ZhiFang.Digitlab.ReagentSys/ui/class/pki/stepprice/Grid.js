...
Ext.define('Shell.class.pki.stepprice.Grid', {
	...
	/**排序字段*/
	defaultOrderBy: [{
		property: 'DStepPrice_BeginDate',
		direction: 'DESC'
	}, {
		property: 'DStepPrice_SampleCount',
		direction: 'DESC'
	}],
	/**带分页栏*/
	...
	initComponent: function() {
		...
		//数据列
		me.columns = [{
			dataIndex: 'DStepPrice_BeginDate',
			text: '开始日期',
			width: 80,
			isDate: true,
			sortable: false
		}, {
			dataIndex: 'DStepPrice_EndDate',
			text: '截止日期',
			width: 80,
			isDate: true,
			sortable: false
		}, {
			dataIndex: 'DStepPrice_SampleCount',
			...
			dataIndex: 'DStepPrice_StepPrice',
			...
			dataIndex: 'DStepPrice_ContractNo',
			text: '合同号',
			width: 100,
			defaultRenderer: true,
			sortable: false
		}, {
			dataIndex: 'DStepPrice_StepPriceMemo',
			text: '阶梯价格备注',
			width: 200,
			defaultRenderer: true,
			sortable: false
		}, {
			dataIndex: 'DStepPrice_Id',
			text: '主键ID',
			hidden: true,
			hideable: false,
			isKey: true
