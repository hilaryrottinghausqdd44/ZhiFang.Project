...
namespace ZhiFang.Digitlab.ReagentSys.ServerContract
{
    ...
    public interface IReagentSysService
    {
        ...
        [ServiceContractDescription(Name = "新增意见反馈表", Desc = "新增意见反馈表", Url = "ReagentSysService.svc/ST_UDTO_AddFFeedback", Get = "", Post = "FFeedback", Return = "BaseResultDataValue", ReturnType = "FFeedback")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_AddFFeedback", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_AddFFeedback(FFeedback entity);

        [ServiceContractDescription(Name = "修改意见反馈表", Desc = "修改意见反馈表", Url = "ReagentSysService.svc/ST_UDTO_UpdateFFeedback", Get = "", Post = "FFeedback", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateFFeedback", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateFFeedback(FFeedback entity);

        [ServiceContractDescription(Name = "修改意见反馈表指定的属性", Desc = "修改意见反馈表指定的属性", Url = "ReagentSysService.svc/ST_UDTO_UpdateFFeedbackByField", Get = "", Post = "FFeedback", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateFFeedbackByField", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateFFeedbackByField(FFeedback entity, string fields);

        [ServiceContractDescription(Name = "删除意见反馈表", Desc = "删除意见反馈表", Url = "ReagentSysService.svc/ST_UDTO_DelFFeedback?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/ST_UDTO_DelFFeedback?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_DelFFeedback(long id);

        [ServiceContractDescription(Name = "查询意见反馈表", Desc = "查询意见反馈表", Url = "ReagentSysService.svc/ST_UDTO_SearchFFeedback", Get = "", Post = "FFeedback", Return = "BaseResultList<FFeedback>", ReturnType = "ListFFeedback")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchFFeedback", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchFFeedback(FFeedback entity);

        [ServiceContractDescription(Name = "查询意见反馈表(HQL)", Desc = "查询意见反馈表(HQL)", Url = "ReagentSysService.svc/ST_UDTO_SearchFFeedbackByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFeedback>", ReturnType = "ListFFeedback")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchFFeedbackByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchFFeedbackByHQL(int page, int limit, string fields, string where, string sort, bool isPlanish);

        [ServiceContractDescription(Name = "通过主键ID查询意见反馈表", Desc = "通过主键ID查询意见反馈表", Url = "ReagentSysService.svc/ST_UDTO_SearchFFeedbackById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFeedback>", ReturnType = "FFeedback")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchFFeedbackById?id={id}&fields={fields}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchFFeedbackById(long id, string fields, bool isPlanish);
        #endregion
