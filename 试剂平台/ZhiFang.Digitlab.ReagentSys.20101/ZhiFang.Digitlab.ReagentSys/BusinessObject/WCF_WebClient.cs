...
namespace ZhiFang.Digitlab.ReagentSys.BusinessObject
{
    /// <summary>
    /// 支持 Session 和 Cookie 的 WebClient。
    /// </summary>
    public class WCF_WebClient : WebClient
    {
        // Cookie 容器
        ...
        public WCF_WebClient(CookieContainer cookies)
        {
        ...
        public object GetData_WcfRest(string GetUrl)
        {
            string responseJson = null;
            Stream data = this.OpenRead(GetUrl);
