...
namespace ZhiFang.Digitlab.Entity.ReagentSys
{
    ...
    /// <summary>
    /// CenQtyDtl object for NHibernate mapped table 'CenQtyDtl'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "平台库存表", ClassCName = "CenQtyDtl", ShortCode = "CenQtyDtl", Desc = "平台库存表")]
    public class CenQtyDtl : BaseEntity
    {
