...
namespace ZhiFang.Entity.LIIP
{
	...
	/// <summary>
	/// BHospitalLevel object for NHibernate mapped table 'B_HospitalLevel'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "医院级别", ClassCName = "BHospitalLevel", ShortCode = "BHospitalLevel", Desc = "医院级别")]
	public class BHospitalLevel : BaseEntityService//BaseEntity
	{
		...
		public BHospitalLevel() { }

		public BHospitalLevel( string name, string code, string sName, string shortcode, string pinYinZiTou, string comment, bool isUse, DateTime dataAddTime, byte[] dataTimeStamp )
		{
			this._name = name;
			this._code = code;
			this._sName = sName;
