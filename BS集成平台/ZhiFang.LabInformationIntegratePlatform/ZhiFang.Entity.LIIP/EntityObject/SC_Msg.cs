...
namespace ZhiFang.Entity.LIIP
{
	...
	public class SCMsg : BaseEntity
	{
        ...
        private long? _SendDeptID;
        private string _SendDeptName;
        private string _SendDeptCode;
        ...
        private long? _NotifyDoctorCount;
        private DateTime? _NotifyDoctorLastDateTime;
        private string _NotifyDoctorByEmpName;
        private long? _NotifyDoctorByEmpID;
        private long? _ConfirmUseTime;
        private long? _HandleUseTime;
        private long? _ConfirmHandleUseTime;

        protected long _handleTypeID;
        protected string _handleTypeName;
        private DateTime? _LastRequireHandleTime;
        private string _TestItemNoList;
        private string _TestItemNameList;
        private DateTime? _RequireAllFinishTime;
        ...
        [DataMember]
        [DataDesc(CName = "接收机构编码", ShortCode = "RecLabCode", Desc = "接收机构编码", ContextType = SysDic.All, Length = 100)]
        public virtual string RecLabCode { get; set; }
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "要求完成总长时间", ShortCode = "RequireAllFinishTime", Desc = "要求完成总长时间", ContextType = SysDic.All, Length = 8)]
        public virtual DateTime? RequireAllFinishTime
        {
            get { return _RequireAllFinishTime; }
            set { _RequireAllFinishTime = value; }
        }
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "最后一次要求处理时间", ShortCode = "LastRequireHandleTime", Desc = "最后一次要求处理时间", ContextType = SysDic.All, Length = 8)]
        public virtual DateTime? LastRequireHandleTime
        {
            get { return _LastRequireHandleTime; }
            set { _LastRequireHandleTime = value; }
        }
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "发送者部门ID", ShortCode = "SendDeptID", Desc = "发送者部门ID", ContextType = SysDic.All, Length = 8)]
        public virtual long? SendDeptID
        {
        ...
        [DataMember]
        [DataDesc(CName = "发送者部门名称", ShortCode = "SendDeptName", Desc = "发送者部门名称", ContextType = SysDic.All, Length = 8)]
        public virtual string SendDeptName
        {
            get { return _SendDeptName; }
            set { _SendDeptName = value; }
        }

        [DataMember]
        [DataDesc(CName = "发送者部门编码", ShortCode = "SendDeptCode", Desc = "发送者部门编码", ContextType = SysDic.All, Length = 8)]
        public virtual string SendDeptCode
        {
            get { return _SendDeptCode; }
            set { _SendDeptCode = value; }
        }

        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "通知医生次数", ShortCode = "NotifyDoctorCount", Desc = "通知医生次数", ContextType = SysDic.All, Length = 8)]
        public virtual long? NotifyDoctorCount
        {
            get { return _NotifyDoctorCount; }
            set { _NotifyDoctorCount = value; }
        }

        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "通知医生时间(最后一次)", ShortCode = "NotifyDoctorLastDateTime", Desc = "通知医生时间(最后一次)", ContextType = SysDic.All, Length = 8)]
        public virtual DateTime? NotifyDoctorLastDateTime
        {
            get { return _NotifyDoctorLastDateTime; }
            set { _NotifyDoctorLastDateTime = value; }
        }

        [DataMember]
        [DataDesc(CName = "通知医生的人员名称", ShortCode = "NotifyDoctorByEmpName", Desc = "通知医生的人员名称", ContextType = SysDic.All, Length = 8)]
        public virtual string NotifyDoctorByEmpName
        {
            get { return _NotifyDoctorByEmpName; }
            set { _NotifyDoctorByEmpName = value; }
        }

        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "通知医生的人员ID", ShortCode = "NotifyDoctorByEmpID", Desc = "通知医生的人员ID", ContextType = SysDic.All, Length = 8)]
        public virtual long? NotifyDoctorByEmpID
        {
            get { return _NotifyDoctorByEmpID; }
            set { _NotifyDoctorByEmpID = value; }
        }

        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "确认用时(秒)", ShortCode = "ConfirmUseTime", Desc = "确认用时(秒)", ContextType = SysDic.All, Length = 8)]
        public virtual long? ConfirmUseTime
        {
            get { return _ConfirmUseTime; }
            set { _ConfirmUseTime = value; }
        }

        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "处理用时(秒)", ShortCode = "HandleUseTime", Desc = "处理用时(秒)", ContextType = SysDic.All, Length = 8)]
        public virtual long? HandleUseTime
        {
            get { return _HandleUseTime; }
            set { _HandleUseTime = value; }
        }

        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "确认处理总用时(秒)", ShortCode = "ConfirmHandleUseTime", Desc = "确认处理总用时(秒)", ContextType = SysDic.All, Length = 8)]
        public virtual long? ConfirmHandleUseTime
        {
            get { return _ConfirmHandleUseTime; }
            set { _ConfirmHandleUseTime = value; }
        }

        [DataMember]
        [DataDesc(CName = "中心条码号", ShortCode = "CenterBarCode", Desc = "中心条码号", ContextType = SysDic.All, Length = 20)]
        public virtual string CenterBarCode { get; set; }

        [DataMember]
        [DataDesc(CName = "送检单位条码号", ShortCode = "LabBarCode", Desc = "送检单位条码号", ContextType = SysDic.All, Length = 20)]
        public virtual string LabBarCode { get; set; }
        ...
        [DataMember]
        [DataDesc(CName = "检验项目编码", ShortCode = "HandleTypeName", Desc = "检验项目编码", ContextType = SysDic.All, Length = 100)]
        ...
        [DataMember]
        [DataDesc(CName = "检验项目名称", ShortCode = "HandleTypeName", Desc = "检验项目名称", ContextType = SysDic.All, Length = 100)]
        ...
        public virtual List<SCMsgHandle> SCMsgHandleList { get; set; }

        public virtual SCMsgHandle SCMsgHandle { get; set; }
