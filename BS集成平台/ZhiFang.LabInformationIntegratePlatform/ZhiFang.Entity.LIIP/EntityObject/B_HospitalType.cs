...
namespace ZhiFang.Entity.LIIP
{
	...
	/// <summary>
	/// BHospitalType object for NHibernate mapped table 'B_HospitalType'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "医院分类", ClassCName = "BHospitalType", ShortCode = "BHospitalType", Desc = "医院分类")]
	public class BHospitalType : BaseEntityService//BaseEntity
	{
		...
		public BHospitalType() { }

		public BHospitalType( string name, string code, string sName, string shortcode, string pinYinZiTou, string comment, bool isUse, DateTime dataAddTime, byte[] dataTimeStamp )
		{
			this._name = name;
			this._code = code;
			this._sName = sName;
