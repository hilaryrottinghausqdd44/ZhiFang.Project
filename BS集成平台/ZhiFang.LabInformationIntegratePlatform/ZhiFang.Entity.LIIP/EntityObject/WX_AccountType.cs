...
namespace ZhiFang.Entity.LIIP
{
	...
	/// <summary>
	/// WXAccountType object for NHibernate mapped table 'WX_AccountType'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "WXAccountType", ShortCode = "WXAccountType", Desc = "")]
	public class WXAccountType : BaseEntityService
	{
		...
		public WXAccountType() { }

		public WXAccountType( long labID, string name, string eName, string sName, string shortcode, string pinYinZiTou, string comment, bool isUse, DateTime dataAddTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
			this._name = name;
			this._eName = eName;
