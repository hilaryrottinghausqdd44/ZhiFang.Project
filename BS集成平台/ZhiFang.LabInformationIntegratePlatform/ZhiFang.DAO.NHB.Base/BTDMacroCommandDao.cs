...
namespace ZhiFang.DAO.NHB.Base
{
    public class BTDMacroCommandDao : HibernateDaoSupport, IDBTDMacroCommandDao
    {
        ...
        Dictionary<string, BTDMacroCommand> IDBTDMacroCommandDao.GetObjects()
        {
            throw new NotImplementedException();
        }

        BTDMacroCommand IDBTDMacroCommandDao.Get(string key)
        {
            throw new NotImplementedException();
        }

        BTDMacroCommand IDBTDMacroCommandDao.Load(string key)
        {
            throw new NotImplementedException();
        }
        #endregion
