...
namespace ZhiFang.ServerContract
{
    [ServiceContract]
...

    {
        ...
        [ServiceContractDescription(Name = "新增文档表", Desc = "新增文档表", Url = "CommonService.svc/QMS_UDTO_AddFFile", Get = "", Post = "FFile", Return = "BaseResultDataValue", ReturnType = "FFile")]
        ...
        [ServiceContractDescription(Name = "通过FormData方式新增文档信息", Desc = "通过FormData方式新增文档信息", Url = "CommonService.svc/QMS_UDTO_AddFFileByFormData", Get = "", Post = "", Return = "Stream", ReturnType = "Stream")]
        ...
        [ServiceContractDescription(Name = "通过FormData方式更新文档信息", Desc = "通过FormData方式更新文档信息", Url = "CommonService.svc/QMS_UDTO_UpdateFFileByFieldAndFormData", Get = "", Post = "", Return = "Stream", ReturnType = "Stream")]
        ...
        [ServiceContractDescription(Name = "新增文档信息及文档抄送对象信息表", Desc = "新增文档信息及文档抄送对象信息表", Url = "CommonService.svc/QMS_UDTO_AddFFileAndFFileCopyUser", Get = "", Post = "FFile", Return = "BaseResultDataValue", ReturnType = "FFile")]
        ...
        [ServiceContractDescription(Name = "修改文档表", Desc = "修改文档表", Url = "CommonService.svc/QMS_UDTO_UpdateFFile", Get = "", Post = "FFile", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改文档表指定的属性", Desc = "修改文档表指定的属性", Url = "CommonService.svc/QMS_UDTO_UpdateFFileByField", Get = "", Post = "FFile", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "更新文档基本信息时,更新文档抄送对象或更新文档阅读对象信息", Desc = "更新文档基本信息时,更新文档抄送对象或更新文档阅读对象信息", Url = "CommonService.svc/QMS_UDTO_UpdateFFileAndFFileCopyUserOrFFileReadingUserByField", Get = "", Post = "FFile", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档表", Desc = "删除文档表", Url = "CommonService.svc/QMS_UDTO_DelFFile?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档信息(更新IsUse为false,文档状态为作废)", Desc = "删除文档信息(更新IsUse为false,文档状态为作废)", Url = "CommonService.svc/QMS_UDTO_DeleleFFileByIds", Get = "", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "置顶/撤消置顶文档信息", Desc = "置顶/撤消置顶文档信息", Url = "CommonService.svc/QMS_UDTO_UpdateFFileIsTopByIds", Get = "", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询文档表", Desc = "查询文档表", Url = "CommonService.svc/QMS_UDTO_SearchFFile", Get = "", Post = "FFile", Return = "BaseResultList<FFile>", ReturnType = "ListFFile")]
        ...
        [ServiceContractDescription(Name = "查询当前登录者的抄送文档信息(HQL)", Desc = "查询当前登录者的抄送文档信息(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileCopyUserListByHQLAndEmployeeID?page={page}&limit={limit}&fields={fields}&where={where}&isSearchChildNode={isSearchChildNode}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&isSearchChildNode={isSearchChildNode}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFile>", ReturnType = "ListFFileCopyUser")]
        ...
        [ServiceContractDescription(Name = "查询当前登录者的阅读文档信息(HQL)", Desc = "查询当前登录者的阅读文档信息(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingUserListByHQLAndEmployeeID?page={page}&limit={limit}&fields={fields}&where={where}&isSearchChildNode={isSearchChildNode}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&isSearchChildNode={isSearchChildNode}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFile>", ReturnType = "ListFFileCopyUser")]
        ...
        [ServiceContractDescription(Name = "依当前登录者的员工Id信息查询当前登录者的阅读文档信息", Desc = "依当前登录者的员工Id信息查询当前登录者的阅读文档信息", Url = "CommonService.svc/UnHREmployeeReaderCount?where={where}", Post = "", Return = "BaseResultList<FFile>", ReturnType = "ListFFileCopyUser")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/UnHREmployeeReaderCount?where={where}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool UnHREmployeeReaderCount(string where);

        [ServiceContractDescription(Name = "查询当前登录者的阅读文档信息(HQL)", Desc = "查询当前登录者的阅读文档信息(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingUserListByHQLAndEmployeeIDAndDictreeids?dictreeids={dictreeids}&page={page}&limit={limit}&fields={fields}&where={where}&isSearchChildNode={isSearchChildNode}&sort={sort}&isPlanish={isPlanish}", Get = "dictreeids={dictreeids}&page={page}&limit={limit}&fields={fields}&where={where}&isSearchChildNode={isSearchChildNode}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFile>", ReturnType = "ListFFileCopyUser")]
        ...
        [ServiceContractDescription(Name = "根据新闻ID进行微信消息推送", Desc = "根据新闻ID进行微信消息推送", Url = "CommonService.svc/QMS_FFileWeiXinMessagePushById?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue<Bool>", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "新增文档附件表", Desc = "新增文档附件表", Url = "CommonService.svc/QMS_UDTO_AddFFileAttachment", Get = "", Post = "FFileAttachment", Return = "BaseResultDataValue", ReturnType = "FFileAttachment")]
        ...
        [ServiceContractDescription(Name = "修改文档附件表", Desc = "修改文档附件表", Url = "CommonService.svc/QMS_UDTO_UpdateFFileAttachment", Get = "", Post = "FFileAttachment", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改文档附件表指定的属性", Desc = "修改文档附件表指定的属性", Url = "CommonService.svc/QMS_UDTO_UpdateFFileAttachmentByField", Get = "", Post = "FFileAttachment", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档附件表", Desc = "删除文档附件表", Url = "CommonService.svc/QMS_UDTO_DelFFileAttachment?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询文档附件表", Desc = "查询文档附件表", Url = "CommonService.svc/QMS_UDTO_SearchFFileAttachment", Get = "", Post = "FFileAttachment", Return = "BaseResultList<FFileAttachment>", ReturnType = "ListFFileAttachment")]
        ...
        [ServiceContractDescription(Name = "查询文档附件表(HQL)", Desc = "查询文档附件表(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileAttachmentByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileAttachment>", ReturnType = "ListFFileAttachment")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询文档附件表", Desc = "通过主键ID查询文档附件表", Url = "CommonService.svc/QMS_UDTO_SearchFFileAttachmentById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileAttachment>", ReturnType = "FFileAttachment")]
        ...
        [ServiceContractDescription(Name = "新增文档抄送对象表", Desc = "新增文档抄送对象表", Url = "CommonService.svc/QMS_UDTO_AddFFileCopyUser", Get = "", Post = "FFileCopyUser", Return = "BaseResultDataValue", ReturnType = "FFileCopyUser")]
        ...
        [ServiceContractDescription(Name = "修改文档抄送对象表", Desc = "修改文档抄送对象表", Url = "CommonService.svc/QMS_UDTO_UpdateFFileCopyUser", Get = "", Post = "FFileCopyUser", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改文档抄送对象表指定的属性", Desc = "修改文档抄送对象表指定的属性", Url = "CommonService.svc/QMS_UDTO_UpdateFFileCopyUserByField", Get = "", Post = "FFileCopyUser", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档抄送对象表", Desc = "删除文档抄送对象表", Url = "CommonService.svc/QMS_UDTO_DelFFileCopyUser?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询文档抄送对象表", Desc = "查询文档抄送对象表", Url = "CommonService.svc/QMS_UDTO_SearchFFileCopyUser", Get = "", Post = "FFileCopyUser", Return = "BaseResultList<FFileCopyUser>", ReturnType = "ListFFileCopyUser")]
        ...
        [ServiceContractDescription(Name = "查询文档抄送对象表(HQL)", Desc = "查询文档抄送对象表(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileCopyUserByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileCopyUser>", ReturnType = "ListFFileCopyUser")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询文档抄送对象表", Desc = "通过主键ID查询文档抄送对象表", Url = "CommonService.svc/QMS_UDTO_SearchFFileCopyUserById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileCopyUser>", ReturnType = "FFileCopyUser")]
        ...
        [ServiceContractDescription(Name = "新增文档交流表（不附带附件）", Desc = "新增文档交流表（不附带附件）", Url = "CommonService.svc/QMS_UDTO_AddFFileInteraction", Get = "", Post = "FFileInteraction", Return = "BaseResultDataValue", ReturnType = "FFileInteraction")]
        ...
        [ServiceContractDescription(Name = "修改文档交流表（不附带附件）", Desc = "修改文档交流表（不附带附件）", Url = "CommonService.svc/QMS_UDTO_UpdateFFileInteraction", Get = "", Post = "FFileInteraction", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改文档交流表（不附带附件）指定的属性", Desc = "修改文档交流表（不附带附件）指定的属性", Url = "CommonService.svc/QMS_UDTO_UpdateFFileInteractionByField", Get = "", Post = "FFileInteraction", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档交流表（不附带附件）", Desc = "删除文档交流表（不附带附件）", Url = "CommonService.svc/QMS_UDTO_DelFFileInteraction?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询文档交流表（不附带附件）", Desc = "查询文档交流表（不附带附件）", Url = "CommonService.svc/QMS_UDTO_SearchFFileInteraction", Get = "", Post = "FFileInteraction", Return = "BaseResultList<FFileInteraction>", ReturnType = "ListFFileInteraction")]
        ...
        [ServiceContractDescription(Name = "查询文档交流表（不附带附件）(HQL)", Desc = "查询文档交流表（不附带附件）(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileInteractionByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileInteraction>", ReturnType = "ListFFileInteraction")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询文档交流表（不附带附件）", Desc = "通过主键ID查询文档交流表（不附带附件）", Url = "CommonService.svc/QMS_UDTO_SearchFFileInteractionById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileInteraction>", ReturnType = "FFileInteraction")]
        ...
        [ServiceContractDescription(Name = "新增文档操作记录表", Desc = "新增文档操作记录表", Url = "CommonService.svc/QMS_UDTO_AddFFileOperation", Get = "", Post = "FFileOperation", Return = "BaseResultDataValue", ReturnType = "FFileOperation")]
        ...
        [ServiceContractDescription(Name = "修改文档操作记录表", Desc = "修改文档操作记录表", Url = "CommonService.svc/QMS_UDTO_UpdateFFileOperation", Get = "", Post = "FFileOperation", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改文档操作记录表指定的属性", Desc = "修改文档操作记录表指定的属性", Url = "CommonService.svc/QMS_UDTO_UpdateFFileOperationByField", Get = "", Post = "FFileOperation", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档操作记录表", Desc = "删除文档操作记录表", Url = "CommonService.svc/QMS_UDTO_DelFFileOperation?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询文档操作记录表", Desc = "查询文档操作记录表", Url = "CommonService.svc/QMS_UDTO_SearchFFileOperation", Get = "", Post = "FFileOperation", Return = "BaseResultList<FFileOperation>", ReturnType = "ListFFileOperation")]
        ...
        [ServiceContractDescription(Name = "查询文档操作记录表(HQL)", Desc = "查询文档操作记录表(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileOperationByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileOperation>", ReturnType = "ListFFileOperation")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询文档操作记录表", Desc = "通过主键ID查询文档操作记录表", Url = "CommonService.svc/QMS_UDTO_SearchFFileOperationById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileOperation>", ReturnType = "FFileOperation")]
        ...
        [ServiceContractDescription(Name = "新增文档阅读记录表", Desc = "新增文档阅读记录表", Url = "CommonService.svc/QMS_UDTO_AddFFileReadingLog", Get = "", Post = "FFileReadingLog", Return = "BaseResultDataValue", ReturnType = "FFileReadingLog")]
        ...
        [ServiceContractDescription(Name = "修改文档阅读记录表", Desc = "修改文档阅读记录表", Url = "CommonService.svc/QMS_UDTO_UpdateFFileReadingLog", Get = "", Post = "FFileReadingLog", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改文档阅读记录表指定的属性", Desc = "修改文档阅读记录表指定的属性", Url = "CommonService.svc/QMS_UDTO_UpdateFFileReadingLogByField", Get = "", Post = "FFileReadingLog", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档阅读记录表", Desc = "删除文档阅读记录表", Url = "CommonService.svc/QMS_UDTO_DelFFileReadingLog?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询文档阅读记录表", Desc = "查询文档阅读记录表", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingLog", Get = "", Post = "FFileReadingLog", Return = "BaseResultList<FFileReadingLog>", ReturnType = "ListFFileReadingLog")]
        ...
        [ServiceContractDescription(Name = "查询文档阅读记录表(HQL)", Desc = "查询文档阅读记录表(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingLogByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileReadingLog>", ReturnType = "ListFFileReadingLog")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询文档阅读记录表", Desc = "通过主键ID查询文档阅读记录表", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingLogById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileReadingLog>", ReturnType = "FFileReadingLog")]
        ...
        [ServiceContractDescription(Name = "新增文档阅读对象表", Desc = "新增文档阅读对象表", Url = "CommonService.svc/QMS_UDTO_AddFFileReadingUser", Get = "", Post = "FFileReadingUser", Return = "BaseResultDataValue", ReturnType = "FFileReadingUser")]
        ...
        [ServiceContractDescription(Name = "修改文档阅读对象表", Desc = "修改文档阅读对象表", Url = "CommonService.svc/QMS_UDTO_UpdateFFileReadingUser", Get = "", Post = "FFileReadingUser", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改文档阅读对象表指定的属性", Desc = "修改文档阅读对象表指定的属性", Url = "CommonService.svc/QMS_UDTO_UpdateFFileReadingUserByField", Get = "", Post = "FFileReadingUser", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除文档阅读对象表", Desc = "删除文档阅读对象表", Url = "CommonService.svc/QMS_UDTO_DelFFileReadingUser?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询文档阅读对象表", Desc = "查询文档阅读对象表", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingUser", Get = "", Post = "FFileReadingUser", Return = "BaseResultList<FFileReadingUser>", ReturnType = "ListFFileReadingUser")]
        ...
        [ServiceContractDescription(Name = "查询文档阅读对象表(HQL)", Desc = "查询文档阅读对象表(HQL)", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingUserByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileReadingUser>", ReturnType = "ListFFileReadingUser")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询文档阅读对象表", Desc = "通过主键ID查询文档阅读对象表", Url = "CommonService.svc/QMS_UDTO_SearchFFileReadingUserById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<FFileReadingUser>", ReturnType = "FFileReadingUser")]
        ...
        [ServiceContractDescription(Name = "下载QMS的文档附件表的文件", Desc = "下载QMS的文档附件表的文件", Url = "CommonService.svc/QMS_UDTO_FFileAttachmentDownLoadFiles?id={id}&operateType={operateType}", Get = "id={id}&operateType={operateType}", Post = "", Return = "Stream", ReturnType = "Stream")]
        ...
        [ServiceContractDescription(Name = "依文档Id及查询类型获取文档的抄送对象信息或阅读对象信息", Desc = "依文档Id及查询类型获取文档的抄送对象信息或阅读对象信息", Url = "CommonService.svc/QMS_UDTO_SearchFFileCopyUserOrReadingUserByFFileId?ffileId={ffileId}&searchType={searchType}", Get = "ffileId={ffileId}&searchType={searchType}", Post = "", Return = "BaseResultList", ReturnType = "ListFFile")]
        ...
        [ServiceContractDescription(Name = "生成帮助文档", Desc = "生成帮助文档", Url = "CommonService.svc/QMS_UDTO_SaveHelpHtmlAndJson?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "BaseResultDataValue")]
        ...
        [ServiceContractDescription(Name = "获取到生成的帮助文档", Desc = "获取到生成的帮助文档", Url = "CommonService.svc/QMS_UDTO_GetHelpHtmlAndJson?no={no}&fileName={fileName}", Get = "no={no}&fileName={fileName}", Post = "", Return = "BaseResultDataValue", ReturnType = "BaseResultDataValue")]
        ...
        [ServiceContractDescription(Name = "下载新闻缩略图文件", Desc = "下载新闻缩略图文件", Url = "CommonService.svc/QMS_UDTO_DownLoadNewsThumbnailsById?id={id}&operateType={operateType}", Get = "id={id}&operateType={operateType}", Post = "", Return = "Stream", ReturnType = "Stream")]
        ...
        [ServiceContractDescription(Name = "新增SC_Operation", Desc = "新增SC_Operation", Url = "SingleTableService.svc/ST_UDTO_AddSCOperation", Get = "", Post = "SCOperation", Return = "BaseResultDataValue", ReturnType = "SCOperation")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_AddSCOperation", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_AddSCOperation(SCOperation entity);

        [ServiceContractDescription(Name = "修改SC_Operation", Desc = "修改SC_Operation", Url = "SingleTableService.svc/ST_UDTO_UpdateSCOperation", Get = "", Post = "SCOperation", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateSCOperation", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateSCOperation(SCOperation entity);

        [ServiceContractDescription(Name = "修改SC_Operation指定的属性", Desc = "修改SC_Operation指定的属性", Url = "SingleTableService.svc/ST_UDTO_UpdateSCOperationByField", Get = "", Post = "SCOperation", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateSCOperationByField", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateSCOperationByField(SCOperation entity, string fields);

        [ServiceContractDescription(Name = "删除SC_Operation", Desc = "删除SC_Operation", Url = "SingleTableService.svc/ST_UDTO_DelSCOperation?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/ST_UDTO_DelSCOperation?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_DelSCOperation(long id);

        [ServiceContractDescription(Name = "查询SC_Operation", Desc = "查询SC_Operation", Url = "SingleTableService.svc/ST_UDTO_SearchSCOperation", Get = "", Post = "SCOperation", Return = "BaseResultList<SCOperation>", ReturnType = "ListSCOperation")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchSCOperation", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchSCOperation(SCOperation entity);

        [ServiceContractDescription(Name = "查询SC_Operation(HQL)", Desc = "查询SC_Operation(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchSCOperationByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<SCOperation>", ReturnType = "ListSCOperation")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchSCOperationByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchSCOperationByHQL(int page, int limit, string fields, string where, string sort, bool isPlanish);

        [ServiceContractDescription(Name = "通过主键ID查询SC_Operation", Desc = "通过主键ID查询SC_Operation", Url = "SingleTableService.svc/ST_UDTO_SearchSCOperationById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<SCOperation>", ReturnType = "SCOperation")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchSCOperationById?id={id}&fields={fields}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchSCOperationById(long id, string fields, bool isPlanish);
        #endregion

        [ServiceContractDescription(Name = "根据文字生成音频文件", Desc = "根据文字生成音频文件", Url = "CommonService.svc/CreatVoice?txt={txt}", Post = "", Return = "BaseResultDataValue", ReturnType = "brdv")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/CreatVoice?txt={txt}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        ...
        [ServiceContractDescription(Name = "获取程序及数据库版本详细信息", Desc = "获取程序及数据库版本详细信息", Url = "CommonService.svc/GetSystemVersionInfo", Get = "", Post = "", Return = "", ReturnType = "")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/GetSystemVersionInfo", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue GetSystemVersionInfo();

        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/GetPinYin?str={str}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
