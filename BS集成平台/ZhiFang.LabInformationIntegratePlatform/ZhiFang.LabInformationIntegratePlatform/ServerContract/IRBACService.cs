...
namespace ZhiFang.ServerContract
{
    ...
    public interface IRBACService
    {
        ...
        [ServiceContractDescription(Name = "新增模块", Desc = "新增模块", Url = "RBACService.svc/RBAC_UDTO_AddRBACModuleaaa", Get = "", Post = "RBACModule", Return = "BaseResultDataValue", ReturnType = "RBACModule")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/RBAC_UDTO_AddRBACModuleaaa", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_AddRBACModuleaaa(RBACModule entity);
        ...
        [ServiceContractDescription(Name = "导入部门_Excel", Desc = "导入部门_Excel", Url = "RBACService.svc/ImportDeptByExcel", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "List<HRDept>")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ImportDeptByExcel", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ImportDeptByExcel();
        #endregion
        ...
        [ServiceContractDescription(Name = "导入部门员工_Excel", Desc = "导入部门员工_Excel", Url = "RBACService.svc/ImportDeptEmpByExcel", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "List<HREmp>")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ImportDeptEmpByExcel", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ImportDeptEmpByExcel();

        [ServiceContractDescription(Name = "获取验证码", Desc = "获取验证码", Url = "RBACService.svc/GetValidateCode", Get = "", Post = "", Return = "", ReturnType = "")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/GetValidateCode", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        Stream GetValidateCode();

        [ServiceContractDescription(Name = "验证验证码", Desc = "验证验证码", Url = "RBACService.svc/CheckValidateCode", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/CheckValidateCode", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue CheckValidateCode(string ValidateCode);
        #endregion
        ...
        [ServiceContractDescription(Name = "查询模块表，根据父模块where返回模块的Tree", Desc = "查询模块表，根据父模块where返回模块的Tree", Url = "RBACService.svc/RBAC_UDTO_SearchRBACModuleToTree?where={where}", Get = "?id={id}", Post = "", Return = "BaseResultTree", ReturnType = "TreeRBACModule")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_UDTO_SearchRBACModuleToTreeByWhere?where={where}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_SearchRBACModuleToTreeByWhere(string where);

        [ServiceContractDescription(Name = "查询模块表，根据父模块where返回模块的Tree", Desc = "查询模块表，根据父模块where返回模块的Tree", Url = "RBACService.svc/RBAC_UDTO_SearchRBACModuleIncludePModuleByWhere?id={id}", Get = "?id={id}", Post = "", Return = "BaseResultTree", ReturnType = "TreeRBACModule")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_UDTO_SearchRBACModuleIncludePModuleByWhere?where={where}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_SearchRBACModuleIncludePModuleByWhere(string where);
        ...
        [ServiceContractDescription(Name = "根据员工ID查询模块列表", Desc = "根据员工ID查询模块列表", Url = "RBACService.svc/RBAC_UDTO_SearchModuleByHREmpID?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/RBAC_UDTO_SearchModuleByHREmpID?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_SearchModuleByHREmpID(long id);
        ...
        #region 电子签名图片处理
        [ServiceContractDescription(Name = "上传电子签名图片", Desc = "上传电子签名图片", Url = "RBACService.svc/SC_UDTO_UploadEmpSignByEmpId", Get = "", Post = "", Return = "Message", ReturnType = "Message")]
        ...
        [ServiceContractDescription(Name = "下载电子签名图片", Desc = "下载电子签名图片", Url = "RBACService.svc/PGM_UDTO_DownLoadEmpSignByEmpId?empId={empId}&operateType={operateType}", Get = "empId={empId}&operateType={operateType}", Post = "", Return = "Stream", ReturnType = "Stream")]
        ...
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/GetEmpSignatureImageByEmpID?EmpId={EmpId}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue GetEmpSignatureImageByEmpID(long EmpId);

        #endregion

        #region 集成平台功能

        [ServiceContractDescription(Name = "获取到某一部门的所有下级部门Id信息", Desc = "获取到某一部门的所有下级部门Id信息", Url = "RBACService.svc/RBAC_RJ_GetSubDeptIdListByDeptId?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_RJ_GetSubDeptIdListByDeptId?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_RJ_GetSubDeptIdListByDeptId(string id);

        [ServiceContractDescription(Name = "根据部门ID获取所有父级部门Id", Desc = "根据部门ID获取所有父级部门Id", Url = "RBACService.svc/RBAC_RJ_GetParentDeptIdListByDeptId?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_RJ_GetParentDeptIdListByDeptId?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_RJ_GetParentDeptIdListByDeptId(string id);

        [ServiceContractDescription(Name = "根据员工ID获取所有角色列表", Desc = "根据员工ID获取所有角色列表", Url = "RBACService.svc/RBAC_UDTO_GetRBACRolesListByEmpId?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_UDTO_GetRBACRolesListByEmpId?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_GetRBACRolesListByEmpId(string id);

        [ServiceContractDescription(Name = "根据角色IDList获取所有角色员工关系列表", Desc = "根据角色IDList获取所有角色员工关系列表", Url = "RBACService.svc/RBAC_UDTO_GetRBACEmpRolesListByRoleIdList?idlist={idlist}", Get = "idlist={idlist}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_UDTO_GetRBACEmpRolesListByRoleIdList?idlist={idlist}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_GetRBACEmpRolesListByRoleIdList(string idlist);

        [ServiceContractDescription(Name = "获取全部员工列表", Desc = "获取全部员工列表", Url = "RBACService.svc/RBAC_UDTO_GetHREmployeeAllList", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_UDTO_GetHREmployeeAllList", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_GetHREmployeeAllList();

        [ServiceContractDescription(Name = "根据角色IDList获取所有角色员工关系列表", Desc = "根据角色IDList获取所有角色员工关系列表", Url = "RBACService.svc/RBAC_UDTO_GetHREmployeeListByDeptIdList?deptidlist={deptidlist}", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_UDTO_GetHREmployeeListByDeptIdList?deptidlist={deptidlist}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_GetHREmployeeListByDeptIdList(string deptidlist);

        [ServiceContractDescription(Name = "根据角色IDList获取所有角色员工关系列表", Desc = "根据角色IDList获取所有角色员工关系列表", Url = "RBACService.svc/RBAC_UDTO_GetHREmployeeById?id={id}", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_UDTO_GetHREmployeeById?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_UDTO_GetHREmployeeById(string id);


        [ServiceContractDescription(Name = "验证或注册HIS用户", Desc = "验证或注册HIS用户", Url = "RBACService.svc/CV_AddDoctorOrNurse", Get = "", Post = "CV_AddDoctorOrNurseVO", Return = "BaseResultDataValue", ReturnType = "")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/CV_AddDoctorOrNurse", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue CV_AddDoctorOrNurse(CV_AddDoctorOrNurseVO entity);

        [ServiceContractDescription(Name = "验证或注册LIS用户", Desc = "验证或注册LIS用户", Url = "RBACService.svc/CV_AddTech", Get = "", Post = "CV_AddTechVO", Return = "BaseResultDataValue", ReturnType = "")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/CV_AddTech", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue CV_AddTech(CV_AddTechVO entity);

        [ServiceContractDescription(Name = "消息确定处理身份认证", Desc = "消息确定处理身份认证", Url = "RBACService.svc/CheckAccountPWDByInterFace", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/CheckAccountPWDByInterFace?Account={Account}&PWD={PWD}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue CheckAccountPWDByInterFace(string Account, string PWD);

        
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RestRBACUserPWD", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RestRBACUserPWD();

        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/GetEmpIDNameByAccount?Account={Account}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue GetEmpIDNameByAccount(string Account);
        #endregion

        [ServiceContractDescription(Name = "新增角色权限", Desc = "新增角色权限", Url = "RBACService.svc/BModuleGetAndAdd", Get = "", Post = "RBACRoleRight", Return = "BaseResultDataValue", ReturnType = "RBACRoleRight")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/BModuleGetAndAdd", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool BModuleGetAndAdd(long bModuleId, string bModule);
    }
}
