...
namespace ZhiFang.ServerContract
{
    ...
    public interface IConstructionService
    {
        ...
        */
        ...
        //[ServiceContractDescription(Name = "测试_JSON字符串接收", Desc = "测试_字符串接收", Url = "ConstructionService.svc/ReceiveJsonStringService", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "String")]
