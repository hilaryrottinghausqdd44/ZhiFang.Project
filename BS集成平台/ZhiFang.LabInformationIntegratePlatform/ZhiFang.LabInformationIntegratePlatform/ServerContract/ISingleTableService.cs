...
namespace ZhiFang.ServerContract
{
    ...
    public interface ISingleTableService
    {
        ...
        [ServiceContractDescription(Name = "新增B_County", Desc = "新增B_County", Url = "SingleTableService.svc/ST_UDTO_AddBCounty", Get = "", Post = "BCounty", Return = "BaseResultDataValue", ReturnType = "BCounty")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_AddBCounty", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_AddBCounty(BCounty entity);

        [ServiceContractDescription(Name = "修改B_County", Desc = "修改B_County", Url = "SingleTableService.svc/ST_UDTO_UpdateBCounty", Get = "", Post = "BCounty", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateBCounty", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateBCounty(BCounty entity);

        [ServiceContractDescription(Name = "修改B_County指定的属性", Desc = "修改B_County指定的属性", Url = "SingleTableService.svc/ST_UDTO_UpdateBCountyByField", Get = "", Post = "BCounty", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateBCountyByField", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateBCountyByField(BCounty entity, string fields);

        [ServiceContractDescription(Name = "删除B_County", Desc = "删除B_County", Url = "SingleTableService.svc/ST_UDTO_DelBCounty?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/ST_UDTO_DelBCounty?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_DelBCounty(long id);

        [ServiceContractDescription(Name = "查询B_County", Desc = "查询B_County", Url = "SingleTableService.svc/ST_UDTO_SearchBCounty", Get = "", Post = "BCounty", Return = "BaseResultList<BCounty>", ReturnType = "ListBCounty")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchBCounty", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchBCounty(BCounty entity);

        [ServiceContractDescription(Name = "查询B_County(HQL)", Desc = "查询B_County(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchBCountyByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BCounty>", ReturnType = "ListBCounty")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchBCountyByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchBCountyByHQL(int page, int limit, string fields, string where, string sort, bool isPlanish);

        [ServiceContractDescription(Name = "通过主键ID查询B_County", Desc = "通过主键ID查询B_County", Url = "SingleTableService.svc/ST_UDTO_SearchBCountyById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BCounty>", ReturnType = "BCounty")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchBCountyById?id={id}&fields={fields}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchBCountyById(long id, string fields, bool isPlanish);
        #endregion
