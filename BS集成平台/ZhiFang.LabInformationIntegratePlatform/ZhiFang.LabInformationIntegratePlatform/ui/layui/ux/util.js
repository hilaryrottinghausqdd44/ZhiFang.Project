    ...
    var uxutil = {
        ...
        path: {
            ...
            init: function () {
                ...
                this.LIIP_ROOT = this.LOCAL + '/ZhiFang.LIIP';//+ '/ZhiFang.LabInformationIntegratePlatform';
        ...
        cookie: {
            ...
            map: {
                ...
                'DEFAULTMODULEID': '000701', //默认模块ID 608EE9C7CA151681C73
                'ISLOCKED': '000702', //锁定标记
                'OLDACCOUNTNAME': '000703', //历史账户名
                'OPENEDMODULEIDS': '000704', //历史打开记录
                'REMEMBERACCOUNT': '000705', //是否记住用户名
                'REMEMBERPWD': '000706' //是否记住密码
            },
            //根据名称获取cookie值
            get: function (name) {
