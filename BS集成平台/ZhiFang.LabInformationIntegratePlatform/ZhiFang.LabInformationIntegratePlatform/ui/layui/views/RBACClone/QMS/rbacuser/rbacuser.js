...
layui.extend({
	...
	var tableObj = {
        ...
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/Customization/RBACCloneService.svc/SYNCRBACUserByQMS',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/Customization/RBACCloneService.svc/CatchRBACUserDataListByQMS',
        checkRowData: [], //选中数据
        refresh: function () {
