...
layui.extend({
	...
	var tableObj = {
        ...
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/Customization/RBACCloneService.svc/SYNCRBACEmpOptionsByQMS',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/Customization/RBACCloneService.svc/CatchRBACEmpOptionsDataListByQMS',
        checkRowData: [], //选中数据
        refresh: function () {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'ModuleIconSize',
                    title: 'ModuleIconSize',
                    minWidth: 130,
                    edit: 'text'
                },
                {
                    field: 'AllModuleIconSize',
                    title: 'AllModuleIconSize',
                    minWidth: 130,
                    edit: 'text'
                },
                {
                    field: 'ModuleInfoSize',
                    title: 'ModuleInfoSize',
                    minWidth: 130,
                    edit: 'text'
                },
                {
