...
layui.extend({
	...
	var tableObj = {
        ...
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/Customization/RBACCloneService.svc/SYNCHRDeptByGeneQMS',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/Customization/RBACCloneService.svc/CatchHRDeptDataListByQMS',
        checkRowData: [], //选中数据
        refresh: function () {
