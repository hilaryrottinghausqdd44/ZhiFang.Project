...
layui.extend({
	...
	var tableObj = {
        ...
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/Customization/RBACCloneService.svc/SYNCRBACRoleRightByQMS',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/Customization/RBACCloneService.svc/CatchRBACRoleRightDataListByQMS',
        checkRowData: [], //选中数据
        refresh: function () {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'RBACModuleOper_Id',
                    title: 'RBACModuleOper_Id',
                    minWidth: 130
                },
                {
                    field: 'RBACRole_Id',
