...
layui.extend({
	...
	var tableObj = {
		...
		form: layui.form,
		fields:{
			Id:"BHospitalLevel_Id",
			IsUse:'BHospitalLevel_IsUse'
        },
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/LIIPCommonService.svc/ST_UDTO_AddBHospitalLevel',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/LIIPCommonService.svc/ST_UDTO_SearchBHospitalLevelByHQL?isPlanish=true',
        updateUrl: uxutil.path.ROOT +'/ServerWCF/LIIPCommonService.svc/ST_UDTO_UpdateBHospitalLevelByField',
        delUrl: uxutil.path.ROOT +'/ServerWCF/LIIPCommonService.svc/ST_UDTO_DelBHospitalLevel',
        checkRowData: [], //选中数据
        refresh: function () {
        ...
        reset: function () { //重置
            if (formObj.type == 'edit') {
                if (tableObj.checkRowData.length > 0) {
                    ...
                    if (tableObj.checkRowData[tableObj.checkRowData.length - 1].BHospitalLevel_IsUse == "true") {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'BHospitalLevel_Name',
                    title: '名称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'BHospitalLevel_SName',
                    title: '简称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'BHospitalLevel_Code',
                    title: '代码',
                    minWidth: 130,
                    //sort: true
                },
                {
                    field: 'BHospitalLevel_Shortcode',
                    title: '快捷码',
                    minWidth: 130,
                    //sort: true
                },
                {
                    field: 'BHospitalLevel_PinYinZiTou',
                    title: '拼音字头',
                    minWidth: 130,
                    //sort: true
                },
                {
                    field: 'BHospitalLevel_Comment',
                    title: '备注',
                    //sort: true,
                    minWidth: 70
                },{
