...
Ext.define('Shell.class.qms.file.basic.FFileDetailedForm', {
	...
	/**内容类型 1：文档 2：新闻 ,通知*/
	FTYPE: '1',
	selectFFileOperationUrl: '/ServerWCF/CommonService.svc/QMS_UDTO_SearchFFileOperationByHQL',
	/**抄送范围和阅读范围*/
	FileCopyUserOrReadingUserUrl: '/ServerWCF/CommonService.svc/QMS_UDTO_SearchFFileCopyUserOrReadingUserByFFileId',
	FFileOperationHtml: '',
	ContentHtml: '',
	FFileCopyUserHtml: '',
	UserInfoHtml: '',
