 ...
 * @version 2016-09-26
 */
Ext.define('Shell.class.qms.file.file.show.App', {
	extend: 'Shell.class.qms.file.basic.ShowApp',
	title: '文档信息',
	basicGrid: 'Shell.class.qms.file.file.show.Grid',
	/**PDF预览0下载按钮显示，1不显示,默认为空 使用内置pdf预览*/
	DOWNLOAD:'',
	/**PDF预览0打印按钮显示，1不显示,默认为空 使用内置pdf预览*/
	PRINT:'',
