 ...
 * @version 2020-04-07
 */
Ext.define('Shell.class.qms.equip.deptemplink.Grid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/RBACService.svc/RBAC_UDTO_SearchHRDeptEmpByHQL?isPlanish=true',
	delUrl:'/RBACService.svc/RBAC_UDTO_DelHRDeptEmp',
	defaultOrderBy: [{
	...
	createButtonToolbarItems:function(){
		...
		buttonToolbarItems.push('refresh','-',{
			...
			name:'Employee_CName',itemId:'Employee_CName',xtype:'uxCheckTrigger1',
	...
	onAddClick: function(id) {
		...
		JShell.Win.open('Shell.class.qms.equip.deptemplink.Form', config).show();
	},
		/**获取带查询参数的URL*/
	getLoadUrl: function() {
		var me = this,
