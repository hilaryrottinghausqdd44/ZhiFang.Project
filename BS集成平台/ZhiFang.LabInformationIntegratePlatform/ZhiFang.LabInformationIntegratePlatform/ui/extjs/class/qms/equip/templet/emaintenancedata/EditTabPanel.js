 ...
 * @version 2016-08-25
 */
Ext.define('Shell.class.qms.equip.templet.emaintenancedata.EditTabPanel', {
...
//				me.Form.removeAll();
	...
	createItems: function() {
		var me = this;
		var items = [];
		me.Form = Ext.create('Shell.class.qms.equip.templet.operate.Form', {
			border: true,
			title: '表单',
			region: 'center',
		    //从外边传参时间控件是否只读,默认是true，不可改, false（可改） 
		...
		me.OperatePanel= Ext.create('Shell.class.qms.equip.templet.operate.TBPanel', {
			title: '列表',
		    region: 'east',
			width:250,
			split: true,
