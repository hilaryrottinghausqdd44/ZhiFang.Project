...
Ext.define('Shell.class.sysbase.module.Grid', {
	...
	initComponent: function() {
		...
		me.buttonToolbarItems = ['refresh','add','edit','del','save',{
			text:'功能权限',tooltip:'功能权限',iconCls:'button-config',
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'模块名称',dataIndex:'RBACModule_CName',width:100,
			...
			text:'模块描述',dataIndex:'RBACModule_Comment',width:200,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			text:'入口地址',dataIndex:'RBACModule_Url',width:150,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			text:'次序',dataIndex:'RBACModule_DispOrder',width:40,
	...
	openOperGrid:function(){
		...
		var id = records[0].get(me.PKField);
		JShell.Win.open('Shell.class.sysbase.module.OperGrid',{
			RBACModuleID:id
		}).show();
	}
});