...
Ext.define('Shell.class.sysbase.module.Form',{
	...
	createItems:function(){
		...
		items.push(
			...
			{x:10,y:160,fieldLabel:'模块描述',width:540,name:'RBACModule_Comment'},
			{
				x: 10, y: 185, fieldLabel: '模块组件JSON', width: 540, height: 70,
				name: 'RBACModule_ComponentsListJson', xtype: 'textarea',
				emptyText:'[{"name":"peizhi1","list":{"FormCode":[{"elem":"#id1","code":"123"},{"elem":"#id1","code":"123"}],"GridCode":[{"elem":"#id1","code":"123"},{"elem":"#id1","code":"123"}]}},{"name":"peizhi2","list":{"FormCode":[{"elem":"#id1","code":"123"},{"elem":"#id1","code":"123"}],"GridCode":[{"elem":"#id1","code":"123"},{"elem":"#id1","code":"123"}]}}]'
			}
		);
	...
	getAddParams:function(){
		...
		var entity = {
			...
			ComponentsListJson: values.RBACModule_ComponentsListJson,
