...
Ext.define('Shell.class.sysbase.org.Form',{
    ...
    /**获取数据服务路径*/
    selectUrl:'/ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptById?isPlanish=true',
    /**新增服务地址*/
	...
	createItems:function(){
		...
		items.push(
			...
			{x:190,y:60,fieldLabel:'上级机构',emptyText:'必填项',allowBlank:false,
				itemId:'HRDept_ParentName',IsnotField:true,
		...
		items.push(
			...
			{x:485,y:110,boxLabel:'是否使用',name:'HRDept_IsUse',
				width:70,xtype:'checkbox',checked:true
			}
		);
		
		items.push(
			{x:10,y:135,fieldLabel:'机构地址',width:540,name:'HRDept_Address'},
		...
		items.push(
			...
			{fieldLabel:'时间戳',name:'HRDept_DataTimeStamp',hidden:true},
			{fieldLabel:'机构ID',name:'HRDept_LabID',itemId:'HRDept_LabID',
