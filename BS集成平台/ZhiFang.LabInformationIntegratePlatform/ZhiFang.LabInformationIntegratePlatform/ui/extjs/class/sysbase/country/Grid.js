 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.sysbase.country.Grid',{
	...
	height: 500,
  	...
  	/**获取数据服务路径*/
	selectUrl:'/ServerWCF/SingleTableService.svc/ST_UDTO_SearchBCountryByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl:'/ServerWCF/SingleTableService.svc/ST_UDTO_UpdateBCountryByField',
	/**删除数据服务路径*/
	delUrl:'/ServerWCF/SingleTableService.svc/ST_UDTO_DelBCountry',
...
//	hasEdit:true,
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'快捷码',dataIndex:'BCountry_Shortcode',defaultRenderer:true
		},{
			text:'拼音字头',dataIndex:'BCountry_PinYinZiTou',defaultRenderer:true
		},{
			xtype:'checkcolumn',text:'使用',dataIndex:'BCountry_IsUse',
			...
			text:'备注',dataIndex:'BCountry_Memo',width:200,
	...
	onSaveClick:function(){
		...
		for(var i=0;i<len;i++){
			...
			var IsUse = rec.get('BCountry_IsUse');
