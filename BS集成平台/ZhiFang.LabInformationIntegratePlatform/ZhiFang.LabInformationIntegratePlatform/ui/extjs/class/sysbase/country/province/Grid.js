...
Ext.define('Shell.class.sysbase.country.province.Grid',{
	...
	height: 500,
  	...
  	/**获取数据服务路径*/
	selectUrl:'/ServerWCF/SingleTableService.svc/ST_UDTO_SearchBProvinceByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl:'/ServerWCF/SingleTableService.svc/ST_UDTO_UpdateBProvinceByField',
	/**删除数据服务路径*/
	delUrl:'/ServerWCF/SingleTableService.svc/ST_UDTO_DelBProvince',
