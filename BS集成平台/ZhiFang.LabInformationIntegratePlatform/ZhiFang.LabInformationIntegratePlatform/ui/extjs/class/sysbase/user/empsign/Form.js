...
Ext.define('Shell.class.sysbase.user.empsign.Form', {
	...
	selectUrl: '/ServerWCF/RBACService.svc/SC_UDTO_DownLoadEmpSignByEmpId',
	/**上传服务地址*/
	uploadUrl: '/ServerWCF/RBACService.svc/SC_UDTO_UploadEmpSignByEmpId',
	/**文件下载服务路径*/
	downloadUrl: "/ServerWCF/RBACService.svc/PGM_UDTO_DownLoadEmpSignByEmpId",
	/**显示成功信息*/
	...
	createPreviewImage: function(fieldLabel) {
		var me = this;
		var src = JShell.System.Path.ROOT + '/EmpImages/' + me.PK + ".png";
		me.PreviewImage = {
			xtype: 'image',
			fieldLabel: fieldLabel,
			src: src,
