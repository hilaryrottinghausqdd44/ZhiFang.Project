...
namespace ZhiFang.Entity.RBAC
{
	...
	public class HREmployee : BaseEntity
	{
        ...
        [DataMember]
        [DataDesc(CName = "标准代码平台内人员唯一编码 ", ShortCode = "StandCode", Desc = "标准代码平台内人员唯一编码", ContextType = SysDic.All, Length = 50)]
		...
		[DataMember]
		[DataDesc(CName = "数据操作时的错误信息", ShortCode = "ErrorInfo", Desc = "数据操作时的错误信息")]
