...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class HRDept : BaseEntity
	{
        ...
        private string _ParentStandCode;
		...
		[DataMember]
		[DataDesc(CName = "父机构编码", ShortCode = "ParentStandCode", Desc = "父机构编码", ContextType = SysDic.NText, Length = 12)]
		public virtual string ParentStandCode
		{
			get { return _ParentStandCode; }
			set
			{
				_ParentStandCode = value;
			}
		}

		[DataMember]
		[DataDesc(CName = "ErrorInfo", ShortCode = "ErrorInfo", Desc = "ErrorInfo", ContextType = SysDic.NText, Length = 12)]
		...
		[DataMember]
		[DataDesc(CName = "上级部门名称", ShortCode = "ParentName", Desc = "上级部门名称", ContextType = SysDic.List)]
