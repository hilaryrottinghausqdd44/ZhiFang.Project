...
namespace ZhiFang.Entity.RBAC
{
	...
	public class RBACModule : BaseEntityService
	{
		...
		protected string _ComponentsListJson;
        ...
        [DataMember]
        [DataDesc(CName = "模块入口地址", ShortCode = "URL", Desc = "模块入口地址", ContextType = SysDic.All, Length = 500)]
		...
		[DataMember]
		[DataDesc(CName = "模块包括的构建控件的参数,json格式", ShortCode = "ComponentsListJson", Desc = "模块包括的构建控件的参数,json格式", ContextType = SysDic.All, Length = 16)]
		public virtual string ComponentsListJson
		{
			get { return _ComponentsListJson; }
			set
			{
				_ComponentsListJson = value;
			}
		}
