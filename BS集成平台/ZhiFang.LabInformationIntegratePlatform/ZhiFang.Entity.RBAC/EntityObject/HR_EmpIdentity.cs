...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class HREmpIdentity : BaseEntity
	{
        ...
        [DataMember]
        [DataDesc(CName = "员工身份类型编码", ShortCode = "YGSFLXID", Desc = "员工身份类型编码", ContextType = SysDic.Number, Length = 8)]
        ...
        [DataMember]
        [DataDesc(CName = "员工身份类型名称", ShortCode = "YGSFLXID", Desc = "员工身份类型名称", ContextType = SysDic.Number, Length = 8)]
        ...
        [DataMember]
        [DataDesc(CName = "员工身份类型所属系统ID", ShortCode = "YGSFLXID", Desc = "员工身份类型所属系统ID", ContextType = SysDic.Number, Length = 8)]
        ...
        [DataMember]
        [DataDesc(CName = "员工身份类型所属系统编码", ShortCode = "YGSFLXID", Desc = "员工身份类型所属系统编码", ContextType = SysDic.Number, Length = 8)]
        ...
        [DataMember]
        [DataDesc(CName = "员工身份类型所属系统名称", ShortCode = "YGSFLXID", Desc = "员工身份类型所属系统名称", ContextType = SysDic.Number, Length = 8)]
