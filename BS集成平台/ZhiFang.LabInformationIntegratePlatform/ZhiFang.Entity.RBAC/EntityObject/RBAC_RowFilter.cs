...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class RBACRowFilter : BaseEntityService
    {
        ...
        protected bool _isPreconditions;
        ...
        [DataMember]
        [DataDesc(CName = "是否预置条件", ShortCode = "IsPreconditions", Desc = "是否预置条件", ContextType = SysDic.All, Length = 1)]
        public virtual bool IsPreconditions
        {
            get { return _isPreconditions; }
            set { _isPreconditions = value; }
        }
        [DataMember]
