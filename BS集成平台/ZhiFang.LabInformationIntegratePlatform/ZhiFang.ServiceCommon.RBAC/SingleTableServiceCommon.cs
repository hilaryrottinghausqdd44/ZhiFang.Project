...
namespace ZhiFang.ServiceCommon.RBAC
{
    public class SingleTableServiceCommon
    {
        ...
        public virtual ZhiFang.IBLL.RBAC.IBBCounty IBBCounty { get; set; }
        ...
        #region BCounty
        //Add  BCounty
        public BaseResultDataValue ST_UDTO_AddBCounty(BCounty entity)
        {
            ...
            if (entity != null)
            {
                ...
                IBBCounty.Entity = entity;
                try
                {
                    baseResultDataValue.success = IBBCounty.Add();
        ...
        //Update  BCounty
        public BaseResultBool ST_UDTO_UpdateBCounty(BCounty entity)
        {
            ...
            if (entity != null)
            {
                ...
                try
                {
                    baseResultBool.success = IBBCounty.Edit();
        ...
        //Update  BCounty
        public BaseResultBool ST_UDTO_UpdateBCountyByField(BCounty entity, string fields)
        {
            BaseResultBool baseResultBool = new BaseResultBool();
            if (entity != null)
            {
                ...
                try
                {
                    if ((fields != null) && (fields.Length > 0))
                    {
                        string[] tempArray = CommonServiceMethod.GetUpdateFieldValueStr(IBBCounty.Entity, fields);
                        if (tempArray != null)
                        {
                            baseResultBool.success = IBBCounty.Update(tempArray);
                            if (baseResultBool.success)
                            {
                                //IBBSampleOperate.AddObjectOperate(entity, entity.GetType().Name, "EditEntity", "修改实体操作");
                            }
        ...
        //Delele  BCounty
        public BaseResultBool ST_UDTO_DelBCounty(long id)
        {
            BaseResultBool baseResultBool = new BaseResultBool();
            try
            {
                IBBCounty.Entity = IBBCounty.Get(id);
                if (IBBCounty.Entity != null)
                {
                    long labid = IBBCounty.Entity.LabID;
                    string entityName = IBBCounty.Entity.GetType().Name;
                    baseResultBool.success = IBBCounty.RemoveByHQL(id);
                    if (baseResultBool.success)
                    {
        ...
        public BaseResultDataValue ST_UDTO_SearchBCounty(BCounty entity)
        {
            EntityList<BCounty> entityList = new EntityList<BCounty>();
            BaseResultDataValue baseResultDataValue = new BaseResultDataValue();
            if (entity != null)
            {
                IBBCounty.Entity = entity;
                try
                {
                    entityList.list = IBBCounty.Search();
                    entityList.count = IBBCounty.GetTotalCount();
                    ParseObjectProperty pop = new ParseObjectProperty("");
                    try
                    {
                        baseResultDataValue.ResultDataValue = pop.GetObjectListPlanish<BCounty>(entityList);
                    }
                    catch (Exception ex)
                    {
                        baseResultDataValue.success = false;
        ...
        public BaseResultDataValue ST_UDTO_SearchBCountyByHQL(int page, int limit, string fields, string where, string sort, bool isPlanish)
        {
            BaseResultDataValue baseResultDataValue = new BaseResultDataValue();
            EntityList<BCounty> entityList = new EntityList<BCounty>();
            try
            {
                if ((sort != null) && (sort.Length > 0))
                {
                    entityList = IBBCounty.SearchListByHQL(where, CommonServiceMethod.GetSortHQL(sort), page, limit);
                }
                else
                {
                    entityList = IBBCounty.SearchListByHQL(where, page, limit);
                }
        ...
        public BaseResultDataValue ST_UDTO_SearchBCountyById(long id, string fields, bool isPlanish)
        {
            BaseResultDataValue baseResultDataValue = new BaseResultDataValue();
            try
            {
                var entity = IBBCounty.Get(id);
                ParseObjectProperty pop = new ParseObjectProperty(fields);
                try
                {
                    if (isPlanish)
                    {
                        baseResultDataValue.ResultDataValue = pop.GetSingleObjectPlanish<BCounty>(entity);
                    }
                    else
                    {
