...
namespace ZhiFang.LIIP.Common
{
    ...
    {
        //过滤\t, \n, \r构建的恶意代码  
        public static string[] keywords = {"javascript", "vbscript", "expression", "applet", "meta", "xml", "blink", "link", "style", "script", "embed", "object", "iframe", "frame", "frameset", "ilayer", "layer", "bgsound", "title", "base"
        ...
        /// </summary>   
        /// <param name="input">传入字符串</param>   
        /// <returns>是否包含攻击脚本</returns>   
        public static bool CheckXSS(string html)
        {
