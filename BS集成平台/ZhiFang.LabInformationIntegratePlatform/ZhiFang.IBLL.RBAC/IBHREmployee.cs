...
{	
	public interface IBHREmployee : ZhiFang.IBLL.Base.IBGenericManager<ZhiFang.Entity.RBAC.HREmployee>
	{
        ...
        IList<HREmployee> GetHREmployeeAllList();
        IList<HREmployee> GetHREmployeeListByDeptIdList(string idlist);
        bool TUpdate(HREmployee entity);
        BaseResultDataValue TransformEmpByExcel(DataTable tmpdt);
    } 
}