...
namespace ZhiFang.Entity.Common
{
	...
	/// <summary>
	/// FFileReadingUser object for NHibernate mapped table 'F_File_ReadingUser'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "文档阅读对象表", ClassCName = "FFileReadingUser", ShortCode = "FFileReadingUser", Desc = "文档阅读对象表")]
	public class FFileReadingUser : BaseEntity
	{
		...
		public FFileReadingUser() { }

		public FFileReadingUser( long labID, long type, string memo, int dispOrder, bool isUse, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, FFile fFile, HREmployee creator, HRDept hRDept, HREmployee user, RBACRole rBACRole )
		{
			this._labID = labID;
			this._type = type;
			this._memo = memo;
        ...
        [DataMember]
        [DataDesc(CName = "阅读人", ShortCode = "User", Desc = "阅读人")]
		...
		[DataMember]
		[DataDesc(CName = "区域", ShortCode = "RBACRole", Desc = "区域")]
