...
{
    /// <summary>
    /// LogisticsClient 的摘要说明
    /// </summary>
    [WebService(Namespace = "ZhiFang.WebLis.Ashx")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    public class LogisticsClient : IHttpHandler
    {
        ...
        [AjaxPro.AjaxMethod]
        public string[] ShowLogisticsClientList(string Account, int PageIndex, int PageSize, int PageCol)
        {
            try
            {
                ...
                ZhiFang.Model.BusinessLogicClientControl lcc_m = new Model.BusinessLogicClientControl() { Account = Account ,SelectedFlag=true,Flag=0};
                DataSet ds = ibbcc.GetClientList_DataSet(lcc_m);
                string tr = "";
                string td = "";
