...
namespace ZhiFang.WebLis
{
    public partial class LoginRedirect : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string textUserid = "";
            string textPassword = "";
            if (Request.QueryString.AllKeys.Contains("j_username")&&Request.QueryString["j_username"] != null && Request.QueryString["j_username"].Trim() != "")
            {
            ...
            if (Request.QueryString.AllKeys.Contains("j_password") && Request.QueryString["j_password"] != null && Request.QueryString["j_password"].Trim() != "")
            {
            ...
            if (wsrbac != null)
            {
                bool a = wsrbac.Login(textUserid.Trim(), Base64Help.EncodingString(textPassword.Trim()), out descr);
                if (a)
                {
                    ...
                    string redirecturl = "Main/Main.aspx";
                    if (Request.QueryString.AllKeys.Contains("j_redirecturl") &&Request.QueryString["j_redirecturl"] != null && Request.QueryString["j_redirecturl"].Trim() != "")
                    {
                        redirecturl= Request.QueryString["j_redirecturl"].Trim();
                    }
