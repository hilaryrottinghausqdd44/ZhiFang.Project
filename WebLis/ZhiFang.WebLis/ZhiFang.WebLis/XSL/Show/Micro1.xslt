...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:13px;text-align:left; ">
  <tr>
	...
	<xsl:for-each select="WebReportFile/ReportMicroItem">
	<tr><td style="font-size:14px">
	<xsl:value-of select="ITEMNAME"/></td>
	</tr>	
	<tr>
	  <td style="padding-left:14px;"><xsl:value-of select="DESCNAME"/></td>
	</tr>
	</xsl:for-each>
	<xsl:for-each select="WebReportFile/ReportMicroItem">
	<tr>
	  <td style="padding-left:14px;"><xsl:value-of select="MICRONAME"/></td>
	</tr>	
	<tr><td>
		<table width="100%" border="0" cellspacing="1" cellpadding="0" style=" padding-left:24px">
        <tr style=" font-size:13px; font-weight:bold;background-color:#8fd9fe;padding-left:0.5em; padding-right:0.5em;">
        <td style="padding-left:0.5em; padding-right:0.5em;white-space:nowrap; width:40%">抗生素</td>
        <td style="padding-left:0.5em; padding-right:0.5em;white-space:nowrap; width:40%">结果MIC(ug/ml)</td>
        <td style="padding-left:0.5em; padding-right:0.5em;white-space:nowrap; width:20%">药敏度</td>
      </tr>
      <xsl:for-each select="ReportMicroAnti">
        <tr style="height:22px; line-height:22px;background:#CCFFFF;" onmouseover="this.style.background='#ffffcc'" onmouseout="this.style.background='#CCFFFF'" onclick="this.style.background='#ffff99'">
          ...
          <td style="padding-left:0.5em; padding-right:0.5em;">
		  <xsl:value-of select="SUSCEPT"/></td>
        </tr>
      </xsl:for-each>
    </table>
	</td></tr>
	...
	<xsl:for-each select="WebReportFile/ReportForm">      
        ...
        <tr>
          <td>开单科室：<xsl:value-of select="DeptName"/></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>就诊类型：<xsl:value-of select="SickTypeName"/></td>
        </tr>
        <tr>
