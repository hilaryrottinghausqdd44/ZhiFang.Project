<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeblisReportFormQueryPrint_Android.aspx.cs" Inherits="ZhiFang.WebLis.ReportPrint.WeblisReportFormQueryPrint_Android" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        //        function Init() {
        //            alert(parent.name);
        //            parent.document.getElementById("treetd").style.display = "none";
        //            }
     </script>
...
<body >
    ...
    <div id="111">
        ...
        <div class="searchstyle">
            <!--#include file="../SearchTools/MeiZhong_Weblis.html"-->
        </div>
            ...
            <div class="contleft">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Button ID="Button1" Style="display: block" runat="server" OnClick="Button1_Click"
                            Text="Button" />
                        ...
                        <asp:Button ID="linkGetAllFrom" Text="hhh" Style="display: block" runat="server" OnClick="linkGetAllItem_Click">
                        </asp:Button>
