...
<div class="contright"> <asp:UpdatePanel ID="UpdatePanel2" runat="server" >
    ...
    <table width="100%" height="40" bgcolor="#eaf7fd"  cellspacing="1" cellpadding="0" border="0">
						<tr >
						
						<td >
						<input onclick ="OpenWindowModal()" type ="button" value ="生成HTML" style="width: 70px; display:none"  />
						<input class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'" onmouseout="this.className='btn1_mouseout'"   type ='button' onclick='dlpd();' value='打印当前' />
						<input class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'" onmouseout="this.className='btn1_mouseout'"   type ="button" onclick="dlp();" value ="批量打印" />
						<input class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'" onmouseout="this.className='btn1_mouseout'"   type ='button' onclick='dlpp();' value='预览打印' /></td>
						<td><input class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'" onmouseout="this.className='btn1_mouseout'"  onclick='Report_PrinterSet();' id="Report_PrinterSet_button" type='button' value='报告默认打印机设置' /></td>
						<td><input class="btn1_mouseout" onmouseover="this.className='btn1_mouseover'" onmouseout="this.className='btn1_mouseout'"   onclick='SelectPageSize();' type='button' value='选择打印' /><div id="ReportPageSizeList" style="display:none" ><input type="checkbox" /></div></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
