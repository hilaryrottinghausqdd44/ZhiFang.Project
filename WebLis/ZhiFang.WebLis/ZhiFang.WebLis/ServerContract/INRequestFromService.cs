...
namespace ZhiFang.WebLis.ServerContract
{
    ...
    public interface INRequestFromService
    {
        ...
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/GetNRequestFromListByRBACToExcel?page={page}&rows={rows}&fields={fields}&jsonentity={jsonentity}&sort={sort}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue GetNRequestFromListByRBACToExcel(int page, int rows, string fields, string jsonentity, string sort);
        ...
        [Description("申请单新增并返回条码号")]
        [OperationContract]
        BaseResultDataValue requestFormAdd_BarCodePrint(NrequestCombiItemBarCodeEntity jsonentity);

        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/RequestFormAdd_Batch_BarCodePrint", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [Description("申请单批量新增并返回条码号")]
        [OperationContract]
        BaseResultDataValue RequestFormAdd_Batch_BarCodePrint(List<NrequestCombiItemBarCodeEntity> jsonentity);
        ...
        #region 四川大家微信消费
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/OSConsumerUserOrderForm", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue OSConsumerUserOrderForm(ConsumerUserOrderFormVO jsonentity);
        ...
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/SearchUnConsumerUserOrderFormList", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue SearchUnConsumerUserOrderFormList(ConsumerUserOrderFormVO jsonentity);
        #endregion

        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/GetNRequestFormList?ClientNo={ClientNo}&txtStartDate={txtStartDate}&txtEndDate={txtEndDate}&txtCollectStartDate={txtCollectStartDate}&txtCollectEndDate={txtCollectEndDate}&SelectDoctor={SelectDoctor}&txtPatientID={txtPatientID}&txtPatientName={txtPatientName}&SickTypeNo={SickTypeNo}&filetype={filetype}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue GetNRequestFormList(string ClientNo, string txtStartDate, string txtEndDate, string txtCollectStartDate, string txtCollectEndDate, string SelectDoctor, string txtPatientID, string txtPatientName, string SickTypeNo, string filetype);

        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/SendBarCodeFromByBarCodeList?BarCodeList={BarCodeList}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool SendBarCodeFromByBarCodeList(string BarCodeList);

        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/DeliveryBarCodeFromByBarCodeList?BarCodeList={BarCodeList}&Flag={Flag}&Reason={Reason}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool DeliveryBarCodeFromByBarCodeList(string BarCodeList, bool Flag, string Reason);

        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ReceiveBarCodeFromByBarCodeList?BarCodeList={BarCodeList}&Flag={Flag}&Reason={Reason}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ReceiveBarCodeFromByBarCodeList(string BarCodeList, bool Flag, string Reason);
    }
}
