$(function () {
    ...
    function resetInfo() {
        ...
        var textboxList = ["form_PersonID", "form_NRequestFormNo", "form_CName", "form_PatNo", "form_WardNo", "form_Diag", "form_Operator", "form_Bed", "form_zdy3", "form_zdy4", "form_zdy5", "form_zdy7", "form_zdy8", "form_zdy10"],
			...
			comboboxList = ["form_AgeUnitNo", "form_DeptNo", "form_DistrictNo", "form_Doctor",
				"form_GenderNo", "form_FolkNo", "form_TestTypeNo", "form_zdy6"];
        ...
        for (var i in comboboxList) {
            if (comboboxList[i] == "form_AgeUnitNo" || comboboxList[i] == "form_GenderNo" || comboboxList[i] == "form_zdy6") {
                if (comboboxList[i] == "form_GenderNo") {
                    var rows = $("#" + comboboxList[i]).combobox('getData'),
                        valueField = $("#" + comboboxList[i]).combobox('options').valueField;
                    $("#" + comboboxList[i]).combobox('select', rows[1][valueField]);
                }
                else {
                    var rows = $("#" + comboboxList[i]).combobox('getData'),
                        valueField = $("#" + comboboxList[i]).combobox('options').valueField;
    ...
    function getNrequestForm() {
        var form = {
            ...
            zdy3: $("#form_zdy3").datetimebox("getValue"), //末次月经日期
