...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class B_Lab_GroupItem : BaseDALLisDB, IDLab_GroupItem
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM B_Lab_GroupItem ");
        ...
        public DataSet GetList(ZhiFang.Model.Lab_GroupItem model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM B_Lab_GroupItem  INNER JOIN   B_Lab_TestItem ON B_Lab_GroupItem.ItemNo =  B_Lab_TestItem.ItemNo and  B_Lab_GroupItem.LabCode =  B_Lab_TestItem.LabCode   where 1=1 ");
            if (model.PItemNo != null)
            {
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_Lab_GroupItem.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_Lab_GroupItem .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }

        public DataSet GetPitemList(Lab_GroupItem model)
        {
            throw new NotImplementedException();
        }
