...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class B_SickTypeControl : BaseDALLisDB, IDSickTypeControl
    {
        ...
        public int Add(ZhiFang.Model.SickTypeControl model)
        {
            ...
            {
                strSql1.Append("SickTypeControlNo,");
                strSql2.Append("'" + model.SickTypeControlNo + "',");
            }
            ...
            {
                strSql1.Append("ControlSickTypeNo,");
                strSql2.Append("" + model.ControlSickTypeNo + ",");
            }
        ...
        public int Update(ZhiFang.Model.SickTypeControl model)
        {
            ...
            if (model.ControlSickTypeNo != null)
            {
                strSql.Append("ControlSickTypeNo=" + model.ControlSickTypeNo + ",");
            }
            if (model.AddTime != null)
            {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where SickTypeControlNo='" + model.SickTypeControlNo + "'");
            if (DbHelperSQL.ExecuteNonQuery(strSql.ToString()) > 0)
            {
                return d_log.OperateLog("SickType", "", "", DateTime.Now, 1);
            }
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SickTypeControl.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SickTypeControl .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
        ...
        public bool CheckIncludeLabCode(List<string> l, string LabCode)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SickTypeControl.CheckIncludeLabCode异常->", ex);
            }
            return b;
        }
        ...
        public bool CheckIncludeCenterCode(List<string> l, string LabCode)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SickTypeControl.CheckIncludeCenterCode异常->", ex);
            }
            return b;
        }
        ...
        public DataSet GetLabCodeNo(string LabCode, List<string> CenterNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SickTypeControl.GetLabCodeNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet GetCenterNo(string LabCode, List<string> LabPrimaryNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SickTypeControl.GetCenterNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet B_lab_GetListByPage(ZhiFang.Model.SickTypeControl model, int nowPageNum, int nowPageSize)
        {
            ...
            //已对照
            if (model.ControlState == "1")
                strSql.Append("select b.SickTypeNo,a.*,b.CName CenterCName from ( select *from b_lab_SickType where 1=1 and labSickTypeno in (select ControlSickTypeNo From B_SickTypeControl where 1=1 and B_SickTypeControl.ControlLabNo ='" + model.ControlLabNo + "'" + strWhere.ToString() + " ) and  b_lab_SickType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_SickTypeControl on B_SickTypeControl.ControlSickTypeNo =a.labSickTypeNo and  B_SickTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join SickType b on b.SickTypeNo = B_SickTypeControl.SickTypeNo");
            //未对照
            else if (model.ControlState == "2")
                strSql.Append("select b.SickTypeNo,a.*,b.CName CenterCName from (select *from b_lab_SickType where 1=1 and labSickTypeno not in (select ControlSickTypeNo From B_SickTypeControl where 1=1 and B_SickTypeControl.ControlLabNo ='" + model.ControlLabNo + "' ) and  b_lab_SickType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_SickTypeControl on B_SickTypeControl.ControlSickTypeNo =a.labSickTypeNo and  B_SickTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join SickType b on b.SickTypeNo = B_SickTypeControl.SickTypeNo");
            //全部 
            else if (model.ControlState == "0")
                strSql.Append("select b.SickTypeNo,a.*,b.CName CenterCName from (select *from b_lab_SickType where 1=1 and b_lab_SickType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_SickTypeControl on B_SickTypeControl.ControlSickTypeNo =a.labSickTypeNo and  B_SickTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join SickType b on b.SickTypeNo = B_SickTypeControl.SickTypeNo ");
            else
