...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class ReportFormFull : BaseDALLisDB, IDReportFormFull
    {
        ...
        public int Update(ZhiFang.Model.ReportFormFull model)
        {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where ReportFormID='" + model.ReportFormID + "' ");
        ...
        public ZhiFang.Model.ReportFormFull GetModel(string ReportFormID)
        {
            ...
            strSql.Append(" where ROWNUM <='1' and ReportFormID='" + ReportFormID + "' ");
        ...
        */
        ...
        public DataSet GetList(ZhiFang.Model.ReportFormFull model)
        {
            try
            {
                ...
                if (model.CHECKDATE != null)
                {
                    strSql.Append(" and CHECKDATE = to_date('" + model.CHECKDATE.ToString() + "','YYYY-MM-DD HH24:MI:SS')");
                }

                if (model.CHECKTIME != null)
                {
                    strSql.Append(" and CHECKTIME = to_date('" + model.CHECKTIME.ToString() + "','YYYY-MM-DD HH24:MI:SS')");
                }
                ...
                {
                    strSql.Append(" and ReceiveDate >= to_date('" + model.Startdate.ToString() + "','YYYY-MM-DD HH24:MI:SS')");
                  
                }

                if (model.Enddate != null)
                {
                    strSql.Append(" and ReceiveDate <= to_date('" + model.Enddate.ToString() + "','YYYY-MM-DD HH24:MI:SS')");
                }

                if (model.CheckStartDate != null)
                {
                    strSql.Append(" and checkdate >= to_date('" + model.CheckStartDate.ToString() + "','YYYY-MM-DD HH24:MI:SS')");
                }

                if (model.CheckEndDate != null)
                {
                    strSql.Append(" and checkdate <= to_date('" + model.CheckEndDate.ToString() + "','YYYY-MM-DD HH24:MI:SS')");
                }
        ...
        public DataSet GetList(ZhiFang.Model.ReportFormFull model, string city)
        {
            try
            {
                ...
                strSql.Append(" FROM ReportFormFull where");

                if (model.Startdate != null)
                {
                    strSql.Append(" RECEIVEDATE  between to_date('" + model.Startdate.Value.ToShortDateString() + "','yyyy-mm-dd') ");
                }

                if (model.Enddate != null)
                {
                    strSql.Append(" and to_date('" + model.Enddate.Value.ToShortDateString() + "','yyyy-mm-dd') ");
                }
        ...
        public DataSet GetList(int Top, Model.ReportFormFull model, string filedOrder)
        {
            ...
            if (model.Startdate != null)
            {
                strSql.Append(" and ReceiveDate>=to_date('" + model.Startdate.Value.ToShortDateString() + "','YYYY-MM-DD HH24:MI:SS') ");
            }

            if (model.Enddate != null)
            {
                strSql.Append(" and ReceiveDate<=to_date('" + model.Enddate.Value.ToShortDateString() + "','YYYY-MM-DD HH24:MI:SS') ");
            }

            if (model.CheckStartDate != null)
            {
                strSql.Append(" and checkdate>=to_date('" + model.CheckStartDate.Value.ToShortDateString() + "','YYYY-MM-DD HH24:MI:SS') ");
            }

            if (model.CheckEndDate != null)
            {
                strSql.Append(" and checkdate<=to_date('" + model.CheckEndDate.Value.ToShortDateString() + "','YYYY-MM-DD HH24:MI:SS') ");
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select COLUMN_NAME from all_tab_columns where table_name = 'REPORTFORMFULL' ");
        ...
        public int GetTotalCount(Model.ReportFormFull model)
        {
            ...
            if (model.OPERDATE != null)
            {
                strSql.Append(" and OPERDATE=to_date('" + model.OPERDATE + "','YYYY-MM-DD HH24:MI:SS') ");
            }

            if (model.OPERTIME != null)
            {
                strSql.Append(" and OPERTIME=to_date('" + model.OPERTIME + "','YYYY-MM-DD HH24:MI:SS') ");
            }
        ...
        {
            return DbHelperSQL.ExecuteDataSet(" SELECT * FROM all_tab_columns WHERE table_name=Object_Id('VIEW_REPORTITEMFULL') ");
        }
        public DataSet GetColumnByTable()
        {
            return DbHelperSQL.ExecuteDataSet(" SELECT * FROM all_tab_columns WHERE table_name='REPORTITEMFULL'  union  SELECT * FROM all_tab_columns WHERE table_name='REPORTITEMFULL'");
        }
        public DataSet GetMatchList(ZhiFang.Model.ReportFormFull model)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("select  ReportFormFull.SerialNo as BarCode,ReportFormFull.*,ReportItemFull.*");
                ...
                if (model.Startdate != null)
                {
                    strSql.Append(" and ReportFormFull.ReceiveDate>='" + model.Startdate.Value.ToShortDateString() + "' ");
                }

                if (model.Enddate != null)
                {
                    strSql.Append(" and ReportFormFull.ReceiveDate<='" + model.Enddate.Value.ToShortDateString() + "' ");
                }
        ...
        public DataSet GetListByView(Model.ReportFormFull rff_m)
        {
            throw new NotImplementedException();
        }
