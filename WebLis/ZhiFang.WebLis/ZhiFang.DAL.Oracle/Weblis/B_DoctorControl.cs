...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class B_DoctorControl : IDDoctorControl
    {
        ...
        public int Add(ZhiFang.Model.DoctorControl model)
        {
            ...
            {
                strSql1.Append("DoctorControlNo,");
                strSql2.Append("'" + model.DoctorControlNo + "',");
            }
            ...
            {
                strSql1.Append("ControlDoctorNo,");
                strSql2.Append("" + model.ControlDoctorNo + ",");
            }
        ...
        public int Update(ZhiFang.Model.DoctorControl model)
        {
            ...
            if (model.DoctorNo != null)
            {
                strSql.Append("DoctorNo=" + model.DoctorNo + ",");
            }
            if (model.ControlLabNo != null)
            {
            ...
            if (model.ControlDoctorNo != null)
            {
                strSql.Append("ControlDoctorNo=" + model.ControlDoctorNo + ",");
            }
            if (model.AddTime != null)
            {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where DoctorControlNo='" + model.DoctorControlNo + "' ");
            if (idb.ExecuteNonQuery(strSql.ToString()) > 0)
            {
                return d_log.OperateLog("Doctor", "", "", DateTime.Now, 1);
            }
