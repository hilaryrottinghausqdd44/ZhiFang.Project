...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class BarCodeForm : BaseDALLisDB, IDBarCodeForm
	{
		...
		public int Add(ZhiFang.Model.BarCodeForm model)
		{
            ...
            {
                strSql1.Append("SamplingGroupNo,");
                strSql2.Append("" + model.SamplingGroupNo + ",");
            }
            if (model.IsPrep != null)
            {
                strSql1.Append("IsPrep,");
                strSql2.Append("" + model.IsPrep + ",");
            }
            if (model.isSpiltItem != null)
            {
                strSql1.Append("isSpiltItem,");
                strSql2.Append("" + model.isSpiltItem + ",");
            }
            if (model.IsAffirm != null)
            {
                strSql1.Append("IsAffirm,");
                strSql2.Append("" + model.IsAffirm + ",");
            }
            ...
            {
                strSql1.Append("SampleCap,");
                strSql2.Append("" + model.SampleCap + ",");
            }
            if (model.ClientHost != null)
            {
                strSql1.Append("ClientHost,");
                strSql2.Append("'" + model.ClientHost + "',");
            }
            ...
            {
                strSql1.Append("refuseUser,");
                strSql2.Append("'" + model.refuseUser + "',");
            }
            if (model.refuseopinion != null)
            {
                strSql1.Append("refuseopinion,");
                strSql2.Append("'" + model.refuseopinion + "',");
            }
            if (model.refusereason != null)
            {
                strSql1.Append("refusereason,");
                strSql2.Append("'" + model.refusereason + "',");
            }
            if (model.refuseTime != null)
            {
                strSql1.Append("refuseTime,");
                strSql2.Append("to_date('" + model.refuseTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            ...
            if (model.inceptTime != null)
            {
                ...
                strSql2.Append("to_date('" + model.inceptTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.inceptDate != null)
            {
                strSql1.Append("inceptDate,");
                strSql2.Append("to_date('" + model.inceptDate.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            ...
            if (model.ReceiveDate != null)
            {
                ...
                strSql2.Append("to_date('" + model.ReceiveDate.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.ReceiveTime != null)
            {
                strSql1.Append("ReceiveTime,");
                strSql2.Append("to_date('" + model.ReceiveTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.PrintInfo != null)
            {
                strSql1.Append("PrintInfo,");
                strSql2.Append("'" + model.PrintInfo + "',");
            }
            ...
            {
                strSql1.Append("Dr2Flag,");
                strSql2.Append("" + model.Dr2Flag + ",");
            }
            ...
            {
                strSql1.Append("SerialScanTime,");
                strSql2.Append("'" + model.SerialScanTime + "',");
            }
            if (model.BarCodeSource != null)
            {
                strSql1.Append("BarCodeSource,");
                strSql2.Append("" + model.BarCodeSource + ",");
            }
            ...
            {
                strSql1.Append("SendOffFlag,");
                strSql2.Append("" + model.SendOffFlag + ",");
            }
            if (model.SendOffMan != null)
            {
                strSql1.Append("SendOffMan,");
                strSql2.Append("'" + model.SendOffMan + "',");
            }
            if (model.EMSMan != null)
            {
                strSql1.Append("EMSMan,");
                strSql2.Append("'" + model.EMSMan + "',");
            }
            if (model.SendOffDate != null)
            {
                strSql1.Append("SendOffDate,");
                strSql2.Append("'" + model.SendOffDate + "',");
            }
            if (model.ReportSignMan != null)
            {
                strSql1.Append("ReportSignMan,");
                strSql2.Append("'" + model.ReportSignMan + "',");
            }
            if (model.ReportSignDate != null)
            {
                strSql1.Append("ReportSignDate,");
                strSql2.Append("'" + model.ReportSignDate + "',");
            }
            if (model.RefuseIncepter != null)
            {
                strSql1.Append("RefuseIncepter,");
                strSql2.Append("'" + model.RefuseIncepter + "',");
            }
            if (model.RefuseIncepterMemo != null)
            {
                strSql1.Append("RefuseIncepterMemo,");
                strSql2.Append("'" + model.RefuseIncepterMemo + "',");
            }
            ...
            {
                strSql1.Append("SendOffMemo,");
                strSql2.Append("'" + model.SendOffMemo + "',");
            }
            ...
            {
                strSql1.Append("SampleSendNo,");
                strSql2.Append("'" + model.SampleSendNo + "',");
            }
            ...
            {
                strSql1.Append("WebLisOpTime,");
                strSql2.Append("to_date('" + model.WebLisOpTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.WebLiser != null)
            {
                strSql1.Append("WebLiser,");
                strSql2.Append("'" + model.WebLiser + "',");
            }
            if (model.WebLisDescript != null)
            {
                strSql1.Append("WebLisDescript,");
                strSql2.Append("'" + model.WebLisDescript + "',");
            }
            ...
            {
                strSql1.Append("WebLisIsReply,");
                strSql2.Append("" + model.WebLisIsReply + ",");
            }
            if (model.WebLisReplyDate != null)
            {
                strSql1.Append("WebLisReplyDate,");
                strSql2.Append("'" + model.WebLisReplyDate + "',");
            }
            ...
            {
                strSql1.Append("WebLisUploadTime,");
                strSql2.Append("to_date('" + model.WebLisUploadTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.WebLisUploadStatus != null)
            {
                strSql1.Append("WebLisUploadStatus,");
                strSql2.Append("" + model.WebLisUploadStatus + ",");
            }
            if (model.WebLisUploadTestStatus != null)
            {
                strSql1.Append("WebLisUploadTestStatus,");
                strSql2.Append("" + model.WebLisUploadTestStatus + ",");
            }
            if (model.WebLisUploader != null)
            {
                strSql1.Append("WebLisUploader,");
                strSql2.Append("'" + model.WebLisUploader + "',");
            }
            if (model.WebLisUploadDes != null)
            {
                strSql1.Append("WebLisUploadDes,");
                strSql2.Append("'" + model.WebLisUploadDes + "',");
            }
            ...
            //if (model.BarCodeOpTime != null)
            //{
            //    strSql1.Append("BarCodeOpTime,");
            //    strSql2.Append("'" + model.BarCodeOpTime + "',");
            //}
        ...
        public int Add_TaiHe(ZhiFang.Model.BarCodeForm model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BarCodeForm(");
            strSql.Append("BarCodeFormNo,Collecter,CollecterID,CollectDate,CollectTime,refuseUser,refuseopinion,refusereason,refuseTime,signflag,incepter,BarCode,inceptTime,inceptDate,ReceiveMan,ReceiveDate,ReceiveTime,PrintInfo,PrintCount,Dr2Flag,FlagDateDelete,DispenseFlag,SamplingGroupNo,SerialScanTime,BarCodeSource,DeleteFlag,SendOffFlag,SendOffMan,EMSMan,SendOffDate,ReportSignMan,ReportSignDate,RefuseIncepter,IsPrep,RefuseIncepterMemo,ReportFlag,SendOffMemo,SampleTypeNo,SampleSendNo,WebLisFlag,WebLisOpTime,WebLiser,WebLisDescript,WebLisOrgID,isSpiltItem,WebLisIsReply,WebLisReplyDate,WebLisSourceOrgId,WebLisUploadTime,WebLisUploadStatus,WebLisUploadTestStatus,WebLisUploader,WebLisUploadDes,WebLisSourceOrgName,ClientNo,IsAffirm,ClientName,ReceiveFlag,SampleCap,ClientHost,WebLisOrgName,color,ItemName,ItemNo,SampleTypeNamer,LabItemName,LabItemNo");
            strSql.Append(") values (");
		...
		public int Update(ZhiFang.Model.BarCodeForm model)
		{
            ...
            if (model.refuseTime != null)
            {
                strSql.Append("refuseTime=to_date('" + model.refuseTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.signflag != null)
            {
            ...
            if (model.inceptTime != null)
            {
                strSql.Append("inceptTime=to_date('" + model.inceptTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.inceptDate != null)
            {
                strSql.Append("inceptDate=to_date('" + model.inceptDate.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.ReceiveMan != null)
            {
            ...
            if (model.ReceiveDate != null)
            {
                strSql.Append("ReceiveDate=to_date('" + model.ReceiveDate.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.ReceiveTime != null)
            {
                strSql.Append("ReceiveTime=to_date('" + model.ReceiveTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.PrintInfo != null)
            {
            ...
            if (model.FlagDateDelete != null)
            {
                strSql.Append("FlagDateDelete=to_date('" + model.FlagDateDelete.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.DispenseFlag != null)
            {
            ...
            if (model.ReportSignDate != null)
            {
                strSql.Append("ReportSignDate=to_date('" + model.ReportSignDate.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.RefuseIncepter != null)
            {
            ...
            if (model.WebLisOpTime != null)
            {
                strSql.Append("WebLisOpTime=to_date('" + model.WebLisOpTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.WebLiser != null)
            {
            ...
            if (model.WebLisUploadTime != null)
            {
                strSql.Append("WebLisUploadTime=to_date('" + model.WebLisUploadTime.ToString() + "','YYYY-MM-DD HH24:MI:SS'),");
            }
            if (model.WebLisUploadStatus != null)
            {
            ...
            //if (model.BarCodeOpTime != null)
            //{
            //    strSql.Append("BarCodeOpTime='" + model.BarCodeOpTime + "',");
            //}
            //else
            //{
            //    strSql.Append("BarCodeOpTime= null ,");
            //}
		...
		public ZhiFang.Model.BarCodeForm GetModel(long BarCodeFormNo)
		{
            ...
            strSql.Append(" BarCodeFormNo,BarCode,SamplingGroupNo,IsPrep,isSpiltItem,IsAffirm,ReceiveFlag,SampleCap,ClientHost,Collecter,CollecterID,CollectDate,CollectTime,refuseUser,refuseopinion,refusereason,refuseTime,signflag,incepter,inceptTime,inceptDate,ReceiveMan,ReceiveDate,ReceiveTime,PrintInfo,PrintCount,Dr2Flag,FlagDateDelete,DispenseFlag,SerialScanTime,BarCodeSource,DeleteFlag,SendOffFlag,SendOffMan,EMSMan,SendOffDate,ReportSignMan,ReportSignDate,RefuseIncepter,RefuseIncepterMemo,ReportFlag,SendOffMemo,SampleTypeNo,SampleSendNo,WebLisFlag,WebLisOpTime,WebLiser,WebLisDescript,WebLisOrgID,WebLisIsReply,WebLisReplyDate,WebLisSourceOrgId,WebLisUploadTime,WebLisUploadStatus,WebLisUploadTestStatus,WebLisUploader,WebLisUploadDes,WebLisSourceOrgName,ClientNo,ClientName,BarCodeOpTime ");
            strSql.Append(" from BarCodeForm ");
            strSql.Append(" where 1=1 and ROWNUM <= '1' and BarCodeFormNo=" + BarCodeFormNo + " ");
        ...
        public DataSet GetWeblisOrgName(ZhiFang.Model.BarCodeForm model)
        {
            ...
            {
                strSql.Append(" BarCodeForm.CollectDate >=to_date('" + model.CollectDateStart.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
		...
		public DataSet GetList(ZhiFang.Model.BarCodeForm model)
		{
            ...
            if(model.BarCodeFormNo!=null &&model.BarCodeFormNo.Value !=0)
                        ...
                        if(model.refuseTime !=null)
                        {
                            strSql.Append(" and refuseTime = to_date('" + model.refuseTime.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        ...
                        if(model.inceptTime !=null)
                        {
                            strSql.Append(" and inceptTime = to_date('" + model.inceptTime.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        }
                                                    
                        if(model.inceptDate !=null)
                        {
                            strSql.Append(" and inceptDate = to_date('" + model.inceptDate.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        }
                        ...
                        if(model.ReceiveDate !=null)
                        {
                            strSql.Append(" and ReceiveDate = to_date('" + model.ReceiveDate.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        }
                                                    
                        if(model.ReceiveTime !=null)
                        {
                            strSql.Append(" and ReceiveTime = to_date('" + model.ReceiveTime.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        }
                        ...
                        if(model.ReportSignDate !=null)
                        {
                            strSql.Append(" and ReportSignDate = to_date('" + model.ReportSignDate.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        }
                        ...
                        if(model.WebLisOpTime !=null)
                        {
                            strSql.Append(" and WebLisOpTime = to_date('" + model.WebLisOpTime.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        }
                        ...
                        if(model.WebLisUploadTime !=null)
                        {
                            strSql.Append(" and WebLisUploadTime = to_date('" + model.WebLisUploadTime.ToString() + "','YYYY-MM-DD HH24:MI:SS') ");
                        }
        ...
        public DataSet GetList(int Top, ZhiFang.Model.BarCodeForm model, string filedOrder)
        {
            ...
            if(model.SendOffDate !=null)
            {
                strSql.Append(" and SendOffDate = to_date('" + model.SendOffDate.ToString() + "','YYYY-MM-DD HH24:MI:SS') "); 
        ...
        public string GetNewBarCode1(string ClientNo)
        {
            ...
            string tmpcode = DbHelperSQL.GetSingle("SELECT WebLisSourceOrgID FROM CLIENTELE WHERE ROWNUM <='1' and (CNAME LIKE '" + NewBarCode + "%') ").ToString();

            string sql = "SELECT  BarCode FROM BarCodeForm WHERE ( BarCode like '" + tmpcode + "%')  and ROWNUM <='1' and len(barcode)=10 ORDER BY BarCode desc";
        ...
        public string GetNewBarCode(string ClientNo)
        {
            ...
            string tmpcode = DbHelperSQL.GetSingle("SELECT  ClientNo FROM CLIENTELE WHERE ROWNUM <='1' and (CNAME LIKE '" + NewBarCode + "%') ").ToString();
            //条码补位
            //string sql = "SELECT  BarCode FROM BarCodeForm WHERE ( BarCode like '" + tmpcode + "%')  and ROWNUM <='1' and len(barcode)=10 ORDER BY BarCode desc";
            if (tmpcode.Length == 1)
            {
            ...
            string sql = "SELECT  BarCode FROM BarCodeForm WHERE ROWNUM <='1' and ( BarCode like '" + tmpcode + "%') ORDER BY BarCode desc";
        ...
        public DataSet GetListByNRequestFormNo(long p)
        {
            throw new NotImplementedException();
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" SELECT NRequestForm.CName,CC.BarCode,CC.ReceiveDate,CC.CollectDate,NRequestForm.OperDate,CC.BarCodeFormNo,NRequestForm.NRequestFormNo FROM ");
            strSql.Append(" ( SELECT * FROM   BarCodeForm WHERE BarCodeForm.OrderNo='" + OrderNo + "') CC ");
            strSql.Append(" inner join NRequestForm ");
            strSql.Append(" on NRequestForm.BarCode like ");
            strSql.Append(" '%'||(cc.BarCode)||'%' ");
            return DbHelperSQL.ExecuteDataSet(strSql.ToString());
        }
