...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class B_SampleTypeControl : BaseDALLisDB, IDSampleTypeControl
    {
        ...
        public int Add(ZhiFang.Model.SampleTypeControl model)
        {
            ...
            {
                strSql1.Append("SAMPLETYPECONTROLNO,");
                strSql2.Append("'" + model.SampleTypeControlNo + "',");
            }
            ...
            {
                strSql1.Append("CONTROLSAMPLETYPENO,");
                strSql2.Append("" + model.ControlSampleTypeNo + ",");
            }
        ...
        public int Update(ZhiFang.Model.SampleTypeControl model)
        {
            ...
            if (model.ControlSampleTypeNo != null)
            {
                strSql.Append("CONTROLSAMPLETYPENO=" + model.ControlSampleTypeNo + ",");
            }
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where SAMPLETYPECONTROLNO='" + model.SampleTypeControlNo + "' ");
            if (DbHelperSQL.ExecuteNonQuery(strSql.ToString()) > 0)
            {
                return d_log.OperateLog("SampleType", "", "", DateTime.Now, 1);
            }
        ...
        public bool CheckIncludeLabCode(List<string> l, string LabCode)
        {
            ...
            try
            {
                ...
                string strSql = "select id,sampletypecontrolno,sampletypeno,controllabno,controlsampletypeno,useflag,addtime from B_SampleTypeControl where ControlLabNo='" + LabCode.Trim() + "' and ControlSampleTypeNo in (" + strItemNos + ")";
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SampleTypeControl.CheckIncludeLabCode异常->", ex);
            }
            return b;
        }
        ...
        public bool CheckIncludeCenterCode(List<string> l, string LabCode)
        {
            ...
            try
            {
                ...
                string strSql = "select id,sampletypecontrolno,sampletypeno,controllabno,controlsampletypeno,useflag,addtime from B_SampleTypeControl where ControlLabNo='" + LabCode.Trim() + "' and SampleTypeNo in (" + strItemNos + ")";
                DataSet ds = DbHelperSQL.ExecuteDataSet(strSql);
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count == count)
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SampleTypeControl.CheckIncludeCenterCode异常->", ex);
            }
            return b;
        }
        ...
        public DataSet GetLabCodeNo(string LabCode, List<string> CenterNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SampleTypeControl.GetLabCodeNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet GetCenterNo(string LabCode, List<string> LabPrimaryNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_SampleTypeControl.GetCenterNo异常->", ex);
            }
            return ds;
        }
