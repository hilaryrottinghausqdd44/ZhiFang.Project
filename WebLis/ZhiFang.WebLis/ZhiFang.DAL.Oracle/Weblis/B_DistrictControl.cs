...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class B_DistrictControl : IDDistrictControl
    {
        ...
        public int Add(ZhiFang.Model.DistrictControl model)
        {
            ...
            {
                strSql1.Append("DistrictControlNo,");
                strSql2.Append("'" + model.DistrictControlNo + "',");
            }
            ...
            {
                strSql1.Append("ControlDistrictNo,");
                strSql2.Append("" + model.ControlDistrictNo + ",");
            }
        ...
        public int Update(ZhiFang.Model.DistrictControl model)
        {
            ...
            if (model.ControlDistrictNo != null)
            {
                strSql.Append("ControlDistrictNo=" + model.ControlDistrictNo + ",");
            }
            if (model.AddTime != null)
            {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where DistrictControlNo='" + model.DistrictControlNo + "'");
        ...
        public ZhiFang.Model.DistrictControl GetModel(string DistrictControlNo)
        {
            ...
            strSql.Append(" Id,DistrictControlNo,DistrictNo,ControlLabNo,ControlDistrictNo,DTimeStampe,AddTime,UseFlag ");
            strSql.Append(" from B_DistrictControl ");
            strSql.Append(" where 1=1 and ROWNUM <= '1' and DistrictControlNo='" + DistrictControlNo + "'");
        ...
        public DataSet B_lab_GetListByPage(ZhiFang.Model.DistrictControl model, int nowPageNum, int nowPageSize)
        {
            ...
            //全部 
                ...
                strSql.Append("select b.DistrictNo,a.*,b.CName CenterCName from (select *from b_lab_District where 1=1 and b_lab_District.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_DistrictControl on B_DistrictControl.ControlDistrictNo =a.labDistrictNo and  B_DistrictControl.ControlLabNo='" + model.ControlLabNo + "' left join District b on b.DistrictNo = B_DistrictControl.DistrictNo");
            else
