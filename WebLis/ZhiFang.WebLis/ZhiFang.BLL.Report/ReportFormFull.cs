...
namespace ZhiFang.BLL.Report
{
    ...
    /// ReportFormFull
    /// </summary>
    public class ReportFormFull : ZhiFang.IBLL.Report.IBReportFormFull
    {
        ...
        {
            return dal.GetListByView(rff_m);
        }
        ...
        public Model.UiModel.WeiXin.ReportForm SearchReportFormResultByReportFormID(string ReportFormID)
        {
            Model.UiModel.WeiXin.ReportForm weixinrf = new Model.UiModel.WeiXin.ReportForm();
            var rf=GetModel(ReportFormID);
            weixinrf.ReportFromFull = rf;
            //lbsarf = IBBSearchAccountReportForm.SearchListByHQL(" ReportFormID =" + ReportFormID).ToList();
            IBReportItemFull IBReportItemFull = BLLFactory<IBReportItemFull>.GetBLL("ReportItemFull");
            IBReportMicroFull IBReportMicroFull = BLLFactory<IBReportMicroFull>.GetBLL("ReportMicroFull");
            IBReportMarrowFull IBReportMarrowFull = BLLFactory<IBReportMarrowFull>.GetBLL("ReportMarrowFull");
            if (rf!=null)
            {
                var tmpi = new Model.ReportItemFull() { ReportFormID = ReportFormID };
                var tmpmi = new Model.ReportMicroFull() { ReportFormID = ReportFormID };
                var tmpma = new Model.ReportMarrowFull() { ReportFormID = ReportFormID };
                switch ((SectionType)Enum.Parse(typeof(SectionType), rf.SectionType))
                {
                    case SectionType.Normal:
                        weixinrf.ItemList = IBReportItemFull.GetModelList(tmpi).ToList();
                        break;
                    case SectionType.Micro:
                        weixinrf.MicroList = IBReportMicroFull.GetModelList(tmpmi).ToList();
                        break;
                    ...
                    case SectionType.CellMorphology:
                        weixinrf.MarrowList = IBReportMarrowFull.GetModelList(tmpma).ToList();
                        break;
        ...
        {
            return dal.SearchReportFormFull_ReportItem_WeiJiZhi(strWhere, orderby, startIndex, endIndex);
        }

        public int SearchReportFormFull_ReportItem_WeiJiZhi_Count(string wherestr)
        {
            return dal.SearchReportFormFull_ReportItem_WeiJiZhi_Count(wherestr);
        }
    }
}
