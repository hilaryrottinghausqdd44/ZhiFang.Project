...
namespace ZhiFang.WebLisService.Service_Customized.PKI
{
    ...
    public class ReportFormRestfull
    {
        ...
        public BaseResultDataValue DownLoadReportFormInfoToOther_PKI(string Account, string PWD, string ReportFormId)
        {
            ...
            try
            {
                ...
                if (dsreportform != null && dsreportform.Tables.Count > 0 && dsreportform.Tables[0].Rows.Count > 0)
                {
                    ...
                    string jsonstr = "ReportFormID=\"" + tmpReportFormFull_VO.ReportFormID + "\",CName=\"" + tmpReportFormFull_VO.CNAME + "\",Age=\"" + tmpReportFormFull_VO.AGE + "\",AgeUnitNo=\"" + tmpReportFormFull_VO.AGEUNITNO + "\",AgeUnitName=\"" + tmpReportFormFull_VO.AGEUNITNAME + "\",GenderNo=\"" + tmpReportFormFull_VO.GENDERNO + "\",GenderName=\"" + tmpReportFormFull_VO.GENDERNAME + "\",ClientNo=\"" + tmpReportFormFull_VO.CLIENTNO + "\",ClientName=\"" + tmpReportFormFull_VO.CLIENTNAME + "\",jztype=\"" + tmpReportFormFull_VO.SICKTYPENO + "\"";

                    jsonstr += "," + PWD;
                    ZhiFang.Common.Log.Log.Error("DownLoadReportFormInfoToOther_PKI:签名结果！json+pwd:" + jsonstr + ";ServiceSign:" + Tools.MD5Helper.md5sign(jsonstr) );
                    brdv.MD5SignString = Tools.MD5Helper.md5sign(jsonstr);
                }
        ...
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/QueryReport_PKI_PWD", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        public string QueryReport_PKI_PWD(QueryReportEntity_Account_PWD reportformentity)
        {
            Log.Info("ReportFormRestfull.QueryReport_PKI_PWD.调用。");            
            return ZhiFang.Common.Public.JsonSerializer.JsonDotNetSerializer(DownLoadReportFormListToOther_PKI(reportformentity.Account, reportformentity.PWD, reportformentity.Serialno, reportformentity.Startdate, reportformentity.Enddate));
        }

        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/QueryReportInfo_PKI_PWD", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        public string QueryReportInfo_PKI_PWD(QueryReportInfoEntity_Account_PWD reportforminfoentity)
        {
            Log.Info("ReportFormRestfull.QueryReportInfo_PKI_PWD.调用。");
            return ZhiFang.Common.Public.JsonSerializer.JsonDotNetSerializer(DownLoadReportFormInfoToOther_PKI(reportforminfoentity.Account, reportforminfoentity.PWD, reportforminfoentity.ReportFormId));
        }

        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/GetPDF_PKI_PWD", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        public Stream GetPDF_PKI_PWD(QueryReportInfoEntity_Account_PWD reportforminfoentity)
        {
            Log.Info("ReportFormRestfull.GetPDF_PKI_PWD.调用。");
            return DownLoadReportFormPDFFiles(reportforminfoentity.Account, reportforminfoentity.PWD, reportforminfoentity.ReportFormId);
        }
    }
    public class QueryReportEntity_Account_PWD
    {
        /// <summary>
        /// Account
        /// </summary>
    ...
    public class QueryReportInfoEntity_Account_PWD
    {
        /// <summary>
        /// Account
        /// </summary>
        ...
        [DataMember]
        public string NameOutputType { get; set; }

        [DataMember]
        public string MD5SignString { get; set; }
    }

    public class ReportFormInfoEntity
    {
        /// <summary>
        ///ReportFormId
        /// </summary>
        ...
        /// </summary>
        [DataMember]
        public string ReportFormInfo { get; set; }

        /// <summary>
        /// ReportItemInfo
        /// </summary>
        [DataMember]
        public string ReportItemInfo { get; set; }

        /// <summary>
        ///ReportMicroInfo
        /// </summary>
        [DataMember]
        public string ReportMicroInfo { get; set; }

        /// <summary>
        ///ReportMarrowInfo
        /// </summary>
        [DataMember]
        public string ReportMarrowInfo { get; set; }
