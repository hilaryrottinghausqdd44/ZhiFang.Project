...
namespace ZhiFang.IDAL
{
    ...
    public interface IDNRequestForm : IDAL.IDataBase<ZhiFang.Model.NRequestForm>, IDAL.IDataPage<ZhiFang.Model.NRequestForm>
    {
        ...
        DataSet GetNRequstFormListByPage_CombiItemNo(NRequestForm nrf_m, int startPage, int pageSize);
        DataSet GetNRequstFormList_SampleSendNo(NRequestForm nrf_m, int startPage, int pageSize);
