...
namespace ZhiFang.Tools
{
    public class EncodeFileName
    {
        ...
        {
            if (HttpContext.Current.Request.ServerVariables["http_user_agent"]!=null && HttpContext.Current.Request.ServerVariables["http_user_agent"].ToLower().IndexOf("firefox") == -1)
            {
