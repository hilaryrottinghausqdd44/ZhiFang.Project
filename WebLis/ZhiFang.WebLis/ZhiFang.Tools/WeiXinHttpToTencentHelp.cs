...
namespace ZhiFang.Tools
{
    public class WeiXinHttpToTencentHelp
    {
        ...
        public static string Post(string xml, string url, string SSLCERT_PATH,string SSLCERT_PASSWORD, bool isUseCert, int timeout)
        {
            ...
            try
            {
                ...
                * ************************************************************/
                ...
                if (isUseCert)
                {
                    ...
                    ZhiFang.Common.Log.Log.Debug("PayBase.SSLCERT_PATH:"+ SSLCERT_PATH);
        ...
        public static string Post(string PostData, string DataType,string url, string SSLCERT_PATH, string SSLCERT_PASSWORD, bool isUseCert, int timeout, bool IsVerification = false)
        {
            System.GC.Collect();//垃圾回收，回收没有正常关闭的http连接
