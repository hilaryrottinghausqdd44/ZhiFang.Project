...
namespace ZhiFang.DAL.MsSql.Weblis  
{
    ...
    public partial class B_Lab_GroupItem : BaseDALLisDB, IDLab_GroupItem
    {
        ...
        public DataSet GetPitemList(ZhiFang.Model.Lab_GroupItem model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM B_Lab_GroupItem  INNER JOIN   dbo.B_Lab_TestItem ON dbo.B_Lab_GroupItem.PItemNo =  dbo.B_Lab_TestItem.ItemNo and  dbo.B_Lab_GroupItem.LabCode =  dbo.B_Lab_TestItem.LabCode   where 1=1 ");
            if (model.PItemNo != null)
            {
                strSql.Append(" and B_Lab_GroupItem.PItemNo='" + model.PItemNo + "' ");
            }
