...
namespace ZhiFang.DAL.MsSql.Weblis
{
    ...
    public partial class D_LabDownLoadInfo :BaseDALLisDB, IDLabDownLoadInfo
    {
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.D_LabDownLoadInfo.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.D_LabDownLoadInfo .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
        #endregion
