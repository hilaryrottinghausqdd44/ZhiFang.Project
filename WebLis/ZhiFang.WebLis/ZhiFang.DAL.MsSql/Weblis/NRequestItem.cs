...
namespace ZhiFang.DAL.MsSql.Weblis
{
    ...
    public partial class NRequestItem : BaseDALLisDB, IDNRequestItem
    {
        ...
        public int Add(ZhiFang.Model.NRequestItem model)
        {
            ...
            if (model.ComboName != null)
            {
                strSql1.Append("ComboName,");
                strSql2.Append("'" + model.ComboName + "',");
            }
            if (model.ItemPrice != null)
            {
                strSql1.Append("ItemPrice,");
                strSql2.Append("'" + model.ItemPrice + "',");
            }
            if (model.ItemAgio != null)
            {
                strSql1.Append("ItemAgio,");
                strSql2.Append("'" + model.ItemAgio + "',");
            }
            if (model.ItemAgioPrice != null)
            {
                strSql1.Append("ItemAgioPrice,");
                strSql2.Append("'" + model.ItemAgioPrice + "',");
            }
            if (model.TransitFlag != null)
            {
                strSql1.Append("TransitFlag,");
                strSql2.Append("" + model.TransitFlag + ",");
            }
            ...
            if (model.IsFreeStatus != null)
            {
                strSql1.Append("IsFreeStatus,");
                strSql2.Append("" + model.IsFreeStatus + ",");
            }
            if (model.IsLocked != null)
            {
                strSql1.Append("IsLocked,");
                strSql2.Append("" + model.IsLocked + ",");
            }
            if (model.IsLockedDate != null)
            {
                strSql1.Append("IsLockedDate,");
                strSql2.Append("'" + model.IsLockedDate + "',");
            }
            if (model.IsReportSend != null)
            {
                strSql1.Append("IsReportSend,");
                strSql2.Append("" + model.IsReportSend + ",");
            }
            if (model.SenderTime1 != null)
            {
                strSql1.Append("SenderTime1,");
                strSql2.Append("'" + model.SenderTime1 + "',");
            }
            if (model.SenderTime1er != null)
            {
                strSql1.Append("SenderTime1er,");
                strSql2.Append("'" + model.SenderTime1er + "',");
            }
            if (model.SenderTime2er != null)
            {
                strSql1.Append("SenderTime2er,");
                strSql2.Append("'" + model.SenderTime2er + "',");
            }
            ...
            if (model.TestDater != null)
            {
                strSql1.Append("TestDater,");
                strSql2.Append("'" + model.TestDater + "',");
            }
            ...
            if (model.IsLocker != null)
            {
                strSql1.Append("IsLocker,");
                strSql2.Append("'" + model.IsLocker + "',");
            }
            if (model.ReportSendDate != null)
            {
                strSql1.Append("ReportSendDate,");
                strSql2.Append("'" + model.ReportSendDate + "',");
            }
            ...
            if (model.CheckDater != null)
            {
                strSql1.Append("CheckDater,");
                strSql2.Append("'" + model.CheckDater + "',");
            }
            ...
            //{
            //    strSql1.Append("NRequestItemNo,");
            //    strSql2.Append("" + model.NRequestItemNo + ",");
            //}
            ...
            strSql.Append(")");
            strSql.Append(";");
            Common.Log.Log.Info("插入NRequestItem的数据："+strSql.ToString());
            //System.Data.SqlClient.SqlCommand c = new SqlCommand(strSql.ToString(), new SqlConnection(ZhiFang.Common.Dictionary.DBSource.WebLisDB()));
