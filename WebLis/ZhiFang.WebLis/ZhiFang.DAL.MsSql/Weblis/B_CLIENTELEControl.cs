...
namespace ZhiFang.DAL.MsSql.Weblis  
{
	...
	public partial class B_CLIENTELEControl: BaseDALLisDB, IDCLIENTELEControl	{	
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_CLIENTELEControl.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }          
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_CLIENTELEControl .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
