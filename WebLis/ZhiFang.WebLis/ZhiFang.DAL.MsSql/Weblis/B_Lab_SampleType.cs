...
namespace ZhiFang.DAL.MsSql.Weblis
{
    ...
    public partial class B_Lab_SampleType : BaseDALLisDB, IDLab_SampleType
    {
        ...
        public int Add(ZhiFang.Model.Lab_SampleType model)
        {
            ...
            strSql.Append("LabCode,LabSampleTypeNo,CName,ShortCode,Visible,DispOrder,HisOrderCode,StandCode,ZFStandCode,UseFlag,code_1,code_2,code_3");
            ...
            SqlParameter[] parameters = {
                        ...
                        new SqlParameter("@LabSampleTypeNo", SqlDbType.VarChar,50) ,            
                        ...
                        new SqlParameter("@code_1", SqlDbType.VarChar,50),
					    new SqlParameter("@code_2", SqlDbType.VarChar,50),
					    new SqlParameter("@code_3", SqlDbType.VarChar,50)            
            ...
            parameters[12].Value = model.code_3;
        ...
        public int Delete(string LabCode, int LabSampleTypeNo)
        {
            ...
            SqlParameter[] parameters = {
					new SqlParameter("@LabCode", SqlDbType.VarChar,50),
					new SqlParameter("@LabSampleTypeNo", SqlDbType.VarChar,4)};
        ...
        public DataSet GetListByPage(ZhiFang.Model.Lab_SampleType model, int nowPageNum, int nowPageSize)
        {
            ...
            strSql.Append("and SampleTypeID not in ");
            strSql.Append("(select top " + (nowPageSize * nowPageNum) + " SampleTypeID from B_Lab_SampleType where 1=1 " + strLike + "  ");
        ...
        public DataSet GetLabCodeNo(string LabCode, List<string> LabCnameList)
        {
            ...
            try
            {
                ...
                ZhiFang.Common.Log.Log.Info("ZhiFang.DAL.MsSql.Weblis.B_Lab_SampleType.GetLabCodeNo:" + strSql);
                ds = DbHelperSQL.ExecuteDataSet(strSql);
            }
            catch (Exception ex)
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_Lab_SampleType.GetLabCodeNo异常->", ex);
            }
            return ds;
        }
    }
