...
namespace ZhiFang.DAL.MsSql.Weblis
{
    public class LocationbarCodePrintPamater : BaseDALLisDB, IDLocationbarCodePrintPamater
    {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.LocationbarCodePrintPamater.ConnectionString：" + DbHelperSQL.ConnectionString+"---sql："+ strSql.ToString()+"---异常信息："+e.ToString());
                return null;
            }
        }
