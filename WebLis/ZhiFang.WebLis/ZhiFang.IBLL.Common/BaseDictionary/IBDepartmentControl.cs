...
{
    /// <summary>
    /// 接口层IBDepartmentControl	
    /// </summary>
    public interface IBDepartmentControl : IBBase<ZhiFang.Model.DepartmentControl>
    {
        #region  成员方法
        /// <summary>
        /// 是否存在该记录
        ...
        List<ZhiFang.Model.Department > ControlDataTableToList(DataTable dt, int ControlLabNo);
        #endregion  成员方法
        ...
        List<ZhiFang.Model.DepartmentControl> DataTableToList(DataTable dt);
        #endregion
    }
}