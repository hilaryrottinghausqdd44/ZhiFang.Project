...
namespace ZhiFang.IBLL.Common.BaseDictionary
{
    ...
    /// </summary>
    public interface IBTestItemControl : IBBase<Model.TestItemControl>, IBTransCodeControl
    {
        #region  成员方法
        /// <summary>
        /// 是否存在该记录
        /// </summary>
        bool Exists(string ItemControlNo);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        int Delete(int Id);
        ...
        /// 得到一个对象实体
        /// </summary>
        ZhiFang.Model.TestItemControl GetModel(string ItemNo, string LabCode, string LabItemNo);
        /// <summary>
        /// 得到中心端对照代码
        /// </summary>
        ...
        #region 项目字典对照
        DataSet GetListByPage(ZhiFang.Model.TestItemControl model, int nowPageNum, int nowPageSize);

        DataSet B_lab_GetListByPage(ZhiFang.Model.TestItemControl model, int nowPageNum, int nowPageSize);
        DataSet B_lab_GetResultListByPage(ZhiFang.Model.ResultTestItemControl model, int nowPageNum, int nowPageSize);

        List<ZhiFang.Model.TestItemControl> DataTableToList(DataTable dt);
        #endregion
    }
}