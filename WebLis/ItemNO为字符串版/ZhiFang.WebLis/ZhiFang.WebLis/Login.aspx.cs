...
namespace ZhiFang.WebLis
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ZhiFang.Common.Log.Log.Debug("ImageButton1_Click");
            ...
            if (wsrbac != null)
            {
                ...
                ZhiFang.Common.Log.Log.Debug("验证登录:" + a);
                if (a)
                {
                ...
                {
                    ZhiFang.Common.Log.Log.Debug("登录信息"+ descr);
            ...
            else
            {
                ...
                ZhiFang.Common.Log.Log.Debug("登录失败:" + this.Label1.Text);
            }
        }
    }
}