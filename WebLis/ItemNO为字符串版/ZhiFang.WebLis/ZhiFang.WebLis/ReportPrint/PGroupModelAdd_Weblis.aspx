<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PGroupModelAdd_Weblis.aspx.cs" Inherits="ZhiFang.WebLis.ReportPrint.PGroupModelAdd_Weblis" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>小组模板设置添加_Weblis</title>
...
<body  style="width:100%; padding:0px; margin:0px">
    ...
    <asp:DropDownList ID="DDL_SpecialtyItem" runat="server">
        </asp:DropDownList></td></tr>
    ...
    <tr style="background-color:#FFFFFF"><td align="right" style="padding:10px">送检单位:</td><td style="padding:10px">
        ...
        <tr style="background-color:#FFFFFF"><td align="right" style="padding:10px">最小项目或图片数:</td><td style="padding:10px">
        <asp:TextBox ID="TxtBox_Min" runat="server"></asp:TextBox></td></tr>
        <tr style="background-color:#FFFFFF"><td align="right" style="padding:10px">最大项目或图片数:</td><td style="padding:10px">
    ...
    <tr style="background-color:#FFFFFF"><td align="right" style="padding:10px">使用标志:</td><td style="padding:10px">
        ...
        <tr style="background-color:#FFFFFF"><td align="right" style="padding:10px">是否套打:</td><td style="padding:10px">
        <asp:DropDownList ID="DDL_BatchPrintFlag" runat="server">
        <asp:ListItem Selected=True Value="0">否</asp:ListItem>
        <asp:ListItem Value="1">是</asp:ListItem>
        </asp:DropDownList>
        <tr style="background-color:#FFFFFF"><td align="right" style="padding:10px">就诊类型:</td><td style="padding:10px">
        <asp:DropDownList ID="DDL_SickTypeNo" runat="server">
        <asp:ListItem Selected=True Value="0">无</asp:ListItem>
        <asp:ListItem Value="1">住院</asp:ListItem>
        <asp:ListItem Value="2">门诊</asp:ListItem>
        <asp:ListItem Value="3">体检</asp:ListItem>
        <asp:ListItem Value="4">外送</asp:ListItem>
        </asp:DropDownList>
        </td></tr>
        <tr style="background-color:#FFFFFF"><td align="right" style="padding:10px">模板抬头类型:</td><td style="padding:10px">
        <asp:DropDownList ID="DDL_ModelTitleType" runat="server">
        <asp:ListItem Selected=True Value="0">医院</asp:ListItem>
