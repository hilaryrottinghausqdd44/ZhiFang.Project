<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PGroupModelSet_Weblis.aspx.cs" Inherits="ZhiFang.WebLis.ReportPrint.PGroupModelSet_Weblis" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript">
        ...
        function EditPGroupModel(id) {
            WOpenMid('PGroupModelAdd_Weblis_QuYu.aspx?Id=' + id, 'EditPGroupModel');
        }
    </script>
</head>
<body  style="width:100%; padding:0px; margin:0px">
    ...
    <td align="center" width="10%"><input type="button" value="添加" onclick="WOpenMid('PGroupModelAdd_Weblis_QuYu.aspx','PGroupModelAdd');" /></td>
    </tr>
	...
	<td width="50">操作</td>
				 	...
				 	<table width="100%" height="25" bgcolor="#ffffff"  onmousemove="this.bgColor='#3F7885';this.style.color='#ffffff'" onmouseout="this.bgColor='#ffffff';this.style.color='#000000'" cellspacing="1" cellpadding="0" border="0">
						...
						<td width="50"><%# DataBinder.Eval(Container.DataItem, "SickTypeNo").ToString() == "1" ? "住院" :""%><%# DataBinder.Eval(Container.DataItem, "SickTypeNo").ToString() == "2" ? "门诊" : ""%><%# DataBinder.Eval(Container.DataItem, "SickTypeNo").ToString() == "3" ? "体检" : ""%>
                        </td>
