...
namespace ZhiFang.WebLis.consume.print
{
    public partial class PrintDeliveryList : ZhiFang.WebLis.Class.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    #endregion
                    #region 姓名
                    if (base.ReadQueryString("PatientName") != null)
                    {
                        txtPatientName = base.ReadQueryString("PatientName");
                    }
                    #endregion
                    #region 消费码
                    if (base.ReadQueryString("zdy10") != null)
                    {
                        txtZDY10 = base.ReadQueryString("zdy10");
                    }
                    #endregion
                    #region 条码
                    ...
                    #endregion
                    PrintNRequestForm(txtPatientName, txtCollectStartDate, txtCollectEndDate, txtStartDate, txtEndDate, SelectDoctor, ClientNo, txtPatientID, "", txtBarCode, txtZDY10);
                }
                catch (Exception eee)
                {
        ...
        public void PrintNRequestForm(string PatientName, string CollectStartDate, string CollectEndDate, string AddStartDate, string AddEndDate, string Doctor, string WebLisSourceOrgID, string PatNo, string SampleTypeNo, string txtBarCode, string txtZDY10)
        {
            ...
            if (txtBarCode.Trim() != "")
            {
                nrf_m.BarCode = txtBarCode.Trim();
            }
            if (txtZDY10.Trim() != "")
            {
                nrf_m.ZDY10 = txtZDY10.Trim();
            }
            ...
            dt = rfb.GetNRequstFormListByDetailsAndPage(nrf_m, 0, 10000, out intPageCount, out iCount);
            if (dt != null)
            {
                FillList(dt);
            }
