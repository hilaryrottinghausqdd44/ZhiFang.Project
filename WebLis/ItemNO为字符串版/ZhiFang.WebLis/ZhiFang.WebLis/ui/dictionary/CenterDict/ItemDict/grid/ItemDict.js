...
$(function () {
    $("#dg").datagrid({
        ...
        columns: [[
            ...
            { field: 'ShortName', title: '简称', width: setWidth(0.2) },
            { field: 'ShortCode', title: '简码', width: setWidth(0.2) },
            {
    ...
    $('#txtItemNo').textbox({
        ...
        onChange: function (newValue, oldValue) {
            var ItemNo = $('#txtItemNo').textbox('getValue');
            if (btnType == 'add') {
                if (ItemNo.length > 50) {
                    $.ajax({
                        success: function () {
                            $('#txtItemNo').textbox('clear');
                        }
                    })
...
function save() {
    if (btnType == 'edit') {
        ...
        var Color = $("#txtColor").combobox('getValue');
        if (Color) {
            r += '"Color":' + Color + ',';
        }
    ...
    if (newValue == "1") {
        ...
        $('#dgwest').datagrid({
            ...
            queryParams: {
                ...
                ItemNo: $('#txtItemNo').textbox('getValue')
            },
            loadFilter: function (data) {
                var result = eval("(" + data.ResultDataValue + ")");
