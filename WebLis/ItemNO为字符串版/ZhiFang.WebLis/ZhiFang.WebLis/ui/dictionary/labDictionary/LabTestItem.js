...
function createColumns() {
    var columns = [
        [
            ...
            { field: 'GreatMasterPrice', title: '大家价格', width: 50, sortable: true },
            ...
            { field: 'ControlStatus', title: '对照状态', width: 60, sortable: true }, //数据库中不存在此字段名
            {
                field: 'opt', title: '操作', align: 'right', width: 120, align: 'center',
