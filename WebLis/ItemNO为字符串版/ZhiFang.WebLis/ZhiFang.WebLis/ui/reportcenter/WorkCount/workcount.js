    ...
    $('#dg').datagrid({
        ...
        onLoadSuccess: function (data) {
            $('#dg').datagrid('appendRow', {
                OperDate: '汇总',
                SampleNum: '<span class="subtotal">' + compute("SampleNum") + '</span>',
                ItemNum: '<span class="subtotal">' + compute("ItemNum") + '</span>',
                ItemTotalprice: '<span class="subtotal">' + compute("ItemTotalprice") + '</span>'
            });
