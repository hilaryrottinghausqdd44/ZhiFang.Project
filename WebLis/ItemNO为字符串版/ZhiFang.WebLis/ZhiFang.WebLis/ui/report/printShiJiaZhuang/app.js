$(function () {
    ...
    function getRECEIVEDATE() {
        var date_s = $("#search-text-RECEIVEDATE-S").datetimebox("getValue"),
    		date_e = $("#search-text-RECEIVEDATE-E").datetimebox("getValue"),
    		where = [];
        ...
        //生成时间条件
        if (date_s) { where.push("RECEIVEDATE>='" + Shell.util.Date.toString(date_s, false) + "'"); }
        if (date_e) { where.push("RECEIVEDATE<'" + Shell.util.Date.toString(Shell.util.Date.getNextDate(date_e), false) + "'"); }
    ...
    function disabledRECEIVEDATE(bo) {
        ...
        $("#search-text-RECEIVEDATE-S").datetimebox(action);
        $("#search-text-RECEIVEDATE-E").datetimebox(action);
    }
    /**清空结果信息*/
    ...
    //核收日期
    var date = Shell.util.Date.toString(new Date(), false);
    $("#search-text-RECEIVEDATE-S").datetimebox({ disabled: true, value: date,showSeconds:false });
    $("#search-text-RECEIVEDATE-E").datetimebox({ disabled: true, value: date,showSeconds:false });
