...
<head id="Head1" runat="server">
    ...
    <script src="../ui/entry_taihe2/barcode.js" type="text/javascript"></script>
    <script language="javascript">
        $(function () {
            ...
            $('#btnaddnrequestform').bind('click', function () {
                ...
                parent.OpenWindowFuc('新增申请单', Math.floor(window.screen.width * 0.9), Math.floor(window.screen.height * 0.7), Shell.util.Path.rootPath ++'/ui/entry_taihe2/apply.html', SN);
            ...
            var toolbar = [{
                ...
                handler: function () {
                    var SN = Shell.util.Path.getRequestParams()["SN"];
                    parent.OpenWindowFuc('新增申请单', Math.floor(window.screen.width * 0.9), Math.floor(window.screen.height * 0.7), '../ui/entry_taihe2/apply.html', SN);
                }
            },
            //                {
            //                    iconCls: 'icon-remove',
    ...
    function ModifyNRequestForm(NRequestFormNo) {
        $.ajax({
            ...
            success: function (data) {
                ...
                if (checkweblisflag) {
                    var SN = Shell.util.Path.getRequestParams()["SN"];
                    parent.OpenWindowFuc('修改申请单', Math.floor(window.screen.width * 0.9), Math.floor(window.screen.height * 0.7), '../ui/entry_taihe2/apply.html?Flag=1&NRequestFormNo=' + NRequestFormNo + '&BarCodeInputFlag=1', SN);
