<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NRequestFormList(AnQing)_BarCodePrint.aspx.cs"
    Inherits="ZhiFang.WebLis.ApplyInput.NRequestFormListAnQing_BarCodePrint" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../ui/entry_AnQing/barcode.js" type="text/javascript"></script>
    <script language="javascript">
        $(function () {
            ...
            $('#btnaddnrequestform').bind('click', function () {
                ...
                parent.OpenWindowFuc('新增申请单', Math.floor(window.screen.width * 0.9), Math.floor(window.screen.height * 0.7), '../ui/entry_AnQing/apply.html', SN);
        ...
        function ModifyNRequestForm(NRequestFormNo) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (checkweblisflag) {
                        var SN = Shell.util.Path.getRequestParams()["SN"];
                        parent.OpenWindowFuc('修改申请单', Math.floor(window.screen.width * 0.9), Math.floor(window.screen.height * 0.7), '../ui/entry_AnQing/apply.html?Flag=1&NRequestFormNo=' + NRequestFormNo + '&BarCodeInputFlag=1', SN);
