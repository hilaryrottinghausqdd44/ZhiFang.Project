<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientClassifyAdd.aspx.cs" Inherits="ZhiFang.WebLis.SetItemMerge.ClientClassifyAdd" %>
...
<body onload="CheckUrl();" style="width:100%; padding:0px; margin:0px;">
   ...
   <table width="100%" cellspacing="1" cellpadding="0" border="0" style="background-color:#0099cc">
    ...
    <td align="center" colspan="3" >客户类别名称：<asp:TextBox ID="txtClientProfileCName" runat="server"></asp:TextBox>合并规则名称:<asp:DropDownList ID="dropMergeRuleName" 
                runat="server"></asp:DropDownList></td>
    </tr>
    <tr style="background-color:#FFFFFF">
        <td align="center" colspan="3" >客户名称: <asp:TextBox ID="txtClientName" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp; <asp:Button ID="Button2" runat="server" 
