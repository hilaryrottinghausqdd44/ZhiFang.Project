...
namespace ZhiFang.DAL.MsSql.Weblis
{
    ...
    public partial class B_SuperGroupControl : BaseDALLisDB, IDSuperGroupControl
    {
        ...
        public DataSet GetList(ZhiFang.Model.SuperGroupControl model)
        {
            ...
            if (model.ControlSuperGroupNo != -1)
            {
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_SuperGroupControl.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_SuperGroupControl .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
        #endregion
        ...
        public bool CheckIncludeLabCode(List<string> l, string LabCode)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_SuperGroupControl.CheckIncludeLabCode异常->", ex);
            }
            return b;
        }
        ...
        public bool CheckIncludeCenterCode(List<string> l, string LabCode)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_SuperGroupControl.CheckIncludeCenterCode异常->", ex);
            }
            return b;
        }
        ...
        public DataSet GetLabCodeNo(string LabCode, List<string> CenterNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_SuperGroupControl.GetLabCodeNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet GetCenterNo(string LabCode, List<string> LabPrimaryNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_SuperGroupControl.GetCenterNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet B_lab_GetListByPage(ZhiFang.Model.SuperGroupControl model, int nowPageNum, int nowPageSize)
        {
            ...
            //已对照
            if (model.ControlState == "1")
                strSql.Append("select *,b.CName CenterCName from ( select *from b_lab_SuperGroup where 1=1 and labSuperGroupno in (select ControlSuperGroupNo From B_SuperGroupControl where 1=1 and B_SuperGroupControl.ControlLabNo ='" + model.ControlLabNo + "'" + strWhere.ToString() + " ) and  b_lab_SuperGroup.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_SuperGroupControl on B_SuperGroupControl.ControlSuperGroupNo =a.labSuperGroupno and  B_SuperGroupControl.ControlLabNo='" + model.ControlLabNo + "' left join SuperGroup b on b.SuperGroupNo = B_SuperGroupControl.SuperGroupNo ");
            //未对照
            else if (model.ControlState == "2")
                strSql.Append("select *,b.CName CenterCName from (select *from b_lab_SuperGroup where 1=1 and labSuperGroupno not in (select ControlSuperGroupNo From B_SuperGroupControl where 1=1 and B_SuperGroupControl.ControlLabNo ='" + model.ControlLabNo + "' ) and  b_lab_SuperGroup.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_SuperGroupControl on B_SuperGroupControl.ControlSuperGroupNo =a.labSuperGroupno and  B_SuperGroupControl.ControlLabNo='" + model.ControlLabNo + "' left join SuperGroup b on b.SuperGroupNo = B_SuperGroupControl.SuperGroupNo ");
            //全部 
            else if (model.ControlState == "0")
                strSql.Append("select *,b.CName CenterCName from (select *from b_lab_SuperGroup where 1=1 and b_lab_SuperGroup.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_SuperGroupControl on B_SuperGroupControl.ControlSuperGroupNo =a.labSuperGroupno and  B_SuperGroupControl.ControlLabNo='" + model.ControlLabNo + "' left join SuperGroup b on b.SuperGroupNo = B_SuperGroupControl.SuperGroupNo ");
