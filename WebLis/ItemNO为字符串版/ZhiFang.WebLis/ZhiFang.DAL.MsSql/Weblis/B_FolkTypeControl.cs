...
namespace ZhiFang.DAL.MsSql.Weblis  
{
    ...
    public partial class B_FolkTypeControl : BaseDALLisDB, IDFolkTypeControl
    {
        ...
        public bool CheckIncludeLabCode(List<string> l, string LabCode)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_FolkTypeControl.CheckIncludeLabCode异常->", ex);
            }
            return b;
        }
        ...
        public bool CheckIncludeCenterCode(List<string> l, string LabCode)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_FolkTypeControl.CheckIncludeCenterCode异常->", ex);
            }
            return b;
        }
        ...
        public DataSet GetLabCodeNo(string LabCode, List<string> CenterNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_FolkTypeControl.GetLabCodeNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet GetCenterNo(string LabCode, List<string> LabPrimaryNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.B_FolkTypeControl.GetCenterNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet B_lab_GetListByPage(ZhiFang.Model.FolkTypeControl model, int nowPageNum, int nowPageSize)
        {
            ...
            //已对照
            if (model.ControlState == "1")
                strSql.Append("select *,b.CName CenterCName from ( select *from b_lab_FolkType where 1=1 and labFolkNo in (select ControlFolkNo From B_FolkTypeControl where 1=1 and B_FolkTypeControl.ControlLabNo ='" + model.ControlLabNo + "'" + strWhere.ToString() + " ) and  b_lab_FolkType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_FolkTypeControl on B_FolkTypeControl.ControlFolkNo =a.labFolkNo and  B_FolkTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join FolkType b on b.FolkNo = B_FolkTypeControl.FolkNo ");
            //未对照
            else if (model.ControlState == "2")
                strSql.Append("select *,b.CName CenterCName from (select *from b_lab_FolkType where 1=1 and labFolkNo not in (select ControlFolkNo From B_FolkTypeControl where 1=1 and B_FolkTypeControl.ControlLabNo ='" + model.ControlLabNo + "' ) and  b_lab_FolkType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_FolkTypeControl on B_FolkTypeControl.ControlFolkNo =a.labFolkNo and  B_FolkTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join FolkType b on b.FolkNo = B_FolkTypeControl.FolkNo ");
            //全部 
            else if (model.ControlState == "0")
                strSql.Append("select *,b.CName CenterCName from (select *from b_lab_FolkType where 1=1 and b_lab_FolkType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_FolkTypeControl on B_FolkTypeControl.ControlFolkNo =a.labFolkNo and  B_FolkTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join FolkType b on b.FolkNo = B_FolkTypeControl.FolkNo ");
            else
