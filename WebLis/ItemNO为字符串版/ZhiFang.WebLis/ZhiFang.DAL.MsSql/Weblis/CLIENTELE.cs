...
namespace ZhiFang.DAL.MsSql.Weblis
{
    ...
    public class CLIENTELE : BaseDALLisDB, IDCLIENTELE, IDBatchCopy
    {
        ...
        public int Add(List<ZhiFang.Model.CLIENTELE> modelList)
        {
            string strsqls = "";
        ...
        public int Update(List<ZhiFang.Model.CLIENTELE> modelList)
        {
            string strsqls = "";
            foreach (var model in modelList)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *,ClIENTNO as LabNo,convert(varchar(100),cast(ClIENTNO as decimal(18,0)))+'_'+CNAME as LabNo_Value,CNAME+'('+convert(varchar(100),cast(ClIENTNO as decimal(18,0)))+')' as LabNoAndName_Text ");
            strSql.Append(" FROM CLIENTELE  where 1=1 ");
        ...
        public DataSet GetListByPage(ZhiFang.Model.CLIENTELE model, int nowPageNum, int nowPageSize)
        {
            ...
            if (model != null && model.LabCode != null)
            {
                ...
                strSql.Append(" select top " + nowPageSize + "  * from CLIENTELE left join CLIENTELEControl on CLIENTELE.ClIENTNO=CLIENTELEControl.ClIENTNO ");
                if (model.LabCode != null)
                {
                    strSql.Append(" and CLIENTELEControl.ControlLabNo='" + model.LabCode + "' ");
                }
                strSql.Append("where ClIENTNO not in ( ");
                strSql.Append("select top " + (nowPageSize * nowPageNum) + " ClIENTNO from  CLIENTELE left join CLIENTELEControl on CLIENTELE.ClIENTNO=CLIENTELEControl.ClIENTNO ");
                if (model.LabCode != null)
                {
                    strSql.Append(" and CLIENTELEControl.ControlLabNo='" + model.LabCode + "' ");
                }
                strSql.Append("where 1=1 " + likesql + " order by CLIENTELE." + model.OrderField + "  desc  ) " + likesql + " order by CLIENTELE." + model.OrderField + " desc  ");
            ...
            else
            {
                ...
                strSql.Append("select top " + nowPageSize + "  * from CLIENTELE where ClIENTNO not in  ");
                strSql.Append("(select top " + (nowPageSize * nowPageNum) + " ClIENTNO from CLIENTELE where 1=1 " + likesql + " order by " + model.OrderField + " desc ) ");
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.CLIENTELE.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Weblis.CLIENTELE .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
        public int DeleteByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.weblis.CLIENTELE.DeleteByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
        ...
        public bool IsExist(string labCodeNo)
        {
            ...
            StringBuilder strSql2 = new StringBuilder();
            strSql2.Append(" select COUNT(1) from B_CLIENTELEControl ");
        ...
        public bool DeleteByLabCode(string LabCodeNo)
        {
            ...
            StringBuilder strSql2 = new StringBuilder();
            strSql2.Append(" delete from B_CLIENTELEControl ");
            strSql2.Append(" where ControlLabNo=" + LabCodeNo + " ");
