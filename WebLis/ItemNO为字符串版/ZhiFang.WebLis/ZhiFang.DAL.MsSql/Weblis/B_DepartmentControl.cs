...
namespace ZhiFang.DAL.MsSql.Weblis
{
    ...
    public partial class B_DepartmentControl : IDDepartmentControl
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *,'('+convert(varchar(100),DepartmentControlNo)+')'+CName as DepartmentControlNoAndName ");
            strSql.Append(" FROM B_DepartmentControl where 1=1 ");
        ...
        //            strWhere.Append(" ) ");
        //    }
        //    strSql.Append("select top " + nowPageSize + " * from B_DepartmentControl where 1=1  ");
        //    if (model.LabCode != null)
        //    {
        //        strSql.Append(" and LabCode='" + model.LabCode + "' ");
        //    }
        //    strSql.Append(" " + strWhere.ToString() + " and DepartmentControlNo not in ");
        //    strSql.Append("(select top " + (nowPageSize * nowPageNum - nowPageSize) + " DepartmentControlNo from B_DepartmentControl where 1=1  ");
        //    if (model.LabCode != null)
        //    {
        //        strSql.Append(" and LabCode='" + model.LabCode + "' ");
        //    }
        //    strSql.Append(" " + strWhere.ToString() + " order by DepartmentControlNo) order by DepartmentControlNo  ");
        //    return idb.ExecuteDataSet(strSql.ToString());
        //}
        ...
        public DataSet B_lab_GetListByPage(ZhiFang.Model.DepartmentControl model, int nowPageNum, int nowPageSize)
        {
            ...
            //全部 
                ...
                strSql.Append("select *,b.CName CenterCName from (select *from b_lab_Department where 1=1 and b_lab_Department.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_DepartmentControl on B_DepartmentControl.ControlDeptNo =a.labDeptNo and  B_DepartmentControl.ControlLabNo='" + model.ControlLabNo + "' left join Department b on b.DeptNo =B_DepartmentControl.DeptNo ");
            else
