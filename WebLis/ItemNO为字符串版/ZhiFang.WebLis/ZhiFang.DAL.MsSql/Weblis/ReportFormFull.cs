        ...
        */
        ...
        public DataSet GetList(ZhiFang.Model.ReportFormFull model)
        {
            try
            {
                ...
                {
                    strSql.Append(" and ReceiveDate>='" + model.Startdate.Value.ToShortDateString() + "' ");
                }
                ...
                {
                    strSql.Append(" and noperdate>='" + model.noperdateStart.Value.ToShortDateString() + "' ");
                }

                if (model.noperdateEnd != null)
                {
                    strSql.Append(" and noperdate<='" + model.noperdateEnd.Value.ToShortDateString() + "' ");
                }
