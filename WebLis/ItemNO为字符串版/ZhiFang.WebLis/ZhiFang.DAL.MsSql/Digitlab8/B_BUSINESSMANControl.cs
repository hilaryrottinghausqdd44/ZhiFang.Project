...
namespace ZhiFang.DAL.MsSql.Digitlab8  
{
	...
	public partial class B_BUSINESSMANControl: IDBUSINESSMANControl	{	
		...
		public int GetMaxId()
        {
            return idb.GetMaxID("BMANControlNo","B_BUSINESSMANControl");
        }
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Digitlab8.B_BUSINESSMANControl.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }          
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Digitlab8.B_BUSINESSMANControl .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
