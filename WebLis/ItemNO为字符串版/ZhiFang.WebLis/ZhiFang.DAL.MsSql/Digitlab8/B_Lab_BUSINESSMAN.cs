...
namespace ZhiFang.DAL.MsSql.Digitlab8  
{
	...
	public partial class B_Lab_BUSINESSMAN: IDLab_BUSINESSMAN	{	
        ...
        public int GetTotalCount(ZhiFang.Model.Lab_BUSINESSMAN model)
        {
            ...
            if (model != null)
            {
                if (model.LabBMANNO != -1)
                {
                    strWhere.Append(" and ( LabBMANNO like '%" + model.LabBMANNO + "%' ");
                }
                if (model.CNAME != null)
                {
        ...
        public DataSet GetListByPage(ZhiFang.Model.Lab_BUSINESSMAN model, int nowPageNum, int nowPageSize)
        {
            ...
            strSql.Append(" " + strWhere.ToString() + " and BNANID not in ");
            ...
            strSql.Append(" " + strWhere.ToString() + " order by BNANID) order by BNANID  ");
            return idb.ExecuteDataSet(strSql.ToString());
        }
		...
		public int GetMaxId()
        {
            return idb.GetMaxID("LabCode,LabBMANNO","B_Lab_BUSINESSMAN");
        }
         ...
         public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Digitlab8.B_Lab_BUSINESSMAN.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }          
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.MsSql.Digitlab8.B_Lab_BUSINESSMAN .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
