...
namespace ZhiFang.DAL.MsSql.Digitlab8  
{
	...
	public partial class S_Dic_AgeUnit : IDAgeUnit,IDBatchCopy,IDGetListByTimeStampe
	{	
		DBUtility.IDBConnection idb;
        public S_Dic_AgeUnit(string dbsourceconn)
        {
            idb = DBUtility.DBFactory.CreateDB(dbsourceconn);
        }
		public S_Dic_AgeUnit()
		{
		...
		public int Add(ZhiFang.Model.AgeUnit model)
		{
			...
			strSql.Append("insert into S_Dic_AgeUnit(");			
            strSql.Append("AgeUnitNo,CName,ShortCode,Visible,DispOrder,HisOrderCode,StandCode,ZFStandCode,UseFlag");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update S_Dic_AgeUnit set ");
		...
		public int Delete(int AgeUnitNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from S_Dic_AgeUnit ");
			strSql.Append(" where AgeUnitNo=@AgeUnitNo ");
						SqlParameter[] parameters = {
					new SqlParameter("@AgeUnitNo", SqlDbType.Int,4)};
		...
		public int DeleteList(string AgeUnitIDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from S_Dic_AgeUnit ");
			strSql.Append(" where ID in ("+AgeUnitIDlist + ")  ");
		...
		public ZhiFang.Model.AgeUnit GetModel(int AgeUnitNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select AgeUnitID, AgeUnitNo, CName, ShortCode, Visible, DispOrder, HisOrderCode, DTimeStampe, AddTime, StandCode, ZFStandCode, UseFlag  ");			
			strSql.Append("  from S_Dic_AgeUnit ");
			strSql.Append(" where AgeUnitNo=@AgeUnitNo ");
						SqlParameter[] parameters = {
					new SqlParameter("@AgeUnitNo", SqlDbType.Int,4)};
			parameters[0].Value = AgeUnitNo;
			...
			{
																if(ds.Tables[0].Rows[0]["AgeUnitID"].ToString()!="")
				{
					model.AgeUnitID=int.Parse(ds.Tables[0].Rows[0]["AgeUnitID"].ToString());
				}
		...
		public DataSet GetList(ZhiFang.Model.AgeUnit model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * ");
			strSql.Append(" FROM S_Dic_AgeUnit where 1=1 ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) FROM S_Dic_AgeUnit ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) FROM S_Dic_AgeUnit where 1=1 ");
        ...
        {
            StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from S_Dic_AgeUnit ");
			strSql.Append(" where AgeUnitNo ='"+AgeUnitNo+"'");
			string strCount = idb.ExecuteScalar(strSql.ToString());
		...
		public bool CopyToLab(List<string> lst)
		{
			...
			string LabTableName="S_Dic_AgeUnit";
            ...
            try
            {
	            for (int i = 0; i < lst.Count; i++)
	            {
	            		...
	            		strSql.Append(" LabAgeUnitNo , CName , ShortCode , Visible , DispOrder , HisOrderCode , StandCode , ZFStandCode , UseFlag ");
						strSql.Append(") select '" + lst[i].Trim() + "' as LabCode, ");
	            		strSql.Append("AgeUnitNo,CName,ShortCode,Visible,DispOrder,HisOrderCode,StandCode,ZFStandCode,UseFlag");            
	            		strSql.Append(" from S_Dic_AgeUnit ");    
	            		
	            		strSqlControl.Append("insert into S_Dic_AgeUnitControl ( ");
	            		...
	            		strSqlControl.Append(" from S_Dic_AgeUnit ");  
		...
		public int GetMaxId()
        {
            return idb.GetMaxID("AgeUnitNo","S_Dic_AgeUnit");
        }
        ...
        public DataSet GetListByTimeStampe(string LabCode, int dTimeStampe)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *,'" + LabCode + "' as LabCode,AgeUnitNo as LabAgeUnitNo from S_Dic_AgeUnit where 1=1 ");
            ...
            strSql2.Append("select *,LabAgeUnitNo as AgeUnitNo from S_Dic_Lab_AgeUnit where 1=1 ");
            if (LabCode.Trim() != "")
            {
            ...
            strSql3.Append("select * from S_Dic_AgeUnitControl where 1=1 ");
            if (LabCode.Trim() != "")
            {
        ...
        public int AddByDataRow(DataRow dr)
        {
            try
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into S_Dic_AgeUnit (");
                strSql.Append("AgeUnitNo,CName,ShortCode,Visible,DispOrder,HisOrderCode,AddTime,StandCode,ZFStandCode,UseFlag");
                strSql.Append(") values (");
                strSql.Append("'" + dr["AgeUnitNo"].ToString().Trim() + "','" + dr["CName"].ToString().Trim() + "','" + dr["ShortCode"].ToString().Trim() + "','" + dr["Visible"].ToString().Trim() + "','" + dr["DispOrder"].ToString().Trim() + "','" + dr["HisOrderCode"].ToString().Trim() + "','" + DateTime.Parse(dr["AddTime"].ToString().Trim()) + "','" + dr["StandCode"].ToString().Trim() + "','" + dr["ZFStandCode"].ToString().Trim() + "','" + dr["UseFlag"].ToString().Trim() + "'");
                strSql.Append(") ");
                return idb.ExecuteNonQuery(strSql.ToString());
            }
            catch
