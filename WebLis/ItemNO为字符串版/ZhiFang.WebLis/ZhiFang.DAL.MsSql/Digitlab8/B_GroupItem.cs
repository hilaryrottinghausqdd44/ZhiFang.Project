...
{
    //B_GroupItem
    public partial class B_GroupItem : IDGroupItem, IDBatchCopy,IDGetListByTimeStampe
    {
        DBUtility.IDBConnection idb;
        public B_GroupItem(string dbsourceconn)
        {
        ...
        public int Add(ZhiFang.Model.GroupItem model)
        {
            ...
            strSql.Append("insert into B_GroupItem(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update B_GroupItem set ");
        ...
        public int Delete(string PItemNo, string ItemNo)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from B_GroupItem ");
            strSql.Append(" where PItemNo=@PItemNo and ItemNo=@ItemNo ");
            SqlParameter[] parameters = {
					new SqlParameter("@PItemNo", SqlDbType.VarChar,50),
					new SqlParameter("@ItemNo", SqlDbType.VarChar,50)};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from B_GroupItem where 1=1 ");
            if (model.PItemNo != null)
            {
        ...
        public ZhiFang.Model.GroupItem GetModel(string PItemNo, string ItemNo)
        {
            ...
            strSql.Append("  from B_GroupItem ");
            strSql.Append(" where PItemNo=@PItemNo and ItemNo=@ItemNo ");
            SqlParameter[] parameters = {
					new SqlParameter("@PItemNo", SqlDbType.VarChar,50),
					new SqlParameter("@ItemNo", SqlDbType.VarChar,50)};
        ...
        public DataSet GetList(ZhiFang.Model.GroupItem model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM B_GroupItem where 1=1 ");
        ...
        public DataSet GetListByTimeStampe(string LabCode, int dTimeStampe)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *,'" + LabCode + "' as LabCode from B_GroupItem where 1=1 ");
            ...
            //strSql3.Append("select * from B_GroupItemControl where 1=1 ");
            //if (LabCode.Trim() != "")
            //{
            ...
            try
            {
                ...
                if (lst.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            strSql.Append("insert into B_Lab_GroupItem (PItemNo,ItemNo,LabCode) ");
                            strSql.Append(" select PItemNo,ItemNo,'" + lst[i].Trim() + "' as LabCode from B_GroupItem ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from B_GroupItem ");
            strSql.Append(" where PItemNo ='" + PItemNo + "' and ItemNo='" + ItemNo + "'");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from B_GroupItem where 1=1 ");
            if (ht.Count > 0)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) FROM B_GroupItem");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) FROM B_GroupItem where 1=1 ");
            if (model.PItemNo != null)
            {
                strSql.Append(" and PItemNo='" + model.PItemNo + "' ");
            }
