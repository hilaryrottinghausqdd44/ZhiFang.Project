                ...
                if (tempEntity != null && tempPropertyInfo != null)
                {
                    ...
                    if (tempFieldValue != null)
                    {
                        ...
                        if (tempKeyStr.Contains(tempType))       //如果为字符串和时间类型，需要加引号
                        {
                            ...
                            {
                                fieldValueArray[tempIndex] = FieldName + "=" + "'" + ZhiFang.Common.Public.StringPlus.SQLConvertSpecialCharacter(Convert.ToDateTime(tempFieldValue).ToString("yyyy-MM-dd HH:mm:ss.fff")) + "'";
                            }
                            else
                            {
                                fieldValueArray[tempIndex] = FieldName + "=" + "'" + ZhiFang.Common.Public.StringPlus.SQLConvertSpecialCharacter(tempFieldValue.ToString()) + "'";
                            }
                        }
