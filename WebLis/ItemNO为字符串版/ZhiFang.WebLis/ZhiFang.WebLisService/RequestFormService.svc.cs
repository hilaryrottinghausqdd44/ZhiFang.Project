...
namespace ZhiFang.WebLisService
{
    ...
    public class RequestFormService : IRequestFormService
    {
        ...
        public bool AppliyUpLoad(byte[] xmlData, string orgID, string jzType, out string sMsg)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in wsBarCode.Tables[0].Rows)
                {
                    ...
                    DataSet dsNRequestForm = ibnrf.GetList(new Model.NRequestForm() { SerialNo = model.SerialNo });
        ...
        /// <summary>
        /// 申请单上传 博尔诚定制 ganwh add 2016-1-11
        /// </summary>
        ...
        public bool CheckAppliy(DataTable dt, string tableName, out string messages)
        {
            ...
            {
                case "ReportForm":
                    Field = "ReportFormID,FORMNO,BARCODE,PersonID,RECEIVEDATE,SECTIONNO,SECTIONNAME,TESTTYPENO,SAMPLENO,STATUSNO, StatusType,SAMPLETYPENO,CNAME,GENDERNO,AGE,AGEUNITNO, FOLKNO,TelNo,DOCTOR, COLLECTER,COLLECTDATE, COLLECTTIME," +
"TECHNICIAN, TESTDATE, TESTTIME, OPERATOR, OPERDATE, OPERTIME,CHECKER, CHECKDATE, CHECKTIME, SERIALNO, SICKTYPENO, WebLisSourceOrgID,WebLisSourceOrgName,WebLisOrgID,WebLisOrgName,resultstatus,AGEUNITNAME,GENDERNAME, DEPTNAME, DOCTORNAME, DISTRICTNAME,WARDNAME, FOLKNAME, SICKTYPENAME, SAMPLETYPENAME, TESTTYPENAME";
                    break;
                case "ReportItem":
                    Field = "ReportFormID, FORMNO,  Barcode, RECEIVEDATE, SECTIONNO,SectionName, TESTTYPENO, SAMPLENO, PARITEMNO, ITEMNO, TESTITEMNAME, TESTITEMSNAME, ORIGINALVALUE, REPORTVALUE, UNIT, ORIGINALDESC, REPORTDESC, STATUSNO, EQUIPNO,  EquipName, CheckType,  CheckTypeName, MODIFIED, REFRANGE, ITEMDATE, ITEMTIME, ISMATCH, RESULTSTATUS, PARITEMNAME,PARITEMSNAME";
                    break;
                case "ReportMicro":
                    Field = "ReportFormID, FormNo,  Barcode,  ReceiveDate,  SectionNo,  TestTypeNo,  SampleNo, ItemNo ItemName, DescNo, DescName, MicroNo, MicroDesc, MicroName, AntiNo, AntiName, Suscept, SusQuan, RefRange, SusDesc, AntiUnit, ItemDesc, EquipNo,EquipName, ItemDate, ItemTime, Modified, CheckType";
                    break;
                case "ReportMarrow":
                    Field = " ReportFormID, FormNo,  Barcode,  ReceiveDate,  SectionNo,  TestTypeNo,  SampleNo, ParItemNo, " +
"ItemNo,  ItemCName,  ItemEName,  ParItemCName,  ParItemEName, BloodNum,BloodPercent, MarrowNum, MarrowPercent, BloodDesc, MarrowDesc, RefRange, EquipNo,  EquipName, ItemDate, ItemTime, ResultStatus";
                    break;
                case "Table":
                    Field = "SerialNo,PersonID,BarCode,GenderNo,GenderName,SampleType,SampleTypeNo,CName,TelNo,Age,AgeUnit,AgeUnitNo,FOLKNAME,CollectDate,CollectTime,WebLisSourceOrgID,WebLisSourceOrgName,WebLisOrgID,WebLisOrgName," +
"TESTTYPENO,TESTTYPEName,STATUSNO,STATUSName,jztype,jztypeName,ItemNo,ItemName,CheckType,CheckTypeName";
                    break;
            }
