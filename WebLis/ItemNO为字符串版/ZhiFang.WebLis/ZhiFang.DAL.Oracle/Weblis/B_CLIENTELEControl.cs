...
namespace ZhiFang.DAL.Oracle.weblis  
{
	...
	public partial class B_CLIENTELEControl: BaseDALLisDB, IDCLIENTELEControl	{	
		...
		public int Add(ZhiFang.Model.CLIENTELEControl model)
		{
            ...
            {
                strSql1.Append("ClIENTControlNo,");
                strSql2.Append("'" + model.ClIENTControlNo + "',");
            }
            ...
            {
                strSql1.Append("ControlClIENTNO,");
                strSql2.Append("" + model.ControlClIENTNO + ",");
            }
		...
		public int Update(ZhiFang.Model.CLIENTELEControl model)
		{
            ...
            if (model.ControlClIENTNO != null)
            {
                strSql.Append("ControlClIENTNO=" + model.ControlClIENTNO + ",");
            }
            if (model.AddTime != null)
            {
		...
		public ZhiFang.Model.CLIENTELEControl GetModel(string ClIENTControlNo)
        {
            ...
            strSql.Append(" Id,BMANControlNo,BMANNO,ControlLabNo,ControlBMANNO,DTimeStampe,AddTime,UseFlag ");
            strSql.Append(" from B_BUSINESSMANControl ");
            strSql.Append(" where 1=1 and rownum <= '1' and ClIENTControlNo='" + ClIENTControlNo + "'");
		...
		public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ClIENTControlNo","B_CLIENTELEControl");
        }
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_CLIENTELEControl.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }          
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_CLIENTELEControl .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
