    ...
    public partial class WhoNet_FormData : BaseDALLisDB, IWhoNet_FormData
    {
        ...
        public int Add(ZhiFang.Model.WhoNet_FormData model)
        {
            ...
            if (model.FormID != null)
            {
                ...
                strSql2.Append("" + model.FormID + ",");
            }
            if (model.country_a != null)
            {
                strSql1.Append("country_a,");
                strSql2.Append("'" + model.country_a + "',");
            }
            if (model.laboratory != null)
            {
                strSql1.Append("laboratory,");
                strSql2.Append("'" + model.laboratory + "',");
            }
            if (model.patient_id != null)
            {
                strSql1.Append("patient_id,");
                strSql2.Append("'" + model.patient_id + "',");
            }
            if (model.last_name != null)
            {
                strSql1.Append("last_name,");
                strSql2.Append("'" + model.last_name + "',");
            }
            if (model.first_name != null)
            {
                strSql1.Append("first_name,");
                strSql2.Append("'" + model.first_name + "',");
            }
            if (model.sex != null)
            {
                strSql1.Append("sex,");
            ...
            if (model.pat_type != null)
            {
                strSql1.Append("pat_type,");
                strSql2.Append("'" + model.pat_type + "',");
            }
            if (model.ward != null)
            {
                strSql1.Append("ward,");
                strSql2.Append("'" + model.ward + "',");
            }
            ...
            if (model.ward_type != null)
            {
                strSql1.Append("ward_type,");
                strSql2.Append("'" + model.ward_type + "',");
            }
            if (model.date_brith != null)
            {
                strSql1.Append("date_brith,");
                strSql2.Append("'" + model.date_brith + "',");
            }
            if (model.institut != null)
            {
                strSql1.Append("institut,");
                strSql2.Append("'" + model.institut + "',");
            }
            if (model.SPEC_NUM != null)
            {
                strSql1.Append("SPEC_NUM,");
                strSql2.Append("'" + model.SPEC_NUM + "',");
            }
            if (model.SPEC_DATE != null)
            {
                strSql1.Append("SPEC_DATE,");
                strSql2.Append("'" + model.SPEC_DATE + "',");
            }
            if (model.SPEC_TYPE != null)
            {
                strSql1.Append("SPEC_TYPE,");
                strSql2.Append("'" + model.SPEC_TYPE + "',");
            }
            if (model.SPEC_CODE != null)
            {
                strSql1.Append("SPEC_CODE,");
                strSql2.Append("'" + model.SPEC_CODE + "',");
            }
            if (model.SPEC_REAS != null)
            {
                strSql1.Append("SPEC_REAS,");
                strSql2.Append("'" + model.SPEC_REAS + "',");
            }
            if (model.DATE_ADMIS != null)
            {
                strSql1.Append("DATE_ADMIS,");
                strSql2.Append("'" + model.DATE_ADMIS + "',");
            }
            if (model.DATE_DISCH != null)
            {
                strSql1.Append("DATE_DISCH,");
                strSql2.Append("'" + model.DATE_DISCH + "',");
            }
            if (model.DATE_OPER != null)
            {
                strSql1.Append("DATE_OPER,");
                strSql2.Append("'" + model.DATE_OPER + "',");
            }
            if (model.DATE_WARD != null)
            {
                strSql1.Append("DATE_WARD,");
                strSql2.Append("'" + model.DATE_WARD + "',");
            }
            if (model.DIAGNOSIS != null)
            {
                strSql1.Append("DIAGNOSIS,");
                strSql2.Append("'" + model.DIAGNOSIS + "',");
            }
            if (model.DATE_INFEC != null)
            {
                strSql1.Append("DATE_INFEC,");
                strSql2.Append("'" + model.DATE_INFEC + "',");
            }
            if (model.SITEINFECT != null)
            {
                strSql1.Append("SITEINFECT,");
                strSql2.Append("'" + model.SITEINFECT + "',");
            }
            ...
            if (model.ORDER_MD != null)
            {
                strSql1.Append("ORDER_MD,");
                strSql2.Append("'" + model.ORDER_MD + "',");
            }
            if (model.CLNOUTCOME != null)
            {
                strSql1.Append("CLNOUTCOME,");
                strSql2.Append("'" + model.CLNOUTCOME + "',");
            }
            if (model.PHYSICIAN != null)
            {
                strSql1.Append("PHYSICIAN,");
                strSql2.Append("'" + model.PHYSICIAN + "',");
            }
            if (model.PRIOR_ABX != null)
            {
                strSql1.Append("PRIOR_ABX,");
                strSql2.Append("'" + model.PRIOR_ABX + "',");
            }
            if (model.RESP_TO_TX != null)
            {
                strSql1.Append("RESP_TO_TX,");
                strSql2.Append("'" + model.RESP_TO_TX + "',");
            }
            if (model.SURGEON != null)
            {
                strSql1.Append("SURGEON,");
                strSql2.Append("'" + model.SURGEON + "',");
            }
            if (model.STORAGELOC != null)
            {
                strSql1.Append("STORAGELOC,");
                strSql2.Append("'" + model.STORAGELOC + "',");
            }
            if (model.STORAGENUM != null)
            {
                strSql1.Append("STORAGENUM,");
                strSql2.Append("'" + model.STORAGENUM + "',");
            }
            if (model.RESID_TYPE != null)
            {
                strSql1.Append("RESID_TYPE,");
                strSql2.Append("'" + model.RESID_TYPE + "',");
            }
            if (model.OCCUPATION != null)
            {
                strSql1.Append("OCCUPATION,");
                strSql2.Append("'" + model.OCCUPATION + "',");
            }
            if (model.ETHNIC != null)
            {
                strSql1.Append("ETHNIC,");
                strSql2.Append("'" + model.ETHNIC + "',");
            }
        ...
        public int Update(ZhiFang.Model.WhoNet_FormData model)
        {
            ...
            if (model.country_a != null)
            {
                strSql.Append("country_a='" + model.country_a + "',");
            }
            else
            {
                strSql.Append("country_a= null ,");
            }
            if (model.laboratory != null)
            {
                strSql.Append("laboratory='" + model.laboratory + "',");
            }
            else
            {
                strSql.Append("laboratory= null ,");
            }
            if (model.patient_id != null)
            {
            ...
            {
                strSql.Append("patient_id= null ,");
            }
            if (model.last_name != null)
            {
                strSql.Append("last_name='" + model.last_name + "',");
            }
            else
            {
                strSql.Append("last_name= null ,");
            }
            if (model.first_name != null)
            {
                strSql.Append("first_name='" + model.first_name + "',");
            }
            else
            {
                strSql.Append("first_name= null ,");
            }
            if (model.sex != null)
            {
            ...
            if (model.pat_type != null)
            {
                strSql.Append("pat_type='" + model.pat_type + "',");
            }
            else
            {
                strSql.Append("pat_type= null ,");
            }
            if (model.ward != null)
            {
            ...
            if (model.ward_type != null)
            {
                strSql.Append("ward_type='" + model.ward_type + "',");
            }
            else
            {
                strSql.Append("ward_type= null ,");
            }
            if (model.date_brith != null)
            {
                strSql.Append("date_brith='" + model.date_brith + "',");
            }
            else
            {
                strSql.Append("date_brith= null ,");
            }
            if (model.institut != null)
            {
                strSql.Append("institut='" + model.institut + "',");
            }
            else
            {
                strSql.Append("institut= null ,");
            }
            if (model.SPEC_NUM != null)
            {
                strSql.Append("SPEC_NUM='" + model.SPEC_NUM + "',");
            }
            else
            {
                strSql.Append("SPEC_NUM= null ,");
            }
            if (model.SPEC_DATE != null)
            {
                strSql.Append("SPEC_DATE='" + model.SPEC_DATE + "',");
            }
            else
            {
                strSql.Append("SPEC_DATE= null ,");
            }
            if (model.SPEC_TYPE != null)
            {
                strSql.Append("SPEC_TYPE='" + model.SPEC_TYPE + "',");
            }
            else
            {
                strSql.Append("SPEC_TYPE= null ,");
            }
            if (model.SPEC_CODE != null)
            {
                strSql.Append("SPEC_CODE='" + model.SPEC_CODE + "',");
            }
            else
            {
                strSql.Append("SPEC_CODE= null ,");
            }
            if (model.SPEC_REAS != null)
            {
                strSql.Append("SPEC_REAS='" + model.SPEC_REAS + "',");
            }
            else
            {
                strSql.Append("SPEC_REAS= null ,");
            }
            if (model.DATE_ADMIS != null)
            {
                strSql.Append("DATE_ADMIS='" + model.DATE_ADMIS + "',");
            }
            else
            {
                strSql.Append("DATE_ADMIS= null ,");
            }
            if (model.DATE_DISCH != null)
            {
                strSql.Append("DATE_DISCH='" + model.DATE_DISCH + "',");
            }
            else
            {
                strSql.Append("DATE_DISCH= null ,");
            }
            if (model.DATE_OPER != null)
            {
                strSql.Append("DATE_OPER='" + model.DATE_OPER + "',");
            }
            else
            {
                strSql.Append("DATE_OPER= null ,");
            }
            if (model.DATE_WARD != null)
            {
                strSql.Append("DATE_WARD='" + model.DATE_WARD + "',");
            }
            else
            {
                strSql.Append("DATE_WARD= null ,");
            }
            if (model.DIAGNOSIS != null)
            {
                strSql.Append("DIAGNOSIS='" + model.DIAGNOSIS + "',");
            }
            else
            {
                strSql.Append("DIAGNOSIS= null ,");
            }
            if (model.DATE_INFEC != null)
            {
                strSql.Append("DATE_INFEC='" + model.DATE_INFEC + "',");
            }
            else
            {
                strSql.Append("DATE_INFEC= null ,");
            }
            if (model.SITEINFECT != null)
            {
                strSql.Append("SITEINFECT='" + model.SITEINFECT + "',");
            }
            else
            {
                strSql.Append("SITEINFECT= null ,");
            }
            if (model.OPERATION != null)
            {
            ...
            if (model.ORDER_MD != null)
            {
                strSql.Append("ORDER_MD='" + model.ORDER_MD + "',");
            }
            else
            {
                strSql.Append("ORDER_MD= null ,");
            }
            if (model.CLNOUTCOME != null)
            {
                strSql.Append("CLNOUTCOME='" + model.CLNOUTCOME + "',");
            }
            else
            {
                strSql.Append("CLNOUTCOME= null ,");
            }
            if (model.PHYSICIAN != null)
            {
                strSql.Append("PHYSICIAN='" + model.PHYSICIAN + "',");
            }
            else
            {
                strSql.Append("PHYSICIAN= null ,");
            }
            if (model.PRIOR_ABX != null)
            {
                strSql.Append("PRIOR_ABX='" + model.PRIOR_ABX + "',");
            }
            else
            {
                strSql.Append("PRIOR_ABX= null ,");
            }
            if (model.RESP_TO_TX != null)
            {
                strSql.Append("RESP_TO_TX='" + model.RESP_TO_TX + "',");
            }
            else
            {
                strSql.Append("RESP_TO_TX= null ,");
            }
            if (model.SURGEON != null)
            {
                strSql.Append("SURGEON='" + model.SURGEON + "',");
            }
            else
            {
                strSql.Append("SURGEON= null ,");
            }
            if (model.STORAGELOC != null)
            {
                strSql.Append("STORAGELOC='" + model.STORAGELOC + "',");
            }
            else
            {
                strSql.Append("STORAGELOC= null ,");
            }
            if (model.STORAGENUM != null)
            {
                strSql.Append("STORAGENUM='" + model.STORAGENUM + "',");
            }
            else
            {
                strSql.Append("STORAGENUM= null ,");
            }
            if (model.RESID_TYPE != null)
            {
                strSql.Append("RESID_TYPE='" + model.RESID_TYPE + "',");
            }
            else
            {
                strSql.Append("RESID_TYPE= null ,");
            }
            if (model.OCCUPATION != null)
            {
                strSql.Append("OCCUPATION='" + model.OCCUPATION + "',");
            }
            else
            {
                strSql.Append("OCCUPATION= null ,");
            }
            if (model.ETHNIC != null)
            {
                strSql.Append("ETHNIC='" + model.ETHNIC + "',");
            }
            else
            {
                strSql.Append("ETHNIC= null ,");
            }
            if (model.DataAddTime != null)
            {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where FormID=" + model.FormID + " ");
