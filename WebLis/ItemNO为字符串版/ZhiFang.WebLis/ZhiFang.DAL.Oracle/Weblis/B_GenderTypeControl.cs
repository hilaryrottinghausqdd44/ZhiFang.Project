...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class B_GenderTypeControl : BaseDALLisDB, IDGenderTypeControl
    {
        ...
        public int Add(ZhiFang.Model.GenderTypeControl model)
        {
            ...
            {
                strSql1.Append("GenderControlNo,");
                strSql2.Append("'" + model.GenderControlNo + "',");
            }
            ...
            {
                strSql1.Append("ControlGenderNo,");
                strSql2.Append("" + model.ControlGenderNo + ",");
            }
        ...
        public int Update(ZhiFang.Model.GenderTypeControl model)
        {
            ...
            if (model.ControlGenderNo != null)
            {
                strSql.Append("ControlGenderNo=" + model.ControlGenderNo + ",");
            }
            if (model.AddTime != null)
            {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where GenderControlNo='" + model.GenderControlNo + "'");
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_GenderTypeControl.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_GenderTypeControl .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
        ...
        public bool CheckIncludeLabCode(List<string> l, string LabCode)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_GenderTypeControl.CheckIncludeLabCode异常->", ex);
            }
            return b;
        }
        ...
        public bool CheckIncludeCenterCode(List<string> l, string LabCode)
        {
            ...
            try
            {
                ...
                string strSql = "select id,gendercontrolno,genderno,controllabno,controlgenderno,addtime,useflag from B_GenderTypeControl where ControlLabNo='" + LabCode.Trim() + "' and GenderNo in (" + strItemNos + ")";
                DataSet ds = DbHelperSQL.ExecuteDataSet(strSql);
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count == count)
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_GenderTypeControl.CheckIncludeCenterCode异常->", ex);
            }
            return b;
        }
        ...
        public DataSet GetLabCodeNo(string LabCode, List<string> CenterNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_GenderTypeControl.GetLabCodeNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet GetCenterNo(string LabCode, List<string> LabPrimaryNoList)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_GenderTypeControl.GetCenterNo异常->", ex);
            }
            return ds;
        }
        ...
        public DataSet B_lab_GetListByPage(ZhiFang.Model.GenderTypeControl model, int nowPageNum, int nowPageSize)
        {
            ...
            //已对照
            if (model.ControlState == "1")
                strSql.Append("select b.GenderNo,a.*,b.CName CenterCName from ( select *from b_lab_GenderType where 1=1 and labGenderno in (select ControlGenderNo From B_GenderTypeControl where 1=1 and B_GenderTypeControl.ControlLabNo ='" + model.ControlLabNo + "'" + strWhere.ToString() + " ) and  b_lab_GenderType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_GenderTypeControl on B_GenderTypeControl.ControlGenderNo =a.labGenderNo and  B_GenderTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join GenderType b on b.GenderNo = B_GenderTypeControl.GenderNo ");
            //未对照
            else if (model.ControlState == "2")
                strSql.Append("select b.GenderNo,a.*,b.CName CenterCName from (select *from b_lab_GenderType where 1=1 and labGenderno not in (select ControlGenderNo From B_GenderTypeControl where 1=1 and B_GenderTypeControl.ControlLabNo ='" + model.ControlLabNo + "' ) and  b_lab_GenderType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_GenderTypeControl on B_GenderTypeControl.ControlGenderNo =a.labGenderNo and  B_GenderTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join GenderType b on b.GenderNo = B_GenderTypeControl.GenderNo ");
            //全部 
            else if (model.ControlState == "0")
                strSql.Append("select b.GenderNo,a.*,b.CName CenterCName from (select *from b_lab_GenderType where 1=1 and b_lab_GenderType.LabCode='" + model.ControlLabNo + "' " + strWhere.ToString() + "  ) a left join B_GenderTypeControl on B_GenderTypeControl.ControlGenderNo =a.labGenderNo and  B_GenderTypeControl.ControlLabNo='" + model.ControlLabNo + "' left join GenderType b on b.GenderNo = B_GenderTypeControl.GenderNo ");
            else
