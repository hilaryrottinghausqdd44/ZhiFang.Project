...
namespace ZhiFang.DAL.Oracle.weblis
{
    ...
    public partial class B_BUSINESSMANControl : BaseDALLisDB, IDBUSINESSMANControl
    {
        ...
        public int Add(ZhiFang.Model.BUSINESSMANControl model)
        {
            ...
            {
                strSql1.Append("BMANControlNo,");
                strSql2.Append("'" + model.BMANControlNo + "',");
            }
            ...
            {
                strSql1.Append("ControlBMANNO,");
                strSql2.Append("" + model.ControlBMANNO + ",");
            }
        ...
        public int Update(ZhiFang.Model.BUSINESSMANControl model)
        {
            ...
            if (model.ControlBMANNO != null)
            {
                strSql.Append("ControlBMANNO=" + model.ControlBMANNO + ",");
            }
            if (model.AddTime != null)
            {
        ...
        public ZhiFang.Model.BUSINESSMANControl GetModel(string BMANControlNo)
        {
            ...
            strSql.Append(" from B_BUSINESSMANControl ");
            strSql.Append(" where 1=1 rownum <=1 and BMANControlNo=" + BMANControlNo + "");
        ...
        public int AddByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_BUSINESSMANControl.AddByDataRow 同步数据时异常：", ex);
                return 0;
            }
        }
        public int UpdateByDataRow(DataRow dr)
        {
            ...
            {
                ZhiFang.Common.Log.Log.Error("ZhiFang.DAL.Oracle.weblis.B_BUSINESSMANControl .UpdateByDataRow同步数据时异常：", ex);
                return 0;
            }
        }
