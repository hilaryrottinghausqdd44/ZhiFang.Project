...
namespace ZhiFang.DAO.NHB.Base
{
    public abstract class BaseDaoByStringNHB<T, T1> : HibernateDaoSupport, IDBaseDao<T, T1> where T : BaseEntityByString
    {
        ...
        public void GetDataRowRoleHQLString()
        {
            ...
            //string labid = ZhiFang.BloodTransfusion.Common.Cookie.CookieHelper.Read(ZhiFang.Entity.Base.SysPublicSet.SysDicCookieSession.LabID);
            //string IsLabFlag = ZhiFang.BloodTransfusion.Common.Cookie.CookieHelper.Read(ZhiFang.Entity.Base.SysPublicSet.SysDicCookieSession.IsLabFlag);
