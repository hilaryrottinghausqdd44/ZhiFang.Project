...
namespace ZhiFang.Entity.BloodTransfusion
{
    ...
    public static class SYSParaNo
    {
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 获取几天内的LIS检验结果 = new KeyValuePair<string, BaseClassDicEntity>("BL-LISG-DAYS-0015", new BaseClassDicEntity() { Id = "BL-LISG-DAYS-0015", Name = "获取几天内的LIS检验结果", Code = "GetLisResultDays", FontColor = "#ffffff", BGColor = "#aad08f", DefaultValue = "7", Memo = "用血申请获取患者的多少天内LIS检验结果的配置", SName = "医生站", DataType = "String" });
        public static KeyValuePair<string, BaseClassDicEntity> LIS结果为空时默认值 = new KeyValuePair<string, BaseClassDicEntity>("BL-LISR-DEVL-0016", new BaseClassDicEntity() { Id = "BL-LISR-DEVL-0016", Name = "LIS结果为空时默认值", Code = "LisDefaulltItemsResult", FontColor = "#ffffff", BGColor = "#aad08f", DefaultValue = "检查中", Memo = "新增用血申请时,检验项目LIS结果为空时,设置的默认值", SName = "医生站", DataType = "String" });

        public static KeyValuePair<string, BaseClassDicEntity> 用血申请传入的患者参数非空字段 = new KeyValuePair<string, BaseClassDicEntity>("BL-HISN-FIED-0017", new BaseClassDicEntity() { Id = "BL-HISN-FIED-0017", Name = "用血申请传入的患者参数非空字段", Code = "NotNullParamField", FontColor = "#ffffff", BGColor = "#aad08f", DefaultValue = "admId", Memo = "HIS调用时,用血申请传入的患者参数非空字段", SName = "HIS", DataType = "String" });
        public static KeyValuePair<string, BaseClassDicEntity> 用血申请审核完成后是否返回给HIS = new KeyValuePair<string, BaseClassDicEntity>("BL-ISTO-HISR-0018", new BaseClassDicEntity() { Id = "BL-ISTO-HISR-0018", Name = "用血申请审核完成后是否返回给HIS", Code = "ReviewCompletedIsToHIS", FontColor = "#ffffff", BGColor = "#aad08f", DefaultValue = "true", Memo = "用血申请审核完成后是否返回给HIS", SName = "HIS", DataType = "String" });
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 紧急用血是否在用血申请确认提交时上传HIS = new KeyValuePair<string, BaseClassDicEntity>("BL-ISTO-HISJ-0020", new BaseClassDicEntity() { Id = "BL-ISTO-HISJ-0020", Name = "紧急用血是否在用血申请确认提交时上传HIS", Code = "IsBUseTimeTypeIDAUToUHis", FontColor = "#ffffff", BGColor = "#aad08f", DefaultValue = "true", Memo = "紧急用血是否在用血申请确认提交时上传HIS", SName = "HIS", DataType = "String" });

        public static KeyValuePair<string, BaseClassDicEntity> 是否允许手工选择患者ABO及患者Rh = new KeyValuePair<string, BaseClassDicEntity>("BL-NULL-ISBH-0021", new BaseClassDicEntity() { Id = "BL-NULL-ISBH-0021", Name = "是否允许手工选择患者ABO及患者Rh", Code = "IsAllowPatabBOAndRHOPT", FontColor = "#ffffff", BGColor = "#aad08f", DefaultValue = "false", Memo = "是否允许手工选择患者ABO及患者Rh", SName = "医生站", DataType = "String" });
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 用血申请确认后是否自动完成审批 = new KeyValuePair<string, BaseClassDicEntity>("BL-BLCF-ISAC-0024", new BaseClassDicEntity() { Id = "BL-BLCF-ISAC-0024", Name = "用血申请确认后是否自动完成审批", Code = "ConfirmedIsAutoCompleted", FontColor = "#ffffff", BGColor = "#a4579d", DefaultValue = "false", Memo = "true:是;false:否;", SName = "医生站", DataType = "String" });
        ...
        public static Dictionary<string, BaseClassDicEntity> GetStatusDic()
        {
            ...
            dic.Add(SYSParaNo.用血申请确认后是否自动完成审批.Key, SYSParaNo.用血申请确认后是否自动完成审批.Value);
            return dic;
        }
    }
    /// <summary>
    ...
    {
        //输血记录项为病人体征输血记录项
        public static KeyValuePair<string, BaseClassDicEntity> 病人体征记录项 = new KeyValuePair<string, BaseClassDicEntity>("1", new BaseClassDicEntity() { Id = "1", Name = "病人体征记录项", Code = "TransfusionAntries", FontColor = "#ffffff", BGColor = "green" });
        ...
        {
            Dictionary<string, BaseClassDicEntity> dic = new Dictionary<string, BaseClassDicEntity>();
            dic.Add(ClassificationOfTransfusionContent.病人体征记录项.Key, ClassificationOfTransfusionContent.病人体征记录项.Value);
    ...
    /// 输血过程登记类型
    /// </summary>
    public static class BloodTransAddType
    {
        public static KeyValuePair<string, BaseClassDicEntity> 输血记录类型不区分 = new KeyValuePair<string, BaseClassDicEntity>("1", new BaseClassDicEntity() { Id = "1", Name = "输血记录类型不区分", Code = "All", FontColor = "#ffffff", BGColor = "#bfbfbf" });
        public static KeyValuePair<string, BaseClassDicEntity> 输血结束前 = new KeyValuePair<string, BaseClassDicEntity>("2", new BaseClassDicEntity() { Id = "2", Name = "输血结束前", Code = "Before", FontColor = "#ffffff", BGColor = "#f4c600" });
        public static KeyValuePair<string, BaseClassDicEntity> 输血结束 = new KeyValuePair<string, BaseClassDicEntity>("3", new BaseClassDicEntity() { Id = "3", Name = "输血结束", Code = "End", FontColor = "#ffffff", BGColor = "#f4c600" });
        public static Dictionary<string, BaseClassDicEntity> GetStatusDic()
        {
            Dictionary<string, BaseClassDicEntity> dic = new Dictionary<string, BaseClassDicEntity>();
            dic.Add(BloodTransAddType.输血记录类型不区分.Key, BloodTransAddType.输血记录类型不区分.Value);
            dic.Add(BloodTransAddType.输血结束前.Key, BloodTransAddType.输血结束前.Value);
            dic.Add(BloodTransAddType.输血结束.Key, BloodTransAddType.输血结束.Value);
            return dic;
        }
    }
}