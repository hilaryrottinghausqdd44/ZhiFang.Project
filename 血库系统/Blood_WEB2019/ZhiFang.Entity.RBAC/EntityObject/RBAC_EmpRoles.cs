...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class RBACEmpRoles : BaseEntityService
    {
        ...
        public RBACEmpRoles(long labID, bool isUse, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, string validity, PUser pUser, HREmployee hREmployee, RBACRole rBACRole)
        {
            this._labID = labID;
            this._isUse = isUse;
