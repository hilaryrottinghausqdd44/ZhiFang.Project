...
layui.extend({
	...
	var bdicttypeTable = {
		...
		config: {
			...
			/**基本查询服务URL*/
			selectUrl: uxutil.path.ROOT + "/SingleTableService.svc/ST_UDTO_SearchBDictTypeByHql?isPlanish=true",
			/**删除数据服务路径*/
			delUrl: uxutil.path.ROOT + "/SingleTableService.svc/ST_UDTO_DelBDictType",
			/**table查询服务URL*/
			url: "",
			where: "",
			//height: 'full-20',
