...
layui.extend({
	...
	var breqtypeForm = {
		config: {
			...
			selectFields: "",
			lastData: "",
			selectUrl: uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBReqTypeById?isPlanish=true",
			/**新增服务地址 BT_UDTO_AddBloodBReqTypeAndDtl */
			addUrl: uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_AddBloodBReqType",
			/**修改服务地址*/
			editUrl: uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodBReqTypeByField"
		}
	};
	//构造器
