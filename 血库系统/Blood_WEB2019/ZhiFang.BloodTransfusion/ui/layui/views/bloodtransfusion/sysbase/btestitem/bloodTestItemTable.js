layui.extend({
	...
	var BloodTestItemTable = function() {
			...
			//数据操作URL
			me.config.addUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_AddBloodBTestItem";
			me.config.editUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodBTestItemByField";
			me.config.delUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_DelBloodBTestItem";
			me.config.defLoadUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBTestItemByHQL?isPlanish=true";
			//初始化字段列，这样写更直观，更简单
