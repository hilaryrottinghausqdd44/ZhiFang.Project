layui.extend({
	...
	var bagoperation = {
    	...
    	bagopUrl: uxutil.path.ROOT + '/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBagHandoverVOById'
	};
    ...
    bagoperation.onSave =function(data, callback){
    	//提交url
    	var url = uxutil.path.ROOT + '/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodBagHandoverVO';
    	var entity = {};
    	//提交参数格式
