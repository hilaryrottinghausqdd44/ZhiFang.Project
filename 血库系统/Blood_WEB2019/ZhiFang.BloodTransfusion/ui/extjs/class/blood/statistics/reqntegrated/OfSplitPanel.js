 ...
 * @version 2020-03-19
 */
Ext.define('Shell.class.blood.statistics.reqntegrated.OfSplitPanel', {
	...
	createItems: function() {
		...
		//配血记录
		me.CroMatGrid = Ext.create('Shell.class.blood.statistics.reqntegrated.crossMatch.DtlGrid', {
			region: 'south',
			height: height1,
			header: true,
			border: false,
		...
		return [me.ReqDtlGrid, me.ReceiGrid, me.CroMatGrid, me.OutDtlGrid, me.TransRecordGrid,me.RecoverGrid, me.InDtlGrid];
	},
	...
	loadData: function(record) {
		...
		me.CroMatGrid.PK = reqFormId;
		me.CroMatGrid.bReqVO=me.getbReqVO(record);
		...
		me.ReceiGrid.onSearchByPatno(record.get("BloodBReqForm_PatNo"));
		me.CroMatGrid.onSearchByBReqFormID(record.get("BloodBReqForm_Id"));
