 ...
 * @version 2020-03-23
 */
Ext.define('Shell.class.blood.nursestation.transrecord.editbatch.App', {
	...
	createItems: function() {
		...
		//输血过程记录项信息
		me.TransPanel = Ext.create('Shell.class.blood.nursestation.transrecord.editbatch.TransPanel', {
			region: 'center',
			header: false,
			split: true,
			itemId: 'TransPanel',
		...
		//不良反应相关信息
		me.AdverseReactionsPanel = Ext.create("Shell.class.blood.nursestation.transrecord.editbatch.AdverseReactionsPanel", {
			region: 'east',
			width: width2,
			header: false,
			split: true,
