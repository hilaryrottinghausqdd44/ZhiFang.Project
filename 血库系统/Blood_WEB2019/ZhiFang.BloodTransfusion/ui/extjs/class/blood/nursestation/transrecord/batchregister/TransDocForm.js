 ...
 * @version 2020-03-23
 */
Ext.define('Shell.class.blood.nursestation.transrecord.batchregister.TransDocForm', {
	...
	outDtlRrecords: [],
	/**获取数据服务路径*/
	selectUrl: '/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodTransFormByOutDtlIdStr?isPlanish=true',
	...
	createItems: function() {
		...
		items.unshift({
			...
			fieldLabel: '姓名',
			name: 'BloodBOutForm_BloodBReqForm_CName',
			xtype: 'textfield',
			IsnotField: true,
			locked: true,
			readOnly: true
			...
			fieldLabel: '病历号',
			name: 'BloodBOutForm_BloodBReqForm_PatNo',
			xtype: 'textfield',
			IsnotField: true,
			locked: true,
			readOnly: true
			...
			fieldLabel: '就诊号',
			name: 'BloodBOutForm_BloodBReqForm_AdmID',
			xtype: 'textfield',
			IsnotField: true,
			locked: true,
			readOnly: true
			...
			fieldLabel: '床号',
			name: 'BloodBOutForm_BloodBReqForm_Bed',
			xtype: 'textfield',
			IsnotField: true,
			locked: true,
			readOnly: true
