 ...
 * @version 2020-02-25
 */
Ext.define('Shell.class.sysbase.transrecordtypeitem.choose.App', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.sysbase.transrecordtypeitem.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.sysbase.transrecordtypeitem.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
	...
	onSetLeftExternalWhere: function() {
		...
		if(arrIdStr && arrIdStr.length > 0) {
			externalWhere = "bloodtransrecordtypeitem.Id not in(" + arrIdStr.join(",") + ")";
		}
