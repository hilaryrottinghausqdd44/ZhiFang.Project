 ...
 * @version 2020-02-11
 */
Ext.define('Shell.class.sysbase.transrecordtypeitem.CheckGrid', {
	...
	initComponent: function() {
		...
		me.defaultWhere += 'bloodtransrecordtypeitem.IsVisible=1';
	...
	createGridColumns: function() {
		...
		var columns = [{
			...
			text: '编码',
			dataIndex: 'BloodTransRecordTypeItem_TransItemCode',
			width: 80,
			hidden: true,
			menuDisabled: true,
			defaultRenderer: true
