...
namespace ZhiFang.BloodTransfusion.ServerContract
{
    ...
    public interface IRBACService
    {
        ...
        [ServiceContractDescription(Name = "根据部门ID获取部门单列树(Department)", Desc = "根据部门ID获取部门单列树(Department)", Url = "RBACService.svc/RBAC_RJ_GetDepartmentFrameTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        ...
        [ServiceContractDescription(Name = "根据部门ID获取部门列表树(Department)", Desc = "根据部门ID获取部门列表树(Department)", Url = "RBACService.svc/RBAC_RJ_GetDepartmentFrameListTree?id={id}&fields={fields}", Get = "id={id}&fields={fields}", Post = "", Return = "BaseResultDataValue", ReturnType = "TreeDepartment")]
        ...
        [ServiceContractDescription(Name = "根据部门ID获取部门员工单列树(Department)", Desc = "根据部门ID获取部门员工单列树(Department)", Url = "RBACService.svc/RBAC_RJ_GetDepartmentEmployeeFrameTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
