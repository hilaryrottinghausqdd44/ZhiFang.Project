...
namespace ZhiFang.IBLL.BloodTransfusion
{
    ...
    public interface IBBloodTransItem : IBGenericManager<BloodTransItem>
    {
        ...
        IList<BloodTransRecordTypeItem> GetRecordTypeItemList(string contentTypeID);
        ...
        /// <param name="empID"></param>
        /// <param name="empName"></param>
        /// <param name="addType">输血登记方式:1:不区分输血结束前及输血结束的批量登记;2:输血结束前批量登记;3:输血结束批量登记(记录项结果值按本次提交进行覆盖更新)</param>
        /// <returns></returns>
        BaseResultDataValue EditBatchTransfusionAntriesByOutDtlList(BloodTransForm editTransForm, IList<BloodTransItem> transfusionAntriesList, long empID, string empName, string addType);
        /// <summary>
        ...
        /// <returns></returns>
        BaseResultDataValue EditBatchClinicalResultsByOutDtlListr(BloodTransForm editTransForm, BloodTransItem clinicalResults, long empID, string empName, string transAddType);
        ...
        /// <param name="transAddType">输血登记方式:1:不区分输血结束前及输血结束的批量登记;2:输血结束前批量登记;3:输血结束批量登记(记录项结果值按本次提交进行覆盖更新)</param>
        /// <returns></returns>
        BaseResultDataValue EditBatchClinicalResultsDescByOutDtlList(BloodTransForm editTransForm, BloodTransItem clinicalResultsDesc, long empID, string empName, string transAddType);
