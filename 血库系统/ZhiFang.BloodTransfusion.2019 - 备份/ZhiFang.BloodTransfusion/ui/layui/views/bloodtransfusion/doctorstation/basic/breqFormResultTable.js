...
layui.extend({
...
}).define(['layer', 'table', 'uxutil', 'dataadapter','cachedata',"bloodsconfig","soulTable"], function (exports) {
	"use strict";
	...
	var breqFormResultTable = {
		...
		config: {			
			...
			selectUrl: uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBReqFormResultEntityListByJoinHql?isPlanish=true",
			/**删除数据服务路径*/
