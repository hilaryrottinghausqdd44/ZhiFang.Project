layui.extend({
	...
	var BloodClassForm = function(){
		...
		me.urlConfig = {
			urlAdd: urlRoot + "/BloodTransfusionManageService.svc/BT_UDTO_AddBloodClass",
			urlEdit: urlRoot + "/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodClassByField",
			urlDel: urlRoot + "/BloodTransfusionManageService.svc/BT_UDTO_DelBloodClass",
			urlSel: urlRoot + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodClassByHQL?isPlanish=true",
			urlSelById: urlRoot + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodClassById?isPlanish=true"
		};
