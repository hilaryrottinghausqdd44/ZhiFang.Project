layui.extend({
	...
	EditForm.prototype.getSelectListBloodUnit = function(callback){
		...
		var selUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUnitByHQL?isPlanish=true&where=(bloodunit.Visible = 1)";
	...
	EditForm.prototype.getSelectListBloodClass = function(callback){
		var selData =  bloodSelectData;
		var selUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodClassByHQL?isPlanish=true&where=(bloodclass.Visible = 1)";
