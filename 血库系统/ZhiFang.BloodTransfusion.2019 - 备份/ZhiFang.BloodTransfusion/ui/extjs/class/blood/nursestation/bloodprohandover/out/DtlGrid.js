 ...
 * @version 2020-03-17
 */
Ext.define('Shell.class.blood.nursestation.bloodprohandover.out.DtlGrid', {
	...
	/**获取数据服务路径*/
	//selectUrl: '/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBOutItemAndBagOperDtlOfHandoverByHQL?isPlanish=true',
	/**只能获取到可配置的系统参数*/
	defaultWhere: "",
	/**默认加载*/
	defaultLoad: false,
	...
	/**用户UI配置Key*/
	userUIKey: 'bloodprohandover.out.DtlGrid',
	/**用户UI配置Name*/
	userUIName: "发血血袋信息",
	...
	createGridColumns: function() {
		...
		/* columns.push({
			text: '血袋外观',
			dataIndex: 'BloodBOutItem_BloodAppearance_BagOperResult',
			width: 90,
			menuDisabled: true,
			defaultRenderer: true
		}, {
			text: '血袋完整性',
			dataIndex: 'BloodBOutItem_BloodIntegrity_BagOperResult',
			width: 90,
			flex: 1,
			menuDisabled: true,
			defaultRenderer: true
