 ...
 * @version 2020-03-23
 */
Ext.define('Shell.class.blood.nursestation.transrecord.batchregister.AdverseReactionsPanel', {
	...
	createItems: function() {
		var me = this;
		//不良反应症状tab
		me.TabPanel = Ext.create("Shell.class.blood.nursestation.transrecord.batchregister.TabPanel", {
			region: 'center',
			header: false,
			//是否包含删除列
			hasDelCol: true,
	...
	onDelBatch: function(typeCode) {
		...
		switch (typeCode) {
			case "AdverseReactions":
				...
				delUrl = "/BloodTransfusionManageService.svc/BT_UDTO_DelBatchTransItemByAdverseReactions";
				break;
