...
Ext.define('Shell.class.sysbase.deptuser.Grid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/BloodTransfusionManageService.svc/BT_UDTO_SearchDepartmentUserByHQL?isPlanish=true',
	/**新增数据服务路径*/
	addUrl: '/BloodTransfusionManageService.svc/BT_UDTO_AddDepartmentUser',
	/**修改服务地址*/
	editUrl: '/BloodTransfusionManageService.svc/BT_UDTO_UpdateDepartmentUserByField',
	/**删除数据服务路径*/
	delUrl: '/BloodTransfusionManageService.svc/BT_UDTO_DelDepartmentUser',
