...
Ext.define('Shell.class.sysbase.bloodbtestitem.Form', {
	...
	/**获取数据服务路径*/
	selectUrl: '/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBTestItemById?isPlanish=true',
	/**新增服务地址*/
	addUrl: '/BloodTransfusionManageService.svc/BT_UDTO_AddBloodBTestItem',
	/**修改服务地址*/
	...
	createItems: function() {
		...
		var items = [{
			...
			{
				boxLabel: '为输血前评估项',
				name: 'BloodBTestItem_IsPreTrransfusionEvaluationItem',
				xtype: 'checkbox',
				checked: true
			}
		];
	...
	getAddParams: function() {
		...
		var entity = {
			...
			Visible: values.BloodBTestItem_Visible ? true : false,
			IsResultItem: values.BloodBTestItem_IsResultItem ? true : false,
			IsPreTrransfusionEvaluationItem: values.BloodBTestItem_IsPreTrransfusionEvaluationItem ? true : false
		};
