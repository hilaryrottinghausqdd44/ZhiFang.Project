...
{
    /// <summary>
    /// 质量指标分类类型图表数据处理-标本标签不合格率
    /// </summary>
    class OfSpecimenCollectionTimingErrorRate : QITypeOfEChartStrategy
    {
        public override BaseResultDataValue GetSAQualityIndicatorTypeOfEChart(IList<SPSAQualityIndicatorType> saList, string qIndicatorType, string sadimension)
        {
            ...
            {
                if (sadimension == SpecimenCollectionTimingErrorRate.就诊类型.Key)
                {
                    axisDataValue = vo.SickTypeCName;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.就诊类型采样人.Key)
                {
                    axisDataValue = vo.SickTypeCName + "_" + vo.Collecter;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.就诊类型样本类型.Key)
                {
                    axisDataValue = vo.SickTypeCName + "_" + vo.SampleTypeCName;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.就诊类型科室.Key)
                {
                    axisDataValue = vo.SickTypeCName + "_" + vo.DeptCName;
                }

                else if (sadimension == SpecimenCollectionTimingErrorRate.样本类型.Key)
                {
                    axisDataValue = vo.SampleTypeCName;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.样本类型科室.Key)
                {
                    axisDataValue = vo.SampleTypeCName + "_" + vo.DeptCName;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.样本类型采样人.Key)
                {
                    axisDataValue = vo.SampleTypeCName + "_" + vo.Collecter;
                }

                else if (sadimension == SpecimenCollectionTimingErrorRate.科室.Key)
                {
                    axisDataValue = vo.DeptCName;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.科室样本类型.Key)
                {
                    axisDataValue = vo.DeptCName + "_" + vo.SampleTypeCName;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.科室采样人.Key)
                {
                    axisDataValue = vo.DeptCName + "_" + vo.Collecter;
                }


                else if (sadimension == SpecimenCollectionTimingErrorRate.采样人.Key)
                {
                    axisDataValue = vo.Collecter;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.按年份.Key)
                {
                    axisDataValue = vo.Year;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.按季度.Key)
                {
                    axisDataValue = vo.Quarter;
                }
                else if (sadimension == SpecimenCollectionTimingErrorRate.按月份.Key)
                {
