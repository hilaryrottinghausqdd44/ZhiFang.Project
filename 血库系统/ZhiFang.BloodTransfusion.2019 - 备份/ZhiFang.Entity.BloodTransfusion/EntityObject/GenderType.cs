...
namespace ZhiFang.Entity.BloodTransfusion
{
	...
	public class GenderType : BaseEntityService
    {
		...
		public GenderType( string cName, string shortCode, int visible, int dispOrder, string hisOrderCode, string code1, string code2, string code3, string code4, string code5, string code6, string code7, string code8, string code9, string code10 )
		{
			this._cName = cName;
