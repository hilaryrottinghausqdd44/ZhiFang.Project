...
namespace ZhiFang.Entity.BloodTransfusion
{
	...
	/// <summary>
	/// WardType object for NHibernate mapped table 'WardType'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "WardType", ShortCode = "WardType", Desc = "")]
	public class WardType : BaseEntity
	{
		...
		public WardType( string cName, string shortName, string shortCode, int visible, int dispOrder, string hisOrderCode, string code1, string code2, string code3, string code4, string code5, string urgentState, string patState, string code6, string code7, string code8, string code9, string code10 )
		{
			this._cName = cName;
