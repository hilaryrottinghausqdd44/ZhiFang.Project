...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class BlooddocGrade : BaseEntity// BaseEntityServiceByString
    {
        ...
        public BlooddocGrade(string gradeName, double? bCount, int dispOrder, long labID, DateTime dataAddTime, byte[] dataTimeStamp)
        {
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "", ShortCode = "BCount", Desc = "", ContextType = SysDic.All)]
