...
layui.extend({
	...
	var bloodsconfig = {
		...
		Common: {
			...
			HISCALL_URL: "/ServerWCF/BloodTransfusionManageService.svc/BT_SYS_GetSysCurDoctorInfoByHisCode",
			//按PUser的帐号及密码登录
			LOGINOFPUSER_URL: "/ServerWCF/BloodTransfusionManageService.svc/BT_SYS_LoginOfPUser",
			//按HIS医生对照码获取PUser的帐号及密码登录
			LOGINOFPUSERBYHISCODE_URL: "/ServerWCF/BloodTransfusionManageService.svc/BT_SYS_LoginOfPUserByHisCode",
			//PUser用户注销服务
			LOGOUTOFPUSER_URL: "/ServerWCF/BloodTransfusionManageService.svc/BT_SYS_LogoutOfPUser",
			//数据库手工升级服务
			DBUPDATE_URL: "/ServerWCF/BloodTransfusionManageService.svc/BT_SYS_DBUpdate",
			//用血申请PDF存放路径
