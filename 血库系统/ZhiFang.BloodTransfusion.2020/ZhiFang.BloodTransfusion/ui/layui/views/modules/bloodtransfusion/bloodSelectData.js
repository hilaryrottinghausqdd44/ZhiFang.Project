	...
	var bloodSelectData = {
		...
		dictList: {
			...
			Department: function(callback) {
				var me = this;
				var html = "";
				var selectUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchDepartmentByHQL?isPlanish=true";
			...
			BlooddocGrade: function(callback) {
				...
				var selectUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBlooddocGradeByHQL?isPlanish=true";
			...
			Doctor: function(callback) {
				var me = this;
				var html = "";
				var selectUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchDoctorByHQL?isPlanish=true";//&page=1&start=0&limit=10000
			...
			BloodBReqType: function(callback) {
				...
				var selectUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBReqTypeByHQL?isPlanish=true";
			...
			BloodUseType: function(callback) {
				var me = this;
				var html = "";//&page=1&start=0&limit=10000
				var selectUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUseTypeByHQL?isPlanish=true";
			...
			WardType: function(callback) {
				var me = this;
				var html = "";//&page=1&start=0&limit=10000
				var selectUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchWardTypeByHQL?isPlanish=true";
