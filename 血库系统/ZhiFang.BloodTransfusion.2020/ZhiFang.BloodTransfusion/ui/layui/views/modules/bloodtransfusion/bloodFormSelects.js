		...
		formSelectsConfig: {
			...
			Department: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchDepartmentByHQL?isPlanish=true&fields=Department_Id,Department_CName&page=1&start=0&limit=10000",
			...
			BlooddocGrade: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchDoctorByHQL?isPlanish=true&fields=BlooddocGrade_Id,BlooddocGrade_CName&page=1&start=0&limit=1000",
					beforeSuccess: function (id, url, searchVal, result) {
						return dataadapter.toList(result);
					},
					response: dataadapter.toResponse()
			...
			Doctor: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchDoctorByHQL?isPlanish=true&fields=Doctor_Id,Doctor_CName",
					beforeSuccess: function (id, url, searchVal, result) {
						return dataadapter.toList(result);
					},
					response: dataadapter.toResponse()
			...
			BloodBReqType: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBReqTypeByHQL?isPlanish=true&fields=BloodBReqType_Id,BloodBReqType_CName",
					beforeSuccess: function (id, url, searchVal, result) {
						return dataadapter.toList(result);
					},
					response: dataadapter.toResponse()
			...
			BloodUseType: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUseTypeByHQL?isPlanish=true&fields=BloodUseType_Id,BloodUseType_CName",
					beforeSuccess: function (id, url, searchVal, result) {
						return dataadapter.toList(result);
					},
					response: dataadapter.toResponse()
			...
			BloodUnit: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUnitByHQL?isPlanish=true&fields=BloodUnit_CName,BloodUnit_Id",
					beforeSuccess: function (id, url, searchVal, result) {
						return dataadapter.toList(result);
					},
					response: dataadapter.toResponse()
			...
			BloodClass: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodClassByHQL?isPlanish=true&fields=BloodClass_Id,BloodClass_CName",
					beforeSuccess: function (id, url, searchVal, result) {
						return dataadapter.toList(result);
					},
					response: dataadapter.toResponse()
			...
			Bloodstyle: function (options) {
				var config = {
					...
					selectUrl: "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodstyleByHQL?isPlanish=true&fields=Bloodstyle_Id,Bloodstyle_CName",
					beforeSuccess: function (id, url, searchVal, result) {
						return dataadapter.toList(result);
					},
					response: dataadapter.toResponse()
