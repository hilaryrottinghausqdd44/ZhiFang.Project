...
layui.extend({
	...
	var bloodbreqtypeTable = {
		...
		config: {
			...
			/**基本查询服务URL*/
			selectUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBReqTypeByHql?isPlanish=true",
			/**删除数据服务路径*/
			delUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBloodBReqType",
			/**table查询服务URL*/
			url: "",
			where:"",
			page: false,
