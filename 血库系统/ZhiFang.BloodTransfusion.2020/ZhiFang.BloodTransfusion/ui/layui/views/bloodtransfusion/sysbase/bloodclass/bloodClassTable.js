layui.extend({
	...
	var BloodClassTable = function(){
		...
		//数据操作URL
		me.config.addUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_AddBloodClass";
		me.config.editUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodClassByField";
		me.config.delUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBloodClass";
		me.config.defLoadUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodClassByHQL?isPlanish=true";
		//初始化字段列，这样写更直观，更简单
