...
layui.extend({
	...
	var bdictTable = {
		...
		config: {
			...
			/**基本查询服务URL*/
			selectUrl: uxutil.path.ROOT + "/ServerWCF/SingleTableService.svc/ST_UDTO_SearchBDictByHql?isPlanish=true",
			/**删除数据服务路径*/
			delUrl: uxutil.path.ROOT + "/ServerWCF/SingleTableService.svc/ST_UDTO_DelBDict",
			/**table查询服务URL*/
			url: "",
			where: "",
			//height: 'full-20',
