...
layui.extend({
	...
	var bdicttypeForm = {
		config: {
			...
			selectFields: "",
			lastData: "",
			selectUrl: uxutil.path.ROOT + "/ServerWCF/SingleTableService.svc/ST_UDTO_SearchBDictTypeById?isPlanish=true",
			/**新增服务地址 BT_UDTO_AddBDictTypeAndDtl */
			addUrl: uxutil.path.ROOT + "/ServerWCF/SingleTableService.svc/ST_UDTO_AddBDictType",
			/**修改服务地址*/
			editUrl: uxutil.path.ROOT + "/ServerWCF/SingleTableService.svc/ST_UDTO_UpdateBDictTypeByField"
		}
	};
	//构造器
