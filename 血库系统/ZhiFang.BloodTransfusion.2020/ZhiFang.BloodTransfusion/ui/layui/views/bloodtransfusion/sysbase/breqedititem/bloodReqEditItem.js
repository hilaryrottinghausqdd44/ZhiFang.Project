layui.extend(
	...
	"use strict";
  	var $ = layui.$,
        ...
        addurl= uxutil.path.ROOT +"/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_AddBloodBReqEditItem",
        editurl= uxutil.path.ROOT +"/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodBReqEditItemByField";
    ...
    var fieldConfig = {
		...
		url: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBReqEditItemByHQL?isPlanish=true",
		cols: [
				[{
					type: 'numbers',
					sort: true,
