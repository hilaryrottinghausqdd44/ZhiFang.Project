layui.extend({
	...
	var BloodStyleTable = function(){
		...
		//数据操作URL
		me.config.addUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_AddBloodstyle";
		me.config.editUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodstyleByField";
		me.config.delUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBloodstyle";
		me.config.defLoadUrl = uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodstyleByHQL?isPlanish=true";
		//初始化字段列，这样写更直观，更简单
