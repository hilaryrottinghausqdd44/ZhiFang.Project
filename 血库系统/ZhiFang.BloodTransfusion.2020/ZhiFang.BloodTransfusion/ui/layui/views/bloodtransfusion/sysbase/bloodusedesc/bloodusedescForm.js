...
layui.extend({
	...
	var bloodusedescForm = {
		config: {
			...
			selectFields: "",
			lastData: "",
			selectUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUseDescById?isPlanish=true",
			/**新增服务地址 BT_UDTO_AddBloodUseDescAndDtl */
			addUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_AddBloodUseDesc",
			/**修改服务地址*/
			editUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodUseDescByField"
		}
	};
	//构造器
