...
layui.extend({
	...
	var chooseBloodstyleTable = {
		...
		config: {
			...
			selectUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodstyleEntityListByJoinHql?isPlanish=true",
			/**删除数据服务路径*/
			delUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBloodstyle",
			/**table查询服务URL*/
			url: "",
			where: "",
			page: true,
