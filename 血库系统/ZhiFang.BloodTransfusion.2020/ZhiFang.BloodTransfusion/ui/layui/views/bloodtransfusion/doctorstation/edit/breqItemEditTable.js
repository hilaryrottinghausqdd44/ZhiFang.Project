...
layui.extend({
	...
	var breqItemEditTable = {
		...
		config: {
			...
			selectUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBReqItemEntityListByJoinHql?isPlanish=true",
			/**删除数据服务路径*/
			delUrl: uxutil.path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBloodBreqItem",
			/**table查询服务URL*/
			url: "",
			where: "",
			page: false,
