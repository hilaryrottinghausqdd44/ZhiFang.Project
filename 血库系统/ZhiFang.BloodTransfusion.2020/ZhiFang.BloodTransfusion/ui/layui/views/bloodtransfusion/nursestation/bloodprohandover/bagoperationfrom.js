layui.extend({
	...
	var bagoperationfrom = {
		urlConfig: {
        	addbagopUrl: uxutil.path.ROOT + '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_AddBloodBagOperationAndDtlOfHandover',
        	selEmpUrl: uxutil.path.ROOT + '/ServerWCF/BloodTransfusionManageService.svc/RS_UDTO_SearchHREmployeeOFLIMPByHQL',
        	selPuserUrl: uxutil.path.ROOT + '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchPUserByHQL'
		},
		fdConfig:{
