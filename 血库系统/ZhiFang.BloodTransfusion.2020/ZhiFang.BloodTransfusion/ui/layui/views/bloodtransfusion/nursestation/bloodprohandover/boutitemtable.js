	...
	var boutitemtableProxy = {
		    ...
		    cacheScandata:{},
   	        config: {
    			...
    			selectUrlByOutformId: uxutil.path.ROOT + '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBOutItemAndBagOperDtlOfHandoverByHQL?isPlanish=true',
			    selectUrlByBagCode: uxutil.path.ROOT + '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBOutItemOfHandoverByBBagCodeHQL?isPlanish=true'
		    }			
	};
