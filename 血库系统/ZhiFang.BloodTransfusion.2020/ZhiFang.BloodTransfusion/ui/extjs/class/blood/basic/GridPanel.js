...
Ext.define('Shell.class.blood.basic.GridPanel', {
	...
	userUIName: null,
	/**新增列表UI配置服务地址*/
	addUIUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_AddBUserUIConfig',
	/**修改列表UI配置服务地址*/
	editUIUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_UpdateBUserUIConfigByField',
	/**删除列表UI配置服务地址*/
	delUIUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBUserUIConfig',
