 ...
 * @version 2018-08-21
 */
Ext.define('Shell.class.blood.template.CheckGrid', {
	...
	publicTemplateDir: "",
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBTemplateByLabIdAndType',
	...
	getLoadUrl: function() {
		...
		url += (url.indexOf('?') == -1 ? '?' : '&') + "labId=" + labId + "&breportType=" + me.breportType +
			"&publicTemplateDir=" + JShell.String.encode(me.publicTemplateDir);
		return url;
	}
});
