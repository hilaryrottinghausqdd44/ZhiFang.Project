...
Ext.define('Shell.class.blood.template.Grid', {
	...
	height: 500,
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBTemplateByHQL?isPlanish=true',
	/**删除数据服务路径*/
	delUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBTemplate',
	/**修改服务地址*/
	editUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_UpdateBTemplateByField',
	/**下载模板文件地址*/
	downLoadUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DownLoadTemplateFrx',
	/**默认加载数据*/
	defaultLoad: true,
	/**模板信息类型Key*/
