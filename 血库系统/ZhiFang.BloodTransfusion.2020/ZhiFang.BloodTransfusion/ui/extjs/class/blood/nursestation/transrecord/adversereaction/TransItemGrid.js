/**
 * 输血过程记录:输血过程记录项列表(不良反应症状)
 * @author longfc
 * @version 2020-02-21
 */
Ext.define('Shell.class.blood.nursestation.transrecord.adversereaction.TransItemGrid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodTransItemByHQL?isPlanish=true',
	delUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelBloodTransItem',
	/**默认查询条件:不良反应选择项*/
