 ...
 * @version 2020-03-23
 */
Ext.define('Shell.class.blood.nursestation.transrecord.editbatch.TransDtlForm', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchPatientSignsByOutDtlIdStr?isPlanish=true',
