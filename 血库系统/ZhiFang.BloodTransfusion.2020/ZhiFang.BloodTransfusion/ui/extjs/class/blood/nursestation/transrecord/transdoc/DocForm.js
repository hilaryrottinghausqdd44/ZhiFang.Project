...
Ext.define('Shell.class.blood.nursestation.transrecord.transdoc.DocForm', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodTransFormById?isPlanish=true',
	...
	onGetRBACUser: function(field, type1) {
		...
		if (fieldVal) {
			...
			var url = JShell.System.Path.ROOT +
				"/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchRBACUserByFieldKey?isPlanish=true";
