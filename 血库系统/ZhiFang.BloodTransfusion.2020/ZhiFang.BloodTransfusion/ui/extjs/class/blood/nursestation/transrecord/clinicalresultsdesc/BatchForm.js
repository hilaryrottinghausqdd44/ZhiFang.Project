/**
 * 输血过程记录:批量修改--临床处理结果描述
 * @author longfc
 * @version 2020-02-21
 */
Ext.define('Shell.class.blood.nursestation.transrecord.clinicalresultsdesc.BatchForm', {
	extend: 'Shell.class.blood.nursestation.transrecord.clinicalresultsdesc.Form',
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchClinicalResultsDescByOutDtlIdStr?isPlanish=true',
	...
	setItemLabel: function(batchSign) {
		var me = this;
		var item1 =me.getComponent("BloodTransItem_TransItemResult");
		var bColor = "";
		if (item1 && batchSign) {
			switch (batchSign) {
				case "1":
