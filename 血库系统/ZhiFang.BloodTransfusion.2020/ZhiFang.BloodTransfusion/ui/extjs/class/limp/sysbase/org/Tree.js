 ...
 * @version 2020-03-04
 */
Ext.define('Shell.class.limp.sysbase.org.Tree',{
	...
	/**获取数据服务路径*/
	selectUrl:'/ServerWCF/BloodTransfusionManageService.svc/RBAC_RJ_GetHRDeptFrameListTree?fields=HRDept_Id,HRDept_DataTimeStamp,HRDept_UseCode',
	/**默认加载数据*/
	defaultLoad:true,
	/**根节点*/
	root:{
