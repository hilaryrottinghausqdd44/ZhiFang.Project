 ...
 * @version 2020-08-10
 */
Ext.define('Shell.class.sysbase.setqtyalertinfo.choose.App', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.sysbase.setqtyalertinfo.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.sysbase.setqtyalertinfo.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
	...
	onSetLeftExternalWhere: function() {
		...
		//bloodsetqtyalertinfo
		if(arrIdStr && arrIdStr.length > 0) {
			externalWhere = "bloodstyle.Id not in(" + arrIdStr.join(",") + ")";
		}
