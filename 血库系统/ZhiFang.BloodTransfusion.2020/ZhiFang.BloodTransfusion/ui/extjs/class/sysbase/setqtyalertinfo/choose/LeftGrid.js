 ...
 * @version 2020-08-11
 */
Ext.define('Shell.class.sysbase.setqtyalertinfo.choose.LeftGrid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodStyleBySetQtyAlertInfoHQL?isPlanish=true',
	/**排序字段*/
	defaultOrderBy: [{
	...
	/**用户UI配置Key*/
	userUIKey: 'setqtyalertinfo.choose.LeftGrid',
	/**用户UI配置Name*/
	userUIName: "待选列表",
	/**关系表查询条件*/
	linkWhere: "",
