...
Ext.define('Shell.class.sysbase.module.Grid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl: '/ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACModuleByField',
	/**删除数据服务路径*/
	delUrl: '/ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACModule',
	...
	createGridColumns: function() {
		...
		var columns = [{
			...
			text: '次序',
			dataIndex: 'RBACModule_DispOrder',
			width: 40,
			sortable: false,
			menuDisabled: true,
			defaultRenderer: true,
			...
			text: '标准代码',
			dataIndex: 'RBACModule_StandCode',
			width: 100,
			sortable: false,
			menuDisabled: true,
			defaultRenderer: true
