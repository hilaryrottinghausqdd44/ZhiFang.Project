...
Ext.define('Shell.class.sysbase.department.Grid', {
	...
	/**修改服务地址*/
	editUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_UpdateDepartmentByField',
	/**删除数据服务路径*/
	delUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_DelDepartment',
	...
	onSync: function(type1) {
		var me = this;
		var url = JShell.System.Path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SyncDeptListToLIMP";
		var params = Ext.JSON.encode({
			syncType: type1
		});
		setTimeout(function() {
	...
	onSyncWarpAndDept: function(id) {
		var me = this;
		var url = JShell.System.Path.ROOT + "/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_AddWarpAndDept";
		setTimeout(function() {
