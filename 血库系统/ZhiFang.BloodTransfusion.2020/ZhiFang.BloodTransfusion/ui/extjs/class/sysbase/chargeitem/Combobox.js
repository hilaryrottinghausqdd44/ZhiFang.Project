 ...
 * @version 2020-07-07
 */
Ext.define('Shell.class.sysbase.chargeitem.Combobox',{
	 ...
	 */
	defaultOrderBy: [{property:'BloodChargeItem_DispOrder',direction:'ASC'}],
	...
	getStoreFields:function(){
		return [
			{name:'BloodChargeItem_CName',type:'auto'},
			{name:'BloodChargeItem_Id',type:'auto'},
			{name:'BloodChargeItem_DispOrder',type:'int'}
		];
	},
