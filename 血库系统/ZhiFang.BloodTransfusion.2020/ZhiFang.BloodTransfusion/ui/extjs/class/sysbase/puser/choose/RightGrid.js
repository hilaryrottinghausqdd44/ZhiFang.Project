 ...
 * @version 2020-03-26
 */
Ext.define('Shell.class.sysbase.puser.choose.RightGrid', {
	...
	/**获取数据服务路径/ServerWCF/BloodTransfusionManageService.svc/ST_UDTO_SearchReaGoodsOrgLinkByHQL?isPlanish=true*/
	selectUrl: '',
	/**排序字段*/
	defaultOrderBy: [{
	...
	defaultPageSize: 500,
	/**用户UI配置Key*/
	userUIKey: 'puser.choose.RightGrid',
	/**用户UI配置Name*/
	userUIName: "当前已选择列表",
