 ...
 * @version 2020-03-26
 */
Ext.define('Shell.class.sysbase.puser.CheckGrid', {
	...
	/**根据部门ID获取数据服务路径*/
	selectUrl2: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchPUserByHQL?isPlanish=true',
	...
	initComponent: function() {
		...
		me.defaultWhere += 'puser.Visible=1';
		...
		me.searchInfo = {
			...
			isLike: true,
			fields: ['puser.Id', 'puser.CName', 'puser.Code1']
		};
