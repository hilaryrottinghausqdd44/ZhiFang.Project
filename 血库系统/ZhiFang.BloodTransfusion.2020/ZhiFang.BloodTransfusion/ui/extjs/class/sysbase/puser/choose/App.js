 ...
 * @version 2020-03-26
 */
Ext.define('Shell.class.sysbase.puser.choose.App', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.sysbase.puser.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.sysbase.puser.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
	...
	onSetLeftExternalWhere: function() {
		...
		if(arrIdStr && arrIdStr.length > 0) {
			externalWhere = "puser.Id not in(" + arrIdStr.join(",") + ")";
		}
