 ...
 * @version 2020-07-08
 */
Ext.define('Shell.class.sysbase.chargegroupitem.choose.LeftGrid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodChargeItemByChargeGItemHQL?isPlanish=true',
	/**排序字段*/
	defaultOrderBy: [{
