 ...
 * @version 2020-07-08
 */
Ext.define('Shell.class.sysbase.chargegroupitem.choose.App', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.sysbase.chargegroupitem.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.sysbase.chargegroupitem.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
	...
	onSetLeftExternalWhere: function() {
		...
		if(arrIdStr && arrIdStr.length > 0) {
			externalWhere = "bloodchargeitem.Id not in(" + arrIdStr.join(",") + ")";
		}
