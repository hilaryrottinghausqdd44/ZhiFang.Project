 ...
 * @version 2020-08-18
 */
Ext.define('Shell.class.sysbase.classunitlink.choose.App', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.sysbase.classunitlink.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.sysbase.classunitlink.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
	...
	onSetLeftExternalWhere: function() {
		...
		if(arrIdStr && arrIdStr.length > 0) {
			externalWhere = "BloodUnit.Id not in(" + arrIdStr.join(",") + ")";
		}
