 ...
 * @version 2020-08-18
 */
Ext.define('Shell.class.sysbase.classunitlink.choose.LeftGrid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUnitByClassUnitLinkHQL?isPlanish=true',
	/**排序字段*/
	defaultOrderBy: [{
	...
	/**用户UI配置Key*/
	userUIKey: 'classunitlink.choose.LeftGrid',
	/**用户UI配置Name*/
	userUIName: "血液单位换算待选列表",
	/**关系表查询条件*/
	linkWhere: "",
