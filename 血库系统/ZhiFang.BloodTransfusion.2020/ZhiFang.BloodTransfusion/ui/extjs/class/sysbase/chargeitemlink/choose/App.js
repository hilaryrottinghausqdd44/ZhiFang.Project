 ...
 * @version 2020-07-08
 */
Ext.define('Shell.class.sysbase.chargeitemlink.choose.App', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.sysbase.chargeitemlink.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.sysbase.chargeitemlink.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
