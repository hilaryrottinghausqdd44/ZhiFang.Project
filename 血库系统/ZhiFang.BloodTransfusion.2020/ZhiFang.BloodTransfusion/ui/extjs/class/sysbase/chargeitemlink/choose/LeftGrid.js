 ...
 * @version 2020-07-08
 */
Ext.define('Shell.class.sysbase.chargeitemlink.choose.LeftGrid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodChargeItemByChargeItemLinkHQL?isPlanish=true',
	/**排序字段*/
	defaultOrderBy: [{
	...
	/**用户UI配置Key*/
	userUIKey: 'chargegroupitem.choose.LeftGrid',
	/**用户UI配置Name*/
	userUIName: "费用项目待选列表",
	...
	createGridColumns: function() {
		...
		var columns = [{
			...
			text: '简称',
			dataIndex: 'BloodChargeItem_SName',
			width: 60,
			hidden:true,
			menuDisabled: true,
			defaultRenderer: true
