...
namespace ZhiFang.IBLL.RBAC
{
    ...
    ///
    /// </summary>
    public interface IBDepartment : IBGenericManager<Department>
    {
        /// <summary>
        /// 获取6.6数据库的科室同步信息
        /// </summary>
        ...
        BaseResultTree SearchDepartmentTree(long longDepartmentID);
        /// <summary>
        /// 根据部门ID查询列表树
        /// </summary>
        /// <param name="longDepartmentID">部门ID</param>
        /// 部门ID等于0时 查询所有部门
        /// <returns>BaseResultTree</returns>
        BaseResultTree<Department> SearchDepartmentListTree(long longDepartmentID);

        BaseResultTree GetDepartmentEmployeeFrameTree(long strDepartmentID);
        ...
        /// <returns></returns>
        IList<Department> SearchDepartmentListByDepartmentId(long deptId);
        ...
        /// <param name="deptId"></param>
        /// <returns></returns>
        string SearchDepIdStrByDeptId(long deptId);

        IList<Department> GetChildList(long ParentID);
