...
namespace ZhiFang.BLL.BloodTransfusion.InterfaceMapingStrategy
{
    ...
    ///业务接口对照关系信息-BDict
    /// </summary>
    class OfBDictMaping : DimensionStrategy<BDict>
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<BDict> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
