...
namespace ZhiFang.BLL.BloodTransfusion.InterfaceMapingStrategy
{
    ...
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<Department> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
