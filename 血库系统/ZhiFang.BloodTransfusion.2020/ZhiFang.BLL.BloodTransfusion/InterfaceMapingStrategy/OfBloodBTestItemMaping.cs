...
{
    /// <summary>
    ///业务接口对照关系信息-BloodBTestItem
    /// </summary>
    class OfBloodBTestItemMaping : DimensionStrategy<BloodBTestItem>
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<BloodBTestItem> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
