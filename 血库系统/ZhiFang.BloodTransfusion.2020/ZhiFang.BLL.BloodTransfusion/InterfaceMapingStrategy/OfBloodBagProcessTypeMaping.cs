...
{
    /// <summary>
    ///业务接口对照关系信息-BloodBagProcessType
    /// </summary>
    class OfBloodBagProcessTypeMaping : DimensionStrategy<BloodBagProcessType>
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<BloodBagProcessType> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
