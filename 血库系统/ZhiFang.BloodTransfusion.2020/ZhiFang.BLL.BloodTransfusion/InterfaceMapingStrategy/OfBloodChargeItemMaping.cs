...
{
    /// <summary>
    ///业务接口对照关系信息-BloodChargeItem
    /// </summary>
    class OfBloodChargeItemMaping : DimensionStrategy<BloodChargeItem>
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<BloodChargeItem> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
