...
namespace ZhiFang.BLL.BloodTransfusion.InterfaceMapingStrategy
{
    ...
    ///业务接口对照关系信息-BloodABO
    /// </summary>
    class OfBloodABOMaping : DimensionStrategy<BloodABO>
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<BloodABO> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
