...
{
    /// <summary>
    ///业务接口对照关系信息-BloodStyle
    /// </summary>
    class OfBloodStyleMaping : DimensionStrategy<BloodStyle>
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<BloodStyle> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
