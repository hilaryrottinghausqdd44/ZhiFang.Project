...
{
    /// <summary>
    ///业务接口对照关系信息-BloodUnit
    /// </summary>
    class OfBloodUnitMaping : DimensionStrategy<BloodUnit>
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<BloodUnit> deveList, IList<BloodInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
