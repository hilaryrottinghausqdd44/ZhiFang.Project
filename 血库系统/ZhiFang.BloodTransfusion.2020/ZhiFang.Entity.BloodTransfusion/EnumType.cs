...
namespace ZhiFang.Entity.BloodTransfusion
{
    ...
    public static class UpdateOperationType
    {
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 临床处理结果记录项 = new KeyValuePair<string, BaseClassDicEntity>("6", new BaseClassDicEntity() { Id = "6", Name = "临床处理结果记录项", Code = "ClinicalResults", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 临床处理结果描述记录项 = new KeyValuePair<string, BaseClassDicEntity>("7", new BaseClassDicEntity() { Id = "7", Name = "临床处理结果描述记录项", Code = "ClinicalResultsDesc", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 公共字典记录 = new KeyValuePair<string, BaseClassDicEntity>("8", new BaseClassDicEntity() { Id = "8", Name = "公共字典记录", Code = "BDict", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 血制品记录 = new KeyValuePair<string, BaseClassDicEntity>("9", new BaseClassDicEntity() { Id = "9", Name = "血制品记录", Code = "BloodStyle", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 检验项目记录 = new KeyValuePair<string, BaseClassDicEntity>("10", new BaseClassDicEntity() { Id = "10", Name = "检验项目记录", Code = "BloodBTestItem", FontColor = "#ffffff", BGColor = "#1c8f36" });

        public static KeyValuePair<string, BaseClassDicEntity> 血型ABO记录 = new KeyValuePair<string, BaseClassDicEntity>("11", new BaseClassDicEntity() { Id = "11", Name = "血型ABO记录", Code = "BloodABO", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 费用项目记录 = new KeyValuePair<string, BaseClassDicEntity>("12", new BaseClassDicEntity() { Id = "12", Name = "费用项目记录", Code = "BloodChargeItem", FontColor = "#ffffff", BGColor = "#1c8f36" });
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 加工类型记录 = new KeyValuePair<string, BaseClassDicEntity>("14", new BaseClassDicEntity() { Id = "14", Name = "加工类型记录", Code = "BloodBagProcessType", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 费用项目类型描述 = new KeyValuePair<string, BaseClassDicEntity>("15", new BaseClassDicEntity() { Id = "15", Name = "费用项目类型描述", Code = "BloodChargeItemType", FontColor = "#ffffff", BGColor = "#1c8f36" });

        public static KeyValuePair<string, BaseClassDicEntity> 血袋记录类型 = new KeyValuePair<string, BaseClassDicEntity>("16", new BaseClassDicEntity() { Id = "16", Name = "血袋记录类型", Code = "BloodBagRecordType", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 血袋记录项字典 = new KeyValuePair<string, BaseClassDicEntity>("17", new BaseClassDicEntity() { Id = "17", Name = "血袋记录项字典", Code = "BloodBagRecordItem", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 血制品单位 = new KeyValuePair<string, BaseClassDicEntity>("18", new BaseClassDicEntity() { Id = "18", Name = "血制品单位", Code = "BloodChargeItemType", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 凝集规则明细字典 = new KeyValuePair<string, BaseClassDicEntity>("19", new BaseClassDicEntity() { Id = "19", Name = "凝集规则明细字典", Code = "BloodAggluItem", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 收费类型费用项目关系 = new KeyValuePair<string, BaseClassDicEntity>("20", new BaseClassDicEntity() { Id = "20", Name = "收费类型费用项目关系", Code = "BloodChargeItemLink", FontColor = "#ffffff", BGColor = "#1c8f36" });

        public static KeyValuePair<string, BaseClassDicEntity> 血制品分类记录 = new KeyValuePair<string, BaseClassDicEntity>("21", new BaseClassDicEntity() { Id = "21", Name = "血制品分类记录", Code = "BloodClass", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 血制品分类单位换算 = new KeyValuePair<string, BaseClassDicEntity>("22", new BaseClassDicEntity() { Id = "22", Name = "血制品分类单位换算", Code = "BloodClassUnitLink", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static KeyValuePair<string, BaseClassDicEntity> 血袋费用项目关系 = new KeyValuePair<string, BaseClassDicEntity>("23", new BaseClassDicEntity() { Id = "23", Name = "血袋费用项目关系", Code = "BloodBagChargeLink", FontColor = "#ffffff", BGColor = "#1c8f36" });

        public static KeyValuePair<string, BaseClassDicEntity> 血制品加工类型关系 = new KeyValuePair<string, BaseClassDicEntity>("24", new BaseClassDicEntity() { Id = "24", Name = "血制品加工类型关系", Code = "BloodBagProcessTypeQry", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static Dictionary<string, BaseClassDicEntity> GetStatusDic()
        {
            Dictionary<string, BaseClassDicEntity> dic = new Dictionary<string, BaseClassDicEntity>();
            ...
            dic.Add(UpdateOperationType.公共字典记录.Key, UpdateOperationType.公共字典记录.Value);
            dic.Add(UpdateOperationType.血制品记录.Key, UpdateOperationType.血制品记录.Value);
            dic.Add(UpdateOperationType.检验项目记录.Key, UpdateOperationType.检验项目记录.Value);

            dic.Add(UpdateOperationType.血型ABO记录.Key, UpdateOperationType.血型ABO记录.Value);
            dic.Add(UpdateOperationType.费用项目记录.Key, UpdateOperationType.费用项目记录.Value);
            dic.Add(UpdateOperationType.字典对照记录.Key, UpdateOperationType.字典对照记录.Value);
            dic.Add(UpdateOperationType.加工类型记录.Key, UpdateOperationType.加工类型记录.Value);
            dic.Add(UpdateOperationType.费用项目类型描述.Key, UpdateOperationType.费用项目类型描述.Value);

            dic.Add(UpdateOperationType.血袋记录类型.Key, UpdateOperationType.血袋记录类型.Value);
            dic.Add(UpdateOperationType.血袋记录项字典.Key, UpdateOperationType.血袋记录项字典.Value);
            dic.Add(UpdateOperationType.血制品单位.Key, UpdateOperationType.血制品单位.Value);
            dic.Add(UpdateOperationType.凝集规则明细字典.Key, UpdateOperationType.凝集规则明细字典.Value);
            dic.Add(UpdateOperationType.收费类型费用项目关系.Key, UpdateOperationType.收费类型费用项目关系.Value);

            dic.Add(UpdateOperationType.血制品分类记录.Key, UpdateOperationType.血制品分类记录.Value);
            dic.Add(UpdateOperationType.血制品分类单位换算.Key, UpdateOperationType.血制品分类单位换算.Value);
            dic.Add(UpdateOperationType.血袋费用项目关系.Key, UpdateOperationType.血袋费用项目关系.Value);
            dic.Add(UpdateOperationType.血制品加工类型关系.Key, UpdateOperationType.血制品加工类型关系.Value);
            return dic;
        }
    }
    #endregion
    ...
    /// </summary>
    public static class BloodDocGrade2
    {
        ...
        {
            Dictionary<string, BaseClassDicEntity> dic = new Dictionary<string, BaseClassDicEntity>();
            dic.Add(BloodDocGrade2.申请医生.Key, BloodDocGrade2.申请医生.Value);
            dic.Add(BloodDocGrade2.主治医师.Key, BloodDocGrade2.主治医师.Value);
            dic.Add(BloodDocGrade2.科主任.Key, BloodDocGrade2.科主任.Value);
            dic.Add(BloodDocGrade2.医务科.Key, BloodDocGrade2.医务科.Value);
            return dic;
        }
    }
    ...
    /// 业务接口字典的字典类型数据对照
    /// </summary>
    public static class MapingBDictType
    {
        public static KeyValuePair<string, BaseClassDicEntity> 申请类型 = new KeyValuePair<string, BaseClassDicEntity>("20", new BaseClassDicEntity() { Id = "20", ParentID = "0", DispOrder = "1", Name = "申请类型", Code = "BloodBReqType", FontColor = "#ffffff", BGColor = "#D2B48C" });
        public static KeyValuePair<string, BaseClassDicEntity> 就诊类型 = new KeyValuePair<string, BaseClassDicEntity>("25", new BaseClassDicEntity() { Id = "25", ParentID = "0", DispOrder = "11", Name = "就诊类型", Code = "BloodSickType", FontColor = "#ffffff", BGColor = "#DEB887" });
        public static KeyValuePair<string, BaseClassDicEntity> 用血方式 = new KeyValuePair<string, BaseClassDicEntity>("40", new BaseClassDicEntity() { Id = "40", ParentID = "0", DispOrder = "12", Name = "用血方式", Code = "BloodWay", FontColor = "#ffffff", BGColor = "#CD853F" });
        public static KeyValuePair<string, BaseClassDicEntity> 收费类型 = new KeyValuePair<string, BaseClassDicEntity>("170", new BaseClassDicEntity() { Id = "170", ParentID = "0", DispOrder = "1", Name = "收费类型", Code = "BloodChargeType", FontColor = "#ffffff", BGColor = "#F4A460" });
        public static Dictionary<string, BaseClassDicEntity> GetStatusDic()
        {
            Dictionary<string, BaseClassDicEntity> dic = new Dictionary<string, BaseClassDicEntity>();
            dic.Add(MapingBDictType.申请类型.Key, MapingBDictType.申请类型.Value);
            dic.Add(MapingBDictType.就诊类型.Key, MapingBDictType.就诊类型.Value);
            dic.Add(MapingBDictType.用血方式.Key, MapingBDictType.用血方式.Value);
            dic.Add(MapingBDictType.收费类型.Key, MapingBDictType.收费类型.Value);
    ...
    public static class InterfaceMapingBDict
    {
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 血制品字典 = new KeyValuePair<string, BaseClassDicEntity>("BloodStyle", new BaseClassDicEntity() { Id = "2", ParentID = "0", DispOrder = "11", Name = "血制品字典", Code = "BloodStyle", FontColor = "#ffffff", BGColor = "#DEB887" });
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 加工类型 = new KeyValuePair<string, BaseClassDicEntity>("BloodBagProcessType", new BaseClassDicEntity() { Id = "4", ParentID = "0", DispOrder = "1", Name = "加工类型", Code = "BloodBagProcessType", FontColor = "#ffffff", BGColor = "#F4A460" });
        public static KeyValuePair<string, BaseClassDicEntity> 血制品单位 = new KeyValuePair<string, BaseClassDicEntity>("BloodUnit", new BaseClassDicEntity() { Id = "5", ParentID = "0", DispOrder = "11", Name = "血制品单位", Code = "BloodUnit", FontColor = "#ffffff", BGColor = "#D2691E" });

        public static KeyValuePair<string, BaseClassDicEntity> 血型ABO = new KeyValuePair<string, BaseClassDicEntity>("BloodABO", new BaseClassDicEntity() { Id = "6", ParentID = "0", DispOrder = "11", Name = "血型ABO", Code = "BloodABO", FontColor = "#ffffff", BGColor = "#D2691E" });
        ...
        public static Dictionary<string, BaseClassDicEntity> GetStatusDic()
        {
            ...
            dic.Add(InterfaceMapingBDict.血制品字典.Key, InterfaceMapingBDict.血制品字典.Value);
            dic.Add(InterfaceMapingBDict.检验项目.Key, InterfaceMapingBDict.检验项目.Value);
            dic.Add(InterfaceMapingBDict.加工类型.Key, InterfaceMapingBDict.加工类型.Value);
            dic.Add(InterfaceMapingBDict.血制品单位.Key, InterfaceMapingBDict.血制品单位.Value);

            dic.Add(InterfaceMapingBDict.血型ABO.Key, InterfaceMapingBDict.血型ABO.Value);
    ...
    public static class AlertType
    {
        ...
        public static KeyValuePair<string, BaseClassDicEntity> 效期已过期预警 = new KeyValuePair<string, BaseClassDicEntity>("3", new BaseClassDicEntity() { Id = "3", Name = "效期已过期预警", Code = "UnReview", FontColor = "#ffffff", BGColor = "#dd6572" });
        public static KeyValuePair<string, BaseClassDicEntity> 效期将过期预警 = new KeyValuePair<string, BaseClassDicEntity>("4", new BaseClassDicEntity() { Id = "4", Name = "效期将过期预警", Code = "Applyed", FontColor = "#ffffff", BGColor = "#1c8f36" });
        public static Dictionary<string, BaseClassDicEntity> GetStatusDic()
        {
            Dictionary<string, BaseClassDicEntity> dic = new Dictionary<string, BaseClassDicEntity>();
            dic.Add(AlertType.低库存预警.Key, AlertType.低库存预警.Value);
            dic.Add(AlertType.高库存预警.Key, AlertType.高库存预警.Value);
            dic.Add(AlertType.效期已过期预警.Key, AlertType.效期已过期预警.Value);
            dic.Add(AlertType.效期将过期预警.Key, AlertType.效期将过期预警.Value);
            return dic;
        }
    }
}