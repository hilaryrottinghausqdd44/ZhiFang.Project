...
namespace ZhiFang.Entity.BloodTransfusion
{
    ...
    public class SCOperation : BaseEntity
    {
        ...
        public SCOperation(long labID, long bobjectID, long type, string typeName, string businessModuleCode, string memo, bool isUse, long creatorID, string creatorName, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
        {
            this._labID = labID;
        ...
        [DataMember]
        [DataDesc(CName = "操作类型名", ShortCode = "TypeName", Desc = "操作类型名", ContextType = SysDic.All, Length = 50)]
