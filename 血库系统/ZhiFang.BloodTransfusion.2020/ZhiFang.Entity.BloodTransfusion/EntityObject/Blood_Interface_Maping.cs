...
namespace ZhiFang.Entity.BloodTransfusion
{
	...
	/// </summary>
	[DataContract]
	[DataDesc(CName = "接口映射(对照)关系表", ClassCName = "BloodInterfaceMaping", ShortCode = "BloodInterfaceMaping", Desc = "接口映射(对照)关系表")]
	public class BloodInterfaceMaping : BaseEntity
	{
		...
		public BloodInterfaceMaping() { }

		public BloodInterfaceMaping(long labID, long bobjectID, string mapingCode, bool isUse, int dispOrder, DateTime dataAddTime, byte[] dataTimeStamp, BDict bobjectType)
		{
			this._labID = labID;
