...
namespace ZhiFang.Entity.BloodTransfusion
{
    ...
    public class BParameter : BaseEntity
    {
        ...
        public BParameter(long labID, string name, string sName, string paraNo, string paraType, string paraValue, string paraDesc, string shortcode, string pinYinZiTou, bool isUse, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, int dispOrder)
        {
            this._labID = labID;
            this._name = name;
            this._sName = sName;
