...
{	
	public class BRBACRole : BaseBLL<ZhiFang.Entity.RBAC.RBACRole>, ZhiFang.IBLL.RBAC.IBRBACRole
    {
        ...
        {
            return ((IDRBACRoleDao)base.DBDao).SearchRoleByHREmpID(longHREmpID);
        }

        public IList<RBACRole> SearchRoleByUserCode(string strUserCode)
        {
            return ((IDRBACRoleDao)base.DBDao).SearchRoleByUserCode(strUserCode);
        }

        public IList<RBACRole> SearchRoleByModuleID(long longModuleID)
        {
            return ((IDRBACRoleDao)base.DBDao).SearchRoleByModuleID(longModuleID);
        }

        public string SearchRoleModuleOperByModuleID(long longModuleID)
        {
            string tempRoleList = "";
            IList<RBACRole> tempRBACRoleList = ((IDRBACRoleDao)base.DBDao).SearchRoleByModuleID(longModuleID);
        ...
        {
            return ((IDRBACRoleDao)base.DBDao).SearchRoleByModuleOperID(longModuleOperID);
        }
