...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class Department : BaseEntityServiceByInt
    {
        ...
        [DataMember]
        [DataDesc(CName = "ShortName", ShortCode = "ShortName", Desc = "ShortName", ContextType = SysDic.All, Length = 10)]
        ...
        [DataMember]
        [DataDesc(CName = "ShortCode", ShortCode = "ShortCode", Desc = "ShortCode", ContextType = SysDic.All, Length = 10)]
