...
namespace ZhiFang.IBLL.BloodTransfusion
{
    ...
    ///
    /// </summary>
    public interface IBBObjectOperate : IBGenericManager<BObjectOperate>
    {
        IBBParameter IBBParameter { set; get; }
        IBBObjectOperateType IBBObjectOperateType { set; get; }
        ...
        bool AddByCode(BObjectOperate entity, string ObjectTypeShortCode, string OperateTypeShortCode);
        /// <summary>
        ...
        bool DeleteBObjectOperate(long? operateObjectID);
    }
}