...
namespace ZhiFang.IBLL.BloodTransfusion
{
    ...
    public interface IBBloodBReqForm : IBGenericManager<BloodBReqForm, string>
    {
        ...
        /// <returns></returns>
        BaseResultDataValue AddBloodBReqFormAndDtl(BloodBReqForm entity, SysCurUserInfo curDoctor, IList<BloodBReqItem> addBreqItemList, IList<BloodBReqFormResult> addResultList, long empID, string empName);
        /// <summary>
        /// 定制修改医嘱申请主单信息及申请明细信息
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// <returns></returns>
        BaseResultBool EditBloodBReqFormAndDtlByField(ref BloodBReqForm entity, SysCurUserInfo curDoctor, string[] tempArray, IList<BloodBReqItem> addBreqItemList, IList<BloodBReqItem> editBreqItemList, IList<BloodBReqFormResult> addResultList, IList<BloodBReqFormResult> editResultList, long empID, string empName);
        /// <summary>
        /// 按医嘱申请单号进行医嘱确认提交操作
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// <returns></returns>
        BaseResultBool EditBloodBReqFormOfConfirmApplyByReqFormId(BloodBReqForm entity, string[] tempArray, long empID, string empName);
        /// <summary>
        /// 医嘱申请打印
        /// </summary>
