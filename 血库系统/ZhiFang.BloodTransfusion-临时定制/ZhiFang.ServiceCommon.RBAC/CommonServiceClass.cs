...
namespace ZhiFang.ServiceCommon.RBAC
{
    ...
    public class CommonServiceMethod
    {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static string GetAddMethodResultStr(BaseEntityByString entity)
        {
            return "{id:" + "\"" + entity.Id.ToString() + "\"" + "}";
        }
        /// <summary>
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static string GetAddMethodResultStr(BaseEntityServiceByString entity)
        {
            return "{id:" + "\"" + entity.Id.ToString() + "\"" + "}";
        }
        /// <summary>
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static string GetAddMethodResultStr(BaseEntityServiceByInt entity)
        {
            return "{id:" + "\"" + entity.Id.ToString() + "\"" + "}";
        }
        /// <summary>
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static string GetAddMethodResultStr(BaseEntityByInt entity)
        {
            return "{id:" + "\"" + entity.Id.ToString() + "\"" + "}";
        }
        public static string GetAddMethodResultStr(long id)
        {
