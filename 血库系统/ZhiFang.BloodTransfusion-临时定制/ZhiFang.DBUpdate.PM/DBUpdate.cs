    ...
    public class DBUpdate
    {
        ...
        public static bool DataBaseUpdate(string oldVersion)
        {
            ...
            if (IsUpdateDataBase(oldVersion, "1.0.0.1"))
            {
                ...
                #region B_Parameter
                updateSql = "  if object_id('B_Parameter') is null CREATE TABLE [dbo].[B_Parameter]( [LabID] [bigint] NOT NULL, [Id] [bigint] NOT NULL, [NodeID] [bigint] NULL, [GroupNo] [bigint] NULL, [Name] [varchar](200) NULL, [SName] [varchar](40) NULL, [ParaNo] [varchar](100) NULL, [ParaType] [varchar](100) NULL, [ParaValue] [varchar](max) NULL, [ParaDesc] [ntext] NULL, [Shortcode] [varchar](100) NULL, [PinYinZiTou] [varchar](100) NULL, [IsUse] [bit] NULL, [DataAddTime] [datetime] NULL, [DataUpdateTime] [datetime] NULL, [DataTimeStamp] [timestamp] NULL, [DispOrder] [int] NULL, [PDictId] [bigint] NULL, CONSTRAINT [PK_B_PARAMETER] PRIMARY KEY CLUSTERED( [Id] ASC)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY] ) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]; ";
                listSQL.Add(updateSql);

                updateSql = "  if not exists(select * from B_Parameter where Id=5233849820005451764) INSERT [B_Parameter]([LabID],[Id],[Name],[SName],[ParaNo],[ParaType],[ParaValue],[ParaDesc],[Shortcode],[IsUse],[DataAddTime],[DispOrder]) VALUES ( 1,5233849820005451764,N'数据库版本号',N'全系统',N'SYS_DBVersion',N'SYS',N'1.0.0.1',N'数据库版本号',N'-1000',1,N'2017/08/03 23:52:02',-1000); ";
                listSQL.Add(updateSql);
            ...
            if (IsUpdateDataBase(oldVersion, "1.0.0.32"))
            {
                ...
                updateSql = " update B_Parameter set SName='医生站',ItemEditInfo=N'{\"ItemXType\":\"textfield\",\"ItemDefaultValue\":\"\",\"ItemUnit\":\"\",\"ItemDataSet\":\"\"}' where Id=5691564273202278074 and ItemEditInfo is null;";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"radiogroup\",\"ItemDefaultValue\":\"0\",\"ItemUnit\":\"\",\"ItemDataSet\":\"[{''1'':''是''},{''0'':''否''}]\"}' where Id=5524339378542032882 and ItemEditInfo is null;";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"radiogroup\",\"ItemDefaultValue\":\"0\",\"ItemUnit\":\"\",\"ItemDataSet\":\"[{''1'':''是''},{''0'':''否''}]\"}' where Id=5214493501844260901 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"radiogroup\",\"ItemDefaultValue\":\"1\",\"ItemUnit\":\"\",\"ItemDataSet\":\"[{''1'':''是''},{''0'':''否''}]\"}' where Id=5214493501844260900 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"textfield\",\"ItemDefaultValue\":\"\",\"ItemUnit\":\"\",\"ItemDataSet\":\"\"}' where Id=5214493501844260811 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"textfield\",\"ItemDefaultValue\":\"\",\"ItemUnit\":\"\",\"ItemDataSet\":\"\"}' where Id=5214493501844260801 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"radiogroup\",\"ItemDefaultValue\":\"0\",\"ItemUnit\":\"\",\"ItemDataSet\":\"[{''1'':''是''},{''0'':''否''}]\"}' where Id=5101233254823494116 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"numberfield\",\"ItemDefaultValue\":\"10\",\"ItemUnit\":\"\",\"ItemDataSet\":\"\"}' where Id=5085688375696300791 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"radiogroup\",\"ItemDefaultValue\":\"1\",\"ItemUnit\":\"\",\"ItemDataSet\":\"[{''1'':''是''},{''0'':''否''}]\"}' where Id=5081884485807967905 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"textfield\",\"ItemDefaultValue\":\"\",\"ItemUnit\":\"\",\"ItemDataSet\":\"\"}' where Id=5000278512090896900 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);
            ...
            if (IsUpdateDataBase(oldVersion, "1.0.0.41"))
            {
                ...
                #region 系统运行参数
                updateSql = " IF NOT EXISTS(SELECT * FROM B_Parameter WHERE [Id] = 5101233254823494117) INSERT [B_Parameter] ([LabID],[Id],[Name],[SName],[ParaType],[ParaNo],[ParaValue],[ParaDesc],[DispOrder],[IsUse],[IsUserSet],[DataAddTime]) VALUES ( 0,5101233254823494117,N'输血登记是否需要交接登记完成后',N'护士站',N'CONFIG',N'BL-BLTF-ISNB-0023',N'0',N'1:是;0:否;',10,1,1,N'2020-02-15 10:17:25'); ";
                listSQL.Add(updateSql);

                updateSql = " update B_Parameter set ItemEditInfo=N'{\"ItemXType\":\"radiogroup\",\"ItemDefaultValue\":\"1\",\"ItemUnit\":\"\",\"ItemDataSet\":\"[{''1'':''是''},{''0'':''否''}]\"}' where Id=5101233254823494117 and ItemEditInfo is null; ";
                listSQL.Add(updateSql);
        ...
        private static void CheckBParameterIsIsExists()
        {
            ...
            if (!CheckDataObjectIsExists("B_Parameter", "U"))
            {
                ...
                updateSql = "EXEC sys.sp_addextendedproperty @name = N\'MS_Description\', @value = N\'参数ID\' , @level0type = N\'SCHEMA\', @level0name = N\'dbo\', @level1type = N\'TABLE\', @level1name = N\'B_Parameter\', @level2type = N\'COLUMN\', @level2name = N\'Id\'";
                listSQL.Add(updateSql);
                ...
                //ExecuteUpdateSQL("insert into [B_Parameter]([LabID],[Id],[PDictId],[Name],[SName],[ParaType],[ParaNo],[ParaValue]," +
                //    "[ParaDesc],[Shortcode],[DispOrder],[PinYinZiTou],[IsUse],[IsUserSet],[DataAddTime],[DataUpdateTime]) " +
                //    " Values(1," +//LabID
                //    ZhiFang.Common.Public.GUIDHelp.GetGUIDLong().ToString() + "," +//Id
                //    "null," +//PDictId
                //    "\'数据库版本号\'," +//Name
                //    "null," +//SName
                //    "\'SYS\'," +//ParaType
