...
namespace ZhiFang.BloodTransfusion.ServerContract
{
    ...
    { 
        ...
        [ServiceContractDescription(Name = "通过参数编码查询参数表", Desc = "通过参数编码查询参数表", Url = "SingleTableService.svc/ST_UDTO_SearchBParameterByByParaNo?paraNo={paraNo}", Get = "paraNo={paraNo}", Post = "", Return = "BParameter", ReturnType = "BParameter")]
        ...
        [ServiceContractDescription(Name = "新增字典类型表", Desc = "新增字典类型表", Url = "SingleTableService.svc/ST_UDTO_AddBDictType", Get = "", Post = "BDictType", Return = "BaseResultDataValue", ReturnType = "BDictType")]
        ...
        [ServiceContractDescription(Name = "修改字典类型表", Desc = "修改字典类型表", Url = "SingleTableService.svc/ST_UDTO_UpdateBDictType", Get = "", Post = "BDictType", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改字典类型表指定的属性", Desc = "修改字典类型表指定的属性", Url = "SingleTableService.svc/ST_UDTO_UpdateBDictTypeByField", Get = "", Post = "BDictType", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除字典类型表", Desc = "删除字典类型表", Url = "SingleTableService.svc/ST_UDTO_DelBDictType?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询字典类型表", Desc = "查询字典类型表", Url = "SingleTableService.svc/ST_UDTO_SearchBDictType", Get = "", Post = "BDictType", Return = "BaseResultList<BDictType>", ReturnType = "ListBDictType")]
        ...
        [ServiceContractDescription(Name = "查询字典类型表(HQL)", Desc = "查询字典类型表(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchBDictTypeByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BDictType>", ReturnType = "ListBDictType")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询字典类型表", Desc = "通过主键ID查询字典类型表", Url = "SingleTableService.svc/ST_UDTO_SearchBDictTypeById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BDictType>", ReturnType = "BDictType")]
        ...
        [ServiceContractDescription(Name = "新增字典表", Desc = "新增字典表", Url = "SingleTableService.svc/ST_UDTO_AddBDict", Get = "", Post = "BDict", Return = "BaseResultDataValue", ReturnType = "BDict")]
        ...
        [ServiceContractDescription(Name = "修改字典表", Desc = "修改字典表", Url = "SingleTableService.svc/ST_UDTO_UpdateBDict", Get = "", Post = "BDict", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改字典表指定的属性", Desc = "修改字典表指定的属性", Url = "SingleTableService.svc/ST_UDTO_UpdateBDictByField", Get = "", Post = "BDict", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除字典表", Desc = "删除字典表", Url = "SingleTableService.svc/ST_UDTO_DelBDict?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询字典表", Desc = "查询字典表", Url = "SingleTableService.svc/ST_UDTO_SearchBDict", Get = "", Post = "BDict", Return = "BaseResultList<BDict>", ReturnType = "ListBDict")]
        ...
        [ServiceContractDescription(Name = "查询字典表(HQL)", Desc = "查询字典表(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchBDictByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BDict>", ReturnType = "ListBDict")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询字典表", Desc = "通过主键ID查询字典表", Url = "SingleTableService.svc/ST_UDTO_SearchBDictById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BDict>", ReturnType = "BDict")]
