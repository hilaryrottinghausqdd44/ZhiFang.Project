...
Ext.define('Shell.class.limp.sysbase.user.CheckGrid',{
	...
	/**获取数据服务路径*/
	selectUrl:'/BloodTransfusionManageService.svc/RBAC_UDTO_SearchHREmployeeByHQL?isPlanish=true',
	/**根据部门ID获取数据服务路径*/
	selectUrl2:'/BloodTransfusionManageService.svc/RBAC_UDTO_GetHREmployeeByHRDeptID?isPlanish=true',
