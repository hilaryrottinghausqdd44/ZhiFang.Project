...
Ext.define('Shell.class.sysbase.bloodclass.Grid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodClassByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl: '/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodClassByField',
	/**删除数据服务路径*/
	delUrl: '/BloodTransfusionManageService.svc/BT_UDTO_DelBloodClass ',
	...
	onSaveClick: function() {
		...
		for (var i = 0; i < len; i++) {
			...
			var Visible = rec.get('BloodClass_Visible');
