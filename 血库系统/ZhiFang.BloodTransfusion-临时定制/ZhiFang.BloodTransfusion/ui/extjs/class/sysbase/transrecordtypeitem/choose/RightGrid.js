 ...
 * @version 2020-02-25
 */
Ext.define('Shell.class.sysbase.transrecordtypeitem.choose.RightGrid', {
	...
	defaultPageSize: 500,
	/**用户UI配置Key*/
	userUIKey: 'transrecordtypeitem.choose.RightGrid',
	/**用户UI配置Name*/
	userUIName: "当前已选择列表",
	...
	createGridColumns: function() {
		...
		var columns = [{
			...
			text: '输血过程记录项分类ID',
			dataIndex: 'BloodTransRecordTypeItem_BloodTransRecordType_Id',
			width: 60,
			hidden:true,
			menuDisabled: true,
			defaultRenderer: true
			...
			text: '输血过程记录项分类名称',
			dataIndex: 'BloodTransRecordTypeItem_BloodTransRecordType_CName',
			width: 60,
			hidden:true,
			menuDisabled: true,
			defaultRenderer: true
