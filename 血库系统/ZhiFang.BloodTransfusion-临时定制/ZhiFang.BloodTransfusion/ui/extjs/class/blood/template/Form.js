...
Ext.define('Shell.class.blood.template.Form', {
	...
	autoScroll: false,
	/**获取数据服务路径*/
	selectUrl: '/BloodTransfusionManageService.svc/BT_UDTO_SearchBTemplateById?isPlanish=true',
	/**新增服务地址*/
	addUrl: '/BloodTransfusionManageService.svc/BT_UDTO_AddTemplateUploadFile',
	/**修改服务地址*/
	editUrl: '/BloodTransfusionManageService.svc/BT_UDTO_UpdateTemplateAndUploadFileByField',
    /**布局方式*/
	layout: {
		type: 'table',
		columns:2 //每行有几列
