...
JcallShell.System.Date = {
	...
	_tryCount: 0,
	_sysTime: null,
	_url: '/ConstructionService.svc/CS_UDTO_GetServerInformation', ///ServerWCF
	_leftSeconds: null,
	_milliseconds: 1000,
	_isError: null,
	/**服务器错误*/
...
JcallShell.System.getPinYinZiTou = function(value, callback) {
	var url = JcallShell.System.Path.ROOT + '/ConstructionService.svc/GetPinYin?chinese=' + value; ///ServerWCF
