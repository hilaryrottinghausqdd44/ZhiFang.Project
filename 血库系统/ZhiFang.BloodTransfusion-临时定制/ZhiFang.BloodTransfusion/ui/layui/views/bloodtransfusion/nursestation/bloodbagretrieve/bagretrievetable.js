layui.extend({
	...
	var bagretrievetableProxy = {
		...
		config:{
			...
			selUrlByDefault: uxutil.path.ROOT+ "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBOutItemOfRecycleByHQL?isPlanish=true",
			selUrlByBagCode: uxutil.path.ROOT+ "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodBOutItemOfRecycleByBBagCodeHQL",
			cols:[
					[{
					    type:'checkbox',
					    LAY_CHECKED: false
