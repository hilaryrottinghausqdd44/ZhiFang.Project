...
layui.extend({
	...
	var bdictForm = {
		config: {
			...
			selectFields: "",
			lastData: "",
			selectUrl: uxutil.path.ROOT + "/SingleTableService.svc/ST_UDTO_SearchBDictById?isPlanish=true",
			/**新增服务地址 BT_UDTO_AddBDictAndDtl */
			addUrl: uxutil.path.ROOT + "/SingleTableService.svc/ST_UDTO_AddBDict",
			/**修改服务地址*/
			editUrl: uxutil.path.ROOT + "/SingleTableService.svc/ST_UDTO_UpdateBDictByField"
		}
	};
	//构造器
