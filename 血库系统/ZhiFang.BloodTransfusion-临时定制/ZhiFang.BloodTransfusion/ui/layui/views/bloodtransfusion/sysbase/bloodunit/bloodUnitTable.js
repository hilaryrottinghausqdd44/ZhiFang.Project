layui.extend({
	...
	var BloodUnitTable = function(){
		...
		//数据操作URL
		me.config.addUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_AddBloodUnit";
		me.config.editUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodUnitByField";
		me.config.delUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_DelBloodUnit";
		me.config.defLoadUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUnitByHQL?isPlanish=true";
		//初始化字段列，这样写更直观，更简单
