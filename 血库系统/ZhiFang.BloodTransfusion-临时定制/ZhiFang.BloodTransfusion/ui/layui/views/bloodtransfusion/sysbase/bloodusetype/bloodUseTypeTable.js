layui.extend({
	...
	var BloodUseTypeTable = function(){
		...
		//数据操作URL
		me.config.addUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_AddBloodUseType";
		me.config.editUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_UpdateBloodUseTypeByField";
		me.config.delUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_DelBloodUseType";
		me.config.defLoadUrl = uxutil.path.ROOT + "/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodUseTypeByHQL?isPlanish=true";
		//初始化字段列，这样写更直观，更简单
