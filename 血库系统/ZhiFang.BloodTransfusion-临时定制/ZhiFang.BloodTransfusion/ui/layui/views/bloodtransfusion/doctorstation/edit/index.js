...
}).use(['util', 'layer', 'laydate', 'table', 'form', 'dataadapter', 'bloodsconfig', 'csserver', "breqEditForm",
	"formSelects", 'breqItemEditTable', 'breqFormResultEditTable', 'uxdata', "cachedata", 'bloodSelectData', 'laydate'
], function() {
	"use strict";
