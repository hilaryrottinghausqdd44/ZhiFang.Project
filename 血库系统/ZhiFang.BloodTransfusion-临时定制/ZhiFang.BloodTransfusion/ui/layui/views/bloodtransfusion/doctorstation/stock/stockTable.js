...
layui.extend({
	...
	//获取列表数据
	var SELECT_URL = bloodsconfig.CSServer.CS_GETBLOODQTY_URL; //uxutil.path.ROOT +"/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodstyleEntityListByJoinHql?isPlanish=true";
