...
layui.extend({
	...
	//获取列表数据
	var SELECT_URL =bloodsconfig.CSServer.CS_GEBLOODBILLINFO_URL;// uxutil.path.ROOT +"/BloodTransfusionManageService.svc/BT_UDTO_SearchBloodstyleEntityListByJoinHql1?isPlanish=true";
