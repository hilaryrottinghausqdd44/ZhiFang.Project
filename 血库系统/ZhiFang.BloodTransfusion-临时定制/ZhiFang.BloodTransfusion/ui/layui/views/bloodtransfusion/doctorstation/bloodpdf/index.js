...
}).use(['uxutil', 'form', 'layer', 'bloodsconfig'],
	function() {
		"use strict";
		...
		function getOptionList(callback) {
			...
			var valueKey = "Id",
				nameKey = "Date";
			var url = bloodsconfig.CSServer.CS_GEBLOODBILLINFO_URL + "?sReqFormNo=" + defaultParams.ReqFormNo + "&sType=" +
		...
		function onPreviewIframeById(id) {
			setTimeout(function() {
				var url = bloodsconfig.CSServer.CS_GEBLOODREPORTPDF_URL + "?sReqFormNo=" + defaultParams.ReqFormNo +
