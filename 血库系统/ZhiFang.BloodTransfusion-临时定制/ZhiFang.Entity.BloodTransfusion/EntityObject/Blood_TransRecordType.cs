...
namespace ZhiFang.Entity.BloodTransfusion
{
	...
	public class BloodTransRecordType : BaseEntity
	{
		...
		public BloodTransRecordType( long labID, int contentTypeID, string cName, string typeCode, int dispOrder, bool isVisible, string memo, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
