...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class PUser : BaseEntityService
    {
        ...
        [DataMember]
        [DataDesc(CName = "Department", ShortCode = "Department", Desc = "Department")]
        ...
        /// </summary>
        [DataMember]
        [DataDesc(CName = "RBACRole", ShortCode = "RBACRole", Desc = "RBACRole")]
