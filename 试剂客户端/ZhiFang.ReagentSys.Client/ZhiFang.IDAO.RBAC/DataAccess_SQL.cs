...
namespace ZhiFang.IDAO.RBAC
{
    ...
    {
        private static readonly string AssemblyPath = "ZhiFang.DAO.SQL.ReagentSys.Client";
        ...
        /// <summary>
        /// 创建CenOrgDao_SQL数据层接口
        /// </summary>
        public static IDAO.RBAC.IDCenOrgDao_SQL CreateCenOrgDao_SQL()
        {
            string ClassNamespace = AssemblyPath + ".CenOrgDao_SQL";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (IDAO.RBAC.IDCenOrgDao_SQL)objType;
        }
        /// <summary>
        ...
        /// <summary>
        /// 创建BParameterDao_SQL数据层接口
        /// </summary>
        public static IDAO.RBAC.IDBParameterDao_SQL CreateBParameterDao_SQL()
        {
            string ClassNamespace = AssemblyPath + ".BParameterDao_SQL";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (IDAO.RBAC.IDBParameterDao_SQL)objType;
        }
        /// <summary>
        /// 创建BDictTypeDao_SQL数据层接口
        /// </summary>
        public static IDAO.RBAC.IDBDictTypeDao_SQL CreateBDictTypeDao_SQL()
        {
            string ClassNamespace = AssemblyPath + ".BDictTypeDao_SQL";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (IDAO.RBAC.IDBDictTypeDao_SQL)objType;
        }
        /// <summary>
        /// 创建ReaCenBarCodeFormatDao_SQL数据层接口
        /// </summary>
        public static IDAO.RBAC.IDReaCenBarCodeFormatDao_SQL CreateReaCenBarCodeFormatDao_SQL()
        {
            string ClassNamespace = AssemblyPath + ".ReaCenBarCodeFormatDao_SQL";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (IDAO.RBAC.IDReaCenBarCodeFormatDao_SQL)objType;
        }
