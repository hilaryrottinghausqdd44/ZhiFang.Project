...
namespace ZhiFang.Entity.ReagentSys.Client
{
    ...
    /// <summary>
    /// SCAttachment object for NHibernate mapped table 'SC_Attachment'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "公共附件表", ClassCName = "SCAttachment", ShortCode = "SCAttachment", Desc = "公共附件表")]
    public class SCAttachment : BaseEntityService
    {
        ...
        public SCAttachment(long labID, string fileName, string fileExt, long fileSize, string filePath, string memo, int dispOrder, bool isUse, long creatorID, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, string newFileName, string fileType, long? bobjectID,string businessModuleCode)
        {
            this._labID = labID;
        ...
        [DataMember]
        [DataDesc(CName = "业务模块代码", ShortCode = "BusinessModuleCode", Desc = "业务模块代码", ContextType = SysDic.All, Length = 50)]
        ...
        [DataMember]
        [DataDesc(CName = "下载次数", ShortCode = "DownloadCounts", Desc = "下载次数", ContextType = SysDic.All, Length = 4)]
        public virtual int DownloadCounts
        {
            get { return _downloadCounts; }
            set { _downloadCounts = value; }
        }
        #endregion
    }
    #endregion
