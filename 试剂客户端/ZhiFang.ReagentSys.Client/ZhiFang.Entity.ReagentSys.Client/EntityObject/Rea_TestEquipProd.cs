...
namespace ZhiFang.Entity.ReagentSys.Client
{
	...
	/// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "ReaTestEquipProd", ShortCode = "ReaTestEquipProd", Desc = "")]
	public class ReaTestEquipProd : BaseEntity
	{
		...
		public ReaTestEquipProd() { }

		public ReaTestEquipProd( long prodOrgID, long testEquipTypeID, string cName, string eName, string shortCode, string memo, int visible, int dispOrder, DateTime dataUpdateTime, DateTime dataAddTime, byte[] dataTimeStamp )
		{
