...
{
    [DataContract]
    [DataDesc(CName = "ReaBmsCenSaleDtlOfCheckVO", ClassCName = "ReaBmsCenSaleDtlOfCheckVO", ShortCode = "ReaBmsCenSaleDtlOfCheckVO", Desc = "ReaBmsCenSaleDtlOV")]
    public class ReaBmsCenSaleDtlOfCheckVO
    {
        public ReaBmsCenSaleDtlOfCheckVO() { }
        ...
        [DataMember]
        [DataDesc(CName = " 混合条码", ShortCode = "MixSerial", Desc = " 混合条码", ContextType = SysDic.All, Length = 150)]
