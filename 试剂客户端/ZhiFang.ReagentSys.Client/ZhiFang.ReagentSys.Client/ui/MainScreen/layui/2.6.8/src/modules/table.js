 ...
 * 数据表格组件
 * 
 * 1369行 Jcall 2021-11-10 支持soulTable列显示隐藏记忆功能
 * 1471行 Jcall 2021-11-10 支持soulTable拖动列宽记忆功能
 */
...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
  ...
  Class.prototype.events = function(){
          ...
          openPanel({
            ...
            ,done: function(){
              form.on('checkbox(LAY_TABLE_TOOL_COLS)', function(obj){
                ...
                if (layui.soulTable) { layui.soulTable.fixTableRemember(that.config, dict)}//Jcall 2021-11-10 支持soulTable列显示隐藏记忆功能
              });
            }
          });
        break;
    ...
    _DOC.on('mousemove', function(e){
      ...
      if(dict.resizeStart){
      	if (layui.soulTable) { layui.soulTable.fixTableRemember(that.config, dict)}//Jcall 2021-11-10 支持soulTable拖动列宽记忆功能
        dict = {};
        _BODY.css('cursor', '');
        that.scrollPatch();
      }
