...
Ext.define('Shell.lodop.Lodop', {
	...
	getLodop: function(isWinOpen) {
		...
		try {
			if(typeof(CLODOP) == "undefined") {
				...
				// 这段代码可以优化（安装Clodop低版本，提示升级cLodop版本）
				if(lodop.VERSION < '6.5.4.2'){
					me.winPromptInstall();
				}
	...
	getStrHtmInstall: function() {
		var strHtmInstall = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='" + JShell.System.Path.UI + "/lodop/resources/" + "CLodop_Setup_for_Win32NT_4.142CN_Extend.exe'>执行安装</a>,安装后请退出系统重新登录。</font>";
		//var strHtmInstall = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='" + JShell.System.Path.UI + "/lodop/resources/" + "CLodop_Setup_for_Win32NT_4.141.exe'>执行安装</a>,安装后请退出系统重新登录。</font>";
	...
	getStrHtmUpdate: function() {
		var strHtmUpdate = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='" + JShell.System.Path.UI + "/lodop/resources/" + "CLodop_Setup_for_Win32NT_4.142CN_Extend.exe'>执行升级</a>,升级后请退出系统重新登录。</font>";
		return strHtmUpdate;
	},
	/**@description 64位安装包安装提示*/
	getStrHtm64_Install: function() {
		var strHtm64_Install = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='" + JShell.System.Path.UI + "/lodop/resources/" + "CLodop_Setup_for_Win32NT_4.142CN_Extend.exe'>执行安装</a>,安装后请退出系统重新登录。</font>";
		return strHtm64_Install;
	},
	/**@description 64位安装包升级提示*/
	getStrHtm64_Update: function() {
		var strHtm64_Update = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='" + JShell.System.Path.UI + "/lodop/resources/" + "CLodop_Setup_for_Win32NT_4.142CN_Extend.exe'>执行升级</a>,升级后请退出系统重新登录。</font>";
