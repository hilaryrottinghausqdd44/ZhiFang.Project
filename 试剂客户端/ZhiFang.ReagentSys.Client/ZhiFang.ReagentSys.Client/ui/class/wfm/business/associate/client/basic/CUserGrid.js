...
Ext.define('Shell.class.wfm.business.associate.client.basic.CUserGrid', {
	...
	title: '授权系统用户列表',
	/**获取数据服务路径*/
	selectUrl: '/SingleTableService.svc/ST_UDTO_SearchCUserByHQL?isPlanish=false',
	/**修改服务地址*/
	editUrl: '/SingleTableService.svc/ST_UDTO_UpdateCUserByField',

	/**将CUser某一记录行复制到PClient中*/
	addUrl: '/SingleTableService.svc/ST_UDTO_CopyCUserToPClientByCUserId',
