 ...
 * @version 2016-11-18
 */
Ext.define('Shell.class.wfm.business.contract.apply.EditPanel', {
	...
	afterRender: function() {
		...
		/*合同金额改变时，收款计划页签的合同金额跟着改变   @author liangyl @version 2017-07-28  */
		var Amount=me.Form.getComponent('PContract_Amount');
		Amount.on({
			change : function(com,  newValue,  oldValue,  eOpts ){
				if(me.Preceiveplan){
					me.Preceiveplan.changeAmountText(newValue,'合同金额:');
				}
			}
		});
	},
	...
	createItems:function(){
		...
		return [me.Form,me.Attachment,me.EquipInfoListForm,me.PurchaseDescForm,me.Preceiveplan,me.Operate,me.Interaction,me.Pdf];
	},
	/**创建挂靠功能栏*/
...
//          }
	...
	isValidAmount:function(Id,callback){
		var me = this,
			values = me.Form.getForm().getValues(),
			url = '/SingleTableService.svc/ST_UDTO_SearchPReceivePlanByHQL?isPlanish=true&fields=PReceivePlan_ReceivePlanAmount';
