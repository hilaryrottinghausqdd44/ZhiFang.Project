 ...
 * @version 2016-11-18
 */
Ext.define('Shell.class.wfm.business.contract.businessaudit.EditFormPanel', {
	...
	afterRender: function() {
		...
		me.Form.changeResult = function(data) {
			...
			var PClientName=me.Form.getComponent('PContract_PClientName');
		    PClientName.emptyText = '必填项';
			PClientName.allowBlank = false;
			
			var ContractNumber=me.Form.getComponent('PContract_ContractNumber');
