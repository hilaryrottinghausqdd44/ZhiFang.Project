...
Ext.define('Shell.class.wfm.business.clientlinker.Form', {
	...
	/**获取数据服务路径*/
	selectUrl: '/SingleTableService.svc/ST_UDTO_SearchPClientLinkerById?isPlanish=true',
	/**新增服务地址*/
	addUrl: '/SingleTableService.svc/ST_UDTO_AddPClientLinker',
	/**修改服务地址*/
...
//	layout: 'anchor',
	...
	getClientName:function(id,callback){
		var me = this;
		var url = JShell.System.Path.ROOT + '/SingleTableService.svc/ST_UDTO_SearchPClientByHQL?isPlanish=true';
