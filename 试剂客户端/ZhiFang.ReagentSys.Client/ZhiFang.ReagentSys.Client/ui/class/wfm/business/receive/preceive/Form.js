...
Ext.define('Shell.class.wfm.business.receive.preceive.Form', {
	...
	/**获取数据服务路径*/
    selectUrl:'/SingleTableService.svc/ST_UDTO_SearchPReceiveById?isPlanish=true',
	/**修改服务地址*/
	addUrl: '/SingleTableService.svc/ST_UDTO_AddPReceive',
	/**删除数据服务路径*/
	editUrl: '/SingleTableService.svc/ST_UDTO_UpdatePReceiveByField',
