...
Ext.define('Shell.class.wfm.business.receive.preceive.seach.Grid',{
    ...
    height: 500,
   	...
   	/**获取数据服务路径*/
	selectUrl: '/SingleTableService.svc/ST_UDTO_AdvSearchPReceiveByHQL?isPlanish=true',
   ...
   getParms:function(){
	...
	getPFinanceReceiveTotal:function(callback){
		var me = this;
		var url = JShell.System.Path.ROOT + '/SingleTableService.svc/ST_UDTO_SearchPReceiveTotalByHQL';
