			...
			editor: {
				...
				listeners: {
					check: function(p, record) {
						...
						var ReceiveGradationName = record ? record.get('BDict_CName') : '';
						...
						if(bo == true) {
							records[0].set('ReceiveGradationID', record ? record.get('BDict_Id') : '');
							records[0].set('ReceiveGradationName', record ? record.get('BDict_CName') : '');
							me.getView().refresh();
//							records[0].set('text', record ? record.get('BDict_CName') : '');
						}
						p.close();
					}
				}
