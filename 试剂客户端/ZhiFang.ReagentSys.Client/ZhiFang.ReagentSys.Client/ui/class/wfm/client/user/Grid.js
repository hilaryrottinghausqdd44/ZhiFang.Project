...
Ext.define('Shell.class.wfm.client.user.Grid',{
    ...
    /**获取数据服务路径*/
   	selectUrl: '/SingleTableService.svc/ST_UDTO_SearchPClientByHQLAndSalesManId?isPlanish=true',

	/**新增数据服务路径*/
	addUrl:'/SingleTableService.svc/ST_UDTO_AddPSalesManClientLink',
	/**删除数据服务路径*/
	delUrl: '/SingleTableService.svc/ST_UDTO_DelPSalesManClientLink',
	 /**导出客户数据服务路径*/
