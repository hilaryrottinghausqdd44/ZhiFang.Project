...
Ext.define('Shell.class.wfm.client.Form',{
    ...
    /**获取数据服务路径*/
    selectUrl:'/SingleTableService.svc/ST_UDTO_SearchPClientById?isPlanish=true',
    /**新增服务地址*/
    addUrl:'/SingleTableService.svc/ST_UDTO_AddPClient',
    /**修改服务地址*/
...
//	},
	...
	createItems:function(){
		...
		if(!me.PK){
			items.push({
				x:10,y:211,width:620,
			   fieldLabel:'网址',name:'PClient_Url'
			});
		}else{
			items.push({
					x:365,y:211,width:265,
			fieldLabel:'网址',name:'PClient_Url'
			});
		}
		items.push({
				x:10,y:237,width:620,itemId:'PClient_Comment',
