...
Ext.define('Shell.class.wfm.authorization.ahserver.basic.EquipLicenceGrid', {
	...
	height: 500,
	/**获取数据服务路径*/
	selectUrl: '/SingleTableService.svc/ST_UDTO_SearchAHServerEquipLicenceByHQL',
	/**修改服务地址*/
	editUrl: '/SingleTableService.svc/ST_UDTO_UpdateAHServerEquipLicenceByField',
	/**删除数据服务路径*/
	delUrl: '/SingleTableService.svc/ST_UDTO_DelAHServerEquipLicence',
	/**上传的授权申请文件的仪器授权明细信息*/
