...
Ext.define('Shell.class.wfm.dict.type.Grid',{
	...
	/**删除数据服务路径*/
	delUrl:'/SingleTableService.svc/ST_UDTO_DelBDictType',
...
//	hasEdit:true,
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			renderer:function(value,meta,record){
				if(record.get('BDictType_DeveCode')){
					return '';
				}else{
			...
			text:'开发商代码',dataIndex:'BDictType_DeveCode',hidden:true,hideable:false
		},{
	...
	onSelectData:function(){
		...
		for(var i=0;i<len;i++){
			if(records[i].get('BDictType_DeveCode')){
				hasDeveCode = true;
				break;
			}
		}
