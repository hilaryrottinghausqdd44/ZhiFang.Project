...
Ext.define('Shell.class.wfm.dict.Form',{
	...
	createItems:function(){
		...
		items.push(
			{fieldLabel:'字典编码',name:'BDict_Shortcode',emptyText:'必填项',allowBlank:false},
			{fieldLabel:'字典名称',name:'BDict_CName',emptyText:'必填项',allowBlank:false},
			{fieldLabel:'显示次序',name:'BDict_DispOrder',xtype:'numberfield',value:0,emptyText:'必填项',allowBlank:false},
			{fieldLabel:'字典描述',name:'BDict_Memo',height:85,labelAlign:'top',xtype:'textarea'},
			{boxLabel:'是否使用',name:'BDict_IsUse',xtype:'checkbox',checked:true},
