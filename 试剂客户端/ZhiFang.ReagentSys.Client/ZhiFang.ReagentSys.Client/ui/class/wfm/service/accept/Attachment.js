...
Ext.define('Shell.class.wfm.service.accept.Attachment', {
	...
	width: 600,
	height: 400,
	selectUrl: '/SingleTableService.svc/ST_UDTO_SearchPCustomerServiceAttachmentByHQL?isPlanish=true',
	delUrl: '/SingleTableService.svc/ST_UDTO_UpdatePCustomerServiceAttachmentByField',
	//新增附件文件时保存服务
	addUrl: '/SingleTableService.svc/SC_UploadAddPCustomerServiceAttachment',
	/**必须传--下载文件服务*/
	downLoadUrl: "/SingleTableService.svc/SC_UDTO_DownLoadPCustomerServiceAttachment",
	/**必须传--更新附件文件时保存服务*/
	editUrl: '/SingleTableService.svc/ST_UDTO_UpdatePCustomerServiceAttachmentByField',
	//新增文件所保存的数据对象名称
