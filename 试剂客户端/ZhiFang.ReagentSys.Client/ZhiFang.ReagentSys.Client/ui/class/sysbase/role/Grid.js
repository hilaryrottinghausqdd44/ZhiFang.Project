...
Ext.define('Shell.class.sysbase.role.Grid', {
	...
	initComponent: function() {
		...
		//查询框信息
		me.searchInfo = {width:220,emptyText:'角色名称/分类',isLike:true,fields:['rbacrole.CName','rbacrole.SName']};
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'分类',dataIndex:'RBACRole_SName',width:100,
			defaultRenderer:true
		},{
			...
			text:'角色ID',dataIndex:'RBACRole_Id',isKey:true,hidden:true,
		},{
			text:'机构ID',dataIndex:'RBACRole_LabID',hidden:true,
		},{
