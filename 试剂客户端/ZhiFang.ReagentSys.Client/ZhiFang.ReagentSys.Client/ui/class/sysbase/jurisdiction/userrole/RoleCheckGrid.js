...
Ext.define('Shell.class.sysbase.jurisdiction.userrole.RoleCheckGrid', {
	...
	/**新增关系服务*/
	addLinkUrl:'/RBACService.svc/RBAC_UDTO_AddRBACEmpRoles',
	/**删除关系服务*/
	delLinkUrl:'/RBACService.svc/RBAC_UDTO_DelRBACEmpRoles',
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'角色编码',dataIndex:'RBACRole_UseCode',width:80,
	...
	addLink:function(rec,id){
		...
		var entity = {
			IsUse:true,
			HREmployee:{Id:me.UserId,DataTimeStamp:[0,0,0,0,0,0,0,0]},
			RBACRole:{Id:id,DataTimeStamp:[0,0,0,0,0,0,0,0]}
		};
	...
	getLinkData:function(callback){
		...
		url += '&where=rbacemproles.HREmployee.Id=' + me.UserId
