...
Ext.define('Shell.class.sysbase.org.Grid', {
	...
	/**删除数据服务路径*/
	delUrl: '/RBACService.svc/RBAC_UDTO_DelHRDept',
	...
	createGridColumns: function() {
		...
		var columns = [{
			...
			text: '标准代码',
			dataIndex: 'HRDept_StandCode',
			width: 100,
			editor: {},
			defaultRenderer: true
		}, {
			text: '开发商代码',
			dataIndex: 'HRDept_DeveCode',
			width: 100,
			defaultRenderer: true
		}, {
			text: '物资对照码',
			dataIndex: 'HRDept_MatchCode',
			width: 100,
			defaultRenderer: true
		}, {
			text: '部门联系人',
			dataIndex: 'HRDept_Contact',
			width: 100,
			defaultRenderer: true
		}, {
			xtype: 'checkcolumn',
			text: '使用',
			dataIndex: 'HRDept_IsUse',
			width: 40,
			align: 'center',
			sortable: false,
			menuDisabled: true,
	...
	updateOneByIsUse: function(index, id, rec) {
		...
		var StandCode = rec.get('HRDept_StandCode');
