...
Ext.define('Shell.class.sysbase.user.Form',{
    ...
    /**获取用户账号列表服务*/
    getUserListUrl:'/RBACService.svc/RBAC_UDTO_SearchRBACUserListByHQL?&isPlanish=true',
	...
	createItems:function(){
		...
		if(me.hasManager){
			items.push({
				fieldLabel:'直接上级',emptyText:'',allowBlank:true,
		...
		items.push({
			...
			fieldLabel:'标准代码',name:'HREmployee_StandCode',itemId:'HREmployee_StandCode'
			//emptyText:'必填项',allowBlank:false
		},{
			fieldLabel:'物资对照码',name:'HREmployee_MatchCode',itemId:'HREmployee_MatchCode'
			//emptyText:'必填项',allowBlank:false
		});
	...
	getAddParams:function(){
		...
		var entity = {
			...
			StandCode:values.HREmployee_StandCode,
			MatchCode:values.HREmployee_MatchCode,
	...
	getEditParams:function(){
		...
		var fields = [
			'HRDept_Id','NameL','NameF','CName','StandCode','MatchCode',
