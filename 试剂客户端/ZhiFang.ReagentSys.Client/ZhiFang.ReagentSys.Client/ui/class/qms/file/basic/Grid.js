...
Ext.define('Shell.class.qms.file.basic.Grid', {
	...
	delUrl: '/CommonService.svc/QMS_UDTO_DeleleFFileByIds',
	/**默认排序字段*/
	defaultOrderBy: [{
...
//	DisagreeOperationType: -1,
	...
	getStatusListData: function(callback) {
		var me = this,
			url = JShell.System.Path.getRootUrl('/CommonService.svc/GetClassDic');
	...
	WeiXinMessagePush: function(id) {
		var me = this;
		var url = JShell.System.Path.getRootUrl('/CommonService.svc/QMS_FFileWeiXinMessagePushById?id=' + id);
		//根据新闻ID进行微信消息推送
