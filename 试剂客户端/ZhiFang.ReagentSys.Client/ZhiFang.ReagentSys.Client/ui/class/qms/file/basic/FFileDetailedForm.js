...
Ext.define('Shell.class.qms.file.basic.FFileDetailedForm', {
	...
	/**抄送范围和阅读范围*/
	FileCopyUserOrReadingUserUrl: '/CommonService.svc/QMS_UDTO_SearchFFileCopyUserOrReadingUserByFFileId',
	FFileOperationHtml: '',
	ContentHtml: '',
	FFileCopyUserHtml: '',
	UserInfoHtml: '',
	...
	//			'<dd> {DataAddTime}</dd>' +
	//			'<dt>审核时间：</dt>' +
	//			'<dd>{CheckerDateTime}</dd>' +
	//			'<dt>审批时间：</dt>' +
	//			'<dd>{ApprovalDateTime}</dd>' +
	//			'<dt>发布时间：</dt>' +
	...
	//			'</div>' +
	//			'<ul >' +
	//			'<p style="padding:0px 5px 0px 16px;word-break:break-all; word-wrap:break-word;">{Memo}</p>' + '</ul>' +
	//
	//			'</div>';
	//
	//		'<br>' +
