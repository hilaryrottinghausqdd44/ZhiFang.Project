 ...
 * @version 2017-01-04
 */
Ext.define('Shell.class.qms.file.news.basic.Form', {
	...
	createFFileCopyUser: function(fieldLabel) {
		...
		me.FFileCopyUser = {
			...
			/**获取数据服务路径*/
			selectUrl: '/CommonService.svc/QMS_UDTO_SearchFFileCopyUserByHQL?isPlanish=true',
	...
	getAddFFileTableLayoutItems: function() {
		...
		//是否使用
		//		me.FFile_IsUse.colspan = 1;
		//		items.push(me.FFile_IsUse);

		//关键字
		me.FFile_Keyword.colspan = 4;
