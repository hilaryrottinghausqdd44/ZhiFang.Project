 ...
 * @version 2018-03-07
 */
Ext.define('Shell.class.rea.client.reastore.App', {
	...
	createItems: function() {
		...
		me.Grid = Ext.create('Shell.class.rea.client.reastore.Grid', {
			region: 'center',
			header: false,
			itemId: 'Grid'
		});
		...
		if(leaf == true) { //货架
			...
			if(id == 0 || id == "0") {
				if(me.isEmpPermission) {
					...
					if(tidArr&&tidArr.length>0)
					hql = 'reabmsqtydtl.StorageID in (' + tidArr.join(',') + ")";
				}
			} else {
