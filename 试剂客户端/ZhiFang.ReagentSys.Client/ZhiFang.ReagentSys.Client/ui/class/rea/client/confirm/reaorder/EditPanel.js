 ...
 * @version 2017-12-14
 */
Ext.define('Shell.class.rea.client.confirm.reaorder.EditPanel', {
	...
	createItems: function() {
		var me = this;
		me.DtlGrid = Ext.create('Shell.class.rea.client.confirm.reaorder.DtlGrid', {
			header: false,
			itemId: 'DtlGrid',
			region: 'center',
			PK: me.PK,
		...
		me.DocForm = Ext.create('Shell.class.rea.client.confirm.reaorder.DocForm', {
			header: false,
			itemId: 'DocForm',
			region: 'north',
			width: me.width,
