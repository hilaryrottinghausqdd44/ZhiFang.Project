 ...
 * @version 2019-06-06
 */
Ext.define('Shell.class.rea.client.qtyoperation.report.ShowPanel', {
	...
	createItems: function() {
		var me = this;
		me.DocForm = Ext.create('Shell.class.rea.client.qtyoperation.report.add.DocForm', {
			header: false,
			itemId: 'DocForm',
			region: 'north',
			height: 190,
		...
		me.TabPanel = Ext.create('Shell.class.rea.client.qtyoperation.report.TabPanel', {
			header: false,
			itemId: 'TabPanel',
			region: 'center',
			split: true,
