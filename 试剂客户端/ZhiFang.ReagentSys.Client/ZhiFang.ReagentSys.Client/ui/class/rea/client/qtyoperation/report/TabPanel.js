 ...
 * @version 2019-06-06
 */
Ext.define('Shell.class.rea.client.qtyoperation.report.TabPanel', {
	...
	createItems: function() {
		var me = this;
		me.DtlGrid = Ext.create('Shell.class.rea.client.qtyoperation.report.basic.DtlGrid', {
			title: '库存变化统计报表信息',
			header: true,
			border: false,
			itemId: 'DtlGrid'
		});
		me.PdfPanel = Ext.create('Shell.class.rea.client.qtyoperation.report.PdfPanel', {
			title: '库存变化统计报表PDF',
			header: true,
			border: false,
			itemId: 'PdfPanel'
