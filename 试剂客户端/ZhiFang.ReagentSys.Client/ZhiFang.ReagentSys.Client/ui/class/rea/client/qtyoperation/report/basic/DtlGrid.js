 ...
 * @version 2019-06-06
 */
Ext.define('Shell.class.rea.client.qtyoperation.report.basic.DtlGrid', {
	...
	createGridColumns: function() {
		var me = this;
		var columns = [{
			dataIndex: 'ReaBmsQtyMonthBalanceDtl_CompanyName',
			text: '所属供货商',
			hidden: true,
			width: 150,
			...
			dataIndex: 'ReaBmsQtyMonthBalanceDtl_ReaGoodsNo',
			text: '货品编码',
			hidden: true,
			width: 150,
			defaultRenderer: true
			...
			dataIndex: 'ReaBmsQtyMonthBalanceDtl_DispOrder',
			text: '货品次序',
			width: 90,
			defaultRenderer: true
		}, {
