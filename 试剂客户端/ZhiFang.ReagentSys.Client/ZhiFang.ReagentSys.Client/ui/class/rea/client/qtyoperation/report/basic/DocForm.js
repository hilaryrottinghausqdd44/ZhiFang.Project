 ...
 * @version 2019-06-06
 */
Ext.define('Shell.class.rea.client.qtyoperation.report.basic.DocForm', {
	...
	changeResult: function(data) {
		...
		if(StartDate) data.ReaBmsQtyMonthBalanceDoc_StartDate = Ext.util.Format.date(StartDate, "Y-m-d");
		if(EndDate) data.ReaBmsQtyMonthBalanceDoc_EndDate = Ext.util.Format.date(EndDate, "Y-m-d");
