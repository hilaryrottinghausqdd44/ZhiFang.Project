 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.rea.client.goods.UploadPanel',{
    ...
    /**文件上传服务*/
   	url:'/ReaManageService.svc/RM_UDTO_UploadGoodsDataByExcel',
   	/**空白提示*/
    ...
    /**厂商信息*/
    Prod:{Id:'',Name:'',readOnly:false,hidden:false,allowBlank:false},
    ...
    createItems:function(){
		...
		items.push({
			...
			emptyText:'必填项',hidden:me.Prod.hidden,
			allowBlank:me.Prod.allowBlank ? true : false,
