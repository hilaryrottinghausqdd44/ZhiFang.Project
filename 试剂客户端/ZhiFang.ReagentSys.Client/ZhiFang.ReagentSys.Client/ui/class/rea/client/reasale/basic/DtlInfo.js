 ...
 * @version 2018-04-26
 */
Ext.define('Shell.class.rea.client.reasale.basic.DtlInfo', {
	...
	initData:function(data){
		...
		html = html.replace(/{ApproveDocNo}/g,data.ApproveDocNo || "");
		me.update(html);
	},
	/**清空数据*/
	clearData:function(){
	...
	getHtmlTemplet:function(){
		...
		'<div style="padding:10px;font-weight:bold;font-size:20px;">' +
			...
			'<div style="padding:2px;">供货数:<span style="color:green;">{GoodsQty}</span> {Unit}</div>' +
