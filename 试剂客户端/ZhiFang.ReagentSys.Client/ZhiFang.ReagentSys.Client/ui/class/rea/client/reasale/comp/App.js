 ...
 * @version 2018-04-26
 */
Ext.define('Shell.class.rea.client.reasale.comp.App', {
	...
	createItems: function() {
		var me = this;
		me.DocGrid = Ext.create('Shell.class.rea.client.reasale.comp.DocGrid', {
			header: false,
			itemId: 'DocGrid',
			region: 'west',
			width: 345,
		...
		me.EditPanel = Ext.create('Shell.class.rea.client.reasale.comp.EditPanel', {
			header: false,
			itemId: 'EditPanel',
			region: 'center',
			split: true,
