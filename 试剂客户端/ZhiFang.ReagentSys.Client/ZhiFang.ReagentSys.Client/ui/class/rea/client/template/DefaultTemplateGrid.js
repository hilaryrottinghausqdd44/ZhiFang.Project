 ...
 * @version 2017-09-08
 */
Ext.define('Shell.class.rea.client.template.DefaultTemplateGrid', {
	...
	height: 350,
	/**获取数据服务路径*/
	selectUrl: '/ReaSysManageService.svc/ST_UDTO_SearchBTemplateByHQL?isPlanish=true',
	/**修改服务地址*/
    editUrl:'/ReaSysManageService.svc/ST_UDTO_UpdateBTemplateByField',
	/**默认加载数据*/
	defaultLoad: false,
	/**货品编码*/
	ReaGoodsNo:null,
	...
	createGridColumns: function() {
		var me = this;
		var columns = [ {
			dataIndex: 'BTemplate_CName',text: '模板名称',width: 160,
			defaultRenderer: true
		},{
			dataIndex: 'BTemplate_SName',text: '简称',
			width: 100,defaultRenderer: true
		}, {
			dataIndex: 'BTemplate_Shortcode',text: '快捷码',
			width: 100,defaultRenderer: true
		},{
			dataIndex: 'BTemplate_IsDefault',
			text: '默认模板',width: 80,align:'center',
			type:'bool',isBool:true,
			...
			dataIndex: 'BTemplate_Id',text: '主键ID',
	...
	createButtonToolbarItems: function() {
		var me = this;
		var items = ['refresh','-',{
			emptyText:'模板类型',xtype: 'uxSimpleComboBox',
			name: 'BTemplateType',itemId: 'BTemplateType',
			hasStyle: true,	
