 ...
 * @version 2017-09-08
 */
Ext.define('Shell.class.rea.client.template.Grid', {
	...
	/**删除数据服务路径*/
	delUrl: '/ReaSysManageService.svc/ST_UDTO_DelBTemplate',
	/**修改服务地址*/
	editUrl: '/ReaSysManageService.svc/ST_UDTO_UpdateBTemplateByField',
	/**下载模板文件地址*/
	downLoadUrl: '/ReaSysManageService.svc/ST_UDTO_DownLoadTemplateFrx',
	/**默认加载数据*/
	defaultLoad: true,
	/**模板信息类型Key*/
