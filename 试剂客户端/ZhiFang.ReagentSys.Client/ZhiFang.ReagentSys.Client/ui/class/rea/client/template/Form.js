 ...
 * @version 2018-02-27
 */
Ext.define('Shell.class.rea.client.template.Form', {
	...
	autoScroll: false,
	/**获取数据服务路径*/
	selectUrl: '/ReaSysManageService.svc/ST_UDTO_SearchBTemplateById?isPlanish=true',
	/**新增服务地址*/
	addUrl: '/ReaSysManageService.svc/ST_UDTO_AddTemplateUploadFile',
	/**修改服务地址*/
	editUrl: '/ReaSysManageService.svc/ST_UDTO_UpdateTemplateAndUploadFileByField',
    /**布局方式*/
	layout: {
		type: 'table',
		columns:2 //每行有几列
