 ...
 * @version 2019-01-14
 */
Ext.define('Shell.class.rea.client.attachment.SCOperation', {
	...
	onLoadData: function(callback) {
		...
		url += '&where=scoperation.LabID=' + labID + ' and scoperation.BobjectID=' + me.PK + " and scoperation.BusinessModuleCode='SServiceClient'";
