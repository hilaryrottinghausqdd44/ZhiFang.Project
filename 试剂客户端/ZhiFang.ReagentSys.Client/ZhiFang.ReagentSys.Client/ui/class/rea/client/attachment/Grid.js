 ...
 * @version 2019-01-14
 */
Ext.define('Shell.class.rea.client.attachment.Grid', {
	...
	onImportExcelClick: function() {
		var me = this;
		JShell.Win.open('Shell.class.rea.client.attachment.UploadPanel', {
			formtype: 'add',
			resizable: false,
			listeners: {
	...
	showForm: function(record) {
		...
		JShell.Win.open('Shell.class.rea.client.attachment.SCOperation', config).show();
	}
});