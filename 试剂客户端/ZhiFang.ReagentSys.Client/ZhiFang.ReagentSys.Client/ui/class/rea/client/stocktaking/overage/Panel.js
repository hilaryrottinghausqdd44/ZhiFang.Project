 ...
 * @version 2018-03-20
 */
Ext.define('Shell.class.rea.client.stocktaking.overage.Panel', {
	...
	createItems: function() {
		var me = this;
		me.DtlGrid = Ext.create('Shell.class.rea.client.stocktaking.overage.DtlGrid', {
			header: false,
			itemId: 'DtlGrid',
			region: 'center',
			defaultLoad: false
		});
		me.DocForm = Ext.create('Shell.class.rea.client.stocktaking.overage.DocForm', {
			header: false,
			itemId: 'DocForm',
			region: 'north',
			height: 155,
