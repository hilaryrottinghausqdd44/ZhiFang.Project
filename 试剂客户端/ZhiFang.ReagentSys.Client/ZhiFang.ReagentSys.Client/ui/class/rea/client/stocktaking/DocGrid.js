 ...
 * @version 2018-03-20
 */
Ext.define('Shell.class.rea.client.stocktaking.DocGrid', {
	...
	getInternalWhere: function() {
		...
		var buttonsToolbar3 = me.getComponent('buttonsToolbar3'),
			...
			lock = buttonsToolbar3.getComponent('StocktakingLock');
