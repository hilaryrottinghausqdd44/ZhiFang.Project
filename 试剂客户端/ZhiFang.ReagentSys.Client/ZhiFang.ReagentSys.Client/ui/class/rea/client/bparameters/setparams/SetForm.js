 ...
 * @version 2020-04-14
 */
Ext.define("Shell.class.rea.client.bparameters.setparams.SetForm", {
	...
	loadBParameterList: function(callback) {
		var me = this;
		//从缓存读取
		var list = JcallShell.REA.cachedata.getCache("bparameterList");
		...
		JShell.Server.get(url, function(data) {
			...
			JcallShell.REA.cachedata.setCache("bparameterList", me.bparameterList)
