 ...
 * @version 2018-03-08
 */
Ext.define('Shell.class.rea.client.bparameters.runparams.Grid', {
	...
	initComponent: function() {
		...
		if(labId)
			me.defaultWhere = me.defaultWhere + " and bparameter.LabID=" + labId;
	...
	onBeforeLoad: function() {
		...
		if(!labId) {
			var error = me.errorFormat.replace(/{msg}/, "获取登录帐号的所属实验室编码(LabId)为空!");
