 ...
 * @version 2018-11-14
 */
Ext.define('Shell.class.rea.client.deptgoods.choose.LeftGrid', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ReaManageService.svc/RS_UDTO_SearchReaGoodsByHQL?isPlanish=true',
	...
	/**用户UI配置Key*/
	userUIKey: 'deptgoods.choose.LeftGrid',
	/**用户UI配置Name*/
	...
	initComponent: function() {
		...
		me.searchInfo = {
			...
			fields: ['reagoods.ReaGoodsNo', 'reagoods.CName', 'reagoods.SName', 'reagoods.GoodsClass',
				'reagoods.GoodsClassType', 'reagoods.DeptName', 'reagoods.PinYinZiTou', 'reagoods.SuitableType'
			]
		};
		//数据列
