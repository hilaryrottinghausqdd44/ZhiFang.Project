 ...
 * @version 2019-02-25
 */
Ext.define('Shell.class.rea.client.statistics.echart.stock.storage.App', {
	...
	selectUrl: '/ReaStatisticalAnalysisService.svc/RS_UDTO_SearchStockEChartsVOListByHql?isPlanish=true',
	...
	createItems: function() {
		...
		me.BarChart = Ext.create('Shell.class.rea.client.statistics.echart.stock.storage.BarChart', {
			region: 'center',
			header: false
		});
