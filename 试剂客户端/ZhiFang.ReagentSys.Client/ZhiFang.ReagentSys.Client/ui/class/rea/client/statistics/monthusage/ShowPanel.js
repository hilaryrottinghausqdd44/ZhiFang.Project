 ...
 * @version 2018-10-24
 */
Ext.define('Shell.class.rea.client.statistics.monthusage.ShowPanel', {
	...
	createItems: function() {
		var me = this;
		me.DocForm = Ext.create('Shell.class.rea.client.statistics.monthusage.add.DocForm', {
			header: false,
			itemId: 'DocForm',
			region: 'north',
			height: 170,
		...
		me.TabPanel = Ext.create('Shell.class.rea.client.statistics.monthusage.TabPanel', {
			header: false,
			itemId: 'TabPanel',
			region: 'center',
			split: true,
