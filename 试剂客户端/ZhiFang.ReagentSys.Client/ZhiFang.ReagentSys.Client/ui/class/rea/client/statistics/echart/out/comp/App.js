 ...
 * @version 2019-02-18
 */
Ext.define('Shell.class.rea.client.statistics.echart.out.comp.App', {
	...
	createItems: function() {
		...
		me.Grid = Ext.create('Shell.class.rea.client.statistics.echart.basic.comp.Grid', {
			region: 'west',
			header: false,
			width: 360,
			split: true,
		...
		me.BarChart = Ext.create('Shell.class.rea.client.statistics.echart.out.comp.BarChart', {
			region: 'center',
			header: false
		});
	...
	afterDataLoad: function(list) {
		...
		if(list && list.length > 0) {
			for(var i = list.length - 1; i >= 0; i--) {
				...
				var record = me.Grid.store.findRecord("ReaCenOrg_Id", list[i]["EChartsVO_ReaCompanyID"]);
				if(record) {
