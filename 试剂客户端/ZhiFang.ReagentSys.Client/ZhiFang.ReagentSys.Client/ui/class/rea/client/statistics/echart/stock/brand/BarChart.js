 ...
 * @version 2019-02-25
 */
Ext.define('Shell.class.rea.client.statistics.echart.stock.brand.BarChart', {
	...
	/**
	 * 更改图表
	 * @param {Object} list 格式[{'ProdOrgName':'aaa','SumTotal':10,'SumTotalPercent':'10%'}]
	 */
	changeData: function(list) {
		...
		for(var i = 0; i < len; i++) {
			...
			axisData.push(list[i].EChartsVO_ProdOrgName);
		}
