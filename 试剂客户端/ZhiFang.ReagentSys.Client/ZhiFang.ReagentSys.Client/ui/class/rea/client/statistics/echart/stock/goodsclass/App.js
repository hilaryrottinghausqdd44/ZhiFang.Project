 ...
 * @version 2019-02-25
 */
Ext.define('Shell.class.rea.client.statistics.echart.stock.goodsclass.App', {
	...
	createItems: function() {
		...
		me.BarChart = Ext.create('Shell.class.rea.client.statistics.echart.stock.goodsclass.BarChart', {
			region: 'center',
			header: false
		});
