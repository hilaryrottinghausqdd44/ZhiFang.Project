 ...
 * @version 2019-02-22
 */
Ext.define('Shell.class.rea.client.statistics.consume.equipreagent.App', {
	...
	createItems: function() {
		...
		me.TabPanel = Ext.create('Shell.class.rea.client.statistics.consume.equipreagent.TabPanel', {
			header: false,
			itemId: 'TabPanel',
			region: 'center',
			collapsible: false,
