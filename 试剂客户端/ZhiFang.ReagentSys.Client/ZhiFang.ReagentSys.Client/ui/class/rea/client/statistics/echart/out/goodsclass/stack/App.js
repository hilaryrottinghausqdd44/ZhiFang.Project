 ...
 * @version 2019-02-25
 */
Ext.define('Shell.class.rea.client.statistics.echart.out.goodsclass.stack.App', {
	...
	createItems: function() {
		...
		me.BarChart = Ext.create('Shell.class.rea.client.statistics.echart.out.goodsclass.stack.BarChart', {
			region: 'center',
			header: false
		});
