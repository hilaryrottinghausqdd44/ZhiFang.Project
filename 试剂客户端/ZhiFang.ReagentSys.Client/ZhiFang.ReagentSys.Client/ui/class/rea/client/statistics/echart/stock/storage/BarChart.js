 ...
 * @version 2019-02-25
 */
Ext.define('Shell.class.rea.client.statistics.echart.stock.storage.BarChart', {
	...
	changeData: function(list) {
		...
		for(var i = 0; i < len; i++) {
			...
			axisData.push(list[i].EChartsVO_StorageName);
		}
