 ...
 * @version 2018-11-14
 */
Ext.define('Shell.class.rea.client.goodsorglink.supply.choose.App1', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.rea.client.goodsorglink.supply.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.rea.client.goodsorglink.supply.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
