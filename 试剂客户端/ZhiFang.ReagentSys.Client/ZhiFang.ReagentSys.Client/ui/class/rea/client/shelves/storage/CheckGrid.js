...
Ext.define('Shell.class.rea.client.shelves.storage.CheckGrid',{
    ...
    /**是否单选*/
	checkOne:false,
    defaultOrderBy:[{property:'ReaStorage_IsMainStorage',direction:'DESC'},{property:'ReaStorage_DispOrder',direction:'ASC'}],
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			dataIndex: 'ReaStorage_IsMainStorage',text: '总库',
			width: 50,align:'center',type:'bool',
			isBool:true,defaultRenderer: true
		},{
			dataIndex: 'ReaStorage_DispOrder',text: '次序',
			width: 50,defaultRenderer: true
		},{
