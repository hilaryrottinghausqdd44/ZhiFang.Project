...
Ext.define('Shell.class.rea.client.goodslot.CheckGrid', {
	...
	createAddRec: function() {
		...
		var obj = {
			"ReaGoodsLot_Id": "",
			"ReaGoodsLot_GoodsID": me.GoodsID,
	...
	updateOne: function(index, record) {
		...
		params.fields = 'Id,ReaGoodsNo,Visible,InvalidDate,ProdDate,DispOrder,LotNo';
	...
	loadDataByGoodsID: function() {
		...
		var value="";var search1=null;
		var buttonsToolbar = me.getComponent('buttonsToolbar');		
		if(buttonsToolbar)search1=buttonsToolbar.getComponent("Search");
		if(search1)value=search1.getValue();		
		if(value)me.internalWhere = me.getSearchWhere(value);
		me.onSearch();
	}
});