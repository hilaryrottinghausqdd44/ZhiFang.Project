 ...
 * @version 2019-02-14
 */
Ext.define('Shell.class.rea.client.testitem.choose.App', {
	...
	createItems: function() {
		var me = this;
		me.LeftGrid = Ext.create('Shell.class.rea.client.testitem.choose.LeftGrid', {
			header: false,
			itemId: 'LeftGrid',
			region: 'west',
			width: "50%",
		...
		me.RightGrid = Ext.create('Shell.class.rea.client.testitem.choose.RightGrid', {
			header: false,
			itemId: 'RightGrid',
			region: 'center',
			split: false,
	...
	onSetLeftExternalWhere: function() {
		...
		if(arrIdStr && arrIdStr.length > 0) {
			externalWhere = "reatestitem.Id not in(" + arrIdStr.join(",") + ")";
		}
