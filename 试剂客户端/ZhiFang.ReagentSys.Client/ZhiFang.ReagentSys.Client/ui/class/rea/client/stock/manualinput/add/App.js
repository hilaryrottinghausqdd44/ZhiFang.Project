 ...
 * @version 2018-03-12
 */
Ext.define('Shell.class.rea.client.stock.manualinput.add.App', {
	...
	/**新增服务地址*/
	addUrl: '/ReaSysManageService.svc/ST_UDTO_AddReaBmsInDocAndDtlOfManualInput',
	/**修改服务地址*/
	...
	createItems: function() {
		var me = this;
		me.DocForm = Ext.create('Shell.class.rea.client.stock.manualinput.add.DocForm', {
			title: '验收单入库',
			itemId: 'DocGrid',
			region: 'north',
			header: false,
		...
		me.DtlGrid = Ext.create('Shell.class.rea.client.stock.manualinput.add.DtlGrid', {
			header: false,
			itemId: 'DtlGrid',
			region: 'center',
			defaultLoad: false,
	...
	onSave: function(status, confirmData) {
		...
		if(me.formtype == "edit") {
			params.fieldsDtl = "Id,GoodsUnit,LotNo,StorageID,PlaceID,StorageName,PlaceName,BiddingNo,ApproveDocNo,LotSerial,RegisterNo,Memo,ProdDate,InvalidDate,RegisterInvalidDate,GoodsQty,Price,SumTotal,TaxRate,ReaGoodsNo,ProdGoodsNo,CenOrgGoodsNo,GoodsNo,FactoryOutTemperature,ArrivalTemperature,AppearanceAcceptance";
			params.fields = docEntity.fields;
			params.dtEditList = dtlInfo.dtEditList;
