 ...
 * @version 2019-03-12
 */
Ext.define('Shell.class.rea.client.out.search.Form', {
	...
	createItems: function() {
		...
		items.push({
			...
			fieldLabel: '确认时间',
			name: 'ReaBmsOutDoc_ConfirmTime',
			itemId: 'ReaBmsOutDoc_ConfirmTime',
			//xtype: 'datefield',
			//format: 'Y-m-d',
			xtype: 'datetimefield',
			format: 'Y-m-d H:i:s',
			...
			fieldLabel: '确认备注',
			name: 'ReaBmsOutDoc_ConfirmMemo',
			itemId: 'ReaBmsOutDoc_ConfirmMemo',
			xtype: 'textarea',
			height: 22,
			colspan: 2,
			width: me.defaults.width * 2
