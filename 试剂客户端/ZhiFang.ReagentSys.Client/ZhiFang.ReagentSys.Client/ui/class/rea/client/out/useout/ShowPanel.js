 ...
 * @version 2019-03-12
 */
Ext.define('Shell.class.rea.client.out.useout.ShowPanel', {
	...
	createItems: function() {
		...
		me.DocForm = Ext.create('Shell.class.rea.client.out.useout.Form', {
			header: false,
			itemId: 'DocForm',
			region: 'north',
			height: 185,
		...
		me.DtlPanel = Ext.create('Shell.class.rea.client.out.useout.DtlPanel', {
			header: false,
			itemId: 'DtlPanel',
			region: 'center',
			split: true,
