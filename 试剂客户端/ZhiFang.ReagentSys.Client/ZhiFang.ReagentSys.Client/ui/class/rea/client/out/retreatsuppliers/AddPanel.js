 ...
 * @version 2019-03-18
 */
Ext.define('Shell.class.rea.client.out.retreatsuppliers.AddPanel', {
	...
	createItems: function() {
		var me = this;
		me.Form = Ext.create("Shell.class.rea.client.out.retreatsuppliers.Form", {
			region: 'north',
			height: 135,
			header: false,
			itemId: 'Form',
		...
		me.QtyDtlGrid = Ext.create('Shell.class.rea.client.out.retreatsuppliers.QtyDtlGrid', {
			region: 'north',
			height: 200,
			header: false,
			itemId: 'QtyDtlGrid',
		...
		me.DtlGrid = Ext.create('Shell.class.rea.client.out.retreatsuppliers.DtlGrid', {
			region: 'center',
			header: false,
			layout: 'fit',
			itemId: 'DtlGrid',
