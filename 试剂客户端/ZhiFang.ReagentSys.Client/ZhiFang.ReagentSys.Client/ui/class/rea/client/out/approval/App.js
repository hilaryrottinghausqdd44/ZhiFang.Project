 ...
 * @version 2019-03-18
 */
Ext.define('Shell.class.rea.client.out.approval.App', {
	...
	createItems: function() {
		var me = this;
		me.DocGrid = Ext.create('Shell.class.rea.client.out.approval.DocGrid', {
			header: false,
			title: '出库主单',
			itemId: 'DocGrid',
			region: 'west',
		...
		me.ShowPanel = Ext.create('Shell.class.rea.client.out.approval.ShowPanel', {
			header: false,
			itemId: 'ShowPanel',
			region: 'center',
			border: false,
