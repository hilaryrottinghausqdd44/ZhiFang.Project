/**
 * @description 部门智能采购申请录入
 * @author liuyj
 * @version 2020-12-15
 */
Ext.define('Shell.class.rea.client.apply.mind.App', {
	...
	createItems: function() {
		var me = this;
		me.ApplyGrid = Ext.create('Shell.class.rea.client.apply.mind.ApplyGrid', {
			header: false,
			itemId: 'ApplyGrid',
			region: 'west',
			width: 345,
		...
		me.EditPanel = Ext.create('Shell.class.rea.client.apply.mind.EditPanel', {
			header: false,
			itemId: 'EditPanel',
			region: 'center',
			collapsible: false,
