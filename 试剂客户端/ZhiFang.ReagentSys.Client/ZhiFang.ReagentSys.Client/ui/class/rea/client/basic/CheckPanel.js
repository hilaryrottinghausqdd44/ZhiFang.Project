 ...
 * @version 2018-12-12
 */
Ext.define('Shell.class.rea.client.basic.CheckPanel', {
	...
	initButtonToolbarItems:function(){
		...
		if(me.checkOne){
			if(me.searchInfo!=null&&!me.searchInfo.width) me.searchInfo.width = 145;
			//自定义按钮功能栏
			me.buttonToolbarItems = me.buttonToolbarItems || [];
			if(me.searchInfo!=null)me.buttonToolbarItems.push({type:'search',info:me.searchInfo});
			...
			if(me.searchInfo!=null&&!me.searchInfo.width) me.searchInfo.width = 205;
			//自定义按钮功能栏
			me.buttonToolbarItems = me.buttonToolbarItems || [];
			if(me.searchInfo!=null)me.buttonToolbarItems.push({type:'search',info:me.searchInfo});
