 ...
 * @version 2019-01-18
 */
Ext.define('Shell.class.rea.client.inventory.shortage.Panel', {
	...
	createItems: function() {
		var me = this;
		me.DtlGrid = Ext.create('Shell.class.rea.client.inventory.shortage.DtlGrid', {
			header: false,
			itemId: 'DtlGrid',
			region: 'center',
			defaultLoad: true
		});
		me.DocForm = Ext.create('Shell.class.rea.client.inventory.shortage.Form', {
			header: false,
			itemId: 'DocForm',
			region: 'north',
			height: 155,
