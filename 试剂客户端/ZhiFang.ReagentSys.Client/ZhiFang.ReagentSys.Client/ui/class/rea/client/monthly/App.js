 ...
 * @version 2018-04-13
 */
Ext.define('Shell.class.rea.client.monthly.App', {
	...
	createItems: function() {
		var me = this;
		me.DocGrid = Ext.create('Shell.class.rea.client.monthly.DocGrid', {
			header: false,
			itemId: 'DocGrid',
			region: 'west',
			width: 345,
		...
		me.ShowPanel = Ext.create('Shell.class.rea.client.monthly.ShowPanel', {
			header: false,
			itemId: 'ShowPanel',
			region: 'center',
			split: true,
