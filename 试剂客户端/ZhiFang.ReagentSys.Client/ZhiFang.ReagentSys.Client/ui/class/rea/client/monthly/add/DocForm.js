 ...
 * @version 2018-04-13
 */
Ext.define('Shell.class.rea.client.monthly.add.DocForm', {
	extend: 'Shell.class.rea.client.monthly.basic.DocForm',
	...
	/**新增服务地址*/
	addUrl: '/ReaManageService.svc/RS_UDTO_AddQtyBalanceReportOfQtyBalanceDtlList',
	/**修改服务地址*/
	editUrl: '',
	buttonDock: "top",
	/**是否启用保存按钮*/
	...
	getAddParams: function() {
		...
		var entity = {
			Id: -1,
			QtyBalanceDocNo: values.ReaBmsQtyMonthBalanceDoc_QtyBalanceDocNo,
		...
		if(values.ReaBmsQtyMonthBalanceDoc_QtyBalanceDocID) entity.QtyBalanceDocID = values.ReaBmsQtyMonthBalanceDoc_QtyBalanceDocID;
