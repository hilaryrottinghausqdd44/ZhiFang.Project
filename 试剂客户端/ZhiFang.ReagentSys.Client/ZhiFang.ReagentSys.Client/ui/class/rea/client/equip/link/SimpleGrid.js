 ...
 * @version 2018-02-27
 */
Ext.define('Shell.class.rea.client.equip.link.SimpleGrid',{
    ...
    CenOrgEnum:null,
    /**用户UI配置Key*/
	userUIKey: 'equip.link.SimpleGrid',
	/**用户UI配置Name*/
	userUIName: "仪器列表",
	...
	initComponent:function(){
		...
		//查询框信息
		me.searchInfo = {
			width:185,emptyText:'仪器名称/英文名称/仪器编码',isLike:true,itemId:'Search',
			fields:['reatestequiplab.CName','reatestequiplab.EName','reatestequiplab.LisCode']
		};		
