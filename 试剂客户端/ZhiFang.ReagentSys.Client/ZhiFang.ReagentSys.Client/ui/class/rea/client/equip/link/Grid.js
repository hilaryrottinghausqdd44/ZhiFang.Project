/**
 * 仪器试剂维护
 * Rea_EquipReagentLink
 * @author liangyl	
 * @version 2018-02-27
 */
Ext.define('Shell.class.rea.client.equip.link.Grid', {
	...
	/**删除数据服务路径*/
	delUrl: '/ReaSysManageService.svc/ST_UDTO_DelReaEquipReagentLink',
	/**修改服务地址*/
	editUrl: '/ReaSysManageService.svc/ST_UDTO_UpdateReaEquipReagentLinkByField',
	/**新增服务地址*/
	addUrl: '/ReaSysManageService.svc/ST_UDTO_AddReaEquipReagentLink',
	/**获取获取供应商数据服务路径*/
	...
	/**排序字段*/
	defaultOrderBy: [{
		property: 'ReaEquipReagentLink_DispOrder',
		direction: 'ASC'
	}],
	...
	createGridColumns: function() {
		...
		var columns = [{
			...
			dataIndex: 'ReaEquipReagentLink_ReaGoods_BarCodeMgr',
			text: '条码类型',
			hidden: true,
			width: 50,
			...
			renderer: function(value, meta, record) {
				var v = "";
				var barCodeMgr = record.get("ReaEquipReagentLink_ReaGoods_BarCodeMgr");
			...
			dataIndex: 'ReaEquipReagentLink_ReaGoods_SName',
			text: '简称',
			minWidth: 100,
			sortable: false,
			defaultRenderer: true
		}, {
			dataIndex: 'ReaEquipReagentLink_ReaGoods_ProdOrgName',
			text: '品牌',
			minWidth: 100,
			sortable: false,
			defaultRenderer: true
			...
			dataIndex: 'ReaEquipReagentLink_ReaGoods_ProdEara',
			text: '产地',
			minWidth: 100,
			sortable: false,
			defaultRenderer: true
	...
	onAddClick: function() {
		...
		var defaultWhere = " 1=1 ";//reagoods.Visible=1
		var arrIdStr = [],
			idStr = "";
		me.store.each(function(record) {
			var goodId = record.get("ReaEquipReagentLink_GoodsID");
	...
	getLinkByIds: function(ids, callback) {
		var me = this,
			...
			'?fields=ReaEquipReagentLink_GoodsID' +
			'&where=reaequipreagentlink.GoodsID in(' + ids.join(',') + ')  and reaequipreagentlink.TestEquipID=' + me.EquipID;
