 ...
 * @version 2017-08-09
 */
Ext.define('Shell.class.rea.sale.lab.manage.App', {
	...
	createItems:function(){
		...
		//主单列表
		me.DocGrid = Ext.create('Shell.class.rea.sale.lab.manage.DocGrid',{
			region:'center',itemId:'DocGrid',header:false,defaultLoad:true
		});
		//主单内容
		me.DocForm = Ext.create('Shell.class.rea.sale.lab.manage.DocForm',{
			region:'east',itemId:'DocForm',header:false,
			split:true,collapsible:true,collapseMode:'mini'
		});
		//明细列表
		me.DtlGrid = Ext.create('Shell.class.rea.sale.lab.manage.DtlGrid',{
