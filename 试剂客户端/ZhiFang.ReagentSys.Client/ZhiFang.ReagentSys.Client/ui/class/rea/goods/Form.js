...
Ext.define('Shell.class.rea.goods.Form', {
	...
	createItems:function(){
		...
		//生产厂家
		items.push({
			x:5,y:105,hidden:true,
			fieldLabel:'生产厂家',name:'Goods_ProdOrgName'
		});
		//拼音字头
		items.push({
			x:5,y:105,
			fieldLabel:'拼音字头',name:'Goods_PinYinZiTou'
		});
		...
		//单位
		items.push({
			x:405,y:80,labelWidth:80,width:220,locked:me.UnitLocked,readOnly:me.UnitReadOnly,
			fieldLabel:'单位',name:'Goods_UnitName',itemId:'Goods_UnitName',
			emptyText:'必填项',allowBlank:false
		});
		//单位描述
		items.push({
			x:405,y:105,labelWidth:80,width:220,locked:me.UnitLocked,readOnly:me.UnitReadOnly,
		...
		//测试数
		items.push({
			x:5,y:230,xtype:'numberfield',value:0,
			fieldLabel:'测试数',name:'Goods_TestCount'
		});
		//适用机型
		items.push({
			x:205,y:230,width:420,
	...
	getAddParams:function(){
		...
		var entity = {
			...
			ProdOrgName:values.Goods_Prod_CName,
			...
			TestCount:values.Goods_TestCount || 0,
			PinYinZiTou:values.Goods_PinYinZiTou
		};
	...
	getEditParams:function(){
		...
		var fields = [
			...
			'SuitableType','TestCount','PinYinZiTou'
		];
	...
	initFilterListeners: function() {
		var me = this,
			...
			Goods_CName = me.getComponent('Goods_CName');
