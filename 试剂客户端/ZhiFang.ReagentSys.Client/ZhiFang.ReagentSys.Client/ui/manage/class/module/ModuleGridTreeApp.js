Ext.ns('Ext.manage');
Ext.define('Ext.manage.module.ModuleGridTreeApp',{
	extend:'Ext.tree.Panel',
	alias: 'widget.modulegridtreeapp',
	//=====================可配参数=======================
	/**
	 * 面板标题
	 * @type String
...
//            {name:'RBACModule_BTDAppComponents_Id',type:'auto'},//模块应用Id
//            {name:'RBACModule_BTDAppComponents_CName',type:'auto'},//模块应用名称
//            {name:'RBACModule_BTDAppComponents_DataTimeStamp',type:'auto'}//模块应用时间戳
		]
    },
    //=====================内部视图渲染=======================
	/**
	...
	createColumns:function(){
		...
		var columns = [{
            ...
            width:205,sortable:true,
            dataIndex:'CName'
		},{
			text:'模块ID',dataIndex:'Id',width:150,hidden:true
		},{
            text:'模块父节点',dataIndex:'ParentID',width:150,hidden:true
        },{
			text:'入口地址',dataIndex:'Url',width:300,hidden:true
		},{
			text:'时间戳',dataIndex:'DataTimeStamp',hidden:true
		},{
            text:'模块类型',dataIndex:'ModuleType',hidden:true
        },
//        {
//            text:'模块应用Id',dataIndex:'RBACModule_BTDAppComponents_Id',hidden:false
//        },
//        {
//            text:'模块应用名称',dataIndex:'RBACModule_BTDAppComponents_CName',hidden:true
//        },
//        {
//            text:'模块应用时间戳',dataIndex:'RBACModule_BTDAppComponents_DataTimeStamp',hidden:true
//        },
        {
			xtype:'actioncolumn',text:'操作',width:90,align:'center',
			items:[{
				iconCls:'build-button-add hand',tooltip:'新增子模块',
                handler:function(grid,rowIndex,colIndex,item,e,record){
                    me.fireEvent('addClick',grid,rowIndex,colIndex,item,e,record);
                    if(me.isWindow==true){
                ...
                handler:function(grid,rowIndex,colIndex,item,e,record){
                    ...
                    if(me.isWindow==true){
	                	...
	                	me.itemButtonClick("edit",grid,rowIndex,colIndex,item,e,record);
                    }
                }
			},{
                ...
                handler:function(grid,rowIndex,colIndex,item,e,record){
                    ...
                    if(me.isWindow==true){
                	   me.itemButtonClick("show",grid,rowIndex,colIndex,item,e,record);
                    }
                }
			},{
	...
	createStore:function(){
		var me = this;
		var fields = "RBACModule_Id,RBACModule_ParentID,RBACModule_LevelNum,RBACModule_TreeCatalog,RBACModule_ModuleType" +
                ",RBACModule_CName,RBACModule_Url,RBACModule_DataTimeStamp";
	...
	createDockedItems:function(){
		...
		var dockedItems = [{
			...
			items:[
				...
				{text:'新增一级模块',tooltip:'新增一级模块',iconCls:'build-button-add',handler:function(button){
                    me.fireEvent('addClick',me,0,0,null,null,null);
	                if(me.isWindow==true){
	                    me.dockItemsAdd();
	                }
                }},
	...
	changeStoreData: function(response){
    	...
    	if(result.success){
	    	...
	    	var changeNode = function(node){
                ...
                for(var i in value){
                    node[i] = value[i];
                    //处理应用子数据对象(BTDAppComponents)
//                    if(i=='BTDAppComponents'&&value[i]!=null){
//                        var obj = value;
//                        var BTDAppComponents =obj.BTDAppComponents;
//                        node['RBACModule_BTDAppComponents_Id']=BTDAppComponents.Id;
//                        node['RBACModule_BTDAppComponents_CName']=BTDAppComponents.CName;
//                        node['RBACModule_BTDAppComponents_DataTimeStamp']=''+BTDAppComponents.DataTimeStamp; 
//                    }else{
//                        node[i] = value[i];
//                    }
                }
