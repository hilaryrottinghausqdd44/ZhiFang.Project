 ...
 *
 * Provides a date input field with a {@link Shell.ux.form.picker.DateTime datetime picker} dropdown and automatic date
 * validation.
 *
...
Ext.define('Shell.ux.form.field.DateTime', {
    ...
    requires: ['Shell.ux.form.picker.DateTime'],
    ...
    createPicker: function() {
        ...
        return new Shell.ux.form.picker.DateTime({
            pickerField: me,
            ownerCt: me.ownerCt,
