...
Ext.define('Shell.ux.grid.Panel', {
	...
	createStore: function() {
		...
		return Ext.create('Ext.data.Store', {
			...
			//sorters:me.defaultOrderBy,//解决在业务类的initComponent获取defaultOrderBy用JShell.JSON.encode解析出错的调整
			sorters: JShell.JSON.decode(JShell.JSON.encode(me.defaultOrderBy)),
			proxy: {
				type: 'ajax',
				url: '',
				reader: {
