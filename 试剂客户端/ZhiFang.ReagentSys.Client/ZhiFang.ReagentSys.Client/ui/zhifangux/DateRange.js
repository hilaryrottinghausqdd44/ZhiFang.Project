 ...
 * 
 * 
 *var dateRange=Ext.create('Ext.zhifangux.DateRange',
 *            {
 *            isOperation:false,
 *            name:"MEPTSampleInceptConditon_MEPTSampleIncept_DataAddTime",
 *            itemId:"MEPTSampleInceptConditon_MEPTSampleIncept_DataAddTime",
 *            fieldLabelOne:"签收日期",
 *            fieldLabelTwo:'',//第二个控件的显示名称设置
 *            layoutType:'hbox',//控件布局设置
 *            labelSeparatorOne:':',//分隔符
 *            labelSeparatorTwo:'',//分隔符
 *            labelWidthTwo:10,
 *            labelWidthOne:55,
 *            labelAlignOne:me.labelAlign,
 *            labelAlignTwo:me.labelAlign,
 *            valueOne:'',
 *            valueTwo:'',
 *            cls:'',//控件样式设置,默认值'bg-white',为"css/icon.css"里的.bg-white
 *           dateFormat:'Y-m-d',
 *            width:325,
 *            height:28,
 *            editable:true,
...
Ext.define('Ext.zhifangux.DateRange', {
    ...
    initConstants: function () {
      ...
      if(me.layoutType=="hbox")
      {
    	  ...
    	  //else if (me.fieldLabelOne!=""&&me.labelWidthOne!=0)
    	  //{
    		  //me.width=260+me.labelWidthOne;
    	  //}
          ...
          //else if (me.fieldLabelTwo!=""&&me.labelWidthTwo!=0)
          //{
             // me.width=260+me.labelWidthTwo;
          //}
      }else if(me.layoutType=="vbox")
      {
          me.height=56;
          if ((me.fieldLabelOne==""||me.fieldLabelTwo=="")&&(me.width<160))
          {
              me.fieldLabelTwo=" ";
              me.fieldLabelOne=" ";
              me.labelWidthTwo=0;
          ...
          //else if (me.fieldLabelOne!=""&&me.fieldLabelTwo!="")
          //{
              //me.width=105+me.labelWidthOne;
          //}
      }
      else{
          me.height=56;
    ...
    createDateTwo:function(){
        ...
        var datetime = {
            ...
            items: [{
                ...
                //name:'dateOne',
                name:me.name,
                fieldLabel:me.fieldLabelOne,
                labelWidth:me.labelWidthOne,
                labelAlign: me.labelAlignOne,
                labelSeparator :me.labelSeparatorOne,
                value:me.valueOne,
                editable:me.editable,
                format:me.dateFormat,
                width:96+me.labelWidthOne,
                listeners:{
                    change:function(){
            ...
            },
            {
                ...
                labelWidth:me.labelWidthTwo,
                labelAlign: me.labelAlignTwo,
                labelSeparator :me.labelSeparatorTwo,
                value:me.valueTwoTwo,
                editable:me.editableTwo,
                format:me.dateFormat,
                width:96+me.labelWidthTwo,
                listeners:{
                    change:function(){
