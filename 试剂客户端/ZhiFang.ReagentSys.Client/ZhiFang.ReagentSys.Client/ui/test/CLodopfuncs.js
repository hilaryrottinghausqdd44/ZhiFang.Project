(function (win) {
        var CLODOP = {
        strWebPageID:"7A9AABa",strTaskID:"",strHostURI:"http://192.168.1.108:8018",
        VERSION:"6.2.2.2",IVERSION:"6222",CVERSION:"3.0.4.1",HTTPS_STATUS:0,VERSION_EXT:true,
                ...
                function() {
                        ...
                        try {
                                if (!this.webskt || this.webskt.readyState==3) {
                                        ...
                                        this.webskt=new WebSocket('ws://192.168.1.108:8018/c_webskt/');
