	...
	createSouth:function(){
		...
		var com = {
			...
			columns:[//列模式的集合
				...
				{text:'region',dataIndex:'region',hidden:true},//border布局时的区域
				{text:'可收缩',dataIndex:'split',hidden:true},//可收缩
				{text:'可收缩',dataIndex:'collapsible',hidden:true},//可收缩
				{text:'默认收缩',dataIndex:'collapsed',hidden:true},//默认收缩
