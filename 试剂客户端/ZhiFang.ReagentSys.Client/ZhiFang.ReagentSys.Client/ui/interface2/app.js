...
Ext.onReady(function() {
	...
	if (params["ACCOUNT"]) config2.account = params["ACCOUNT"];
	if (params["PASSWORD"]) config2.password = params["PASSWORD"];
	JShell.Window = Ext.create('Ext.window.Window', config);
	var view = Ext.create('Shell.interface2.Viewport',config2);
