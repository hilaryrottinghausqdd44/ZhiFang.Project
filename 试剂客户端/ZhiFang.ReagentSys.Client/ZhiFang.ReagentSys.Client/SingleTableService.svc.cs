...
namespace ZhiFang.ReagentSys.Client
{
    ...
    public class SingleTableService : SingleTableServiceCommon, ZhiFang.ReagentSys.Client.ServerContract.ISingleTableService
    {
        ...
        public virtual IBBLodopTemplet IBBLodopTemplet { get; set; }
        ...
        public BaseResultBool ST_UDTO_UpdateBParameterListByBatch(IList<BParameter> entityList)
        {
            ...
            try
            {
                IList<BParameter> editList = new List<BParameter>();
                tempBaseResultBool = IBBParameter.EditBParameterListByBatch(entityList, ref editList);
            ...
            catch (Exception ex)
            {
                tempBaseResultBool.success = false;
                tempBaseResultBool.ErrorInfo = "错误信息：" + ex.Message;
                ZhiFang.Common.Log.Log.Error("ST_UDTO_UpdateBParameterListByBatch.Error" + ex.StackTrace);
            }
            return tempBaseResultBool;
        }
        #endregion
        ...
        //Add  BLodopTemplet
        public BaseResultDataValue ST_UDTO_AddBLodopTemplet(BLodopTemplet entity)
        {
        ...
        public BaseResultBool ST_UDTO_UpdateBLodopTemplet(BLodopTemplet entity)
        {
            IBBLodopTemplet.Entity = entity;
            BaseResultBool tempBaseResultBool = new BaseResultBool();
            try
        ...
        //Update  BLodopTemplet
        public BaseResultBool ST_UDTO_UpdateBLodopTempletByField(BLodopTemplet entity, string fields)
        {
            IBBLodopTemplet.Entity = entity;
            BaseResultBool tempBaseResultBool = new BaseResultBool();
            try
        ...
        public BaseResultBool ST_UDTO_DelBLodopTemplet(long longBLodopTempletID)
        {
            BaseResultBool tempBaseResultBool = new BaseResultBool();
            try
            {
        ...
        public BaseResultDataValue ST_UDTO_SearchBLodopTemplet(BLodopTemplet entity)
        {
            IBBLodopTemplet.Entity = entity;
        ...
        public BaseResultDataValue ST_UDTO_SearchBLodopTempletByHQL(int page, int limit, string fields, string where, string sort, bool isPlanish)
        {
            BaseResultDataValue tempBaseResultDataValue = new BaseResultDataValue();
            EntityList<BLodopTemplet> tempEntityList = new EntityList<BLodopTemplet>();
            try
        ...
        public BaseResultDataValue ST_UDTO_SearchBLodopTempletById(long id, string fields, bool isPlanish)
        {
            BaseResultDataValue tempBaseResultDataValue = new BaseResultDataValue();
            try
            {
