...
{
    [ServiceContract(Namespace = "ZhiFang.ReagentSys.Client.WeiXinAppService")]
    public interface IWeiXinAppService
    {
        ...
        [ServiceContractDescription(Name = "订单微信消息推送", Desc = "订单微信消息推送", Url = "WeiXinAppService.svc/PushAddReaBmsCenOrderDoc?Id={Id}", Get = "Id={Id}", Post = "", Return = "BaseResultList<BAccountType>", ReturnType = "ListBAccountType")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/PushAddReaBmsCenOrderDoc?Id={Id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue PushAddReaBmsCenOrderDoc(long Id);

        [ServiceContractDescription(Name = "订单确认微信消息推送", Desc = "订单确认微信消息推送", Url = "WeiXinAppService.svc/PushConfirmReaBmsCenOrderDoc?Id={Id}", Get = "Id={Id}", Post = "", Return = "BaseResultList<BAccountType>", ReturnType = "ListBAccountType")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/PushConfirmReaBmsCenOrderDoc?Id={Id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue PushConfirmReaBmsCenOrderDoc(long Id);
    }
}
