...
namespace ZhiFang.ReagentSys.Client.ServerContract
{
    ...
    { 
        ...
        #region BParameter
        [ServiceContractDescription(Name = "新增参数表(依ParaNo判断是否已存在)", Desc = "新增参数表(依ParaNo判断是否已存在)", Url = "SingleTableService.svc/ST_UDTO_AddBParameterByParaNo", Get = "", Post = "BParameter", Return = "BaseResultDataValue", ReturnType = "BParameter")]
        ...
        [ServiceContractDescription(Name = "修改参数表指定的属性(依ParaNo判断是否已存在)", Desc = "修改参数表指定的属性(依ParaNo判断是否已存在)", Url = "SingleTableService.svc/ST_UDTO_UpdateBParameterByParaNoAndField", Get = "", Post = "BParameter", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "通过参数编码查询参数表", Desc = "通过参数编码查询参数表", Url = "SingleTableService.svc/ST_UDTO_SearchBParameterByByParaNo?paraNo={paraNo}&groupNo={groupNo}&nodeName={nodeName}", Get = "paraNo={paraNo}&groupNo={groupNo}&nodeName={nodeName}", Post = "", Return = "BParameter", ReturnType = "BParameter")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchBParameterByByParaNo?paraNo={paraNo}&groupNo={groupNo}&nodeName={nodeName}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchBParameterByByParaNo(string paraNo, long groupNo, string nodeName);

        [ServiceContractDescription(Name = "按分组获取用户设置的系统运行参数集合信息(HQL)", Desc = "按分组获取用户设置的系统运行参数集合信息(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchBParameterOfUserSetByHQL?where={where}&sort={sort}", Get = "where={where}&sort={sort}", Post = "", Return = "BaseResultList<BParameter>", ReturnType = "ListBParameter")]
        ...
        [ServiceContractDescription(Name = "批量修改用户设置的系统运行参数值", Desc = "批量修改用户设置的系统运行参数值", Url = "SingleTableService.svc/ST_UDTO_UpdateBParameterListByBatch", Get = "", Post = "entityList", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "新增对象操作", Desc = "新增对象操作", Url = "SingleTableService.svc/ST_UDTO_AddBObjectOperate", Get = "", Post = "BObjectOperate", Return = "BaseResultDataValue", ReturnType = "BObjectOperate")]
        ...
        [ServiceContractDescription(Name = "修改样本操作", Desc = "修改样本操作", Url = "SingleTableService.svc/ST_UDTO_UpdateBObjectOperate", Get = "", Post = "BObjectOperate", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改样本操作指定的属性", Desc = "修改样本操作指定的属性", Url = "SingleTableService.svc/ST_UDTO_UpdateBObjectOperateByField", Get = "", Post = "BObjectOperate", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除样本操作", Desc = "删除样本操作", Url = "SingleTableService.svc/ST_UDTO_DelBObjectOperate?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询样本操作", Desc = "查询样本操作", Url = "SingleTableService.svc/ST_UDTO_SearchBObjectOperate", Get = "", Post = "BObjectOperate", Return = "BaseResultList<BObjectOperate>", ReturnType = "ListBObjectOperate")]
        ...
        [ServiceContractDescription(Name = "查询样本操作(HQL)", Desc = "查询样本操作(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchBObjectOperateByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BObjectOperate>", ReturnType = "ListBObjectOperate")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询样本操作", Desc = "通过主键ID查询样本操作", Url = "SingleTableService.svc/ST_UDTO_SearchBObjectOperateById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BObjectOperate>", ReturnType = "BObjectOperate")]
        ...
        [ServiceContractDescription(Name = "新增样本操作类型", Desc = "新增样本操作类型", Url = "SingleTableService.svc/ST_UDTO_AddBObjectOperateType", Get = "", Post = "BObjectOperateType", Return = "BaseResultDataValue", ReturnType = "BObjectOperateType")]
        ...
        [ServiceContractDescription(Name = "修改样本操作类型", Desc = "修改样本操作类型", Url = "SingleTableService.svc/ST_UDTO_UpdateBObjectOperateType", Get = "", Post = "BObjectOperateType", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改样本操作类型指定的属性", Desc = "修改样本操作类型指定的属性", Url = "SingleTableService.svc/ST_UDTO_UpdateBObjectOperateTypeByField", Get = "", Post = "BObjectOperateType", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除样本操作类型", Desc = "删除样本操作类型", Url = "SingleTableService.svc/ST_UDTO_DelBObjectOperateType?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询样本操作类型", Desc = "查询样本操作类型", Url = "SingleTableService.svc/ST_UDTO_SearchBObjectOperateType", Get = "", Post = "BObjectOperateType", Return = "BaseResultList<BObjectOperateType>", ReturnType = "ListBObjectOperateType")]
        ...
        [ServiceContractDescription(Name = "查询样本操作类型(HQL)", Desc = "查询样本操作类型(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchBObjectOperateTypeByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BObjectOperateType>", ReturnType = "ListBObjectOperateType")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询样本操作类型", Desc = "通过主键ID查询样本操作类型", Url = "SingleTableService.svc/ST_UDTO_SearchBObjectOperateTypeById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BObjectOperateType>", ReturnType = "BObjectOperateType")]
        ...
        [ServiceContractDescription(Name = "新增类型树", Desc = "新增类型树", Url = "SingleTableService.svc/UDTO_AddBDictTree", Get = "", Post = "BDictTree", Return = "BaseResultDataValue", ReturnType = "BDictTree")]
        ...
        [ServiceContractDescription(Name = "修改类型树", Desc = "修改类型树", Url = "SingleTableService.svc/UDTO_UpdateBDictTree", Get = "", Post = "BDictTree", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改类型树指定的属性", Desc = "修改类型树指定的属性", Url = "SingleTableService.svc/UDTO_UpdateBDictTreeByField", Get = "", Post = "BDictTree", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除类型树", Desc = "删除类型树", Url = "SingleTableService.svc/UDTO_DelBDictTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询类型树", Desc = "查询类型树", Url = "SingleTableService.svc/UDTO_SearchBDictTree", Get = "", Post = "BDictTree", Return = "BaseResultList<BDictTree>", ReturnType = "ListBDictTree")]
        ...
        [ServiceContractDescription(Name = "查询类型树(HQL)", Desc = "查询类型树(HQL)", Url = "SingleTableService.svc/UDTO_SearchBDictTreeByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BDictTree>", ReturnType = "ListBDictTree")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询类型树", Desc = "通过主键ID查询类型树", Url = "SingleTableService.svc/UDTO_SearchBDictTreeById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BDictTree>", ReturnType = "BDictTree")]
        ...
        [ServiceContractDescription(Name = "新增Lodop打印模板维护信息", Desc = "新增Lodop打印模板维护信息", Url = "SingleTableService.svc/ST_UDTO_AddBLodopTemplet", Get = "", Post = "BLodopTemplet", Return = "BaseResultDataValue", ReturnType = "BLodopTemplet")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_AddBLodopTemplet", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_AddBLodopTemplet(BLodopTemplet entity);

        [ServiceContractDescription(Name = "修改Lodop打印模板维护信息", Desc = "修改Lodop打印模板维护信息", Url = "SingleTableService.svc/ST_UDTO_UpdateBLodopTemplet", Get = "", Post = "BLodopTemplet", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateBLodopTemplet", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateBLodopTemplet(BLodopTemplet entity);

        [ServiceContractDescription(Name = "修改Lodop打印模板维护信息指定的属性", Desc = "修改Lodop打印模板维护信息指定的属性", Url = "SingleTableService.svc/ST_UDTO_UpdateBLodopTempletByField", Get = "", Post = "BLodopTemplet", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_UpdateBLodopTempletByField", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_UpdateBLodopTempletByField(BLodopTemplet entity, string fields);

        [ServiceContractDescription(Name = "删除Lodop打印模板维护信息", Desc = "删除Lodop打印模板维护信息", Url = "SingleTableService.svc/ST_UDTO_DelBLodopTemplet?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/ST_UDTO_DelBLodopTemplet?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool ST_UDTO_DelBLodopTemplet(long id);

        [ServiceContractDescription(Name = "查询Lodop打印模板维护信息", Desc = "查询Lodop打印模板维护信息", Url = "SingleTableService.svc/ST_UDTO_SearchBLodopTemplet", Get = "", Post = "BLodopTemplet", Return = "BaseResultList<BLodopTemplet>", ReturnType = "ListBLodopTemplet")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchBLodopTemplet", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchBLodopTemplet(BLodopTemplet entity);

        [ServiceContractDescription(Name = "查询Lodop打印模板维护信息(HQL)", Desc = "查询Lodop打印模板维护信息(HQL)", Url = "SingleTableService.svc/ST_UDTO_SearchBLodopTempletByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BLodopTemplet>", ReturnType = "ListBLodopTemplet")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchBLodopTempletByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchBLodopTempletByHQL(int page, int limit, string fields, string where, string sort, bool isPlanish);

        [ServiceContractDescription(Name = "通过主键ID查询Lodop打印模板维护信息", Desc = "通过主键ID查询Lodop打印模板维护信息", Url = "SingleTableService.svc/ST_UDTO_SearchBLodopTempletById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<BLodopTemplet>", ReturnType = "BLodopTemplet")]
        [WebGet(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/ST_UDTO_SearchBLodopTempletById?id={id}&fields={fields}&isPlanish={isPlanish}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue ST_UDTO_SearchBLodopTempletById(long id, string fields, bool isPlanish);
        #endregion
    }
}
