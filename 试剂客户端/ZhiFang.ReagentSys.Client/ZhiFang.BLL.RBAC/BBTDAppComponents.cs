...
{
    public class BBTDAppComponents : BaseBLL<BTDAppComponents>, ZhiFang.IBLL.RBAC.IBBTDAppComponents
    {
        public IDBaseDao<BTDAppComponentsRef,long> BTDAppComponentsRefDBDao { get; set; }
        public IDBaseDao<BTDAppComponentsOperate, long> BTDAppComponentsOperateDBDao { get; set; }
