...
namespace ZhiFang.ReagentSys.Client.Common
{
    ...
    public class ExportExcelCommand
    {
        ...
        protected string eEC_total;

        protected string eEC_apply;
        /// <summary>
        /// 当前日期
        /// </summary>
        ...
        /// 申请人
        /// </summary>
        public virtual string EEC_Apply
        {
            get
            {
                return eEC_apply;
        ...
        /// 明细统计合计数
        /// </summary>
        public virtual string EEC_Total
        {
            get
            {
                return eEC_total;
    ...
    public class ExcelReportHelp
    {
        ...
        public static void CreateEECDataTable(ExportExcelCommand excelCommand, ref DataSet dataSet)
        {
            ...
            eecDt.TableName = "Rea_ExportExcelCommand";
