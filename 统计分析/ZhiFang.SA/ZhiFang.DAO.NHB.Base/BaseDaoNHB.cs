...
namespace ZhiFang.DAO.NHB.Base
{
    public abstract class BaseDaoNHB<T, T1> : HibernateDaoSupport, IDBaseDao<T, T1> where T : BaseEntity
    {
        ...
        public void GetDataRowRoleHQLString()
        {
            ...
            string labid = ZhiFang.SA.Common.Cookie.CookieHelper.Read(ZhiFang.Entity.Base.SysPublicSet.SysDicCookieSession.LabID);
            string IsLabFlag = ZhiFang.SA.Common.Cookie.CookieHelper.Read(ZhiFang.Entity.Base.SysPublicSet.SysDicCookieSession.IsLabFlag);
