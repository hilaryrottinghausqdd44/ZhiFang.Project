...
namespace ZhiFang.SA
{
    public class EncodeFileName
    {
        ...
        public static string ToEncodeFileName(string fileName)
        {
            ...
            //{               
            //}
            //ZhiFang.Common.Log.Log.Debug("http_user_agent:" + HttpContext.Current.Request.ServerVariables["http_user_agent"].ToLower()+ ",IndexOf.firefox:"+ HttpContext.Current.Request.ServerVariables["http_user_agent"].ToLower().IndexOf("firefox"));
