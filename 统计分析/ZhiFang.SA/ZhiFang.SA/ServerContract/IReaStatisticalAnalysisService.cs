...
namespace ZhiFang.SA.ServerContract
{
    ...
    public interface IReaStatisticalAnalysisService
    {
        ...
        [OperationContract]
        BaseResultDataValue RS_UDTO_SearchDepartmentById(long id, string fields, bool isPlanish);
        #endregion
        ...
        [OperationContract]
        BaseResultDataValue RS_UDTO_SearchDoctorById(long id, string fields, bool isPlanish);
        #endregion
