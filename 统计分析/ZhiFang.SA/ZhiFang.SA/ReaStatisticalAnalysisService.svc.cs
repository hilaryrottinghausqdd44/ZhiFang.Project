...
namespace ZhiFang.SA
{
    ...
    public class ReaStatisticalAnalysisService : IReaStatisticalAnalysisService
    {
        ...
        IBLL.SA.IBNRequestForm IBNRequestForm { get; set; }
        IBLL.SA.IBPhraseswatch IBPhraseswatch { get; set; }
        IBLL.SA.IBPhrasesWatchClass IBPhrasesWatchClass { get; set; }
        IBLL.SA.IBPhrasesWatchClassItem IBPhrasesWatchClassItem { get; set; }
        IBLL.SA.IBLStatTotal IBLStatTotal { get; set; }
        ...
        public BaseResultDataValue RS_UDTO_SearchDepartmentById(long id, string fields, bool isPlanish)
        {
            BaseResultDataValue tempBaseResultDataValue = new BaseResultDataValue();
            try
            {
        ...
        public BaseResultDataValue RS_UDTO_SearchDoctorById(long id, string fields, bool isPlanish)
        {
            BaseResultDataValue tempBaseResultDataValue = new BaseResultDataValue();
            try
            {
