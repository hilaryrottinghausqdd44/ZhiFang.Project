...
namespace ZhiFang.Entity.SA
{
	...
	/// <summary>
	/// AgeUnit object for NHibernate mapped table 'AgeUnit'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "AgeUnit", ShortCode = "AgeUnit", Desc = "")]
	public class AgeUnit : BaseEntity
	{
		...
		public AgeUnit( string cName, string shortCode, int visible, int dispOrder, string hisOrderCode, string code1, string code2, string code3, string code4, string code5, string code6, string code7, string code8, string code9, string code10 )
		{
			this._cName = cName;
