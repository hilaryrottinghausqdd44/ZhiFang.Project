...
namespace ZhiFang.Entity.SA
{
	...
	public class PUser : BaseEntity
	{
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "HisOrder", Desc = "", ContextType = SysDic.All, Length = 4)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "HisOrderCode", Desc = "", ContextType = SysDic.All, Length = 50)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "Usertype", Desc = "", ContextType = SysDic.All, Length = 20)]
