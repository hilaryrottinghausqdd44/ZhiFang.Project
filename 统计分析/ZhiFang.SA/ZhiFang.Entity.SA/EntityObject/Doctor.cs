...
namespace ZhiFang.Entity.SA
{
	...
	public class Doctor : BaseEntity
	{
		...
		public Doctor( string cName, string shortCode, string hisOrderCode, int visible, string doctorPhoneCode, string code1, string code2, string code3, string code4, string code5, string adminName, int gradeNo, string code6, string code7, string code8, string code9, string code10 )
		{
			this._cName = cName;
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "DoctorPhoneCode", Desc = "", ContextType = SysDic.All, Length = 20)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "AdminName", Desc = "", ContextType = SysDic.All, Length = 20)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "GradeNo", Desc = "", ContextType = SysDic.All, Length = 4)]
        public virtual int GradeNo
		{
			get { return _gradeNo; }
			set { _gradeNo = value; }
		}
