...
namespace ZhiFang.Entity.SA
{
    ...
    public class BParameter : BaseEntity
    {
        ...
        public BParameter(long labID, long nodeID, long groupNo, string name, string sName, string paraNo, string paraType, string paraValue, string paraDesc, string shortcode, string pinYinZiTou, bool isUse, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, int dispOrder, BDict pDictId)
        {
            this._labID = labID;
            this._nodeID = nodeID;
