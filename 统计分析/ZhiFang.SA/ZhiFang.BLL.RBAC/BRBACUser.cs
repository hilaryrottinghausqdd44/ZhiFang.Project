...
namespace ZhiFang.BLL.RBAC
{
    ...
    public class BRBACUser : Base.BaseBLL<RBACUser>, IBRBACUser
    {
        ...
        public bool AddRBACUser(HREmployee emp, string strUserAccount, string pwd)
        {
            RBACUser entity = new RBACUser();
            if (string.IsNullOrEmpty(strUserAccount))
                entity.Account = PinYinConverter.Get(emp.CName);
            else
                entity.Account = strUserAccount;
            entity.Account = CheckUserAccount(entity.Account);
            entity.PWD = pwd;
            ...
            entity.IsUse = true;
            entity.EnMPwd = true;
            entity.PwdExprd = true;
            entity.AccBeginTime = DateTime.Now;
