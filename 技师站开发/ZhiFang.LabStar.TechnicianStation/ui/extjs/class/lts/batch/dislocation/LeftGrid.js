 ...
 * @version 2021-02-23
 */
Ext.define('Shell.class.lts.batch.dislocation.LeftGrid', {
	...
	initComponent:function(){
		var me = this;
		me.buttonToolbarItems =[{xtype: 'label',text: '当前检验单检验结果',margin: '0 0 0 10',style: "font-weight:bold;color:blue;"}];
		//数据列
	...
	createGridColumns:function(){
		...
		var columns = [{
            ...
            text: '项目名称',dataIndex: 'LisTestItem_LBItem_CName',sortable:false,menuDisabled:true,width: 130
        }, {
