 ...
 * @version 2020-09=09
 */
Ext.define('Shell.class.lts.sample.operate.basic.authorize.Info', {
	...
	initComponent:function(){
		...
		me.buttonToolbarItems = [{
			text:'采用',tooltip:'采用',iconCls:'button-accept',handler:function(){
				me.onAcceptClick();//确定选择行
			}
		}];
	...
	createItems:function(){
		var me = this;
		var items = [{
			xtype:'textarea',fieldLabel:'授权详细内容',name:'Comment',height:155,labelAlign:'top'
		},{
			xtype:'checkboxgroup',fieldLabel:'授权小组',itemId:'SectionID',
			columns:2,vertical:true,vertical:true,
			items:[]
		},{
			xtype:'textfield',fieldLabel:'',hidden:true,
			itemId:'LisOperateAuthorize_Id',name:'LisOperateAuthorize_Id'
		},{
			xtype:'textfield',fieldLabel:'授权操作类型',hidden:true,
			itemId:'LisOperateAuthorize_OperateType',name:'LisOperateAuthorize_OperateType'
		},{
			xtype:'textfield',fieldLabel:'授权人',hidden:true,
			itemId:'LisOperateAuthorize_OperateTypeID',name:'LisOperateAuthorize_OperateTypeID'
		},{
			xtype:'textfield',fieldLabel:'授权人',hidden:true,
			itemId:'LisOperateAuthorize_AuthorizeUserID',name:'LisOperateAuthorize_AuthorizeUserID'
		},{
			xtype:'textfield',fieldLabel:'被授权人',hidden:true,
			itemId:'LisOperateAuthorize_OperateUserID',name:'LisOperateAuthorize_OperateUserID'
		},{
			xtype:'textfield',fieldLabel:'授权人',hidden:true,
			itemId:'LisOperateAuthorize_AuthorizeUser',name:'LisOperateAuthorize_AuthorizeUser'
		},{
			xtype:'textfield',fieldLabel:'被授权人',hidden:true,
			itemId:'LisOperateAuthorize_OperateUser',name:'LisOperateAuthorize_OperateUser'
		},{
			xtype:'textfield',fieldLabel:'授权开始时间',hidden:true,
			itemId:'LisOperateAuthorize_BeginTime',name:'LisOperateAuthorize_BeginTime'
		},{
			xtype:'textfield',fieldLabel:'授权开始时间',hidden:true,
			itemId:'LisOperateAuthorize_EndTime',name:'LisOperateAuthorize_EndTime'
		},{
			xtype:'textfield',fieldLabel:'授权开始时间',hidden:true,
			itemId:'LisOperateAuthorize_AuthorizeInfo',name:'LisOperateAuthorize_AuthorizeInfo'
		},{
			xtype:'textfield',fieldLabel:'授权类型',hidden:true,
			itemId:'LisOperateAuthorize_AuthorizeType',name:'LisOperateAuthorize_AuthorizeType'
		},{
	...
	loadDataByID:function(id){
		...
		me.getOperateASection(id,function(list){
			...
			for(var i=0;i<list.length;i++){
				...
				itemlist.push({
					name:'LBSection',checked:true,
					boxLabel:list[i].LisOperateASection_LBSection_CName,
					inputValue: list[i].LisOperateASection_LBSection_Id
				});
			}
