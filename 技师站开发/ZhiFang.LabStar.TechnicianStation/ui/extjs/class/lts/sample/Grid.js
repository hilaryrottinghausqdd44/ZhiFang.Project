 ...
 * 默认查询日期：按设置的参数来
 */
Ext.define('Shell.class.lts.sample.Grid',{
...
//			,{
//				html:me.ColorLineTemplet.replace(/{color}/g,me.ColorMap.打印.color) + '打印'
//			},{
//				html:me.MainStatusTemplet.replace(/{color}/g,me.ColorMap.危急值.color).replace(/{text}/g,me.ColorMap.危急值.iconText) + '危急值'
//			},{
//				xtype:'button',text:'仪器状态',
//				menu:[{
//					text:me.ColorLineTemplet.replace(/{color}/g,me.ColorMap.仪器通过.color) + me.ColorMap.仪器通过.text,
//					tooltip:me.ColorMap.仪器通过.text
//				},{
//					text:me.ColorLineTemplet.replace(/{color}/g,me.ColorMap.仪器警告.color) + me.ColorMap.仪器警告.text,
//					tooltip:me.ColorMap.仪器警告.text
//				},{
//					text:me.ColorLineTemplet.replace(/{color}/g,me.ColorMap.仪器异常.color) + me.ColorMap.仪器异常.text,
//					tooltip:me.ColorMap.仪器异常.text
//				}]
//			},{
//				html:me.ColorLineTemplet.replace(/{color}/g,me.ColorMap.阳性保卡.color) + '阳性保卡'
//			}
			]
		};
		return dockedItems;
