 ...
 * @version 2020-05-11
 */
Ext.define('Shell.class.lts.operate.basic.Grid', {
	...
	createGridColumns:function(){		  
		...
		var columns = [{
			...
			text:'授权人',dataIndex:'LisOperateAuthorize_AuthorizeUser',width:85,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			text:'授权类型',dataIndex:'LisOperateAuthorize_AuthorizeType',width:80,
