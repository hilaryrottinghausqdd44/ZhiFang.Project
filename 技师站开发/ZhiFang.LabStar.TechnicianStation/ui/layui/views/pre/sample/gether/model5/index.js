layui.extend({
	...
	PreSampleGetherIndex:'modules/pre/sample/gether/model5/index',
	...
	function initToolbar(){
		...
		uxtoolbar.render({
			...
			buttons:[
				...
				{type:'check',text:'确认采样',iconCls:'layui-icon-ok-circle',buttonCls:''},
			...
			event:{
				check:function(){PreSampleGetherIndexInstance.updateSampleGatherState();},
