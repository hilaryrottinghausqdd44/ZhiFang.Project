...
layui.extend({
        ...
        config: {
            ...
            cols: [
                [
                    ...
                    { field: 'LisOrderForm_DestinationID', title: '送检目的地', width: 120, sort: false },
    ...
    Class.pt.iniListeners = function () {
        ...
        table.on('toolbar(mainTable)', function (obj) {
            ...
            switch (obj.event) {
                case 'PackingList': //打包清单
                    me.PackingList();
                    break;
                case 'PrintList': //打印清单
                    me.PrintList();
                    break;
                case 'CancelAcquisition': //撤销采集
                    me.CancelAcquisition();
                    break;
            };
        });
        //监听行单击事件
    ...
    //打包清单
    Class.pt.PackingList = function () {
        var me = this;
    }
    //打印清单
    Class.pt.PrintList = function () {
        var me = this;
    }
    //撤销采集
    Class.pt.CancelAcquisition = function () {
        var me = this;
    }
    //暴露接口
