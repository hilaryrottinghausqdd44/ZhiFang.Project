...
layui.extend({
    uxutil: 'ux/util',
    mainTable: 'views/system/setting/formItem/mainTable'
    ...
    function init() {
        ...
        setTimeout(function () {
            ...
            var IUrl = uxutil.path.ROOT + '/ui/layui/views/system/setting/formItem/main/app.html';
    ...
    function initGroupListeners() {
        ...
        layui.onevent('rightTableOnSearch', 'search', function (obj) {
            ...
            if (IFrame.layui.mainTable)
                IFrame.layui.mainTable.onSearch('mainTable', { FormID: obj.BModuleFormList_Id, FormCode: obj.BModuleFormList_FormCode, CName: obj.BModuleFormList_CName ,systemHost: uxutil.path.ROOT});
            else
                setTimeout(function () {
                    IFrame.layui.mainTable.onSearch('mainTable', { FormID: obj.BModuleFormList_Id, FormCode: obj.BModuleFormList_FormCode, CName: obj.BModuleFormList_CName ,systemHost: uxutil.path.ROOT});
                }, 500);
        ...
        layui.onevent('noData', 'noData', function (obj) {
            var IFrame = $("#rightTableIframe")[0].contentWindow;
            if (IFrame.layui.mainTable)
                IFrame.layui.mainTable.onSearch('mainTable', { FormID: null, FormCode: null, CName: null ,systemHost: uxutil.path.ROOT});
            else
                setTimeout(function () {
                    IFrame.layui.mainTable.onSearch('mainTable', { FormID: null, FormCode: null, CName: null ,systemHost: uxutil.path.ROOT});
                }, 500);
