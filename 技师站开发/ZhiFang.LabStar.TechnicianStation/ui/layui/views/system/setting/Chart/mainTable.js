...
layui.extend({
    ...
    var mainTable = {
        ...
        config: {
            ...
            selectUrl: uxutil.path.ROOT + '/ServerWCF/SingleTableService.svc/ST_UDTO_SearchBModuleChartListByHQL?isPlanish=true',
            addUrl: uxutil.path.ROOT + '/ServerWCF/SingleTableService.svc/ST_UDTO_AddBModuleChartList',
            editUrl: uxutil.path.ROOT + '/ServerWCF/SingleTableService.svc/ST_UDTO_UpdateBModuleChartListByField',
            delUrl: uxutil.path.ROOT + '/ServerWCF/SingleTableService.svc/ST_UDTO_DelBModuleChartList',
            where: "",
            toolbar: '#Toolbar',
            ...
            cols: [[
                ...
                { field: 'ChartID', width: 80, title: '主键ID', sort: false, hide: true },
                { field: 'LabID', width: 80, title: '实验室ID', sort: false, hide: true },
                { field: 'LabNo', title: '实验室No', width: 120, sort: true, hide: true },
                { field: 'QFuncID', width: 80, title: '快捷功能ID', sort: false, hide: true },
                { field: 'ChartCode', title: '图表代码', width: 120, sort: true },
                { field: 'SourceCodeUrl', title: '源代码Url', width: 120, sort: true },
                { field: 'SourceCode', title: '源代码', width: 120, sort: true },
                ...
                { field: 'TypeName', title: '类型名称', width: 120, sort: true, hide: false },
                { field: 'ClassID', title: '样式类型Id', width: 120, sort: true, hide: true },
                { field: 'ClassName', title: '样式类型名称', width: 120, sort: true, hide: false },
    ...
    Class.pt.addClick = function () {
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                entity["ChartCode"] = $("#ChartCode").val();
    ...
    Class.pt.delClick = function (checkData) {
        ...
        layer.confirm('确定删除选中项?', { icon: 3, title: '提示' }, function (index) {
            ...
            $.each(checkData, function (i, item) {
                var url = me.config.delUrl + '?id=' + item.ChartID;
                uxutil.server.ajax({
                    url: url
                }, function (data) {
