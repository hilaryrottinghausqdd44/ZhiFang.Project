...
layui.extend({
    uxutil: 'ux/util',
    mainTable: 'views/system/setting/tableColumn_client/main/mainTable'
    ...
    function init() {
        ...
        if (String(config.params.isSearch) == "true") {
            setTimeout(function () {
                mainTable.onSearch('mainTable',{GridCode:config.params.gridCode,userOpen:config.params.userOpen,systemHost:config.params.systemHost});
            }, 100);
        }
        //监听联动
        initGroupListeners();
