...
layui.extend({
    uxutil: 'ux/util',
    mainTable: 'views/system/setting/tableColumn_client/mainTable'
    ...
    function init() {
        ...
        setTimeout(function () {
            ...
            var IUrl = uxutil.path.ROOT + '/ui/layui/views/system/setting/tableColumn_client/main/app.html';
    ...
    function initGroupListeners() {
        ...
        layui.onevent('rightTableOnSearch', 'search', function (obj) {
            ...
            if (IFrame.layui.mainTable)
                IFrame.layui.mainTable.onSearch('mainTable', { GridCode: obj["BModuleGridList_GridCode"],systemHost: uxutil.path.ROOT });
            else
                setTimeout(function () {
                    IFrame.layui.mainTable.onSearch('mainTable', { GridCode: obj["BModuleGridList_GridCode"],systemHost: uxutil.path.ROOT});
                }, 500);
        ...
        layui.onevent('noData', 'noData', function (obj) {
            var IFrame = $("#rightTableIframe")[0].contentWindow;
            if (IFrame.layui.mainTable)
                IFrame.layui.mainTable.onSearch('mainTable', { GridCode: null ,systemHost: uxutil.path.ROOT});
            else
                setTimeout(function () {
                    IFrame.layui.mainTable.onSearch('mainTable', { GridCode: null,systemHost: uxutil.path.ROOT });
                }, 500);
