...
layui.extend({
	...
	var tableObj = {
		...
		fields:{
			Id:"LBSickType_Id",
			IsUse:'LBSickType_IsUse'
        },
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_AddLBSickType',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBSickTypeByHQL?isPlanish=true&sort=[{property:"LBSickType_DispOrder",direction:"ASC"}]',
        updateUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_UpdateLBSickTypeByField',
        delUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_DelLBSickType',
        ...
        reset: function () { //重置
            if (formObj.type == 'edit' || formObj.type == 'show') {
                if (tableObj.checkRowData.length > 0) {
                    ...
                    if (tableObj.checkRowData[tableObj.checkRowData.length - 1].LBSickType_IsUse == "true") {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'LBSickType_CName',
                    title: '就诊类型名称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSickType_SName',
                    title: '简称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSickType_EName',
                    title: '英文名',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSickType_Shortcode',
                    title: '快捷码',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSickType_PinYinZiTou',
                    title: '拼音字头',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSickType_UseCode',
                    title: '用户编码',
                    sort: true,
                    hide: true,
                    minWidth: 70
                ...
                {
                    field: 'LBSickType_StandCode',
                    title: '标准编码',
                    minWidth: 100,
                    sort: true,
                    hide: true
                }, {
                    field: 'LBSickType_DispOrder',
                    title: '排列次序',
                    minWidth: 100,
                    sort: true
                },
    ...
    function getDispOrder() {
        uxutil.server.ajax({
            url: tableObj.getMaxNoByEntityFieldUrl + '?entityName=LBSickType&entityField=DispOrder'
        }, function (res) {
            if (res.success) {
