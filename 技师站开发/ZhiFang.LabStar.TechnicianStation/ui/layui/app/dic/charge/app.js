...
layui.extend({
	...
	var tableObj = {
		...
		fields:{
			Id:"LBChargeType_Id",
			IsUse:'LBChargeType_IsUse'
        },
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_AddLBChargeType',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBChargeTypeByHQL?isPlanish=true&sort=[{property:"LBChargeType_DispOrder",direction:"ASC"}]',
        updateUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_UpdateLBChargeTypeByField',
        delUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_DelLBChargeType',
        ...
        reset: function () { //重置
            if (formObj.type == 'edit' || formObj.type == 'show') {
                if (tableObj.checkRowData.length > 0) {
                    ...
                    if (tableObj.checkRowData[tableObj.checkRowData.length - 1].LBChargeType_IsUse == "true") {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'LBChargeType_CName',
                    title: '就诊类型名称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBChargeType_SName',
                    title: '简称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBChargeType_EName',
                    title: '英文名',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBChargeType_Shortcode',
                    title: '快捷码',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBChargeType_PinYinZiTou',
                    title: '拼音字头',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBChargeType_UseCode',
                    title: '用户编码',
                    sort: true,
                    hide: true,
                    minWidth: 70
                ...
                {
                    field: 'LBChargeType_StandCode',
                    title: '标准编码',
                    minWidth: 100,
                    sort: true,
                    hide: true
                }, {
                    field: 'LBChargeType_DispOrder',
                    title: '排列次序',
                    minWidth: 100,
                    sort: true
                },
    ...
    function getDispOrder() {
        uxutil.server.ajax({
            url: tableObj.getMaxNoByEntityFieldUrl + '?entityName=LBChargeType&entityField=DispOrder'
        }, function (res) {
            if (res.success) {
