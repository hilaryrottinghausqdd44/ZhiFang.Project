layui.extend({
	...
	//获取采样组项目列表数据
	var GET_ITEM_LIST_URL = uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBSectionItemVOByHQL?isPlanish=true';
	...
	var lefttable = {
		...
		config:{
			...
			cols:[[
				...
				{field:'LBSectionItemVO_LBSectionItem_Id',width: 150,title: '小组项目ID',sort: true,hide:true},
				{field:'LBSectionItemVO_LBItem_Id',width: 150,title: '项目编号',sort: true},
                {field:'LBSectionItemVO_LBItem_CName', minWidth:150,flex:1, title: '项目名称', sort: true},
			    {field:'LBSectionItemVO_LBItem_EName', width:150, title: '英文名称', sort: true},
