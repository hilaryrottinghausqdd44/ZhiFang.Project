...
layui.extend({
	...
	var tableObj = {
		...
		fields:{
			Id:"LBSpecialty_Id",
			IsUse:'LBSpecialty_IsUse'
        },
        current: null,
        delIndex:null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_AddLBSpecialty',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBSpecialtyByHQL?isPlanish=true&sort=[{property:"LBSpecialty_DispOrder",direction:"ASC"}]',
        updateUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_UpdateLBSpecialtyByField',
        delUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_DelLBSpecialty',
        ...
        reset: function () { //重置
            if (formObj.type == 'edit' || formObj.type == 'show') {
                if (tableObj.checkRowData.length > 0) {
                    ...
                    if (tableObj.checkRowData[tableObj.checkRowData.length - 1].LBSpecialty_IsUse == "true") {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'LBSpecialty_CName',
                    title: '名称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSpecialty_SName',
                    title: '简称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSpecialty_EName',
                    title: '英文名',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSpecialty_Shortcode',
                    title: '快捷码',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSpecialty_PinYinZiTou',
                    title: '拼音字头',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBSpecialty_UseCode',
                    title: '用户编码',
                    sort: true,
                    hide: true,
                    minWidth: 70
                ...
                {
                    field: 'LBSpecialty_StandCode',
                    title: '标准编码',
                    minWidth: 100,
                    sort: true,
                    hide: true
                }, {
                    field: 'LBSpecialty_DispOrder',
                    title: '排列次序',
                    minWidth: 100,
                    sort: true
                },
		...
		switch(obj.event) {
            ...
            case 'import':
                layer.open({
                    ...
                    title: '选择导入文件',
                    area: ['400px', '160px'],
                    content: uxutil.path.LAYUI + '/views/system/comm/import/file/index.html?ENTITYNAME=LBSpecialty',
    ...
    function getDispOrder() {
        uxutil.server.ajax({
            url: tableObj.getMaxNoByEntityFieldUrl + '?entityName=LBSpecialty&entityField=DispOrder'
        }, function (res) {
            if (res.success) {
