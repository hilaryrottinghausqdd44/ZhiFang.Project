...
layui.extend({
	...
	var tableObj = {
		...
		fields:{
			Id:"LBCollectPart_Id",
			IsUse:'LBCollectPart_IsUse'
        },
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_AddLBCollectPart',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBCollectPartByHQL?isPlanish=true&sort=[{property:"LBCollectPart_DispOrder",direction:"ASC"}]',
        updateUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_UpdateLBCollectPartByField',
        delUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_DelLBCollectPart',
        ...
        reset: function () { //重置
            if (formObj.type == 'edit' || formObj.type == 'show') {
                if (tableObj.checkRowData.length > 0) {
                    ...
                    if (tableObj.checkRowData[tableObj.checkRowData.length - 1].LBCollectPart_IsUse == "true") {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'LBCollectPart_CName',
                    title: '名称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBCollectPart_SName',
                    title: '简称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBCollectPart_EName',
                    title: '英文名',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBCollectPart_Shortcode',
                    title: '快捷码',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBCollectPart_PinYinZiTou',
                    title: '拼音字头',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBCollectPart_UseCode',
                    title: '用户编码',
                    sort: true,
                    hide: true,
                    minWidth: 70
                ...
                {
                    field: 'LBCollectPart_StandCode',
                    title: '标准编码',
                    minWidth: 100,
                    hide: true,
                    sort: true
                }, {
                    field: 'LBCollectPart_DispOrder',
                    title: '排列次序',
                    minWidth: 100,
                    sort: true
                },
    ...
    function getDispOrder() {
        $.ajax({
            type: "get",
            url: tableObj.getMaxNoByEntityFieldUrl + '?entityName=LBCollectPart&entityField=DispOrder',
            cache: false,
            dataType: 'json',
            success: function (res) {
                if (res.success) {
