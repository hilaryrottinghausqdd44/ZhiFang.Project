...
layui.extend({
	uxutil: 'ux/util',
	sortlist:'app/dic/test_item/item_sort/list'
    ...
    var fields = {
        Id: "LBItem_Id",
        DispOrder: "LBItem_DispOrder"
    };
    var paramsObj = {
        url: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBItemListByHQL?isPlanish=true&sort=[{property:"LBItem_DispOrder",direction:"ASC"}]',
        searchWhere: null
    };
    getParams();
    //获得传递参数
