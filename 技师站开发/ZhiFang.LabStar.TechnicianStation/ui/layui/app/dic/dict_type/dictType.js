...
layui.extend({
    ...
    var tableObj = {
        ...
        fields: {
            Id: "LBDictType_Id",
            IsUse: 'LBDictType_IsUse'
        },
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_AddLBDictType',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBDictTypeByHQL?isPlanish=true&sort=[{property:"LBDictType_DispOrder",direction:"ASC"}]',
        updateUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_UpdateLBDictTypeByField',
        delUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_DelLBDictType',
        ...
        reset: function () { //重置
            if (formObj.type == 'edit' || formObj.type == 'show') {
                if (tableObj.checkRowData.length > 0) {
                    ...
                    if (tableObj.checkRowData[tableObj.checkRowData.length - 1].LBDictType_IsUse == "true") {
    ...
    function tableRender() {
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'LBDictType_CName',
                    title: '名称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBDictType_DictTypeCode',
                    title: '编码',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBDictType_SName',
                    title: '简称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBDictType_EName',
                    title: '英文名',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBDictType_Shortcode',
                    title: '快捷码',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBDictType_PinYinZiTou',
                    title: '拼音字头',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBDictType_UseCode',
                    title: '用户编码',
                    sort: true,
                    hide: true,
                    minWidth: 70
    ...
    function getDispOrder() {
        uxutil.server.ajax({
            url: tableObj.getMaxNoByEntityFieldUrl + '?entityName=LBDictType&entityField=DispOrder'
        }, function (res) {
            if (res.success) {
