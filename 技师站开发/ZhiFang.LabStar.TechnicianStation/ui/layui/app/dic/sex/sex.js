...
layui.extend({
	...
	var tableObj = {
		...
		fields:{
			Id:"LBGender_Id",
			IsUse:'LBGender_IsUse'
        },
        current: null,
        delIndex: null,
        addUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_AddLBGender',
        selectUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBGenderByHQL?isPlanish=true&sort=[{property:"LBGender_DispOrder",direction:"ASC"}]',
        updateUrl: uxutil.path.ROOT +'/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_UpdateLBGenderByField',
        delUrl: uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_DelLBGender',
        ...
        reset: function () { //重置
            if (formObj.type == 'edit' || formObj.type == 'show') {
                if (tableObj.checkRowData.length > 0) {
                    ...
                    if (tableObj.checkRowData[tableObj.checkRowData.length - 1].LBGender_IsUse == "true") {
    ...
    function tableRender() {
        ...
        tableObj.table.render({
            ...
            cols: [
                ...
                {
                    field: 'LBGender_CName',
                    title: '性别名称',
                    minWidth: 130,
                    sort: true
                },
                {
                    field: 'LBGender_SName',
                    title: '简称',
                    sort: true,
                    minWidth: 70
                },
                {
                    field: 'LBGender_EName',
                    title: '英文名',
                    sort: true,
                    minWidth: 70
                },
                {
                    field: 'LBGender_Shortcode',
                    title: '快捷码',
                    sort: true,
                    minWidth: 70
                },
                {
                    field: 'LBGender_PinYinZiTou',
                    title: '拼音字头',
                    sort: true,
                    minWidth: 70
                },
                {
                    field: 'LBGender_DeveCode',
                    title: '开发商标准码',
                    minWidth: 130,
                    hide: true,
                    sort: true
                ...
                {
                    field: 'LBGender_StandCode',
                    title: '标准编码',
                    minWidth: 100,
                    hide: true,
                    sort: true
                }, {
                    field: 'LBGender_DispOrder',
                    title: '排列次序',
                    minWidth: 100,
                    sort: true
                },
    ...
    function getDispOrder() {
        uxutil.server.ajax({
            url: tableObj.getMaxNoByEntityFieldUrl + '?entityName=LBGender&entityField=DispOrder'
        }, function (res) {
            if (res.success) {
