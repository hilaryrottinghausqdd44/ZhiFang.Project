/**
 * @name：modules/pre/sample/barcode/basic/hosttype 站点类型
 * @author：Jcall
 * @version 2020-08-17
 */
layui.extend({
	...
	Class.prototype.getHistoryInfo = function(){
		...
		return uxutil.localStorage.get('PreSampleBarcodeBasicHostType_' + empId,true);
	};
	...
	Class.prototype.insertHistoryInfo = function(info){
		...
		uxutil.localStorage.set('PreSampleBarcodeBasicHostType_' + empId,JSON.stringify(info));
	};
