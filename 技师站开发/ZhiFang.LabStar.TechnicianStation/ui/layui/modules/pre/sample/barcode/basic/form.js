/**
 * @name：modules/pre/sample/barcode/form 撤销确认
 * @author：GUOHX
 * @version 2021-12-09
 */
layui.extend({
	...
	//扫码获取信息
	var BARCODE_LIST_URL = uxutil.path.ROOT + "/ServerWCF/LabStarPreService.svc/LS_UDTO_PreSampleAffirmDataVerifyByBarCode";
	//撤销确认服务
	var SAVE_REVOCATION_URL = uxutil.path.ROOT + "/ServerWCF/LabStarPreService.svc/LS_UDTO_PreSampleRevocationAffirmByBarCode";
		//样本单信息字段
	var FIELDS = [
