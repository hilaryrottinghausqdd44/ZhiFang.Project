/**
 * @name：modules/common/select/sampletype 样本类型下拉框
 * @author：zhangda
 * @version 2020-09-15
 */
layui.extend({
	...
	var $ = layui.$,
		...
		MOD_NAME = 'CommonSelectSampleType';

	var SELECT_URL = uxutil.path.ROOT + '/ServerWCF/LabStarBaseTableService.svc/LS_UDTO_SearchLBSampleTypeByHQL?isPlanish=true' +
	...
	var Module = {
		...
		config: {
			...
			keyField: 'LBSampleType_Id',//值字段
			valueField: 'LBSampleType_CName',//显示文字字段
