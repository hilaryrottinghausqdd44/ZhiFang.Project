var Lodop = {
    Win32_Install_URL: Shell.util.Path.ROOT + '/ui/src/lodop/resources/CLodop_Setup_for_Win32NT_3.041Extend.exe',
    Win32_Update_URL: Shell.util.Path.ROOT + '/ui/src/lodop/resources/CLodop_Setup_for_Win32NT_3.041Extend.exe',
    Win64_Install_URL: Shell.util.Path.ROOT + '/ui/src/lodop/resources/CLodop_Setup_for_Win64NT_3.041Extend.exe',
    Win64_Update_URL: Shell.util.Path.ROOT + '/ui/src/lodop/resources/CLodop_Setup_for_Win64NT_3.041Extend.exe',
    //获取LODOP
    getLodop: function () {
        var me = this,
            lodop = null;
