...
namespace ZhiFang.IDAO.Base
{
    public interface IDBaseDao<T, T1>
    {
        ...
        ZhiFang.Entity.Base.EntityPageList<T> GetListByHQL(long id, string strHqlWhere, string Order, int start, int count);

        ZhiFang.Entity.Base.EntityPageList<T> GetListByHQL(long id, string strHqlWhere, string Order, int start, int count, string strHQL, string strHQLCount);
        ...
        IList<T> GetListByHQL(string strHqlWhere, string[] listEntityName);

        ZhiFang.Entity.Base.EntityList<T> GetListByHQL(string strHqlWhere, string order, int start, int count, string[] listEntityName);

        string GetBaseDataFilter();
