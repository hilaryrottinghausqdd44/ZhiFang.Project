...
namespace ZhiFang.Entity.LabStar
{
	...
	/// <summary>
	/// LBCollectPart object for NHibernate mapped table 'LB_CollectPart'.
	/// </summary>
	[DataContract]
	[DataDesc(CName = "采样部位", ClassCName = "LBCollectPart", ShortCode = "LBCollectPart", Desc = "采样部位")]
	public class LBCollectPart : BaseEntity
	{
		...
		public LBCollectPart() { }

		public LBCollectPart(long labID, string cName, string eName, string sName, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
		{
			this._labID = labID;
			this._cName = cName;
			this._eName = eName;
