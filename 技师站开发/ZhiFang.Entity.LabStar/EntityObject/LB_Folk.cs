...
namespace ZhiFang.Entity.LabStar
{
    ...
    /// <summary>
    /// LBFolk object for NHibernate mapped table 'LB_Folk'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "LBFolk", ShortCode = "LBFolk", Desc = "")]
    public class LBFolk : BaseEntity
    {
        ...
        public LBFolk(string cName, string eName, string sName, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, long labID, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
        {
            this._cName = cName;
            this._eName = eName;
            this._sName = sName;
