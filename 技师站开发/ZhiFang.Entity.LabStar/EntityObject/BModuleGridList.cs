...
namespace ZhiFang.Entity.LabStar
{
	...
	/// <summary>
	/// BModuleGridList object for NHibernate mapped table 'B_Module_GridList'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "BModuleGridList", ShortCode = "BModuleGridList", Desc = "")]
	public class BModuleGridList : BaseEntity
	{
