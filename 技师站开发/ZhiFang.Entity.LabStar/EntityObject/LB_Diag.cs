...
namespace ZhiFang.Entity.LabStar
{
    ...
    /// <summary>
    /// LBDiag object for NHibernate mapped table 'LB_Diag'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "LBDiag", ShortCode = "LBDiag", Desc = "")]
    public class LBDiag : BaseEntity
    {
        ...
        public LBDiag(string cName, string eName, string sName, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, long labID, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
        {
            this._cName = cName;
            this._eName = eName;
            this._sName = sName;
