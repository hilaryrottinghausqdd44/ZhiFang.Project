...
namespace ZhiFang.Entity.LabStar
{
	...
	/// <summary>
	/// LBPhyPeriod object for NHibernate mapped table 'LB_PhyPeriod'.
	/// </summary>
	[DataContract]
	[DataDesc(CName = "生理期", ClassCName = "LBPhyPeriod", ShortCode = "LBPhyPeriod", Desc = "生理期")]
	public class LBPhyPeriod : BaseEntity
	{
		...
		public LBPhyPeriod(long labID, string cName, string eName, string sName, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
		{
			this._labID = labID;
			this._cName = cName;
			this._eName = eName;
