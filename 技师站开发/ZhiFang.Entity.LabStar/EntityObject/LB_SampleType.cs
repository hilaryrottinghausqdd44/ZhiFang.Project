...
namespace ZhiFang.Entity.LabStar
{
    ...
    /// <summary>
    /// LBSampleType object for NHibernate mapped table 'LB_SampleType'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "样本类型", ClassCName = "LBSampleType", ShortCode = "LBSampleType", Desc = "样本类型")]
    public class LBSampleType : BaseEntity
    {
        ...
        public LBSampleType(long parSampleTypeID, string cName, string eName, string sName, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, long labID, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, int sampleTypeNo)
        {
        ...
        [DataMember]
        [DataDesc(CName = "样本类型编码", ShortCode = "SampleTypeNo", Desc = "样本类型编码", ContextType = SysDic.All, Length = 4)]
