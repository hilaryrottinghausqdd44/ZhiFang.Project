...
namespace ZhiFang.Entity.LabStar
{
    ...
    /// <summary>
    /// LBSickType object for NHibernate mapped table 'LB_SickType'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "LBSickType", ShortCode = "LBSickType", Desc = "")]
    public class LBSickType : BaseEntity
    {
        ...
        public LBSickType(string cName, string eName, string sName, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, long labID, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
        {
            this._cName = cName;
            this._eName = eName;
            this._sName = sName;
