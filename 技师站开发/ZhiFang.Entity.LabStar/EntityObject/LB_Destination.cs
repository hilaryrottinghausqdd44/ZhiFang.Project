...
namespace ZhiFang.Entity.LabStar
{
    ...
    /// <summary>
    /// LBDestination object for NHibernate mapped table 'LB_Destination'.
    /// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "LBDestination", ShortCode = "LBDestination", Desc = "")]
    public class LBDestination : BaseEntity
    {
        #region Member Variables

        protected string _destinationNo;
        ...
        public LBDestination() { }

        public LBDestination(string destinationNo, string cName, string eName, string sName, string useCode, string standCode, string deveCode, string shortcode, string pinYinZiTou, string comment, bool isUse, int dispOrder, long labID, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp)
        {
            this._destinationNo = destinationNo;
            this._cName = cName;
            this._eName = eName;
            this._sName = sName;
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "DestinationNo", Desc = "", ContextType = SysDic.All, Length = 50)]
        public virtual string DestinationNo
        {
            get { return _destinationNo; }
            set { _destinationNo = value; }
        }
