...
namespace ZhiFang.IBLL.Base
{
    public interface IBGenericManager<T>
    {
        ...
        EntityPageList<T> SearchListByHQL(long id, string strHqlWhere, string Order, int page, int count);
        ...
        IList<T> SearchListByHQL(string strHqlWhere, string[] listEntityName);

        EntityList<T> SearchListByHQL(string strHqlWhere, string order, int start, int count, string[] listEntityName);
