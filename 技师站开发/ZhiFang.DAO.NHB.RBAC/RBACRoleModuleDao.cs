...
{
    public class RBACRoleModuleDao : Base.BaseDaoNHBService<RBACRoleModule, long>, IDRBACRoleModuleDao
    {
        //返回用户角色与模块关系表
        ...
        public override int DeleteByHql(string hql)
        {
            ...
            {
                ZhiFang.LabStar.Common.LogHelp.Debug("角色模块删除动作(DeleteByHql)：操作人ID=" + ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeID) + "@操作人姓名=" + ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeName) + "@hql=" + hql);
            }
        ...
        public override bool Delete(long id)
        {
            if (ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeID) != null)
            {
                ZhiFang.LabStar.Common.LogHelp.Debug("角色模块删除动作(Delete)：操作人ID=" + ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeID) + "@操作人姓名=" + ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeName) + "@id=" + id);
            }
        ...
        public override bool Delete(RBACRoleModule entity)
        {
            if (ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeID) != null)
            {
                ZhiFang.LabStar.Common.LogHelp.Debug("角色模块删除动作(Deleteentity)：操作人ID=" + ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeID) + "@操作人姓名=" + ZhiFang.Common.Public.Cookie.CookieHelper.Read(ZhiFang.Entity.RBAC.DicCookieSession.EmployeeName) + "@entityid=" + entity.Id);
            }
