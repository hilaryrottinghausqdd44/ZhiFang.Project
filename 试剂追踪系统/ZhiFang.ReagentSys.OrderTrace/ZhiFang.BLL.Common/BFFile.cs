...
namespace ZhiFang.BLL.Common
{
    ...
    public class BFFile : BaseBLL<FFile>, ZhiFang.IBLL.Common.IBFFile
    {
        ...
        public BaseResultDataValue AddFFileAndFFileCopyUser(FFile entity, IList<FFileCopyUser> fFileCopyUserList, int fFileOperationType, int ffileCopyUserType, string ffileOperationMemo, IList<FFileReadingUser> fFileReadingUserList, int ffileReadingUserType, object p)
        {
            throw new NotImplementedException();
        }

        public BaseResultDataValue UploadNewsThumbnails(object file, string v)
        {
            throw new NotImplementedException();
        }
