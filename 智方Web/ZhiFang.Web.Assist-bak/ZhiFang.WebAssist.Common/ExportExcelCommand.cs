...
namespace ZhiFang.WebAssist.Common
{
    ...
    public class ExportExcelCommand
    {
        ...
        /// 当前用户所属机构名称
        /// </summary>
        public virtual string EEC_LabName { get; set; }

        /// <summary>
        /// 统计年份
        /// </summary>
        public virtual int EEC_StatYear { get; set; }

        /// <summary>
        /// 统计季度
        /// </summary>
        public virtual int EEC_StatQuarterly { get; set; }

        /// <summary>
        /// 当前结果集总记录数
        /// </summary>
        public virtual int EEC_RecTotal { get; set; }
