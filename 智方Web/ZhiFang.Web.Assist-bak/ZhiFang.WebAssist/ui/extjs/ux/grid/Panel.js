...
Ext.define('Shell.ux.grid.Panel', {
	...
	delOneById: function(index, id) {
		var me = this;
		var url = (me.delUrl.slice(0, 4) == 'http' ? '' : me.getPathRoot()) + me.delUrl;
	...
	//根据ID更新该行数据
	onChangeRecodeDataById:function(id){
		var me = this,
			url = me.getPathRoot() + me.selectUrl,
			where = [];
			
		var PKFieldArr = me.PKField.split('_');
