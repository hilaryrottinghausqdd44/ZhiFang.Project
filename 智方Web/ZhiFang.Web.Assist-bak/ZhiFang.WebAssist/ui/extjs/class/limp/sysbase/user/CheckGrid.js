...
Ext.define('Shell.class.limp.sysbase.user.CheckGrid',{
	...
	/**获取数据服务路径*/
	selectUrl:'/ServerWCF/WebAssistManageService.svc/RBAC_UDTO_SearchHREmployeeByHQL?isPlanish=true',
	/**根据部门ID获取数据服务路径*/
	selectUrl2:'/ServerWCF/WebAssistManageService.svc/RBAC_UDTO_GetHREmployeeByHRDeptID?isPlanish=true',
