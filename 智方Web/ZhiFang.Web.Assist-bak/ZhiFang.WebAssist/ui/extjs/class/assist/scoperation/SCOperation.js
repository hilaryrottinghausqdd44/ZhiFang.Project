 ...
 * @version 2020-03-26
 */
Ext.define('Shell.class.assist.scoperation.SCOperation', {
	extend: 'Ext.panel.Panel',
	title: '公共操作记录',
	autoScroll: true,
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/WebAssistManageService.svc/WA_UDTO_SearchSCOperationByHQL?isPlanish=true',
	...
	onLoadData: function(callback) {
		...
		url += '&sort=[{"property":"SCOperation_DataAddTime","direction":"ASC"},{"property":"SCOperation_Type","direction":"ASC"}]';
