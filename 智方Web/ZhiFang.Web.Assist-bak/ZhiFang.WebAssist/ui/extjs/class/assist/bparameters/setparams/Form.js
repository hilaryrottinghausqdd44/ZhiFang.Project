 ...
 * @version 2020-04-14
 */
Ext.define("Shell.class.assist.bparameters.setparams.Form", {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/SingleTableService.svc/ST_UDTO_SearchBParameterByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl: '/ServerWCF/SingleTableService.svc/ST_UDTO_UpdateBParameterListByBatch',
	
	/**内容周围距离*/
	bodyPadding: '15px 15px 15px 220px',
	...
	createFieldset: function(data, fwidth) {
		...
		if (me.hasCalcFHeight == true) {
			fheight = parseInt((itemList.length * 30 + 45));
		}
	...
	loadBParameterList: function(callback) {
		...
		//过滤输血申请单当前流水号
		var where = "bparameter.ParaType='CONFIG' and bparameter.IsUse=1 and bparameter.ParaNo!='C-ULAB-DATA-0022'";
		var sort = [{
		...
		var url = JShell.System.Path.ROOT + '/ServerWCF/SingleTableService.svc/ST_UDTO_SearchBParameterOfUserSetByHQL';
	...
	load: function() {
		...
		//过滤实验室数据升级版本
		var where="bparameter.ParaNo!='C-ULAB-DATA-0022'";
		url +="&where="+where;
