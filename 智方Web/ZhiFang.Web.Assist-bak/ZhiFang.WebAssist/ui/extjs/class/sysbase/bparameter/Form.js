...
Ext.define("Shell.class.sysbase.bparameter.Form", {
	...
	isAdd: function() {
		var me = this;
		me.callParent(arguments);
		me.getComponent('BParameter_Id').setReadOnly(false);
	},
	isEdit: function(id) {
		var me = this;
		me.callParent(arguments);
		me.getComponent('BParameter_Id').setReadOnly(true);
	},
	isShow: function(id) {
		var me = this;
		me.callParent(arguments);
	...
	getAddLayoutItems: function() {
		var me = this,
			items = [];
		//名称
		me.BParameter_Id.colspan = 2;
		me.BParameter_Id.width = me.defaults.width * me.BParameter_Id.colspan;
		items.push(me.BParameter_Id);
		//名称
	...
	getAddParams: function() {
		...
		if (values.BParameter_Id) entity.Id = values.BParameter_Id;
