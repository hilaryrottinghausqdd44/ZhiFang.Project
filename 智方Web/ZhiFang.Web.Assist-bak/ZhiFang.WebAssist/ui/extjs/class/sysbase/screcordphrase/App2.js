 ...
 * @version 2020-02-11
 */
Ext.define('Shell.class.sysbase.screcordphrase.App2', {
	...
	createItems: function() {
		var me = this;
		me.TypeGrid = Ext.create('Shell.class.sysbase.screcordtypeitem.SimpleGrid', {
			region: 'west',
			header: false,
			split: true,
			collapsible: true,
	...
	loadGrid: function(record) {
		...
		JShell.Action.delay(function() {
			...
			me.Grid.defaultWhere = 'screcordphrase.PhraseType=1 and screcordphrase.BObjectId=' + id;
			me.Grid.onSearch();
		}, null, 500);
	},
