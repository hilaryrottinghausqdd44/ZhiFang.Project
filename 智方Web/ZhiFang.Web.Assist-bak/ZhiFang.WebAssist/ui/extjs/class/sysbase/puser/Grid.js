...
Ext.define('Shell.class.sysbase.puser.Grid', {
	...
	/**删除数据服务路径*/
	delUrl: '/ServerWCF/WebAssistManageService.svc/WA_UDTO_DelPUser',
	...
	initComponent: function() {
		...
		me.searchInfo = {
			width: 145,
			emptyText: '用户编码/名称/帐号/对照码',
			itemId: "search",
			isLike: true,
			fields: ['puser.Id', 'puser.CName', 'puser.ShortCode', 'puser.Code1', 'puser.Code2', 'puser.Code3']
		};
	...
	onSync: function(type1) {
		...
		var url = JShell.System.Path.ROOT +
			"/ServerWCF/WebAssistManageService.svc/WA_UDTO_SyncPuserListOfHREmployeeToLIMP";
		if (type1 == "usertolimp") {
			url = JShell.System.Path.ROOT + "/ServerWCF/WebAssistManageService.svc/WA_UDTO_SyncPuserListOfRBACUseToLIMP";
		}
