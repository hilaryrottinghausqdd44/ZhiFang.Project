 ...
 * @version 2020-02-25
 */
Ext.define('Shell.class.sysbase.screcordtypeitem.choose.RightGrid', {
	...
	/**获取数据服务路径/ServerWCF/WebAssistManageService.svc/ST_UDTO_SearchReaGoodsOrgLinkByHQL?isPlanish=true*/
	selectUrl: '',
	/**排序字段*/
	defaultOrderBy: [{
	...
	defaultPageSize: 500,
	/**用户UI配置Key*/
	userUIKey: 'screcordtypeitem.choose.RightGrid',
	/**用户UI配置Name*/
	userUIName: "当前已选择列表",
