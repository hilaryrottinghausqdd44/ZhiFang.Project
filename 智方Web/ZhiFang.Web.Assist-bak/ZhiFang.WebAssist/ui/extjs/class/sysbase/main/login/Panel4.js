 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.sysbase.main.login.Panel4', {
	...
	onLogin: function(Account, Pwd) {
		...
		var url = JShell.System.Path.ROOT + me.loginUrl + '?strUserAccount=' + Account +'&strPassWord=' + Pwd;

		me.onMsgChange();
		me.showMask('登录验证处理中...'); //显示遮罩层
		...
		JShell.Server.get(url, function(data) {
			...
			if (data == 'true') {
				...
				me.onMsgChange('登录失败,请确认帐号及密码是否存在和有效！');
				me.onAccountFocus(me.focusTimes);
			}
		}, true, null, true);
	},
