...
function getServerInformation(callback){
    var me = this;
    var url = getRootPath() + '/ServerWCF/ConstructionService.svc/CS_UDTO_GetServerInformation';///ServerWCF
    var c = function(text){
    	var result = Ext.JSON.decode(text);
        var value = null;
...
var cookie = {
	...
	'200001':'DoctorId',//6.6人员帐号绑定的所属医生Id
	'200002':'DoctorCName',//6.6人员帐号绑定的所属医生姓名
	'200003':'GradeId'//6.6人员帐号绑定的所属医生的等级
};
//=========================系统信息-END=========================
