...
layui.extend({
...
}).define(['jquery', 'uxutil', 'webassistconfig'], function(exports) {
	"use strict";
	...
	var csserver = {
		...
		CS_TIME_OUT:65000,
		//CS服务端口
		CS_PORT: webassistconfig.CSServer.CS_PORT || "",
		//CS机构Id
		CS_LABID: webassistconfig.CSServer.CS_LABID || "",
		//CS服务访问域名称domain
		CS_DOMAIN: webassistconfig.CSServer.CS_DOMAIN || "",
		CS_LONIN: webassistconfig.CSServer.CS_LONIN || "",
		//CS密钥
		CS_PMOPERTYPEKEY: webassistconfig.CSServer.CS_PMOPERTYPEKEY || "A3751787-C218-45A8-A79B-32ACAD2973EC",
		//CS请求头信息
		CS_HEADERS: {
			"Accept": "application/json; charset=utf-8",
			"PMOPERTYPEKEY": webassistconfig.CSServer.CS_PMOPERTYPEKEY || "A3751787-C218-45A8-A79B-32ACAD2973EC",
		},
		CS_USER: {
			"USERID": "UserNo",
			"USERNAME": "CName",
		...
		/***
		 * @description ajax请求:返回数据集合调用
		 * @description 可配置参数showError：true返回原始错误信息，false返回替换的错误信息
		 * @param {Object} config
		...
		/***
		 * @description 返回操作成功或失败调用{success: false, ErrorInfo: "失败-没有查到待返HIS的数据！"}
		 * @param {Object} config
		 * @param {Object} callback
		 * @param {Object} showError
		 * @param {Object} isBool
