layui.extend({
	...
	var clodopprint = {
		...
		getStrHtmInstall: function() {
			var strHtmInstall = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='" + uxutil.path.getLayuiPath() + "/src/lodop/resources/" + "CLodop_Setup_for_Win32NT_3.041Extend.exe'>执行安装</a>,安装后请退出系统重新登录。</font>";
			return strHtmInstall;
		},
		/**@description 32位安装包升级提示*/
		getStrHtmUpdate: function() {
			var strHtmUpdate = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='" + uxutil.path.getLayuiPath() + "/src/lodop/resources/" + "CLodop_Setup_for_Win32NT_3.041Extend.exe'>执行升级</a>,升级后请退出系统重新登录。</font>";
			return strHtmUpdate;
		},
		/**@description 64位安装包安装提示*/
		getStrHtm64_Install: function() {
			var strHtm64_Install = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='" + uxutil.path.getLayuiPath() + "/src/lodop/resources/" + "CLodop_Setup_for_Win64NT_3.041Extend.exe'>执行安装</a>,安装后请退出系统重新登录。</font>";
			return strHtm64_Install;
		},
		/**@description 64位安装包升级提示*/
		getStrHtm64_Update: function() {
			var strHtm64_Update = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='" + uxutil.path.getLayuiPath() + "/src/lodop/resources/" + "CLodop_Setup_for_Win64NT_3.041Extend.exe'>执行升级</a>,升级后请退出系统重新登录。</font>";
