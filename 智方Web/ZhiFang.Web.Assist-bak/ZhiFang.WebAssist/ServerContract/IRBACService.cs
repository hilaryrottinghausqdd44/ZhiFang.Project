...
namespace ZhiFang.WebAssist.ServerContract
{
    ...
    public interface IRBACService
    {
        ...
        [ServiceContractDescription(Name = "新增帐户", Desc = "新增帐户", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACUser", Get = "", Post = "RBACUser", Return = "BaseResultDataValue", ReturnType = "RBACUser")]
        ...
        [ServiceContractDescription(Name = "修改帐户", Desc = "修改帐户", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACUser", Get = "", Post = "RBACUser", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改帐户指定的属性", Desc = "修改帐户指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACUserByField", Get = "", Post = "RBACUser", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除帐户", Desc = "删除帐户", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACUser?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询帐户", Desc = "查询帐户", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACUser", Get = "", Post = "RBACUser", Return = "BaseResultList<RBACUser>", ReturnType = "ListRBACUser")]
        ...
        [ServiceContractDescription(Name = "查询帐户(HQL)", Desc = "查询帐户(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACUserByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACUser>", ReturnType = "ListRBACUser")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询帐户", Desc = "通过主键ID查询帐户", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACUserById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACUser>", ReturnType = "RBACUser")]
        ...
        [ServiceContractDescription(Name = "新增角色权限", Desc = "新增角色权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACRoleRight", Get = "", Post = "RBACRoleRight", Return = "BaseResultDataValue", ReturnType = "RBACRoleRight")]
        ...
        [ServiceContractDescription(Name = "修改角色权限", Desc = "修改角色权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRoleRight", Get = "", Post = "RBACRoleRight", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改角色权限指定的属性", Desc = "修改角色权限指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRoleRightByField", Get = "", Post = "RBACRoleRight", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除角色权限", Desc = "删除角色权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACRoleRight?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询角色权限", Desc = "查询角色权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleRight", Get = "", Post = "RBACRoleRight", Return = "BaseResultList<RBACRoleRight>", ReturnType = "ListRBACRoleRight")]
        ...
        [ServiceContractDescription(Name = "查询角色权限(HQL)", Desc = "查询角色权限(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleRightByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRoleRight>", ReturnType = "ListRBACRoleRight")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询角色权限", Desc = "通过主键ID查询角色权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleRightById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRoleRight>", ReturnType = "RBACRoleRight")]
        ...
        [ServiceContractDescription(Name = "新增角色模块访问权限", Desc = "新增角色模块访问权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACRoleModule", Get = "", Post = "RBACRoleModule", Return = "BaseResultDataValue", ReturnType = "RBACRoleModule")]
        ...
        [ServiceContractDescription(Name = "修改角色模块访问权限", Desc = "修改角色模块访问权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRoleModule", Get = "", Post = "RBACRoleModule", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改角色模块访问权限指定的属性", Desc = "修改角色模块访问权限指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRoleModuleByField", Get = "", Post = "RBACRoleModule", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除角色模块访问权限", Desc = "删除角色模块访问权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACRoleModule?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询角色模块访问权限", Desc = "查询角色模块访问权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleModule", Get = "", Post = "RBACRoleModule", Return = "BaseResultList<RBACRoleModule>", ReturnType = "ListRBACRoleModule")]
        ...
        [ServiceContractDescription(Name = "查询角色模块访问权限(HQL)", Desc = "查询角色模块访问权限(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleModuleByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRoleModule>", ReturnType = "ListRBACRoleModule")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询角色模块访问权限", Desc = "通过主键ID查询角色模块访问权限", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleModuleById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRoleModule>", ReturnType = "RBACRoleModule")]
        ...
        [ServiceContractDescription(Name = "新增角色", Desc = "新增角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACRole", Get = "", Post = "RBACRole", Return = "BaseResultDataValue", ReturnType = "RBACRole")]
        ...
        [ServiceContractDescription(Name = "修改角色", Desc = "修改角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRole", Get = "", Post = "RBACRole", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改角色指定的属性", Desc = "修改角色指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRoleByField", Get = "", Post = "RBACRole", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除角色", Desc = "删除角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACRole?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询角色", Desc = "查询角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRole", Get = "", Post = "RBACRole", Return = "BaseResultList<RBACRole>", ReturnType = "ListRBACRole")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询角色", Desc = "通过主键ID查询角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRole>", ReturnType = "RBACRole")]
        ...
        [ServiceContractDescription(Name = "新增模块", Desc = "新增模块", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACModule", Get = "", Post = "RBACModule", Return = "BaseResultDataValue", ReturnType = "RBACModule")]
        ...
        [ServiceContractDescription(Name = "修改模块", Desc = "修改模块", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACModule", Get = "", Post = "RBACModule", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改模块指定的属性", Desc = "修改模块指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACModuleByField", Get = "", Post = "RBACModule", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除模块", Desc = "删除模块", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACModule?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询模块", Desc = "查询模块", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModule", Get = "", Post = "RBACModule", Return = "BaseResultList<RBACModule>", ReturnType = "ListRBACModule")]
        ...
        [ServiceContractDescription(Name = "查询模块(HQL)", Desc = "查询模块(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACModule>", ReturnType = "ListRBACModule")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询模块", Desc = "通过主键ID查询模块", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACModule>", ReturnType = "RBACModule")]
        ...
        [ServiceContractDescription(Name = "新增模块操作", Desc = "新增模块操作", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACModuleOper", Get = "", Post = "RBACModuleOper", Return = "BaseResultDataValue", ReturnType = "RBACModuleOper")]
        ...
        [ServiceContractDescription(Name = "修改模块操作", Desc = "修改模块操作", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACModuleOper", Get = "", Post = "RBACModuleOper", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改模块操作指定的属性", Desc = "修改模块操作指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACModuleOperByField", Get = "", Post = "RBACModuleOper", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除模块操作", Desc = "删除模块操作", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACModuleOper?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询模块操作", Desc = "查询模块操作", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleOper", Get = "", Post = "RBACModuleOper", Return = "BaseResultList<RBACModuleOper>", ReturnType = "ListRBACModuleOper")]
        ...
        [ServiceContractDescription(Name = "查询模块操作(HQL)", Desc = "查询模块操作(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleOperByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACModuleOper>", ReturnType = "ListRBACModuleOper")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询模块操作", Desc = "通过主键ID查询模块操作", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleOperById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACModuleOper>", ReturnType = "RBACModuleOper")]
        ...
        [ServiceContractDescription(Name = "新增员工角色", Desc = "新增员工角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACEmpRoles", Get = "", Post = "RBACEmpRoles", Return = "BaseResultDataValue", ReturnType = "RBACEmpRoles")]
        ...
        [ServiceContractDescription(Name = "修改员工角色", Desc = "修改员工角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACEmpRoles", Get = "", Post = "RBACEmpRoles", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改员工角色指定的属性", Desc = "修改员工角色指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACEmpRolesByField", Get = "", Post = "RBACEmpRoles", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除员工角色", Desc = "删除员工角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACEmpRoles?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询员工角色", Desc = "查询员工角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACEmpRoles", Get = "", Post = "RBACEmpRoles", Return = "BaseResultList<RBACEmpRoles>", ReturnType = "ListRBACEmpRoles")]
        ...
        [ServiceContractDescription(Name = "查询员工角色(HQL)", Desc = "查询员工角色(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACEmpRolesByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACEmpRoles>", ReturnType = "ListRBACEmpRoles")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询员工角色", Desc = "通过主键ID查询员工角色", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACEmpRolesById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACEmpRoles>", ReturnType = "RBACEmpRoles")]
        ...
        [ServiceContractDescription(Name = "新增员工设置", Desc = "新增员工设置", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACEmpOptions", Get = "", Post = "RBACEmpOptions", Return = "BaseResultDataValue", ReturnType = "RBACEmpOptions")]
        ...
        [ServiceContractDescription(Name = "修改员工设置", Desc = "修改员工设置", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACEmpOptions", Get = "", Post = "RBACEmpOptions", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改员工设置指定的属性", Desc = "修改员工设置指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACEmpOptionsByField", Get = "", Post = "RBACEmpOptions", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除员工设置", Desc = "删除员工设置", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACEmpOptions?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询员工设置", Desc = "查询员工设置", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACEmpOptions", Get = "", Post = "RBACEmpOptions", Return = "BaseResultList<RBACEmpOptions>", ReturnType = "ListRBACEmpOptions")]
        ...
        [ServiceContractDescription(Name = "查询员工设置(HQL)", Desc = "查询员工设置(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACEmpOptionsByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACEmpOptions>", ReturnType = "ListRBACEmpOptions")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询员工设置", Desc = "通过主键ID查询员工设置", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACEmpOptionsById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACEmpOptions>", ReturnType = "RBACEmpOptions")]
        ...
        [ServiceContractDescription(Name = "新增行过滤", Desc = "新增行过滤", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACRowFilter", Get = "", Post = "RBACRowFilter", Return = "BaseResultDataValue", ReturnType = "RBACRowFilter")]
        ...
        [ServiceContractDescription(Name = "修改行过滤", Desc = "修改行过滤", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRowFilter", Get = "", Post = "RBACRowFilter", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改行过滤指定的属性", Desc = "修改行过滤指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACRowFilterByField", Get = "", Post = "RBACRowFilter", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除行过滤", Desc = "删除行过滤", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelRBACRowFilter?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询行过滤", Desc = "查询行过滤", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRowFilter", Get = "", Post = "RBACRowFilter", Return = "BaseResultList<RBACRowFilter>", ReturnType = "ListRBACRowFilter")]
        ...
        [ServiceContractDescription(Name = "查询行过滤(HQL)", Desc = "查询行过滤(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRowFilterByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRowFilter>", ReturnType = "ListRBACRowFilter")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询行过滤", Desc = "通过主键ID查询行过滤", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRowFilterById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRowFilter>", ReturnType = "RBACRowFilter")]
        ...
        [ServiceContractDescription(Name = "新增职位", Desc = "新增职位", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddHRPosition", Get = "", Post = "HRPosition", Return = "BaseResultDataValue", ReturnType = "HRPosition")]
        ...
        [ServiceContractDescription(Name = "修改职位", Desc = "修改职位", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRPosition", Get = "", Post = "HRPosition", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改职位指定的属性", Desc = "修改职位指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRPositionByField", Get = "", Post = "HRPosition", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除职位", Desc = "删除职位", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelHRPosition?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询职位", Desc = "查询职位", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRPosition", Get = "", Post = "HRPosition", Return = "BaseResultList<HRPosition>", ReturnType = "ListHRPosition")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询职位", Desc = "通过主键ID查询职位", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRPositionById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HRPosition>", ReturnType = "HRPosition")]
        ...
        [ServiceContractDescription(Name = "新增员工", Desc = "新增员工", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddHREmployee", Get = "", Post = "HREmployee", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "修改员工", Desc = "修改员工", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHREmployee", Get = "", Post = "HREmployee", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改员工指定的属性", Desc = "修改员工指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHREmployeeByField", Get = "", Post = "HREmployee", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除员工", Desc = "删除员工", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelHREmployee?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询员工", Desc = "查询员工", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmployee", Get = "", Post = "HREmployee", Return = "BaseResultList<HREmployee>", ReturnType = "ListHREmployee")]
        ...
        [ServiceContractDescription(Name = "查询员工(HQL)", Desc = "查询员工(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmployeeByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HREmployee>", ReturnType = "ListHREmployee")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询员工", Desc = "通过主键ID查询员工", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmployeeById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "新增员工身份", Desc = "新增员工身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddHREmpIdentity", Get = "", Post = "HREmpIdentity", Return = "BaseResultDataValue", ReturnType = "HREmpIdentity")]
        ...
        [ServiceContractDescription(Name = "修改员工身份", Desc = "修改员工身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHREmpIdentity", Get = "", Post = "HREmpIdentity", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改员工身份指定的属性", Desc = "修改员工身份指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHREmpIdentityByField", Get = "", Post = "HREmpIdentity", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除员工身份", Desc = "删除员工身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelHREmpIdentity?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询员工身份", Desc = "查询员工身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmpIdentity", Get = "", Post = "HREmpIdentity", Return = "BaseResultList<HREmpIdentity>", ReturnType = "ListHREmpIdentity")]
        ...
        [ServiceContractDescription(Name = "查询员工身份(HQL)", Desc = "查询员工身份(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmpIdentityByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HREmpIdentity>", ReturnType = "ListHREmpIdentity")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询员工身份", Desc = "通过主键ID查询员工身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmpIdentityById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HREmpIdentity>", ReturnType = "HREmpIdentity")]
        ...
        [ServiceContractDescription(Name = "新增部门", Desc = "新增部门", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddHRDept", Get = "", Post = "HRDept", Return = "BaseResultDataValue", ReturnType = "HRDept")]
        ...
        [ServiceContractDescription(Name = "修改部门", Desc = "修改部门", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRDept", Get = "", Post = "HRDept", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改部门指定的属性", Desc = "修改部门指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRDeptByField", Get = "", Post = "HRDept", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除部门", Desc = "删除部门", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelHRDept?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询部门", Desc = "查询部门", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDept", Get = "", Post = "HRDept", Return = "BaseResultList<HRDept>", ReturnType = "ListHRDept")]
        ...
        [ServiceContractDescription(Name = "查询部门(HQL)", Desc = "查询部门(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HRDept>", ReturnType = "ListHRDept")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询部门", Desc = "通过主键ID查询部门", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HRDept>", ReturnType = "HRDept")]
        ...
        [ServiceContractDescription(Name = "新增部分身份", Desc = "新增部分身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddHRDeptIdentity", Get = "", Post = "HRDeptIdentity", Return = "BaseResultDataValue", ReturnType = "HRDeptIdentity")]
        ...
        [ServiceContractDescription(Name = "修改部分身份", Desc = "修改部分身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRDeptIdentity", Get = "", Post = "HRDeptIdentity", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改部分身份指定的属性", Desc = "修改部分身份指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRDeptIdentityByField", Get = "", Post = "HRDeptIdentity", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除部分身份", Desc = "删除部分身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelHRDeptIdentity?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询部分身份", Desc = "查询部分身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptIdentity", Get = "", Post = "HRDeptIdentity", Return = "BaseResultList<HRDeptIdentity>", ReturnType = "ListHRDeptIdentity")]
        ...
        [ServiceContractDescription(Name = "查询部分身份(HQL)", Desc = "查询部分身份(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptIdentityByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HRDeptIdentity>", ReturnType = "ListHRDeptIdentity")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询部分身份", Desc = "通过主键ID查询部分身份", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptIdentityById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HRDeptIdentity>", ReturnType = "HRDeptIdentity")]
        ...
        [ServiceContractDescription(Name = "新增部门员工关系", Desc = "新增部门员工关系", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddHRDeptEmp", Get = "", Post = "HRDeptEmp", Return = "BaseResultDataValue", ReturnType = "HRDeptEmp")]
        ...
        [ServiceContractDescription(Name = "修改部门员工关系", Desc = "修改部门员工关系", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRDeptEmp", Get = "", Post = "HRDeptEmp", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改部门员工关系指定的属性", Desc = "修改部门员工关系指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateHRDeptEmpByField", Get = "", Post = "HRDeptEmp", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除部门员工关系", Desc = "删除部门员工关系", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelHRDeptEmp?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询部门员工关系", Desc = "查询部门员工关系", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptEmp", Get = "", Post = "HRDeptEmp", Return = "BaseResultList<HRDeptEmp>", ReturnType = "ListHRDeptEmp")]
        ...
        [ServiceContractDescription(Name = "查询部门员工关系(HQL)", Desc = "查询部门员工关系(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptEmpByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HRDeptEmp>", ReturnType = "ListHRDeptEmp")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询部门员工关系", Desc = "通过主键ID查询部门员工关系", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHRDeptEmpById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HRDeptEmp>", ReturnType = "HRDeptEmp")]
        ...
        [ServiceContractDescription(Name = "查询员工(HQL)", Desc = "查询员工(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmployeeByHQLEx?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<HREmployee>", ReturnType = "ListHRDeptEmp")]
        ...
        [ServiceContractDescription(Name = "新增系统日志", Desc = "新增系统日志", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_AddSLog", Get = "", Post = "SLog", Return = "BaseResultDataValue", ReturnType = "SLog")]
        ...
        [ServiceContractDescription(Name = "修改系统日志", Desc = "修改系统日志", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateSLog", Get = "", Post = "SLog", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "修改系统日志指定的属性", Desc = "修改系统日志指定的属性", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_UpdateSLogByField", Get = "", Post = "SLog", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "删除系统日志", Desc = "删除系统日志", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_DelSLog?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "查询系统日志", Desc = "查询系统日志", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchSLog", Get = "", Post = "SLog", Return = "BaseResultList<SLog>", ReturnType = "ListSLog")]
        ...
        [ServiceContractDescription(Name = "查询系统日志(HQL)", Desc = "查询系统日志(HQL)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchSLogByHQL?page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Get = "page={page}&limit={limit}&fields={fields}&where={where}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<SLog>", ReturnType = "ListSLog")]
        ...
        [ServiceContractDescription(Name = "通过主键ID查询系统日志", Desc = "通过主键ID查询系统日志", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchSLogById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<SLog>", ReturnType = "SLog")]
        ...
        #region 查询员工列表
        [ServiceContractDescription(Name = "根据HQL查询条件查询用户列表", Desc = "根据HQL查询条件查询用户列表", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACUserListByHQL?where={where}&start={start}&count={count}", Get = "", Post = "", Return = "EntityList<RBACUser> ", ReturnType = "ListRBACUser")]
        ...
        [ServiceContractDescription(Name = "查询部门直属员工列表(包含子部门)", Desc = "查询部门直属员工列表(包含子部门)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_GetHREmployeeByHRDeptID?where={where}&page={page}&limit={limit}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Get = "where={where}&page={page}&limit={limit}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "ListHREmployee")]
        ...
        [ServiceContractDescription(Name = "查询部门直属的未分配角色的员工列表(包含子部门)", Desc = "查询部门直属的未分配角色的员工列表(包含子部门)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_GetHREmployeeNoRoleByHRDeptID?where={where}&page={page}&limit={limit}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Get = "where={where}&page={page}&limit={limit}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "ListHREmployee")]
        ...
        [ServiceContractDescription(Name = "查询部门直属的已分配角色的员工列表(包含子部门)", Desc = "查询部门直属的已分配角色的员工列表(包含子部门)", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_GetHREmployeeRoleByHRDeptID?where={where}&page={page}&limit={limit}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Get = "where={where}&page={page}&limit={limit}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "ListHREmployee")]
        ...
        [ServiceContractDescription(Name = "查询部门直属员工列表(包含子部门),并过滤已分配特定角色的员工", Desc = "查询部门直属员工列表(包含子部门),并过滤已分配特定角色的员工", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_GetHREmployeeNoRBACRoleIDByHRDeptID?longHRDeptID={longHRDeptID}&longRBACRoleID={longRBACRoleID}&fields={fields}&isPlanish={isPlanish}", Get = "longHRDeptID={longHRDeptID}&longRBACRoleID={longRBACRoleID}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "ListHREmployee")]
        ...
        [ServiceContractDescription(Name = "根据Session中人员ID查询该员工的信息", Desc = "根据Session中人员ID查询该员工的信息", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_GetHREmployeeBySessionHREmpID?fields={fields}&isPlanish={isPlanish}", Get = "fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "根据部门ID获取部门列表树", Desc = "根据部门ID获取部门列表树", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetHRDeptFrameListTree?id={id}&fields={fields}", Get = "id={id}&fields={fields}", Post = "", Return = "BaseResultDataValue", ReturnType = "TreeHRDept")]
        ...
        [ServiceContractDescription(Name = "根据部门ID获取部门单列树", Desc = "根据部门ID获取部门单列树", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetHRDeptFrameTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        ...
        [ServiceContractDescription(Name = "根据部门ID获取部门员工单列树", Desc = "根据部门ID获取部门员工单列树", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetHRDeptEmployeeFrameTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        ...
        #region 查询角色列表
        [ServiceContractDescription(Name = "根据用户ID查询该用户拥有的角色列表", Desc = "根据用户ID查询该用户拥有的角色列表", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRoleByHREmpID?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRole>", ReturnType = "ListRBACRole")]
        ...
        [ServiceContractDescription(Name = "根据模块ID查询拥有该模块权限的角色列表", Desc = "根据模块ID查询拥有该模块权限的角色列表", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRoleByModuleID?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACRole>", ReturnType = "ListRBACRole")]
        ...
        [ServiceContractDescription(Name = "根据模块ID查询拥有该模块权限的角色操作列表", Desc = "根据模块ID查询拥有该模块权限的角色操作列表", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRoleModuleOperByModuleID?id={id}", Get = "id={id}", Post = "", Return = "BaseResultList<RBACRole>", ReturnType = "ListRBACRole")]
        ...
        [ServiceContractDescription(Name = "根据角色ID获取角色列表树", Desc = "根据角色ID获取角色列表树", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetRBACRoleFrameListTree?id={id}&fields={fields}", Get = "id={id}&fields={fields}", Post = "", Return = "BaseResultDataValue", ReturnType = "TreeRBACRole")]
        ...
        [ServiceContractDescription(Name = "根据角色ID获取角色单列树", Desc = "根据角色ID获取角色单列树", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetRBACRoleFrameTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        ...
        #region 查询模块列表
        [ServiceContractDescription(Name = "根据人员ID查询该人员所属角色所具有权限的模块列表", Desc = "根据人员ID查询该人员所具有权限的模块列表", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchModuleByHREmpIDRole?id={id}&page={page}&limit={limit}&fields={fields}&isPlanis={isPlanis}", Get = "id={id}&page={page}&limit={limit}&fields={fields}&isPlanis={isPlanis}", Post = "", Return = "BaseResultList<RBACModule>", ReturnType = "ListRBACModule")]
        ...
        [ServiceContractDescription(Name = "获取常用模块列表加权限判断", Desc = "获取常用模块列表加权限判断", Url = "ServerWCF/RBACService.svc/RBAC_RJ_CheckEmpModuleRight?id={id}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&sort={sort}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "ListRBACEmpOptions")]
        ...
        [ServiceContractDescription(Name = "根据模块ID获取此模块的应用组件", Desc = "根据模块ID获取此模块的应用组件", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchBTDAppComponentsByModuleID?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultDataValue", ReturnType = "RBACModule")]
        ...
        [ServiceContractDescription(Name = "通过ID查询模块", Desc = "通过ID查询模块", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_GetRBACModuleById?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Return = "BaseResultDataValue", ReturnType = "RBACModule")]
        ...
        [ServiceContractDescription(Name = "查询模块表，根据父模块ID返回模块的Tree", Desc = "查询模块表，根据父模块ID返回模块的Tree", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleToTree?id={id}", Get = "?id={id}", Post = "", Return = "BaseResultTree", ReturnType = "TreeRBACModule")]
        ...
        [ServiceContractDescription(Name = "查询模块表，根据父模块ID返回模块的ListTree", Desc = "查询模块表，根据父模块ID返回模块的ListTree", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACModuleToListTree?id={id}&fields={fields}", Get = "?id={id}&fields={fields}", Post = "", Return = "BaseResultTree", ReturnType = "TreeRBACModule")]
        ...
        [ServiceContractDescription(Name = "根据Session中员工ID查询该人员所具有权限的模块树", Desc = "根据Session中员工ID查询该人员所具有权限的模块树", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchModuleTreeBySessionHREmpID", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "TreeRBACModule")]
        ...
        [ServiceContractDescription(Name = "根据员工ID查询该人员所具有权限的模块树", Desc = "根据员工ID查询该人员所具有权限的模块树", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchModuleTreeByHREmpID?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "TreeRBACModule")]
        ...
        #region 查询操作列表
        [ServiceContractDescription(Name = "根据模块ID查询其包含的模块操作列表", Desc = "根据模块ID查询其包含的模块操作列表", Url = "ServerWCF/RBACService.svc/RBAC_UDTO_SearchModuleOperByModuleID?id={id}&fields={fields}&isPlanish={isPlanish}", Get = "id={id}&fields={fields}&isPlanish={isPlanish}", Post = "", Return = "BaseResultList<RBACModule>", ReturnType = "ListRBACModule")]
        ...
        [ServiceContractDescription(Name = "根据模块操作ID获取此操作的行过滤树", Desc = "根据模块操作ID获取此操作的行过滤树", Url = "ServerWCF/RBACService.svc/RBAC_RJ_SearchRBACRowFilterTreeByModuleOperID?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        ...
        [ServiceContractDescription(Name = "用户登陆服务", Desc = "用户登陆服务", Url = "ServerWCF/RBACService.svc/RBAC_BA_Login?strUserAccount={strUserAccount}&strPassWord={strPassWord}&isValidate={isValidate}", Get = "strUserAccount={strUserAccount}&strPassWord={strPassWord}&isValidate={isValidate}", Post = "", Return = "bool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "用户注销服务", Desc = "用户注销服务", Url = "ServerWCF/RBACService.svc/RBAC_BA_Logout?strUserAccount={strUserAccount}", Get = "strUserAccount={strUserAccount}", Post = "", Return = "bool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "身份验证令牌服务", Desc = "身份验证令牌服务", Url = "ServerWCF/RBACService.svc/RBAC_RJ_Authentication", Get = "", Post = "", Return = "bool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "模块权限判定服务", Desc = "模块权限判定服务", Url = "ServerWCF/RBACService.svc/RBAC_RJ_JudgeModuleByRBACUserCode?strUserCode={strUserCode}&longModuleID={longModuleID}", Get = "strUserCode={strUserCode}", Post = "", Return = "bool", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "获取数据实体对象信息服务", Desc = "获取数据实体对象信息服务", Url = "ServerWCF/RBACService.svc/SYS_BA_GetEntityInfo", Get = "", Post = "", Return = "", ReturnType = "")]
        ...
        [ServiceContractDescription(Name = "获取数据实体服务列表服务", Desc = "获取数据实体服务列表服务", Url = "ServerWCF/RBACService.svc/SYS_BA_GetEntityListInfo", Get = "", Post = "", Return = "", ReturnType = "List")]
        ...
        [ServiceContractDescription(Name = "验证码服务", Desc = "验证码服务", Url = "ServerWCF/RBACService.svc/RBAC_BA_GetVerificationcode", Get = "", Post = "", Return = "string", ReturnType = "Bool")]
        ...
        [ServiceContractDescription(Name = "组织机构，模块列表，模块操作列表（权限），角色列表，身份列表", Desc = "组织机构，模块列表，模块操作列表（权限），角色列表，身份列表", Url = "ServerWCF/RBACService.svc/RBAC_BA_GetRBACInfoByRBACUserCode?strUserCode={strUserCode}", Get = "strUserCode={strUserCode}", Post = "", Return = "BaseResultBool", ReturnType = "List")]
        ...
        [ServiceContractDescription(Name = "自动生成和修改员工账号名", Desc = "自动生成和修改员工账号名", Url = "ServerWCF/RBACService.svc/RBAC_RJ_AutoCreateUserAccount?id={id}&strUserAccount={strUserAccount}", Get = "id={id}&strUserAccount={strUserAccount}", Post = "", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "验证用户账户是否存在", Desc = "验证用户账户是否存在", Url = "ServerWCF/RBACService.svc/RBAC_RJ_ValidateUserAccountIsExist?strUserAccount={strUserAccount}", Get = "strUserAccount={strUserAccount}", Post = "", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "账户密码重置", Desc = "账户密码重置", Url = "ServerWCF/RBACService.svc/RBAC_RJ_ResetAccountPassword?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "批量增加或减少员工与角色的关系", Desc = "批量增加或减少员工与角色的关系", Url = "ServerWCF/RBACService.svc/RBAC_RJ_SetEmpRolesByEmpIdList?empIdList={empIdList}&roleIdList={roleIdList}&flag={flag}", Get = "empIdList={empIdList}&roleIdList={roleIdList}&flag={flag}", Post = "", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "批量导入员工(支持同步生成账户)", Desc = "批量导入员工(支持同步生成账户)", Url = "ServerWCF/RBACService.svc/RBAC_RJ_AddInEmpList", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "HREmployee")]
        ...
        [ServiceContractDescription(Name = "批量导入部门", Desc = "批量导入部门", Url = "ServerWCF/RBACService.svc/RBAC_RJ_AddInDeptList", Get = "", Post = "", Return = "BaseResultDataValue", ReturnType = "HRDept")]
        ...
        [ServiceContractDescription(Name = "复制角色权限", Desc = "复制角色权限", Url = "ServerWCF/RBACService.svc/RBAC_RJ_CopyRoleRightByModuleOperID?sourceModuleOperID={sourceModuleOperID}&targetModuleOperID={targetModuleOperID}", Get = "sourceModuleOperID={sourceModuleOperID}&targetModuleOperID={targetModuleOperID}", Post = "", Return = "BaseResultDataValue", ReturnType = "bool")]
        ...
        [ServiceContractDescription(Name = "导入人员Excel文件", Desc = "导入人员Excel文件", Url = "ServerWCF/RBACService.svc/RBAC_RJ_UploadHRDeptEmpByExcel", Get = "", Post = "", Return = "Message", ReturnType = "Message")]
        ...
        [ServiceContractDescription(Name = "根据部门ID获取部门单列树(Department)", Desc = "根据部门ID获取部门单列树(Department)", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetDepartmentFrameTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_RJ_GetDepartmentFrameTree?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_RJ_GetDepartmentFrameTree(string id);

        [ServiceContractDescription(Name = "根据部门ID获取部门列表树(Department)", Desc = "根据部门ID获取部门列表树(Department)", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetDepartmentFrameListTree?id={id}&fields={fields}", Get = "id={id}&fields={fields}", Post = "", Return = "BaseResultDataValue", ReturnType = "TreeDepartment")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_RJ_GetDepartmentFrameListTree?id={id}&fields={fields}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_RJ_GetDepartmentFrameListTree(string id, string fields);

        [ServiceContractDescription(Name = "根据部门ID获取部门员工单列树(Department)", Desc = "根据部门ID获取部门员工单列树(Department)", Url = "ServerWCF/RBACService.svc/RBAC_RJ_GetDepartmentEmployeeFrameTree?id={id}", Get = "id={id}", Post = "", Return = "BaseResultDataValue", ReturnType = "Tree")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/RBAC_RJ_GetDepartmentEmployeeFrameTree?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue RBAC_RJ_GetDepartmentEmployeeFrameTree(string id);
