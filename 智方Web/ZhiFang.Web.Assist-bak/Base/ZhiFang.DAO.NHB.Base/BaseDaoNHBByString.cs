...
{
    public abstract class BaseDaoByStringNHB<T, T1> : HibernateDaoSupport, IDBaseDao<T, T1> where T : BaseEntityByString
    {
        #region IBaseDao<T,T1> 成员
        public string DataRowRoleHQLString = "";
        public BaseDaoByStringNHB()
        {
        ...
        {
            ((BaseEntityByString)entity).DataAddTime = DateTime.Now;
