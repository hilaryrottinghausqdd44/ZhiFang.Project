...
namespace ZhiFang.BLL.Base
{
    public class BaseBLL<T> : ZhiFang.IBLL.Base.IBGenericManager<T> where T : class
    {
        ...
        public ZhiFang.IDAO.Base.IDBaseDao<T, string> DBDaoByString { get; set; }
        public ZhiFang.IDAO.Base.IDBaseDao<T, int> DBDaoByInt { get; set; }
        ...
        public virtual bool Remove(int longID)
        {
            return DBDaoByInt.Delete(longID);
        }

        public virtual bool RemoveByHQL(int longID)
        {
            return DBDaoByInt.DeleteByHQL(longID);
        }

        public virtual bool Remove(string longID)
        {
            return DBDaoByString.Delete(longID);
        }

        public virtual bool RemoveByHQL(string longID)
        {
            return DBDaoByString.DeleteByHQL(longID);
        }
        ...
        public virtual T Get(int longID)
        {
            return DBDaoByInt.Get(longID);
        }
        public virtual T Get(string longID)
        {
            return DBDaoByString.Get(longID);
        }
        ...
        public IList<T> SearchIListByHQL(string strHqlWhere, string Order, int start, int count)
        {
            IList<T> el = DBDao.GetIListByHQL(strHqlWhere, Order, start, count);
            return el;
        }
