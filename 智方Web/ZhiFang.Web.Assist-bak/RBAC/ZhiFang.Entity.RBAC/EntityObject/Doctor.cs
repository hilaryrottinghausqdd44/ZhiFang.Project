...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class Doctor : BaseEntityServiceByInt
    {
        ...
        public Doctor(string cName, string shortCode, string hisOrderCode, int visible, string doctorPhoneCode, string code1, string code2, string code3, string code4, string code5, string adminName, long labID, byte[] dataTimeStamp, int dispOrder)
        {
            this._cName = cName;
