...
namespace ZhiFang.Entity.RBAC
{
    ...
    public class RBACRole : BaseEntityService//BaseEntityService
    {
        #region Member Variables
        protected long? _sySType;
        ...
        [DataDesc(CName = "系统预置类型", ShortCode = "SySType", Desc = "系统预置类型", ContextType = SysDic.All, Length = 8)]
        public virtual long? SySType
        {
            get { return _sySType; }
            set { _sySType = value; }
        }
