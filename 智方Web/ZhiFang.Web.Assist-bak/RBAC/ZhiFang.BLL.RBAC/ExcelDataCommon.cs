...
namespace ZhiFang.BLL.RBAC
{
    ...
    {
        public static T AddExcelDataToDataBaseByInt<T>(DataRow dataRow, Dictionary<string, string> dic, Dictionary<string, string> dicDefaultValue) where T : BaseEntityServiceByInt
        {
            T resultEntity = null;
            int EmptyCount = 0;
            EmptyCount = 0;
