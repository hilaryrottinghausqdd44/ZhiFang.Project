...
namespace ZhiFang.DAO.SQL.WebAssist.Lis
{
    /// <summary>
    ...
    {
        //默认的数据库连接
        public new static string ConnectionString = DBUtility.PubConstant.GetADODataBaseSettings(Common.Public.ConfigHelper.GetDataBaseSettings("lisdatabaseSettings", "db.connectionString"));
