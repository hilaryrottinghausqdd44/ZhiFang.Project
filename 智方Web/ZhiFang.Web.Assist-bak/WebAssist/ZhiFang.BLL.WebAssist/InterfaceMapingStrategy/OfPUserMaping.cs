...
namespace ZhiFang.BLL.WebAssist.InterfaceMapingStrategy
{
    ...
    {
        public override IList<BDictMapingVO> GetBDictMapingVOList(IList<PUser> deveList, IList<SCInterfaceMaping> mapingList, string deveCode, BDict bobjectType, ref IList<BDictMapingVO> addList)
        {
            //对照关系集合
