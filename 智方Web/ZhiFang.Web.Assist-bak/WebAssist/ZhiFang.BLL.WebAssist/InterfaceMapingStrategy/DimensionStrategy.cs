...
namespace ZhiFang.BLL.WebAssist.InterfaceMapingStrategy
{
    ...
    abstract class DimensionStrategy<T>
    {
        ...
        /// <returns></returns>
        public abstract IList<BDictMapingVO> GetBDictMapingVOList(IList<T> ovList, IList<SCInterfaceMaping> mapingList, string deveCode, BDict bobjectType,ref IList<BDictMapingVO> addList);
    }
}
