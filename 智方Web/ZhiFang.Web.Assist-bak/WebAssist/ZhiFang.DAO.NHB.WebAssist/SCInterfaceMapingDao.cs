...
{	
	public class SCInterfaceMapingDao : BaseDaoNHB<SCInterfaceMaping, long>, IDSCInterfaceMapingDao
	{
        #region 公共
        ...
        private int SearchBDictMapingVOCount(string strCountHQL)
        {
            ...
            DaoNHBGetCountByHqlAction<BDictMapingVO> actionCount = new DaoNHBGetCountByHqlAction<BDictMapingVO>(strCountHQL);
