...
namespace ZhiFang.Entity.WebAssist
{
	...
	public class SCOperation : BaseEntityService
	{
        ...
        [DataMember]
        [DataDesc(CName = "业务模块代码", ShortCode = "BusinessModuleCode", Desc = "业务模块代码", ContextType = SysDic.All)]
        ...
        [DataMember]
        [DataDesc(CName = "备注", ShortCode = "Memo", Desc = "备注", ContextType = SysDic.Text, Length=Int32.MaxValue)]
