...
namespace ZhiFang.Entity.WebAssist
{
	...
	public class BLodopTemplet : BaseEntity
	{
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "TemplateCode", Desc = "", ContextType = SysDic.All, Length = 16)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "DataTestValue", Desc = "", ContextType = SysDic.All, Length = 16)]
        public virtual string DataTestValue
		{
			...
			{
				if ( value != null && value.Length > 16)
					throw new ArgumentOutOfRangeException("Invalid value for DataTestValue", value, value.ToString());
