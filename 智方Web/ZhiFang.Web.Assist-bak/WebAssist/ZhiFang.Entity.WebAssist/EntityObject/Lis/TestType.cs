...
namespace ZhiFang.Entity.WebAssist
{
	...
	/// <summary>
	/// TestType object for NHibernate mapped table 'TestType'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "TestType", ShortCode = "TestType", Desc = "")]
	public class TestType : BaseEntityServiceByInt
    {
		#region Member Variables
		
        protected string _cName;
        protected string _testTypeDesc;
		...
		public TestType( string cName, string testTypeDesc, string shortCode, int visible, int dispOrder, string hisOrderCode, string code1, string code2, string code3, string code4, string code5, string code6, string code7, string code8, string code9, string code10 )
		{
			this._cName = cName;
			this._testTypeDesc = testTypeDesc;
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "TestTypeDesc", Desc = "", ContextType = SysDic.All, Length = 250)]
        public virtual string TestTypeDesc
		{
			get { return _testTypeDesc; }
			set
			{
				if ( value != null && value.Length > 250)
					throw new ArgumentOutOfRangeException("Invalid value for TestTypeDesc", value, value.ToString());
				_testTypeDesc = value;
			}
		}
