...
namespace ZhiFang.Entity.WebAssist
{
	...
	/// <summary>
	/// District object for NHibernate mapped table 'District'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "", ClassCName = "District", ShortCode = "District", Desc = "")]
	public class District : BaseEntityService
    {
		...
		public District( string cName, string shortName, string shortCode, int visible, int dispOrder, string hisOrderCode, string code1, string code2, string code3, string code4, string code5, string urgentState, string patState, string code6, string code7, string code8, string code9, string code10 )
		{
			this._cName = cName;
