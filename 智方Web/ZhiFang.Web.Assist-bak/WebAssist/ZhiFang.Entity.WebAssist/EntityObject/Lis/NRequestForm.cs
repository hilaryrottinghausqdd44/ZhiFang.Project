...
namespace ZhiFang.Entity.WebAssist
{
	...
	public class NRequestForm : BaseEntityServiceByString
	{
        ...
        protected string _affirmUser;
        protected DateTime? _oldflagdatedelete;
        protected DateTime? _nurseSendTime2;
        protected string _nurseSender2;
		...
		public NRequestForm( int receiveFlag, int statusNo, int sampleTypeNo, string patNo, string cName, int genderNo, DateTime birthday, double age, int ageUnitNo, int folkNo, int districtNo, int wardNo, string bed, int deptNo, int doctor, int diagNo, int chargeNo, decimal charge, string collecterID, string collecter, DateTime collectDate, DateTime collectTime, string operator1, DateTime operDate, DateTime operTime, string formMemo, string requestSource, string artificerorder, string sickorder, string chargeflag, int jztype, string zdy1, string zdy2, string zdy3, string zdy4, string zdy5, DateTime flagDateDelete, string formComment, string nurseflag, string diag, string caseNo, string refuseopinion, string refusereason, DateTime signintime, string signer, int signflag, int samplingGroupNo, int printCount, string printInfo, double sampleCap, int isPrep, int isAffirm, int isSampling, int isSend, string incepter, DateTime inceptTime, DateTime inceptDate, bool isByHand, int assignFlag, string oldSerialNo, int testTypeNo, int isCheckFee, string countNodesFormSource, int dr2Flag, int execDeptNo, string clientHost, int preNumber, int clientno, int stateFlag, int dispenseFlag, string refuseUser, DateTime refuseTime, string jytype, string serialScanTime, DateTime affirmTime, string urgentState, string zDY6, string zDY7, string zDY8, string zDY9, string zDY10, string phoneCode, int isNode, int phoneNodeCount, int autoNodeCount, int isNurseDo, int reportFlag, byte[] patPhoto, string chargeOrderNo, string nurseSender, DateTime nurseSendTime, string nurseSendCarrier, int collectCount, int foreignSendFlag, int hisAffirm, string reportDateDesc, double balance, string hisDoctorId, string hisDoctorPhoneCode, int lisDoctorNo, string patState, int isSendMsg, string nurseSendNo, string collectPack, string nurseSendFlag, string mergeno, int hospitalizedTimes, int queueNoState, string operCliet, DateTime arriveTime, string arriveHost, string carrierCode, int doInputflag, int signIntervalTime, int signOverTimeFlag, string inceptHost, string newLisCode, string newLisCodeDisp, string remover, DateTime removeTime, string removeHost, string conceder, DateTime concedeTime, string concedeHost, string concedeInfo, int refuseID, int inceptID, string groupSigner, int groupSignID, DateTime groupSignTime, string groupSignHost, string collectPart, string refuseComment, string tranSport, string collectFlag, string photoPath, string iDCardNo, string patAddress, string ageDesc, string zDY11, string affirmUser, DateTime oldflagdatedelete, DateTime nurseSendTime2, string nurseSender2, double weight, string weightDesc, string cancelReason )
		{
			...
			this._queueNoState = queueNoState;
			...
			this._zDY11 = zDY11;
			this._affirmUser = affirmUser;
			this._oldflagdatedelete = oldflagdatedelete;
			this._nurseSendTime2 = nurseSendTime2;
			this._nurseSender2 = nurseSender2;
			this._weight = weight;
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "FormMemo", Desc = "", ContextType = SysDic.All, Length = 160)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "RequestSource", Desc = "", ContextType = SysDic.All, Length = 100)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "Signer", Desc = "", ContextType = SysDic.All, Length = 500)]
        ...
        [DataMember]
        [DataDesc(CName = "机器名称", ShortCode = "ClientHost", Desc = "机器名称", ContextType = SysDic.All, Length = 60)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "ReportDateDesc", Desc = "", ContextType = SysDic.All, Length = 50)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "QueueNoState", Desc = "", ContextType = SysDic.All, Length = 4)]
        public virtual int QueueNoState
		{
			get { return _queueNoState; }
			set { _queueNoState = value; }
		}
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "CarrierCode", Desc = "", ContextType = SysDic.All, Length = 50)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "PhotoPath", Desc = "", ContextType = SysDic.All, Length = 50)]
        public virtual string PhotoPath
		{
			...
			{
				if ( value != null && value.Length > 50)
					throw new ArgumentOutOfRangeException("Invalid value for PhotoPath", value, value.ToString());
				_photoPath = value;
			}
		}
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "PatAddress", Desc = "", ContextType = SysDic.All, Length = 300)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "AffirmUser", Desc = "", ContextType = SysDic.All, Length = 50)]
        public virtual string AffirmUser
		{
			get { return _affirmUser; }
			set
			{
				if ( value != null && value.Length > 50)
					throw new ArgumentOutOfRangeException("Invalid value for AffirmUser", value, value.ToString());
				_affirmUser = value;
			}
		}
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "", ShortCode = "Oldflagdatedelete", Desc = "", ContextType = SysDic.All, Length = 8)]
		public virtual DateTime? Oldflagdatedelete
		{
			get { return _oldflagdatedelete; }
			set { _oldflagdatedelete = value; }
		}

        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "", ShortCode = "NurseSendTime2", Desc = "", ContextType = SysDic.All, Length = 8)]
		public virtual DateTime? NurseSendTime2
		{
			get { return _nurseSendTime2; }
			set { _nurseSendTime2 = value; }
		}

        [DataMember]
        [DataDesc(CName = "", ShortCode = "NurseSender2", Desc = "", ContextType = SysDic.All, Length = 50)]
        public virtual string NurseSender2
		{
			get { return _nurseSender2; }
			set
			{
				if ( value != null && value.Length > 50)
					throw new ArgumentOutOfRangeException("Invalid value for NurseSender2", value, value.ToString());
				_nurseSender2 = value;
			}
		}
