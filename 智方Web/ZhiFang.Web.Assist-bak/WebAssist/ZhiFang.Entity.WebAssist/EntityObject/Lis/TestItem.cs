...
namespace ZhiFang.Entity.WebAssist
{
    ...
    public class TestItem : BaseEntityServiceByInt
    {
        ...
        public TestItem(string cName, string eName, string shortName, string shortCode, string diagMethod, string unit, int isCalc, int visible, int dispOrder, int prec, int isProfile, string orderNo, string standardCode, string itemDesc, int defaultSType, string specName, string zdy1, string zdy2, double fWorkLoad, int secretgrade, int cuegrade, int isDoctorItem, string isNurseItem, int ischargeItem, int hisDispOrder, string code1, string code2, string code3, string code4, string code5, string code6, string code7, string code8, string defaultReagent, string useCode, string standCode, string deveCode, int userNo, DateTime dataAddTime, DateTime dataUpdateTime, int isPrint, string printCName, double hisCompH, double hisCompHH, string printItemDesc, int sectorTypeNo, string receiveWeek, int isUnion, int isSplitReceiveItem, long labID, byte[] dataTimeStamp)
        {
            ...
            this._printCName = printCName;
            this._hisCompH = hisCompH;
            this._hisCompHH = hisCompHH;
            this._printItemDesc = printItemDesc;
            this._sectorTypeNo = sectorTypeNo;
            this._receiveWeek = receiveWeek;
            this._isUnion = isUnion;
            this._isSplitReceiveItem = isSplitReceiveItem;
            this._labID = labID;
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "PrintCName", Desc = "", ContextType = SysDic.All, Length = 100)]
        public virtual string PrintCName
        {
            get { return _printCName; }
            set
            {
                if (value != null && value.Length > 100)
                    throw new ArgumentOutOfRangeException("Invalid value for PrintCName", value, value.ToString());
                _printCName = value;
            }
        }
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "", ShortCode = "HisCompH", Desc = "", ContextType = SysDic.All, Length = 8)]
        ...
        [DataMember]
        [JsonConverter(typeof(JsonConvertClass))]
        [DataDesc(CName = "", ShortCode = "HisCompHH", Desc = "", ContextType = SysDic.All, Length = 8)]
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "PrintItemDesc", Desc = "", ContextType = SysDic.All, Length = 200)]
        public virtual string PrintItemDesc
        {
            ...
            set
            {
                if (value != null && value.Length > 200)
                    throw new ArgumentOutOfRangeException("Invalid value for PrintItemDesc", value, value.ToString());
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "ReceiveWeek", Desc = "", ContextType = SysDic.All, Length = 50)]
        public virtual string ReceiveWeek
        {
            get { return _receiveWeek; }
            set
            {
                if (value != null && value.Length > 50)
                    throw new ArgumentOutOfRangeException("Invalid value for ReceiveWeek", value, value.ToString());
                _receiveWeek = value;
            }
        }
        ...
        [DataMember]
        [DataDesc(CName = "", ShortCode = "IsSplitReceiveItem", Desc = "", ContextType = SysDic.All, Length = 4)]
        public virtual int IsSplitReceiveItem
        {
            get { return _isSplitReceiveItem; }
            set { _isSplitReceiveItem = value; }
        }
