<%@ Page Language="c#" AutoEventWireup="True" Inherits="OA.RBAC.Roles.RapidAccessModules" Codebehind="RapidAccessModules.aspx.cs" %>
...
<head>
    ...
    <script language="javascript" id="clientEventHandlersJS">
			...
			function ViewRoleM(roltTypeName, roleID, objRole) {
			    var strRoleTypeName = "";
			    if (roltTypeName == 1)
			        strRoleTypeName = "按部门分配";
			    parent.document.getElementById("txtRoleTypeName").value = strRoleTypeName;
			    parent.document.getElementById("txtRoleName").value = objRole.innerHTML;
			    parent.document.getElementById("txtRoleID").value = roleID;
			    parent.document.getElementById("txtRoleType").value = roltTypeName;
...
<body bgcolor="#f0f0f0" leftmargin="0" topmargin="0" onunload="return window_onunload()">
        ...
        <table cellspacing="1" cellpadding="0" width="100%" bgcolor="#009999" border="0"
            ...
            <tr bgcolor="#d5d5d5">
                ...
                <td align="center" width="40%" height="20">
                    <span class="style5">操作按钮权限</span>
                </td>
                <td align="center" width="40%" height="20">
                    <span class="style5">已经继承权限</span>
                </td>
                
            </tr>
            <% if(xd!=null) LoopNodes(xd.DocumentElement.ChildNodes);%>
        </table>
    </p>
