<%@ Page Language="c#" AutoEventWireup="True" Inherits="OA.RBAC.Roles.ModuelValidity" Codebehind="ModuelValidity.aspx.cs" %>
    ...
    <table height="404" width="768" bgcolor="#ffffff">
            ...
            <td align="right" bgcolor="#f0f0f0" colspan="2" height="43">
                <p align="left">
                    <iewc:Toolbar ID="Toolbar1" runat="server" BorderWidth="0px" Width="480px" BorderColor="Transparent"
                        ...
                        <iewc:ToolbarButton Text="&amp;nbsp;按员工分配" ImageUrl="../../images/icons/0013_b.gif"
                            DefaultStyle="display;border:solid 1px skyblue;" ID="Employee" HoverStyle="border:solid 1px red;"
                            SelectedStyle="border:Outset 1px red;"></iewc:ToolbarButton>
                        <iewc:ToolbarButton Text="&amp;nbsp;按部门分配" ImageUrl="../../images/icons/0013_b.gif"
                            DefaultStyle="display;border:solid 1px skyblue;" ID="Department" HoverStyle="border:solid 1px red;">
                        </iewc:ToolbarButton>
                        <iewc:ToolbarButton Text="&amp;nbsp;按职位分配" ImageUrl="../../images/icons/0016_b.gif"
                            DefaultStyle="display;border:solid 1px skyblue;" ID="Position" HoverStyle="border:solid 1px red;">
                        </iewc:ToolbarButton>
                        <iewc:ToolbarButton Text="&amp;nbsp;按岗位分配" ImageUrl="../../images/icons/0014_b.gif"
        ...
        <tr align="left">
            <td height="98" colspan="2" valign="top" bgcolor="#f0f0f0">
                <iframe id="frmAccess" frameborder="0" width="100%" height="100" src="ValidityTime.aspx">
                </iframe>
            </td>
        </tr>
