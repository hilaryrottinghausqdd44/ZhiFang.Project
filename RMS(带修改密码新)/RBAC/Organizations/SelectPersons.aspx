<%@ Page Language="c#" AutoEventWireup="True" Inherits="OA.RBAC.Organizations.SelectPersons" Codebehind="SelectPersons.aspx.cs" %>
...
<body ms_positioning="GridLayout">
                        ...
                        <%if (DtE.Rows.Count != 0)
                          {
                              ...
                              for (int i = 0; i < DtE.Rows.Count; i++)
                              {
                                  ...
                                  Response.Write("<td>");
                                  Response.Write("<input  type=\"checkbox\" name=\"selectEmp\" id=\"selectEmp\" value=\"" + DtE.Rows[i]["NameL"] + DtE.Rows[i]["NameF"] + "," + DtE.Rows[i]["Mobile"] + "\">");
                                  Response.Write("</td>");
    ...
    <script language="javascript" defer>
			var strIN = '<%Response.Write(Request.ServerVariables["Query_String"].ToString());%>';
			//alert(strIN); 
			var strIN = strIN.split('=');
			
			if(strIN.length>2)
			{
				var strNames = strIN[2];
