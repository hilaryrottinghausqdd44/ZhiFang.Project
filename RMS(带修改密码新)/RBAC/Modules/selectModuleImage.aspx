<%@ Page Language="c#" AutoEventWireup="True"
    Inherits="OA.RBAC.Modules.selectModuleImage" Codebehind="selectModuleImage.aspx.cs" %>
...
<body language="javascript">
    <iframe frameborder="0" src="UploadImg.aspx" style="width: 558px; height: 56px">
    </iframe>
    <br>
    ...
    <table width="300" border="0" cellspacing="5" cellpadding="1">
        <tr>
            ...
            <td style="border-right: #99cccc 1px solid; border-top: #99cccc 1px solid; border-left: #99cccc 1px solid;
                ...
                <img src="../../images/icons/<%=dirFile.Name%>" style="border-right: #ff6633 1px dotted;
