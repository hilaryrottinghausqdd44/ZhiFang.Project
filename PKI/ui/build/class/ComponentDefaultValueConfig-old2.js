...
Ext.define('Ext.build.ComponentDefaultValueConfig',{
	 ...
	 * 2:下拉框(combobox、combo)、单选组(radiogroup)、复选组(checkboxgroup)
	 * 3:复选框(checkboxfield、checkbox)
	 * @type String
	 */
	valueType:'',
	/**
	...
	getValue:function(){
		...
		}else if(me.valueType == '3'){
			value = me.getComponent('value').getValue();
		}else{
			value = null;
		}
		return value;
