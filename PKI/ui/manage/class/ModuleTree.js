Ext.ns('Ext.manage');
Ext.define('Ext.manage.ModuleTree',{
	...
	createDockedItems:function(){
		...
		var dockedItems = [{
			...
			items:[
				'->',
				{text:'更新',iconCls:'build-button-refresh',handler:function(button){me.load();}},
				{text:'确定',iconCls:'build-button-ok',handler:function(button){me.fireEvent('okClick');}}
			]
		}];
	...
	selectNode:function(){
		...
		if(me.selectId == "0"){
			...
			node = me.getRootNode().findChild('Id',me.selectId,true);
		}
		//打开节点的所有上级节点
