 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.pki.report2.SearchToolbar2', {
	...
	createItems: function() {
		...
		items.push({
			x: 5,
			y: 105,
			fieldLabel: '<span style="color:#0000CD ;">检验项目</span>',
		...
		items.push({
			...
			width: 190,
			labelWidth: 50,
			fieldLabel: '<span style="color:#0000CD;">经销商</span>',
			itemId: 'Dealer_Name',
			xtype: 'uxCheckTrigger',
		...
		items.push({
			...
			margin: '0 0 0 10px',
			xtype: 'button',
			text: '<span style="color:#0000CD;">计算</span>',
	...
	getParams: function() {
		...
		var textList = ['SerialNo', 'BarCode', 'NRequestForm_CName'];
		var comboList = ['BillingUnitType', 'IsLocked'];
		var checkList = [
	...
	getLoadUrl: function() {
		...
		url += (url.indexOf('?') == -1 ? '?' : '&') + 'fields=DDealerCalcPrice_DealerName,DDealerCalcPrice_ItemName,DDealerCalcPrice_AllItemCount,DDealerCalcPrice_PersonalCount,DDealerCalcPrice_FreeCount,DDealerCalcPrice_HospitalCount,DDealerCalcPrice_StepPriceCount,DDealerCalcPrice_CalcStepPriceCount,DDealerCalcPrice_StepPrice,DDealerCalcPrice_StepPriceSum,DDealerCalcPrice_Id,DDealerCalcPrice_DealerID,DDealerCalcPrice_ItemID';
		...
		url += params.join("") + '&page=1&start=0&limit=50';
