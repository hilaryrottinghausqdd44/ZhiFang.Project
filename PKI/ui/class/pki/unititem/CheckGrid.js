 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.pki.unititem.CheckGrid',{
	...
	initComponent:function(){
		...
		me.columns = [{
			...
			dataIndex:'DUnitItem_UnitType',text:'单位类型',width:60,
...
//		},{
//			dataIndex:'DUnitItem_IsStepPrice',text:'是否阶梯价',width:70,
//			isBool:true,align:'center',type:'bool',
			...
			dataIndex:'DUnitItem_CoopLevel',text:'合作级别',hidden:true,hideable:false
		}];
