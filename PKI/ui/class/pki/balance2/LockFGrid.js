...
Ext.define('Shell.class.pki.balance2.LockFGrid', {
    ...
    * */
	...
	onSetItemPriceSum:function(){
	 ...
	 /**获取总计值*/
	getItemPriceSum:function(callback){
		var me = this;
		...
		var url = (me.selectUrl.slice(0, 4) == 'http' ? '' :
			JShell.System.Path.ROOT) +'/StatService.svc/Stat_UDTO_NRequestItemPriceSum';

		url += (url.indexOf('?') == -1 ? '?' : '&') + 'fieldName=NRequestItem_ItemPrice';
		//做处理
