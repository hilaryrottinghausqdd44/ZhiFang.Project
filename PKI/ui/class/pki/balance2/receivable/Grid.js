 ...
 * @version 2017-11-10
 */
Ext.define('Shell.class.pki.balance2.receivable.Grid', {
...
//		}
    ...
    /**设置应收价*/
	showEditItemPriceForm: function(idList) {
		var me = this,
			config = {
				resizable: false,
				idList:idList,
		...
		JShell.Win.open('Shell.class.pki.balance2.receivable.Form', config).show();
	},
	 /**将选中的数据设置应收价*/
    doEditItemPrice: function (isOpen, isJudge) {
        var me = this,
        ...
        me.showEditItemPriceForm(idList);
    }
});