 ...
 * @version 2015-07-02
 */
Ext.define('Shell.class.pki.SellDealerForm',{
	...
	createItems:function(){
		...
		items.push({
			x:0,y:10,width:410,fieldLabel:'经销商',allowBlank:false,
	...
	initData:function(){
		...
		var url = JShell.System.Path.ROOT + 
			'/BaseService.svc/ST_UDTO_SearchBDealerByHQL?isPlanish=true' +
			'&fields=BDealer_Id,BDealer_Name,BDealer_DataTimeStamp';
	...
	getAddParams:function(){
		...
		var entity = {
			...
			BDealer:{Id:values.DDealSeller_BDealer_Id},
		...
		if(record) entity.BDealer.DataTimeStamp = record.get('BDealer_DataTimeStamp').split(',');
