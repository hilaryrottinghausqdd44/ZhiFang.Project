  ...
  <xsl:template match="/TREENODES/treenode[@NodeData='Topmenu']">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <HEAD>
        ...
        <LINK rel="stylesheet" type="text/css" href="/OA/images2008-12/css.css"/>
      </HEAD>
        ...
        <table width="100%" height="100" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="11%" height="22" align="left" bgcolor="#49b4f8">
              ...
              <img src="/OA/images2008-12/logo_z.gif" width="25" height="22" />
            </td>
            <td width="45%" align="left" bgcolor="#49b4f8">
              <table width="20%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td>
                    <a href="../library/ChangeUserPwd.aspx" target="_blank">修改密码</a>
                  </td>
                </tr>
              </table>
            </td>
            <td width="44%" align="right" bgcolor="#49b4f8">
              <img src="/OA/images2008-12/top2.jpg" width="280" height="22" />
            </td>
          </tr>
          <tr>
            <td height="78" colspan="3" background="/OA/images2008-12/nav-bg.gif">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <table width="221" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="68" align="center">
                          <img src="/OA/images2008-12/man.jpg" width="46" height="44" />
                        </td>
                        <td width="122">
                          <table width="117" height="45" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>
                                <span class="font">欢迎您：</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span class="font">
                                  <xsl:value-of select="$UserName"/>的办公桌</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                        ...
                        <td width="20" rowspan="2" align="right">
                          <img src="/OA/images2008-12/line.gif" width="9" height="70" />
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
                          ...
                          <table width="190" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="95" align="center">
                                <a href="#">
                                  <img src="/OA/images2008-12/botton_ygzt.gif" width="81" height="19" border="0" />
                                </a>
                              </td>
                              <td width="95" align="center">
                                <a href="#">
                                  <img src="/OA/images2008-12/botton_ksxt.gif" width="81" height="19" border="0" />
                                </a>
                              </td>
                            </tr>
                          </table>
                  ...
                  <td width="81%">
                    <table width="90%" height="65" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
