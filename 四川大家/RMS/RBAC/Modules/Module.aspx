...
<body language="javascript" bgcolor="#f0f0f0" leftmargin="0" topmargin="0" onload="return window_onload()"
    ...
    <table style="font-size: 10pt; z-index: 101" height="276" cellspacing="1" cellpadding="0"
        ...
        <tr bgcolor="white">
            ...
            <td id="tdFrmButtons" align="left" width="409" bgcolor="#f0f0f0" colspan="3" height="175" style="height: 120px"
                valign="top">
                <input onclick="ChooseTemplate('<%=TemName%>');" type="button" value="选择预定义按钮组" style="width: 112px;
                    height: 22px" />
                <input onclick="javascript:ChooseButtons('<%=TemName%>')" type="button" value="增加参考按钮"
                    style="width: 112px; height: 22px" />
                     <input onclick="javascript:ChooseButtonsAdd('<%=TemName%>')" type="button" value="新增一个按钮"
                    style="width: 112px; height: 22px" />
                <iframe frameborder="0" name="frmButtons" id="frmButtons" src="ModuleButtons.aspx?buttTempName=<%=TemName%>"
        ...
        <tr>
            ...
            <td align="left" width="409" bgcolor="#f0f0f0" colspan="3" height="25">
                ...
                }模块的(<b><a href="#" onclick="Javascript:ButtSelectModule_onclick()">重新选择</a></b>)<asp:TextBox ID="tbRefModuleID" 
