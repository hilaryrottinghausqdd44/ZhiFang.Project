<%@ Page Language="c#" AutoEventWireup="True" Inherits="ortronics.Config.UploadImg" Codebehind="UploadImg.aspx.cs" %>
...
<body ms_positioning="GridLayout" topmargin="0">
    ...
    runat="server">
    上载图片：<input class="btnFile" id="fileUpload" style="border-right: #cccccc 1px solid;
