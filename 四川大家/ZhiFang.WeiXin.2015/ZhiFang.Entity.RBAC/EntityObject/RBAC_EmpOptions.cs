...
namespace ZhiFang.Entity.RBAC
{
	...
	public class RBACEmpOptions : BaseEntity
	{
		...
		public RBACEmpOptions( long labID, int moduleIconSize, DateTime newModuleLookTime, int allModuleIconSize, bool isLock, long moduleInfoSize, DateTime newInfoModuleLookTime, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, HREmployee hREmployee, RBACModule rbacmodule )
		{
			this._labID = labID;
