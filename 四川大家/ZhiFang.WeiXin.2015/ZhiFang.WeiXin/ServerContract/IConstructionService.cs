...
namespace ZhiFang.WeiXin.ServerContract
{
    ...
    public interface IConstructionService
    {
        ...
        [OperationContract]
        BaseResultDataValue CS_BA_GetCRUDAndFrameByEntityName(string EntityName);
        ...
        [ServiceContractDescription(Name = "新增应用组件并保存JS文件", Desc = "新增应用组件并保存JS文件", Url = "ConstructionService.svc/CS_UDTO_AddBTDAppComponentsAndSaveJSFile", Get = "", Post = "BTDAppComponents", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/CS_UDTO_AddBTDAppComponentsAndSaveJSFile", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultDataValue CS_UDTO_AddBTDAppComponentsAndSaveJSFile();
        ...
        [ServiceContractDescription(Name = "修改应用组件并修改JS文件", Desc = "修改应用组件并修改JS文件", Url = "ConstructionService.svc/CS_UDTO_UpdateBTDAppComponentsAndUpdateJSFile", Get = "", Post = "BTDAppComponents", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, UriTemplate = "/CS_UDTO_UpdateBTDAppComponentsAndUpdateJSFile", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool CS_UDTO_UpdateBTDAppComponentsAndUpdateJSFile();
        ...
        [ServiceContractDescription(Name = "删除应用组件和JS文件", Desc = "删除应用组件和JS文件", Url = "ConstructionService.svc/CS_UDTO_DelBTDAppComponentsAndJSFile?id={id}", Get = "id={id}", Post = "", Return = "BaseResultBool", ReturnType = "Bool")]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "/CS_UDTO_DelBTDAppComponentsAndJSFile?id={id}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        [OperationContract]
        BaseResultBool CS_UDTO_DelBTDAppComponentsAndJSFile(long id);
