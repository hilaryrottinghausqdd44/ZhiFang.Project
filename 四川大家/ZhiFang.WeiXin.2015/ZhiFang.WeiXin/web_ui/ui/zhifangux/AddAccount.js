...
Ext.define('Ext.zhifangux.AddAccount', {
    ...
    isok:false,
    layout:"absolute",
    CheckUserNameUrl:getRootPath()+'/'+'ServerWCF/RBACService.svc/RABC_RJ_AutoCreateUserAccount',
    CreateUserAccountUrl:getRootPath()+'/'+'ServerWCF/RBACService.svc/RABC_RJ_AutoCreateUserAccount',
    RandomPwdUrl:getRootPath()+'/'+'ServerWCF/RBACService.svc/RABC_RJ_GetRandomNumber',
        ...
        },
        {
            ...
            store:new Ext.data.Store({
                ...
                proxy:{
                    type:"ajax",
                    async:false,
                    url:getRootPath() + "/" + "ServerWCF/RBACService.svc/RBAC_UDTO_SearchHREmployeeByHQL?isPlanish=true&where=&",
                    reader:{
                        type:"json",
                        root:"list"
                    },
