...
Ext.define('Ext.zhifangux.appComponentsTree', {
    ...
    title:'应用操作树选择',
    selectServerUrl:getRootPath() + '/' + 'ServerWCF/ConstructionService.svc/CS_RJ_GetBTDAppComponentsFrameTree',
    /***
     * 模块操作
     * @type 
     */
    saveServerUrl:getRootPath() + '/'+'ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACModuleOper' ,
    autoScroll:true,
    hideNodeId:null,
