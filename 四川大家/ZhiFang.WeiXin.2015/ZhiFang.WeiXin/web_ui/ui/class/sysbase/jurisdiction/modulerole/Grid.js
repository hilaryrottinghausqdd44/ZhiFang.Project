...
Ext.define('Shell.class.sysbase.jurisdiction.modulerole.Grid', {
	...
	ModuleId:null,
  	...
  	/**获取数据服务路径*/
	selectUrl:'/ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACRoleModuleByHQL?isPlanish=true',
	/**新增服务地址*/
	...
	createGridColumns:function(){
		...
		var columns = [{
			text:'角色名称',dataIndex:'RBACRoleModule_RBACRole_CName',width:80
		},{
			text:'角色编码',dataIndex:'RBACRoleModule_RBACRole_UseCode',width:100,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			text:'角色描述',dataIndex:'RBACRoleModule_RBACRole_Comment',width:200,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			text:'主键ID',dataIndex:'RBACRoleModule_Id',isKey:true,hidden:true,hideable:false
		},{
			text:'角色ID',dataIndex:'RBACRoleModule_RBACRole_Id',hidden:true,hideable:false
		}];
	...
	addLink:function(p,roleId){
		...
		var entity = {
			IsUse:true,
			RBACModule:{Id:me.ModuleId,DataTimeStamp:[0,0,0,0,0,0,0,0]},
			RBACRole:{Id:roleId,DataTimeStamp:[0,0,0,0,0,0,0,0]}
		};
