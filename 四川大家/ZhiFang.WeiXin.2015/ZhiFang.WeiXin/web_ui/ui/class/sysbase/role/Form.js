...
Ext.define('Shell.class.sysbase.role.Form',{
	...
	createItems:function(){
		...
		var items = [
			{fieldLabel:'角色编码',name:'RBACRole_UseCode',emptyText:'必填项,唯一',allowBlank:false},
			{fieldLabel:'角色名称',name:'RBACRole_CName',itemId:'RBACRole_CName',emptyText:'必填项',allowBlank:false},
			...
			{fieldLabel:'显示次序',name:'RBACRole_DispOrder',xtype:'numberfield',value:0,emptyText:'必填项',allowBlank:false},
			{fieldLabel:'角色描述',name:'RBACRole_Comment',height:85,labelAlign:'top',xtype:'textarea'},
			{boxLabel:'是否使用',name:'RBACRole_IsUse',xtype:'checkbox',checked:true},
			{fieldLabel:'主键ID',name:'RBACRole_Id',hidden:true},
			{fieldLabel:'机构ID',name:'RBACRole_LabID',itemId:'RBACRole_LabID',hidden:true,value:me.LabId}
		];
