...
Ext.define('Shell.class.sysbase.dict.Form', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_SearchBDictById?isPlanish=true',
	/**新增服务地址*/
	addUrl: '/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_AddBDict',
	/**修改服务地址*/
	...
	getAddParams: function() {
		...
		if(me.formtype=="add")
		{
			...
			entity.BDictType.DataTimeStamp=strDataTimeStamp.split(',');
		}
		return {
			entity: entity
		};
