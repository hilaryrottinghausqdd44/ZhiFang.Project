...
Ext.define('Shell.class.sysbase.dict.Grid',{
	...
	height: 500,
  	...
  	/**获取数据服务路径*/
	selectUrl:'/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_SearchBDictByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl:'/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_UpdateBDictByField',
	/**删除数据服务路径*/
	delUrl:'/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_DelBDict',
...
//	hasEdit:true,
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'编码',dataIndex:'BDict_Shortcode',width:100,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			...
			text:'创建时间',dataIndex:'BDict_DataAddTime',width:130,
			isDate:true,hasTime:true
		},{
			text:'备注',dataIndex:'BDict_Memo',width:150,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
			text:'次序',dataIndex:'BDict_DispOrder',width:50,
