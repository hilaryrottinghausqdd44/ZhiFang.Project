 ...
 * @version 2015-09-29
 */
Ext.define('Shell.class.sysbase.bequip.Combobox',{
	 ...
	 */
	defaultOrderBy: [{property:'BEquip_DispOrder',direction:'ASC'}],
	...
	getStoreFields:function(){
		return [
			{name:'BEquip_CName',type:'auto'},
			{name:'BEquip_Id',type:'auto'},
			{name:'BEquip_DispOrder',type:'int'}
		];
	},
