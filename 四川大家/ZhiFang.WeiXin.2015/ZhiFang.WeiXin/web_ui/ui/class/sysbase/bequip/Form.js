...
Ext.define('Shell.class.sysbase.bequip.Form', {
	...
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/DictionaryService.svc/ST_UDTO_SearchBEquipById?isPlanish=true',
	/**新增服务地址*/
	addUrl: '/ServerWCF/DictionaryService.svc/ST_UDTO_AddBEquip',
	/**修改服务地址*/
	editUrl: '/ServerWCF/DictionaryService.svc/ST_UDTO_UpdateBEquipByField',
	/**是否启用保存按钮*/
	hasSave: false,
	/**是否重置按钮*/
	hasReset: false,
	...
	cnameChangeForPinYinZiTou: function(obj, newValue) {
		...
		if(newValue != "") {
			var url = JShell.System.Path.ROOT + '/ServerWCF/ConstructionService.svc/GetPinYin?chinese=' + newValue,
