...
Ext.define('Shell.class.sysbase.dicttree.Grid', {
	...
	height: 500,
	/**获取数据服务路径*/
	selectUrl: '/ProjectProgressMonitorManageService.svc/UDTO_SearchBDictTreeByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl: '/ProjectProgressMonitorManageService.svc/UDTO_UpdateBDictTreeByField',
	/**删除数据服务路径*/
	delUrl: '/ProjectProgressMonitorManageService.svc/UDTO_DelBDictTree',
