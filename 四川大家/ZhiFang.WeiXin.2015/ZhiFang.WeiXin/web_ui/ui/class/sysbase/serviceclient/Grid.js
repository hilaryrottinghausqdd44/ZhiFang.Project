...
Ext.define('Shell.class.sysbase.serviceclient.Grid',{
	...
	height: 500,
  	...
  	/**获取数据服务路径*/
	selectUrl:'/ServerWCF/WeiXinAppService.svc/ST_UDTO_SearchSServiceClientByHQL?isPlanish=true',
	/**修改服务地址*/
	editUrl:'/ServerWCF/WeiXinAppService.svc/ST_UDTO_UpdateSServiceClientByField',
	/**删除数据服务路径*/
	delUrl:'/ServerWCF/WeiXinAppService.svc/ST_UDTO_DelSServiceClient',
	...
	defaultOrderBy:[
		{property:'SServiceClient_DataAddTime',direction:'DESC'}
	],
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'备注',dataIndex:'SServiceClient_Comment',width:150,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
	...
	onAddClick:function(){
		...
		var me = this;
		JShell.Win.open('Shell.class.sysbase.serviceclient.create.TabPanel',{
			title:'新增平台客户',
			listeners: {
				save: function(p,id) {
					p.close();
