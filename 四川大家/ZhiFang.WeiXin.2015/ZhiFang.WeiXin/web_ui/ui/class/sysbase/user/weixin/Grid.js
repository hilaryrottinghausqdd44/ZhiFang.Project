...
Ext.define('Shell.class.sysbase.user.weixin.Grid',{
    ...
    /**获取数据服务路径*/
	selectUrl:'/ServerWCF/WeiXinAppService.svc/ST_UDTO_SearchBWeiXinEmpLinkByHQL?isPlanish=true',
	/**删除数据服务路径*/
	delUrl:'/ServerWCF/WeiXinAppService.svc/ST_UDTO_DelBWeiXinEmpLink',
