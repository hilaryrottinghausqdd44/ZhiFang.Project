...
Ext.define('Shell.class.sysbase.user.account.Add', {
	...
	formtype:'add',
	/**修改服务地址*/
	addUrl:'/ServerWCF/RBACService.svc/RBAC_UDTO_AddRBACUser',
	/**自动生成账号服务地址*/
	createAccountUrl:'/ServerWCF/RBACService.svc/RBAC_RJ_AutoCreateUserAccount',
	...
	createFormItems: function() {
		...
		items.push({
			...
			x:150,y:100,xtype:'checkbox',boxLabel:'允许修改密码',name:'EnMPwd',
			checked:true,width:110
		},{
			x:10,y:100,xtype:'checkbox',boxLabel:'默认密码(' + me.defaultPwd + ')',
			itemId:'isDefaultPwd',checked:true,width:140
		},{
			x:10,y:130,fieldLabel:'密码设置',emptyText:'必填',itemId:'Pwd',name:'Pwd',
			allowBlank:false,hidden:true,value:me.defaultPwd
		},{
			x:10,y:160,fieldLabel:'密码验证',emptyText:'重新输入密码',itemId:'Pwd2',name:'Pwd2',
			allowBlank:false,hidden:true,value:me.defaultPwd
		});
	...
	getAddParams: function() {
		...
		var entity = {
			entity: {
				HREmployee:{Id:me.HREmployeeId,DataTimeStamp:[0,0,0,0,0,0,0,0]},
