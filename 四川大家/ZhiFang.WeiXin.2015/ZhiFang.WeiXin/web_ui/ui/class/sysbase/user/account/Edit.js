...
Ext.define('Shell.class.sysbase.user.account.Edit', {
	...
	height: 220,
	formtype:'edit',
	selectUrl:'/ServerWCF/RBACService.svc/RBAC_UDTO_SearchRBACUserById?isPlanish=true',
	/**修改服务地址*/
	editUrl:'/ServerWCF/RBACService.svc/RBAC_UDTO_UpdateRBACUserByField',
	/**自动生成账号服务地址*/
	createAccountUrl:'/ServerWCF/RBACService.svc/RBAC_RJ_AutoCreateUserAccount',
	/**密码重置服务地址*/
	pwdResetUrl:'/ServerWCF/RBACService.svc/RBAC_RJ_ResetAccountPassword',
