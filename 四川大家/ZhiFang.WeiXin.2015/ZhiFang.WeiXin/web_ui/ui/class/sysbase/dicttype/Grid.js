...
Ext.define('Shell.class.sysbase.dicttype.Grid',{
	...
	/**删除数据服务路径*/
	delUrl:'/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_DelBDictType',
...
//	hasEdit:true,
	...
	defaultOrderBy:[{property:'BDictType_DispOrder',direction:'DESC'}],
	...
	createGridColumns:function(){
		...
		var columns = [{
			...
			text:'备注',dataIndex:'BDictType_Memo',width:200,
			sortable:false,menuDisabled:true,defaultRenderer:true
		},{
