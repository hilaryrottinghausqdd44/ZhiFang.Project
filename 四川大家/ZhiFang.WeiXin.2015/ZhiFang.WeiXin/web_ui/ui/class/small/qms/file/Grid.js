 ...
 * @version 2016-09-18
 */
Ext.define('Shell.class.small.qms.file.Grid',{
    extend: 'Shell.class.small.basic.Grid',
    
    title:'文档列表',
    /**获取数据服务路径*/
	selectUrl: '/QMSService.svc/QMS_UDTO_SearchFFileReadingUserListByHQLAndEmployeeID?isPlanish=true&isSearchChildNode=true',
	/**默认排序字段*/
	defaultOrderBy:[
		{property:'FFile_IsTop',direction:'DESC'},
		{property:'FFile_PublisherDateTime',direction:'DESC'},
		{property:'FFile_BDictTree_CName',direction:'ASC'},
		{property:'FFile_Title',direction:'ASC'}
	],
	
	/**默认树节点ID*/
	IDS:'5569287534789329919',
	/**文档类型*/
	FTYPE:'2',
	...
	createGridColumns:function(){
		var me = this;
		var columns = [{
			text:'文档标题',dataIndex:'FFile_Title',
			...
			text:'发布人',dataIndex:'FFile_PublisherName',width:70,
