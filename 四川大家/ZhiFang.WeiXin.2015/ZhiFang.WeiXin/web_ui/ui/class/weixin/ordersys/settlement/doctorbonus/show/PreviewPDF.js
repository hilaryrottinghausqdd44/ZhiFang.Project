 ...
 * @version 2017-02-20
 */
Ext.define('Shell.class.weixin.ordersys.settlement.doctorbonus.show.PreviewPDF', {
	...
	defaultLoad: false,
	autoScroll: false,
	selectUrl: '/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_OSDoctorBonusFormPreviewPdf',
	layout: {
		type: 'border',
		regionWeights: {
			south: 1,
