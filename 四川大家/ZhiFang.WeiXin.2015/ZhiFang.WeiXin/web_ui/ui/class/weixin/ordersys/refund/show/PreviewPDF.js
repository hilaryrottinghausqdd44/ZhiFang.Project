 ...
 * @version 2017-02-20
 */
Ext.define('Shell.class.weixin.ordersys.refund.show.PreviewPDF', {
	...
	defaultLoad: false,
	autoScroll: false,
	selectUrl: '/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_OSManagerRefundFormPreviewPdf',
	layout: {
		type: 'border',
		regionWeights: {
			south: 1,
	...
	showPdf: function(isClear) {
		...
		var where = "?id=" + me.PK + "&templetName=" + me.templetName + "&operateType=" + me.operateType + "&isPreview=" + me.isPreview;
