 ...
 * @version 2016-11-11
 */
Ext.define('Shell.class.weixin.ordersys.settlement.doctorbonus.one.Grid', {
	extend: 'Shell.class.weixin.ordersys.settlement.doctorbonus.basic.Grid',
	title: '奖金结算一审',

	EditTabPanelCalss: 'Shell.class.weixin.ordersys.settlement.doctorbonus.one.EditTabPanel',
	...
	initDefaultWhere: function() {
		var me = this;
		me.defaultWhere = "(Status=2 and BonusOneReviewManID = null) or ( BonusOneReviewManID=" + JShell.System.Cookie.get(JShell.System.Cookie.map.USERID) + ")";
	},
