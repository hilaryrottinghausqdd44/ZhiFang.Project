 ...
 * @version 2017-02-27
 */
Ext.define('Shell.class.weixin.report.finance.App', {
	...
	createItems: function() {
		var me = this;
		me.Grid = Ext.create('Shell.class.weixin.report.finance.Grid', {
			region: 'center',
			header: false,
			itemId: 'Grid'
		});
		me.Form = Ext.create('Shell.class.weixin.report.finance.Form', {
			region: 'east',
			width: 210,
			header: false,
			itemId: 'Form',
