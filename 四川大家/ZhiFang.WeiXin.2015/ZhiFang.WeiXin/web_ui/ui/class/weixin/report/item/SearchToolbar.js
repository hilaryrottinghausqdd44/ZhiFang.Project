 ...
 * @version 2017-01-23
 */
Ext.define('Shell.class.weixin.report.item.SearchToolbar', {
	extend: 'Shell.class.weixin.report.basic.SearchToolbar',
	height: 108,
	toolbarHeight: 108,
	/**下载EXCEL文件服务地址*/
	downLoadExcelUrl: '/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_ExportExcelUserConsumerItemDetails',
	/**打印pdf服务地址*/
	downPdfUrl: '/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_GetUserConsumerItemExcelToPdfFile',
	...
	getParams: function() {
		...
		var textList = ['UOFCode', 'UOIID', 'BillingBeginDate', 'BillingEndDate', 'SampleBeginDate', 'SampleEndDate', 'ItemName', 'RefundNO', 'TransferNO', 'Client'];
		var comboList = ['ISRefund', 'ISTransfer'];
		var checkList = [
			'AreaID', 'DoctorID', 'ItemID'
		];
