Ext.define("Shell.class.weixin.dict.core.Doctor.Grid",{
	...
	PKField: 'Doctor_Id',
	/**获取数据服务路径*/
	selectUrl: '/ServerWCF/DictionaryService.svc/ST_UDTO_SearchDoctorByHQL?isPlanish=true',
	/**删除数据服务路径*/
	delUrl: '/ServerWCF/DictionaryService.svc/ST_UDTO_DelDoctor',
	/**是否启用修改按钮*/
	hasEdit: false,
	/**是否启用保存按钮*/
	hasSave: false,
...
//		}
	...
	createMeButtontoolbar: function() {
		...
		},
		{
			xtype: 'uxCheckTrigger',
				...
				className: 'Shell.class.weixin.dict.core.Doctor.CheckGrid',
				classConfig: {
					title: '实验室选择',
					/**是否单选*/
					checkOne: false
	...
	getLabTestItem:function(){
		...
		for(var i =0 ; i< row.length;i++){
			arrId.push(row[i].get('Doctor_Id'));
		}
		return arrId;
	},
	...
	onCopyClick:function(Arr, ItemNoList, isall){
		var me =this;
		JShell.Win.open('Shell.class.weixin.dict.core.Doctor.MsgFrom', {
			//resizable: false,
			formtype: 'add',
