Ext.define("Shell.class.weixin.dict.lab.BlabSickType.contrast.BtnPanel",{
	...
	onSaveAdd:function(contorlRow,row,ClienteleId){
	    ...
	    var controlSickTypeID=contorlRow.get('SickType_Id');
	    var labSickTypeNo=row.get('BLabSickType_LabSickTypeNo');
	    
	    var entity={
			SickTypeControlNo:ClienteleId+"_"+controlSickTypeID+"_"+labSickTypeNo,
	...
	onClearClick:function(row){
		var me = this;
		var id = row.get('BLabSickType_isContrast');
