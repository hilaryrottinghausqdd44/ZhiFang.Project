 ...
 * @version 2018-02-24
 */
Ext.define('Shell.class.weixin.dict.lab.dictitem.MsgFrom', {
	...
	/**复制保存数据服务路径*/
	copyUrl:'/ServerWCF/ZhiFangWeiXinService.svc/ST_UDTO_BLabTestItemCopy',    
	...
	createItems: function() {
        ...
        var items =[];
    	items.push({
			fieldLabel: '复制类型',name: 'copyType',itemId: 'copyType',
	        xtype: 'uxSimpleComboBox',hasStyle: true,
			value: me.defaultType,data: me.TypeList,
			listeners: {
	        ...
	        xtype: 'label',text: '项目存在则跳过,不存在会被复制',itemId:'Tag', style: "font-weight:bold;color:red;",
	        margin: '0 0 5 75'
		});
		return items;
	},
