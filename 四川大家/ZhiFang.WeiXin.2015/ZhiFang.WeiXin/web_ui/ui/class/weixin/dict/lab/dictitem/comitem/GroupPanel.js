 ...
 * @version 2018-02-01
 */
Ext.define('Shell.class.weixin.dict.lab.dictitem.comitem.GroupPanel',{
	...
	createItems:function(){
		var me = this;
		me.IsGroupItemGrid = Ext.create('Shell.class.weixin.dict.lab.dictitem.comitem.IsGroupItemGrid', {
			region: 'north',
			header: false,
			split: false,
			collapsible: false,
		...
		me.ItemGrid = Ext.create('Shell.class.weixin.dict.lab.dictitem.comitem.ItemGrid', {
			region: 'center',
			split: false,
			header:false,
			  /**主项目编号*/
