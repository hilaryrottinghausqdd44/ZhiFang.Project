<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RefundTest.aspx.cs" Inherits="ZhiFang.WeiXin.WebForm.RefundTest" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="refund_fee" runat="server" style="width:96%;height:35px;margin-left:2%;" />
        <br />
        <br />&nbsp; 退款单号：<br />
