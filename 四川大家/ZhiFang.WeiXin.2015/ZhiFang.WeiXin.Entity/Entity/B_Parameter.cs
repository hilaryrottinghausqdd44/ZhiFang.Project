...
namespace ZhiFang.WeiXin.Entity
{
    ...
    public class BParameter : BaseEntity
    {
        ...
        public BParameter(long labID, string name, string sName, string paraType, string paraNo, string paraValue, string paraDesc, string shortcode, int dispOrder, string pinYinZiTou, bool isUse, bool isUserSet, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, BDict bDict)
        {
            this._labID = labID;
            this._name = name;
            this._sName = sName;
        ...
        [DataMember]
        [DataDesc(CName = "字典表", ShortCode = "BDict", Desc = "字典表")]
