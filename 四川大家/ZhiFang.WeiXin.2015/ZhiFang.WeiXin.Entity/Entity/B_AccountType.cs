...
namespace ZhiFang.WeiXin.Entity
{
	...
	public class BAccountType : BaseEntity
	{
		...
		public BAccountType( string name, string eName, string sName, string shortcode, string pinYinZiTou, string comment, bool isUse, DateTime dataAddTime, byte[] dataTimeStamp )
		{
			this._name = name;
			this._eName = eName;
			this._sName = sName;
