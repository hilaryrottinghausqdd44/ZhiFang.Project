...
namespace ZhiFang.WeiXin.Entity
{
	...
	public class BHospitalDept : BaseEntity
	{
		...
		public BHospitalDept( long labID, string name, string sName, string shortcode, string pinYinZiTou, string comment, bool isUse, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
			this._name = name;
			this._sName = sName;
