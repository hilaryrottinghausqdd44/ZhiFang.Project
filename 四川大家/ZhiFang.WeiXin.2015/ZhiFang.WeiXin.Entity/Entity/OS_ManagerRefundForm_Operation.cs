...
namespace ZhiFang.WeiXin.Entity
{
	...
	/// <summary>
	/// OSManagerRefundFormOperation object for NHibernate mapped table 'OS_ManagerRefundForm_Operation'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "退款单操作记录表", ClassCName = "OSManagerRefundFormOperation", ShortCode = "OSManagerRefundFormOperation", Desc = "退款单操作记录表")]
	public class OSManagerRefundFormOperation : BaseEntity
	{
		...
		public OSManagerRefundFormOperation() { }

		public OSManagerRefundFormOperation( long labID, long bobjectID, long type, string typeName, string businessModuleCode, string memo, int dispOrder, bool isUse, long creatorID, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
			this._labID = labID;
