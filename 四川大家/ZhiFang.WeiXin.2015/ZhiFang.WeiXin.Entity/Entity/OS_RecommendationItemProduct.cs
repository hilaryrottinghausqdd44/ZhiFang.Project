...
namespace ZhiFang.WeiXin.Entity
{
	...
	/// <summary>
	/// OSRecommendationItemProduct object for NHibernate mapped table 'OS_RecommendationItemProduct'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "特推项目产品", ClassCName = "OSRecommendationItemProduct", ShortCode = "OSRecommendationItemProduct", Desc = "特推项目产品")]
	public class OSRecommendationItemProduct : BaseEntity
	{
        ...
        public OSRecommendationItemProduct() { }

		public OSRecommendationItemProduct( long areaID, long itemID, string cName, string sName, string shortcode, string memo, int dispOrder, bool isUse, int status, long creatorID, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, long checkerID, string checkerName, long approvalID, string approvalName, long publisherID, string publisherName, long drafterId, string drafterCName, long offShelveManID, string offShelveManName, bool isTop, DateTime drafterDateTime, DateTime checkerDateTime, DateTime startDateTime, DateTime endDateTime, DateTime approvalDateTime, DateTime publisherDateTime, int counts, bool isDiscuss, double marketPrice, double greatMasterPrice, double discountPrice, double discount, string image )
		{
			this._areaID = areaID;
			this._itemID = itemID;
			this._cName = cName;
			...
			this._offShelveManID = offShelveManID;
			this._offShelveManName = offShelveManName;
			this._isTop = isTop;
        ...
        [DataMember]
        [DataDesc(CName = "固定咨询费", ShortCode = "BonusPercent", Desc = "固定咨询费", ContextType = SysDic.All, Length = 50)]
