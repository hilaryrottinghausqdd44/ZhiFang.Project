...
namespace ZhiFang.WeiXin.Entity
{
	...
	/// <summary>
	/// OSManagerRefundFormAttachment object for NHibernate mapped table 'OS_ManagerRefundForm_Attachment'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "退款单单附件表", ClassCName = "OSManagerRefundFormAttachment", ShortCode = "OSManagerRefundFormAttachment", Desc = "退款单单附件表")]
	public class OSManagerRefundFormAttachment : BaseEntity
	{
		...
		public OSManagerRefundFormAttachment() { }

		public OSManagerRefundFormAttachment( long labID, long bobjectID, string fileName, string fileExt, long fileSize, string filePath, string memo, int dispOrder, bool isUse, long creatorID, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp, string newFileName, string fileType, string businessModuleCode )
		{
			this._labID = labID;
