...
namespace ZhiFang.WeiXin.Entity
{
	...
	/// <summary>
	/// OSDoctorBonusOperation object for NHibernate mapped table 'OS_DoctorBonus_Operation'.
	/// </summary>
    [DataContract]
    [DataDesc(CName = "医生结算单操作记录表", ClassCName = "OSDoctorBonusOperation", ShortCode = "OSDoctorBonusOperation", Desc = "医生结算单操作记录表")]
	public class OSDoctorBonusOperation : BaseEntity
	{
		...
		public OSDoctorBonusOperation() { }

		public OSDoctorBonusOperation( long bobjectID, long type, string typeName, string businessModuleCode, string memo, int dispOrder, bool isUse, long creatorID, string creatorName, DateTime dataAddTime, DateTime dataUpdateTime, byte[] dataTimeStamp )
		{
