...
{
    [DataContract]
    public partial class NRequestFormVO
    {
		...
		[DataMember]
		[DataDesc(CName = "", ShortCode = "ItemName", Desc = "", ContextType = SysDic.All, Length = 3000)]
