...
namespace ZhiFang.WeiXin.BLL
{
    ...
    ///
    /// </summary>
    public class BOSManagerRefundFormAttachment : BaseBLL<OSManagerRefundFormAttachment>, ZhiFang.WeiXin.IBLL.IBOSManagerRefundFormAttachment
    {
        public IBBParameter IBBParameter { get; set; }
        public BaseResultDataValue AddSCAttachment(string fkObjectId, string fkObjectName, HttpPostedFile file, string parentPath, string tempPath, string fileExt, OSManagerRefundFormAttachment entity)
        {
        ...
        public OSManagerRefundFormAttachment GetAttachmentFilePathAndFileName(long attachmentID, ref string filePath)
        {
            filePath = "";
            OSManagerRefundFormAttachment attachment = null;
            if (attachmentID > 0)
            {
                string basePath = "";
