...
namespace ZhiFang.WeiXin.Interceptor
{
    public class RBACAdvice : IMethodInterceptor
    {
    ...
    public class WeiXinAppUserAdvice : IMethodInterceptor
    {       
        public bool WeiXinAppUser(IMethodInvocation invocation)
        {
            return true;            
        }
        public object Invoke(IMethodInvocation invocation)
        {
            bool CheckModuleAccess = WeiXinAppUser(invocation);
    ...
    public class AuthorityFilter : IMethodBeforeAdvice
    {
