...
namespace ZhiFang.Entity.Base
{
    public class JsonConvertClass : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(ZhiFang.WeiXin.Common.JsonSerializer.ByteTypeToString((byte[])value));
            }
            if (value.GetType().FullName == "System.DateTime")
            {
              
                //writer.WriteValue(((System.DateTime)value).Ticks.ToString());
                writer.WriteValue(((System.DateTime)value).ToString(ZhiFang.WeiXin.Common.JsonSerializer.JsonDateTimeFormat, DateTimeFormatInfo.InvariantInfo));
            }
        }
