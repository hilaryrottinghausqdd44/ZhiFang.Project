<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false " CodeBehind="Lock.aspx.cs"
    Inherits="OA.MenuMain.Lock" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Openchild(nrequestformno) {
            ...
            var c = document.getElementById("operbegin").value;
            var d = document.getElementById("txtend").value;
            var strurl = 'Lock_list.aspx?nrequestformno=' + nrequestformno + '&flag=1&sdbegin=' + a + '&sdend=' + b + '&operdatebegin=' + c + '&operdateend=' + d;
            //alert(strurl);
                            ...
                            <td align="left" width="50%" style="color: #ff3300; border-bottom: #aecdd5 solid 1px;">
                                <table>
                                    <tr align="left">
                                        ...
                                        <td>
                                            条码号:<asp:TextBox runat="server" CssClass="input_text" ID="txtserialno" Width="90px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label Width="155px" runat="server" ID="labmsg" ForeColor="Red" Height="16px"></asp:Label>
                                                        <asp:Label ID="Label1" runat="server" Width="796px" Height="16px"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="Btn_AllLock" runat="server" Text="所有单子锁定" OnClick="Btn_AllLock_Click"
                                                            CssClass="buttonstyle" />
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="Btn_AllCancelLock" runat="server" Text="所有单子解锁" OnClick="Btn_AllCancelLock_Click"
                                                            CssClass="buttonstyle" Width="96px" />
                                                    </td>
                                                </tr>
                                            </table>
                                            &nbsp; &nbsp;
                                            <asp:DataGrid ID="nrequestform" runat="server" Style="cursor: hand; padding: 0px;
                                                ...
                                                Width="100%" AllowPaging="true" PageSize="20" OnItemDataBound="nrequestform_ItemDataBound"
                                                OnItemCreated="nrequestform_ItemCreated" OnPageIndexChanged="nrequestform_PageIndexChanged">
                                                        ...
                                                        <HeaderTemplate>
                                                            <table id="header" width="100%" style="cursor: hand; padding: 0px; margin: 0px; font-size: 12px"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" style="width: 7%" align="left">
                                                                        条码号
                                                                    </td>
                                                            ...
                                                            <table id="tbcomboorg" width="100%" style="cursor: hand; padding: 0px; margin: 0px;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" style="width: 30%">
                                                                        <asp:Button runat="server" Width="25%" CssClass="buttonstyle" ID="BtnLock" Text='此单锁定'
                                                                            CommandArgument='<%# Bind("nrequestformno") %>' OnClick="BtnLock_Click1" />
                                                                        <asp:Button runat="server" Width="25%" BorderWidth="0" CssClass="buttonstyle" ID="Btn_jiesuo"
                                                                            Text='此单解锁' CommandArgument='<%# Bind("nrequestformno") %>' OnClick="Btn_jiesuo_Click" />
                                                                        <a onclick='Openchild("<%# DataBinder.Eval(Container, "DataItem.nrequestformno") %>");'
                                                                            href="#" style="text-decoration: underline">项目详细列表</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
