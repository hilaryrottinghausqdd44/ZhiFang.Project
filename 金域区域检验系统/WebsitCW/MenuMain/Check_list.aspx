<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check_list.aspx.cs" Inherits="OA.MenuMain.Check_list" %>
...
<body    onload ="document.body.scrollTop=GetCookie('posy')" onunload ="SetCookie('posy',document.body.scrollTop)">
    ...
    <asp:Label Width ="180px"  runat="server" ID="labmsg" ForeColor=Red 
                                                Height="16px"  ></asp:Label> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button 
                    ID="Button1" runat="server" onclick="Button1_Click" 
        Text="选定项执行" Width="97px" CssClass="buttonstyle" />
                                    ...
                                    <tr>
                                        <td>
                                                                        ...
                                                                        <asp:DataGrid id="dgclientcombo" runat="server" CellPadding="4" BackColor="White"
                                                                            BorderWidth="1px" Width="100%" BorderStyle="None" BorderColor="#3366CC"
                                                                            ...
                                                                            <asp:TemplateColumn>
                                                                                ...
                                                                                <asp:TemplateColumn HeaderText="审核状态">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                      <asp:Button runat="server" Width=50   ID="BtnLock" Text='<%#Bind("isfreestatus") %>' CommandArgument='<%# Bind("nrequestitemno") %>'    BorderWidth =0 />
                                                                                ...
                                                                                <asp:TemplateColumn >
                                                                                    <HeaderStyle Width="5%" BackColor="Silver"></HeaderStyle>
                                                                                    <ItemTemplate>
                                                                                      <asp:Button runat="server" Width=50   ID="work" Text='操作' 
                                                                                            CommandArgument='<%# Bind("nrequestitemno") %>' onclick="work_Click"/>
