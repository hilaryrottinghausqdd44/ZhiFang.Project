<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false " CodeBehind="Check.aspx.cs"
    Inherits="OA.MenuMain.Check" %>
                            ...
                            <td align="left" width="100%" style="color: #ff3300; border-bottom: #aecdd5 solid 1px;">
                                <table>
                                    <tr align="left">
                                        ...
                                        <td align=right ><asp:TextBox onkeyup="GetClientSearch();" Width="113px" ID="txtBox"
                                                MaxLength="50" runat="server" CssClass="input_var"></asp:TextBox></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label Width="136px" runat="server" ID="labmsg" ForeColor="Red" Height="16px"></asp:Label>
                                                        <asp:Label ID="Label1" runat="server" Width="800"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="Btn_AllCheck" runat="server" Text="所有单子审核" CssClass="buttonstyle"
                                                            OnClick="Btn_AllLock_Click" />
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="Btn_AllCancelCheck" runat="server" Text="所有单子解审" CssClass="buttonstyle"
                                                            OnClick="Btn_AllCancelCheck_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                                        ...
                                                        <ItemTemplate>
                                                            <table id="tbcomboorg" width="100%" style="cursor: hand; padding: 0px; margin: 0px;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 40%">
                                                                        <asp:Button runat="server" Width="24%" ID="Button2" Text='此单审核' CommandArgument='<%# Bind("nrequestformno") %>'
                                                                            OnClick="BtnLock_Click1" CssClass="buttonstyle" />
                                                                        <asp:Button runat="server" Width="60" ID="Btn_cancleCheck" Text='此单解审' CssClass="buttonstyle"
                                                                            CommandArgument='<%# Bind("nrequestformno") %>' OnClick="Btn_cancleCheck_Click" />
                                                                     <a href="Check_list.aspx?nrequestformno=<%# DataBinder.Eval(Container, "DataItem.nrequestformno") %>&&flag=1"
                                                                            style="text-decoration: underline" target="_blank">项目详细列表</a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 3%">
