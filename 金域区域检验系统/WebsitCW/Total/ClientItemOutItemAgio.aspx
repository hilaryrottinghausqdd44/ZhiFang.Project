<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientItemOutItemAgio.aspx.cs" Inherits="OA.Total.ClientItemOutItemAgio" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>未在客户特殊项目中的项目列表</title>
    ...
    <script type="text/javascript">
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ClientItemOutItemAgio.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
        ...
        function GetItemSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ClientItemOutItemAgio.GetItemListByItemKey(clientkey, GetCallitemresult);
            }
            else
            { changediv(key); }
        }
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="2" align="center" width="100%" style="border-bottom: #aecdd5 solid 1px;">
                                        <font size="4">未在客户特殊项目中的项目列表</font>
                                    </td>
                                </tr>
                                <tr>
                                                    ...
                                                    <asp:DataGrid ID="dgclient" runat="server" Style="cursor: hand; padding: 0px; margin: 0px;
                                                        ...
                                                        <Columns>                                                           
                                                            <asp:TemplateColumn HeaderText="客户名称">
                                                                ...
                                                                <ItemTemplate>
                                                                    <a href='clientitemmanage.aspx?clientno=<%# DataBinder.Eval(Container, "DataItem.clientno") %>&&clientname=<%# DataBinder.Eval(Container, "DataItem.clientname") %>'
                                                                        target="_blank">
                                                                        (<%# DataBinder.Eval(Container, "DataItem.clientno") %>)<%# DataBinder.Eval(Container, "DataItem.clientname") %></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>                                                           
                                                            <asp:TemplateColumn HeaderText="项目名称">
                                                                ...
                                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                <ItemTemplate>                                                                   
                                                                        (<%# DataBinder.Eval(Container, "DataItem.paritemno") %>)<%# DataBinder.Eval(Container, "DataItem.itemname") %>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>                                                          
                                                        </Columns>
