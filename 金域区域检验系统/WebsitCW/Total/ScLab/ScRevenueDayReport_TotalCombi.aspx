<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScRevenueDayReport_TotalCombi.aspx.cs" Inherits="OA.Total.ScLab.ScRevenueDayReport_TotalCombi" %>
<%@ Register TagPrefix="idatagrid" Assembly="WebSiteOA" Namespace="OA.ZCommon.CommonControl" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>收入日报表(组套统计)</title>
    ...
    <script type="text/javascript" src="../../Css/calendar1.js"></script>
     <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ScLab.ScRevenueDayReport_TotalCombi.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScRevenueDayReport_TotalCombi.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
        ...
        function GetItemSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScRevenueDayReport_TotalCombi.GetItemListByItemKey(clientkey, GetCallitemresult);
            }
            else
            { changediv(key); }
        }
                            ...
                            <table cellspacing="0" cellpadding="1" width="100%" bgcolor="#fcfcfc" style="border: #aecdd5 solid 1px;
                                ...
                                <tbody>
                                    ...
                                    <tr align="left">
                                        ...
                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;">
                                            <asp:TextBox runat="server" ID="txtoperdatebegin" Width="70px" CssClass="input_text" Text="2011-05-01"
                                                ondblclick="calendar();"></asp:TextBox>
                                            -<asp:TextBox runat="server" ID="txtoperdateend" Width="70px" CssClass="input_text" Text="2011-05-01"
                                                ondblclick="calendar();"></asp:TextBox>
                                        </td>
                                        <td align="right" style="border-bottom: #aecdd5 solid 1px;">
                                            样本类型:
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td colspan="4">
                                            ...
                                            <table id="columnconfigTable" cellspacing="0" cellpadding="0" width="100%" bgcolor="#fcfcfc" style="display:none;border: #aecdd5 solid 1px;
                                                border-top: #aecdd5 solid 1px; border-bottom: #aecdd5 solid 1px;border-left:#aecdd5 solid 1px;border-right:#aecdd5 solid 1px;" border="0">
                                                <tbody>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtclientnameorder"></asp:TextBox>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtbusinessnameorder"></asp:TextBox>
                                                         ...
                                                         <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtparitemnoorder"></asp:TextBox>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtitemnameorder"></asp:TextBox>
                                                         ...
                                                         <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtsectionorder"></asp:TextBox>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtnfsicktypenameorder"></asp:TextBox>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtnequipnameorder"></asp:TextBox>
                                                         ...
                                                         <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtnfclientstyleorder"></asp:TextBox>
                                                         ...
                                                         <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtnfclientareaorder"></asp:TextBox>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="25px" ID="txtnfclienttypeorder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ControlToValidate="txtnfclienttypeorder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" width="15%" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                          最小收费单位
                                                        </td>
                                                        <td align="left" width="10%" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                          绑定发票金额
                                                    ...
                                                    <tr>
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                           <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="MiniChargeUnit" ID="chkMiniChargeUnitShow" />显示
                                                                        
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="MiniChargeUnit" ID="chkMiniChargeUnitTotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="30px" ID="txtMiniChargeUnitOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server" ControlToValidate="txtMiniChargeUnitOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList runat="server" Width="50px" ID="drpMiniChargeUnit">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="MiniChargeUnit asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="MiniChargeUnit desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCWMoneyBind" ID="chkInvoiceCWMoneyBindShow" />显示
                                                                        
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCWMoneyBind" ID="chkInvoiceCWMoneyBindTotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="30px" ID="txtInvoiceCWMoneyBindOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server" ControlToValidate="txtInvoiceCWMoneyBindOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList runat="server" Width="50px" ID="ddlInvoiceCWMoneyBind">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCWMoneyBind asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCWMoneyBind desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                         ...
                                                         <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                           <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCWMoneyUnBind" ID="chkInvoiceCWMoneyUnBindShow" />显示
                                                                        
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCWMoneyUnBind" ID="chkInvoiceCWMoneyUnBindTotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="30px" ID="txtInvoiceCWMoneyUnBindOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator13" runat="server" ControlToValidate="txtInvoiceCWMoneyUnBindOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList runat="server" Width="50px" ID="ddlInvoiceCWMoneyUnBind">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCWMoneyUnBind asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCWMoneyUnBind desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCWMoney" ID="chkInvoiceCWMoneyShow" />显示
                                                                        
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCWMoney" ID="chkInvoiceCWMoneyTotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="30px" ID="txtInvoiceCWMoneyOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator14" runat="server" ControlToValidate="txtInvoiceCWMoneyOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList runat="server" Width="50px" ID="ddlInvoiceCWMoney">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCWMoney asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCWMoney desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                         ...
                                                         <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                           <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCW" ID="chkInvoiceCWShow" />显示
                                                                        
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="InvoiceCW" ID="chkInvoiceCWTotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="30px" ID="txtInvoiceCWOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" ControlToValidate="txtInvoiceCWOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList runat="server" Width="50px" ID="ddlInvoiceCW">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCW asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="InvoiceCW desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator16" runat="server" ControlToValidate="txtitempriceorder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                     ...
                                                     <tr style="display:none">
                                                       <td align="right" colspan="10" style="border-right: #aecdd5 solid 1px;">
                                                           栏目名称:<asp:TextBox runat="server" CssClass="input_text" ID="txtcolumnsname"></asp:TextBox> &nbsp;<asp:Button runat="server" 
                                                               ID="btnSaveColumn" Text="创建" OnClientClick="javascript:if(document.getElementById('txtcolumnsname').value==''){
                                                            alert('请输入创建新栏目名称');document.getElementById('txtcolumnsname').focus();return false;}return true;" CssClass="buttonstyle" onclick="btnSaveColumn_Click" />
                                                       </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <asp:Label runat="server" ID="labmsg"></asp:Label>                                                                        
                                            <div id="showdiv">
                                                <idatagrid:InheritDataGrid ID="dgrp" runat="server" PageSize="1" BorderWidth="1px"
                                                    ...
                                                    Font-Size="Smaller" OnItemDataBound="dgrp_ItemDataBound"  AutoGenerateColumns="False"
                                                    >
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblitemnocw" Text='<%# GetIsShowComboNo()==""?"":Eval("itemnocw") %>'></asp:Label>
                                                                <asp:Label runat="server" ID="lblCombiItemNo" Text='<%# GetIsShowComboNo()==""?"":Eval("CombiItemNo") %>'></asp:Label>                                                                
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
