<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScItemParticulars.aspx.cs"
    Inherits="OA.Total.ScLab.ScItemParticulars" %>
    ...
    <script type="text/javascript">
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScItemParticulars.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
                                        ...
                                        <td>
                                            ...
                                            <div id="showdiv">
                                                <idatagrid:InheritDataGrid ID="dgrp" runat="server" PageSize="1" BorderWidth="1px"
                                                    ...
                                                    Font-Size="Smaller" OnItemDataBound="dgrp_ItemDataBound" OnPageIndexChanged="dgrp_PageIndexChanged">
                                                    <SelectedItemStyle Font-Bold="True" ForeColor="#663399" BackColor="#FFCC66"></SelectedItemStyle>
