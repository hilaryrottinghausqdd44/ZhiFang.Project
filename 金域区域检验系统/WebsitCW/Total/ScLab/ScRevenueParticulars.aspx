<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScRevenueParticulars.aspx.cs"
    Inherits="OA.Total.ScLab.ScRevenueParticulars" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ScLab.ScRevenueParticulars.GetExportList(GetCallresult);
        ...
        function CloseExcel(flag, filename) {
            ...
            closediv();
            if (flag == "1") {
                window.open("../downloadfile.aspx?file=sclab/TotalExcel/" + filename);
            }
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScRevenueParticulars.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
                        ...
                        <div id="divSearchin" style="word-wrap: break-word; float: left; text-align: left;
                            ...
                            <table cellspacing="0" cellpadding="1" width="100%" bgcolor="#fcfcfc" style="border: #aecdd5 solid 1px;
                                ...
                                <tbody style="display:none">
                                    ...
                                    <tr style="display:none">
                                        <td align="right" style="display:block;border-bottom: #aecdd5 solid 1px;">
                                           项目类型
                                        </td>
                                        <td align="left" style="display:block;border-bottom: #aecdd5 solid 1px;">
                                            <asp:TextBox runat="server" ID="txtItemType" CssClass="input_text" Width="120px"></asp:TextBox>
                                        </td>
                                        <td align="right" style="display:block;border-bottom: #aecdd5 solid 1px;">
                                            样本类型:
                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="75px" ID="txtMiniChargeUnitOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txtMiniChargeUnitOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        排序:<asp:DropDownList runat="server" ID="drpMiniChargeUnit">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="75px" ID="txtItemPriceOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtItemPriceOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        排序:<asp:DropDownList runat="server" ID="ddlItemPrice">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtItemAgioPriceOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;">
                                                           <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="75px" ID="txtnfsicktypenameorder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtnfsicktypenameorder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        排序:<asp:DropDownList runat="server" Width="75px" ID="drpnfsicktypenamesort">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
