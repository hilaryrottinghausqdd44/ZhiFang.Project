<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScTotalSingleItemReport.aspx.cs" Inherits="OA.Total.ScLab.ScTotalSingleItemReport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function check() {
            ...
            if (document.getElementById('txtBox').value == "" || document.getElementById('txtBox').value == null) {
                alert('客户不能为空!');
        ...
        function GetExportClient() {
            OA.Total.ScLab.ScTotalSingleItemReport.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScTotalSingleItemReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
        ...
        function GetItemSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScTotalSingleItemReport.GetItemListByItemKey(clientkey, GetCallitemresult);
            }
            else
            { changediv(key); }
        }
                                                    ...
                                                    <tr>                                                    
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="itemagio" ID="chkitemagioShow" />显示
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:CheckBox runat="server" ToolTip="itemagio" ID="chkitemagioTotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="30px" ID="txtitemagioOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server"
                                                                            ControlToValidate="txtitemagioOrder" ErrorMessage="必须为数字" SetFocusOnError="True"
                                                                            ValidationExpression="^\d+(\.\d+)?$" Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList runat="server" Width="50px" ID="ddlitemagio">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="itemagio asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="itemagio desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                        ...
                                        <td>                                            
                                            <div id="showdiv">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="gvReport" runat="server" AllowPaging="false" Width="100%" BorderWidth="1px"
