<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScRevenueDayReportNew.aspx.cs" Inherits="OA.Total.ScLab.ScRevenueDayReportNew" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                           <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="75px" ID="txtItemAgioPriceOrder"></asp:TextBox>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator17" runat="server" ControlToValidate="txtItemAgioPriceOrder"
                                                                            ErrorMessage="必须为数字" SetFocusOnError="True" ValidationExpression="^\d+(\.\d+)?$"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        排序:<asp:DropDownList runat="server" ID="ddlItemAgioPrice">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                    ...
                                    <tr>
                                        <td>           
                                            <asp:DropDownList ID="ddlClientList" runat="server" AutoPostBack="True" 
                                                onselectedindexchanged="ddlClientList_SelectedIndexChanged" Visible="False" >
                                            </asp:DropDownList>
