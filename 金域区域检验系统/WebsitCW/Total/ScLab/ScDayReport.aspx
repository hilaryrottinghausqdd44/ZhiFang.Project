<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScDayReport.aspx.cs" Inherits="OA.Total.ScLab.ScDayReport" %>
                                    ...
                                    <tbody>
                                        <tr align="left">
                                            <td align="left" style="border-bottom: #aecdd5 solid 1px;">
                                                ...
                                                <asp:TextBox runat="server" ID="txtenddate" Visible="false" Width="70px" CssClass="input_text" onfocus="calendar();"></asp:TextBox>
                                                ...
                                                <idatagrid:InheritDataGrid ID="dgmonthreport" runat="server" PageSize="50" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="送检单位">
                                                         ...
                                                         <asp:TemplateColumn HeaderText="清单名">
                                                            <HeaderStyle HorizontalAlign="left" Width="10%" BackColor="Silver"></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                            <ItemTemplate>
                                                                 <asp:Label runat="server" ID="labcname" Text='<%# DataBinder.Eval(Container, "DataItem.cname") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="项目名称">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="labitemname" Text='<%# DataBinder.Eval(Container, "DataItem.itemname") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="折扣价">
                                                            <HeaderStyle HorizontalAlign="left" Width="10%" BackColor="Silver"></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                            <ItemTemplate>
