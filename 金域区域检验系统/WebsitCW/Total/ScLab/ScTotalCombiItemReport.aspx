<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScTotalCombiItemReport.aspx.cs" Inherits="OA.Total.ScLab.ScTotalCombiItemReport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ScLab.ScTotalCombiItemReport.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScTotalCombiItemReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
        ...
        function GetItemSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScTotalCombiItemReport.GetItemListByItemKey(clientkey, GetCallitemresult);
            }
            else
            { changediv(key); }
        }
