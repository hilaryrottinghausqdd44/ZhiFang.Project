<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScItemParticularsNew.aspx.cs"
    Inherits="OA.Total.ScLab.ScItemParticularsNew" %>
                                                ...
                                                <Columns>
                                                    <asp:TemplateColumn>
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="labclientno" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.colno") %>' Visible="false"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                </Columns>
