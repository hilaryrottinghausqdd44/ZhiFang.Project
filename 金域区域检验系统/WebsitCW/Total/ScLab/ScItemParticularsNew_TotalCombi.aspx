<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScItemParticularsNew_TotalCombi.aspx.cs"
    Inherits="OA.Total.ScLab.ScItemParticularsNew_TotalCombi" %>

<%@ Register TagPrefix="idatagrid" Assembly="WebSiteOA" Namespace="OA.ZCommon.CommonControl" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>项目明细表(组套统计)</title>
    ...
    <script type="text/javascript">
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScItemParticularsNew_TotalCombi.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
