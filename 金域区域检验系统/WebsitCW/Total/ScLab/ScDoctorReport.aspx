<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScDoctorReport.aspx.cs" Inherits="OA.Total.ScLab.ScDoctorReport" %>
                                        ...
                                        <td>
                                            ...
                                            <div id="showdiv">
                                                <idatagrid:InheritDataGrid ID="dgmonthreport" runat="server" PageSize="50" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="日 期">
                                                        ...
                                                        <asp:TemplateColumn HeaderText="送检单位">
                                                         ...
                                                         <asp:TemplateColumn HeaderText="医生名称">
                                                            <HeaderStyle HorizontalAlign="left" Width="15%" BackColor="Silver"></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="labdoctorname" Text='<%# DataBinder.Eval(Container, "DataItem.doctorname") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
