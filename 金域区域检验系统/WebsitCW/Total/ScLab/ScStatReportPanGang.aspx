<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScStatReportPanGang.aspx.cs"
    Inherits="OA.Total.ScLab.ScStatReportPanGang" %>

<%@ Register TagPrefix="idatagrid" Assembly="WebSiteOA" Namespace="OA.ZCommon.CommonControl" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>四川大家攀钢财务统计</title>
    ...
    <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ScLab.ScStatReportPanGang.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScStatReportPanGang.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
        ...
        function GetItemSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ScLab.ScStatReportPanGang.GetItemListByItemKey(clientkey, GetCallitemresult);
            }
            else
            { changediv(key); }
        }
                            ...
                            <table cellspacing="0" cellpadding="1" width="100%" bgcolor="#fcfcfc" style="border: #aecdd5 solid 1px;
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;">
                                            <asp:TextBox runat="server" ID="txtTargetClientNo" CssClass="input_text" Width="180px"></asp:TextBox>
                                        </td>
                                        <td align="right" style="border-bottom: #aecdd5 solid 1px;">    
                                            &nbsp;                      
                                        </td>
                                                    ...
                                                    <tr>                                                    
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="TargetClientCName" ID="chkTargetClientNoShow" />显示
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:CheckBox runat="server" ToolTip="TargetClientCName" ID="chkTargetClientNoTotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList runat="server" Width="50px" ID="ddlTargetClientNo">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="TargetClientCName asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="TargetClientCName desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                ...
                                <table bordercolor="#00CCFF" border="1" cellpadding="0" style="padding: 0px; margin: 0px;"
                                    ...
                                    <tr>
                                        <td>                                            
                                            ...
                                            <br />
                                            <div id="showRedundanceData">
                                                <asp:Label runat="server" ID="labRedundanceMsg" ForeColor="Red" Font-Size="X-Small"></asp:Label>
                                                <asp:GridView ID="gvRedundanceData" runat="server" Width="100%" BorderWidth="1px"
                                                        CellPadding="4" BackColor="White" BorderColor="#003366" 
                                                        Font-Size="Smaller" onrowdatabound="gvRedundanceData_RowDataBound" >
                                            ...
                                            <br />
                                            <div id="showTotal">
                                                <asp:Label runat="server" ID="labTotalMsg" ForeColor="Red" Font-Size="X-Small"></asp:Label>
                                            
                                                <br />
                                                <asp:Label ID="labTotalInfo" runat="server" Text="" Font-Size="X-Small"></asp:Label>
