<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScSickTypeMonthReport.aspx.cs" Inherits="OA.Total.ScLab.ScSickTypeMonthReport" %>
<%@ Register TagPrefix="idatagrid" Assembly="WebSiteOA" Namespace="OA.ZCommon.CommonControl"%>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>就诊类型月报表</title> <link href="../../Css/style.css" rel="stylesheet" />
                                                ...
                                                <idatagrid:InheritDataGrid ID="dgmonthreport" runat="server" PageSize="50" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="就诊类型">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="labsicktypename" Text='<%# DataBinder.Eval(Container, "DataItem.sicktypename") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
