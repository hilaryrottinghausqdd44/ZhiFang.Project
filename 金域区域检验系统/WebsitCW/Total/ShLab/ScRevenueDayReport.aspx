<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScRevenueDayReport.aspx.cs" Inherits="OA.Total.ShLab.ScRevenueDayReport" %>
    ...
    <script type="text/javascript" src="../../Css/calendar1.js"></script>
     <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ShLab.ScRevenueDayReport.GetExportList(GetCallresult);
        ...
        function CloseExcel(flag,filename) {
            ...
            closediv();
            if (flag == "1") {
                window.open("../downloadfile.aspx?file=ShLab/TotalExcel/" + filename);
            }
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ShLab.ScRevenueDayReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
...
<body onclick="hidDIV();" onload="ShowDivSearch();">
    ...
    <div id="divSearch" style="position: absolute; background: #fcfcfc; display: none;
        ...
        <table cellspacing="0" cellpadding="0" width="600px" bgcolor="#fcfcfc" border="0">
            <tbody>
                <tr>
                    <td colspan="2">
                                      ...
                                      <tr>
                                        <td colspan="4">
                                            ...
                                            <table id="columnconfigTable" cellspacing="0" cellpadding="0" width="100%" bgcolor="#fcfcfc" style="display:none;border: #aecdd5 solid 1px;
                                                ...
                                                <tbody>
                                                    <tr>
                                                          <td align="left" width="20%" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                           客户
                                                        </td>
                                                        <td align="left" width="20%" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                           销售员
                                                        ...
                                                        <td align="left" width="20%" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                         ...
                                                         <td align="left" width="20%" style="border-bottom: #aecdd5 solid 1px;">
                                                          小组
                                                        </td>                                                
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ToolTip="clientname" ID="chkclientnameisvisible" />显示
                                                                        <asp:CheckBox runat="server" ToolTip="clientname" ID="chkclientnameissubtotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        排序:<asp:DropDownList runat="server" ID="drpclientnamesort">
                                                                            ...
                                                                            <asp:ListItem Value="clientname asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="clientname desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px; border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:CheckBox runat="server" ToolTip="businessname" ID="chkbusinessnameisvisible" />显示
                                                                        <asp:CheckBox runat="server" ToolTip="businessname" ID="chkbusinessnameissubtotal" />小计
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        排序:<asp:DropDownList runat="server" ID="drpbusinessnamesort">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="businessname asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="businessname desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;border-right: #aecdd5 solid 1px;">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        次序:<asp:TextBox runat="server" CssClass="input_text" Width="75px" ID="txtsectionorder"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        设置:<asp:DropDownList runat="server" ID="drpsectionsort">
                                                                            <asp:ListItem Value="">未设置</asp:ListItem>
                                                                            <asp:ListItem Value="itemnamecw asc">正序asc</asp:ListItem>
                                                                            <asp:ListItem Value="itemnamecw desc">倒序desc</asp:ListItem>
                                                                        </asp:DropDownList>
                                                     ...
                                                     <tr>
                                                       <td align="right" colspan="5" style="border-right: #aecdd5 solid 1px;">
