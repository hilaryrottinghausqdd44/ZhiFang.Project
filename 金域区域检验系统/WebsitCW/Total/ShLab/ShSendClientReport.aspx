<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShSendClientReport.aspx.cs" Inherits="OA.Total.ShLab.ShSendClientReport" %>
    ...
    <script type="text/javascript" src="../../Css/calendar1.js"></script>
     <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ShLab.ShSendClientReport.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ShLab.ShSendClientReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
                                        ...
                                        <asp:Label runat="server" ID="labmsg"></asp:Label>                                                                        
                                            <div id="showdiv">
                                                <idatagrid:InheritDataGrid ID="dgrp" runat="server" PageSize="1" BorderWidth="1px"
                                                    ...
                                                    Font-Size="Smaller" OnItemDataBound="dgrp_ItemDataBound" AutoGenerateColumns="true">
