<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShBussinessReport.aspx.cs" Inherits="OA.Total.ShLab.ShBussinessReport" %>
    ...
    <script type="text/javascript" src="../../Css/calendar1.js"></script>
     <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ShLab.ShBussinessReport.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ShLab.ShBussinessReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
