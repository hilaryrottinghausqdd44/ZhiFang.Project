<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShSendClientItems.aspx.cs"
    Inherits="OA.Total.ShLab.ShSendClientItems" %>
    ...
    <script type="text/javascript">
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ShLab.ShSendClientItems.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
                            ...
                            <table cellspacing="0" cellpadding="1" width="100%" bgcolor="#fcfcfc" style="border: #aecdd5 solid 1px;
                                ...
                                <tbody>
                                    ...
                                    <tr align="left">
                                        ...
                                        <td align="left" style="border-bottom: #aecdd5 solid 1px;">
                                            <asp:DropDownList runat="server" ID="drpclientstyle" CssClass="input_text" Width="60px"></asp:DropDownList>
                                        </td>
                                    </tr>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2" align="center" height="50px" width="100%" style="border-bottom: #aecdd5 solid 1px;">
                                <font size="6">按项目对帐外送单位数据统计</font>
