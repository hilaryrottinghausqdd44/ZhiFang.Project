<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScTestItemReport.aspx.cs" Inherits="OA.Total.ShLab.ScTestItemReport" %>
     ...
     <script type="text/javascript">
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ShLab.ScTestItemReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
...
<body onclick="hidDIV();" onload="ShowDivSearch();">
   ...
   <div id="table1" style="background: #FFFFFF; display: none; position: absolute; z-index: 1;
    ...
    <div id="divSearch" style="position: absolute; background: #fcfcfc; display: none;
        ...
        <table cellspacing="0" cellpadding="0" width="450px" bgcolor="#fcfcfc" border="0">
            <tbody>
                <tr>
                    <td colspan="2">
