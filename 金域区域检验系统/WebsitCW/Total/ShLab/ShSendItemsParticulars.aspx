<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShSendItemsParticulars.aspx.cs"
    Inherits="OA.Total.ShLab.ShSendItemsParticulars" %>
    ...
    <script type="text/javascript">
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ShLab.ShSendItemsParticulars.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
                                        ...
                                        <td>
                                            ...
                                            <div id="showdiv" style="word-wrap: break-word;">
                                                <idatagrid:InheritDataGrid ID="dgrp" Width="100%" runat="server" BorderWidth="1px"
                                                    ...
                                                    OnItemDataBound="dgrp_ItemDataBound" AutoGenerateColumns="false">
                                                    <SelectedItemStyle Font-Bold="True" ForeColor="#663399" BackColor="#FFCC66"></SelectedItemStyle>
