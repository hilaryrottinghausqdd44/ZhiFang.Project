<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScRevenueParticulars.aspx.cs"
    Inherits="OA.Total.ShLab.ScRevenueParticulars" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.ShLab.ScRevenueParticulars.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.ShLab.ScRevenueParticulars.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
