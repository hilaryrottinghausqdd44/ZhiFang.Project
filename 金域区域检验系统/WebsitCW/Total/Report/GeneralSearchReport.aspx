<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralSearchReport.aspx.cs"
    Inherits="OA.Total.Report.GeneralSearchReport" %>
...
<head runat="server">
    ...
    <link href="../../JavaScriptFile/datetime/skin/WdatePicker.css" rel="stylesheet"
        type="text/css" />
    
    <script type="text/javascript">
        function SaveConfig() {
            var reporttype = "<%=ReportType %>";
            var configname = $("#textConfigName").val();
            var accountid = "<%=AccountId %>";
            $.ajax({
                type: "post",
                url: "../HandlerBLL/ColumnConfig.ashx",
                data: { action: "Save", reporttype: reporttype, configname: configname, accountid: accountid },
                dataType: "json",
    ...
    <script type="text/javascript">
        function check() {
            var datebegin = document.getElementById('txtinceptdatebegin');
            var dateend = document.getElementById('txtinceptdateend');
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.Report.GeneralSearchReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
                                            ...
                                            <table id="columnconfigTable" cellspacing="0" cellpadding="0" width="100%" bgcolor="#fcfcfc"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                        <br />
                                                            <asp:Repeater ID="repConfigs" runat="server" onitemcommand="repConfigs_ItemCommand">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="Link" runat="server" CommandName="show" CommandArgument='<%# Eval("ColumnConfigId")+"#"+Eval("ColumnConfigName") %>'><%# Eval("ColumnConfigName")%></asp:LinkButton>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <br />
                                                           配置名称：
                                                           <input type="text" id="textConfigName" runat="server" /> 
                                                           <input type="hidden" id="hiddenConfigId" runat="server" />
                                                           
                                                           <asp:Button ID="btnSaveConfigToDB" runat="server" OnClientClick="javascript:if(document.getElementById('textConfigName').value==''){
                                                            alert('请输入配置名称');document.getElementById('textConfigName').focus();return false;}return true;" OnClick="btnSaveConfigToDB_Click" Text="新增" CssClass="buttonstyle" />
                                                            
                                                            <asp:Button ID="btnEditConfig" runat="server"  OnClientClick="javascript:if(document.getElementById('textConfigName').value==''){
                                                            alert('请选择要修改的配置');document.getElementById('textConfigName').focus();return false;}return true;" Text="修改" CssClass="buttonstyle" onclick="Button1_Click" />
                                                           
                                                            <asp:Button ID="btnDelConfig" runat="server" CssClass="buttonstyle" OnClientClick="javascript:if(document.getElementById('textConfigName').value==''){
                                                            alert('请选择要删除的配置');document.getElementById('textConfigName').focus();return false;}return true;" OnClick="btnDelConfig_Click" Text="删除当前配置" />
                                                       </td>                                                                            
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <table bordercolor="#00CCFF" border="1" cellpadding="0" style="padding: 0px; margin: 0px;"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div id="showdiv">
                                                <idatagrid:InheritDataGrid ID="dgrp" runat="server" BorderWidth="1px"
                                                    ...
                                                    OnPageIndexChanged="dgrp_PageIndexChanged" AutoGenerateColumns="False">
                                                    <SelectedItemStyle Font-Bold="True" ForeColor="#663399" BackColor="#FFCC66"></SelectedItemStyle>
                                                    <ItemStyle ForeColor="#330099" Wrap="false" BackColor="White"></ItemStyle>
                                                    <HeaderStyle Font-Size="Smaller" Wrap="true" Font-Bold="True" Height="26px" ForeColor="Black"
                                                        BackColor="#CCCCCC"></HeaderStyle>
                                                    <FooterStyle ForeColor="#330099" BackColor="#FFFFCC"></FooterStyle>
                                                    <Columns>
                                                    </Columns>
                                        ...
                                        &nbsp;
                                            <asp:LinkButton ID="linkPre" runat="server" onclick="linkPre_Click">上一页</asp:LinkButton>
                                            &nbsp;
