<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScTestItemReport.aspx.cs" Inherits="OA.Total.MkLab.ScTestItemReport" %>
     ...
     <script type="text/javascript">
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.MkLab.ScTestItemReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
