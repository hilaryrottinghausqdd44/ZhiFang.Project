<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScRevenueDayReport.aspx.cs" Inherits="OA.Total.MkLab.ScRevenueDayReport" %>
    ...
    <script type="text/javascript" src="../../Css/calendar1.js"></script>
     <script type="text/javascript">
        ...
        function GetExportClient() {
            OA.Total.MkLab.ScRevenueDayReport.GetExportList(GetCallresult);
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.MkLab.ScRevenueDayReport.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
