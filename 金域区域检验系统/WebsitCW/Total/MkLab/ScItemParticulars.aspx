<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScItemParticulars.aspx.cs"
    Inherits="OA.Total.MkLab.ScItemParticulars" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CloseExcel(flag, filename) {
            ...
            closediv();
            if (flag == "1") {
                window.location.href = "../downloadfile.aspx?file=mklab/TotalExcel/" + filename;
            }
        ...
        function GetClientSearch() {
            ...
            if (key != 40 && key != 38 && key != 13) {
                ...
                PopupDiv.innerHTML = "";
                showimage();
                OA.Total.MkLab.ScItemParticulars.GetClientListByKey(clientkey, GetCallclientresult);
            }
            else
            { changediv(key); }
        }
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div id="showdiv" style="word-wrap: break-word;">
                                                <idatagrid:InheritDataGrid ID="dgrp" Width="100%" runat="server" PageSize="1" BorderWidth="1px"
                                                    CellPadding="4" BorderStyle="None" BackColor="White" BorderColor="#A7C4F7" Font-Size="Smaller"
                                                    OnItemDataBound="dgrp_ItemDataBound" OnPageIndexChanged="dgrp_PageIndexChanged"
