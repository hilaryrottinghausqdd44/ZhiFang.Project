<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ShowStatChartALLForm.aspx.cs" Inherits="OA.STAT.ShowStatChartALLForm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<%@ Register Assembly="dotnetCHARTING" Namespace="dotnetCHARTING" TagPrefix="dotnetCHARTING" %>

<%@ Register src="../UserControlLib/STATQueryFormWebControl.ascx" tagname="STATQueryFormWebControl" tagprefix="uc1" %>

<%@ Register src="../UserControlLib/STATGroupWebControl.ascx" tagname="STATGroupWebControl" tagprefix="uc2" %>

<%@ OutputCache Duration="1" VaryByParam="none" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>统计图查询与显示页面</title>
    ...
    <table id="Table1" cellspacing="1" cellpadding="1" width="700" border="0">
        <tr>
            <td>
                ...
                <asp:LinkButton ID="btnExportData" runat="server" CssClass="LinkButton" OnClick="btnExportData_Click">      导出原始数据</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Image ID="imageStatChart" EnableViewState="false" runat="server"></asp:Image>
            </td>
        </tr>
        <tr>
            <td>
                <uc2:STATGroupWebControl ID="STATGroupWebControl1" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="LabelTitle" style="white-space: nowrap" align="left">
                &nbsp;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <uc1:STATQueryFormWebControl ID="STATQueryFormWebControl1" runat="server" />
            </td>
        </tr>
    </table>
    </form>
