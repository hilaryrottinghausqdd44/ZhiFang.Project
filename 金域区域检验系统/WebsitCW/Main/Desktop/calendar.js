...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: 98CAF2 1px solid;BORDER-TOP: 98CAF2 1px solid;BORDER-LEFT: 98CAF2 1px solid;';
strFrame+='BORDER-BOTTOM: 98CAF2 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=98CAF2 bgcolor=98CAF2 Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=98CAF2 style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='        <td width=16 bgcolor=98CAF2 align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=98CAF2 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#FF9900 BORDERCOLORDARK=#FFFFFF bgcolor=98CAF2 width=140 height=120 Author="wayx">';
