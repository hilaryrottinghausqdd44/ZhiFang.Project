    ...
    <table id="Table1" style="z-index: 101; left: 8px; width: 483px; position: absolute;
        ...
        <tr>
            <td nowrap align="right" width="489" bgcolor="#f0f0f0" colspan="4" height="27">
                <p align="left">
                    ...
                    <asp:Button ID="SaveTemplate" runat="server" Text="保存模板" Width="104px" OnClick="SaveTemplate_Click">
                    </asp:Button>&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtNewTemplate" runat="server" Width="96px"></asp:TextBox><asp:Button
                        ID="SaveNewTemplate" runat="server" Text="保存为新模板" Width="84px" OnClick="SaveNewTemplate_Click">
                    </asp:Button></p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="height: 25px" align="center" bgcolor="#f0f0f0" colspan="4" height="25">
                <input type="button" value="选择按钮" onclick="ChooseButton();">
            </td>
        </tr>
        <tr>
            <td style="height: 17px" align="left" width="94" bgcolor="#f0f0f0" colspan="4" height="17">
            </td>
        </tr>
    </table>
