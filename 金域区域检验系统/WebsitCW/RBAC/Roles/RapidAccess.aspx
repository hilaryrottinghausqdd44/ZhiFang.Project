...
<body leftmargin="0" topmargin="0">
    ...
    <p>
        <table id="Table1" cellspacing="1" cellpadding="1" width="300" border="0" style="font-size: 12px">
            <tr>
                <td>
                    <span class="style4">Re: 只读权限，可以列出此模块 <span class="style2">*</span>最小权限 </span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="style4">S : 访问权限，能读取此模块的信息</span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="style4">Ru: 运行权限，可以运行此模块，并访问相关数据</span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="style4">C : 创建下级模块</span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="style4">M : 修改本模块的名称，地址，图片等相关信息</span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="style4">D : 删除本模块</span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="style4">RD: 再分配权限，可以把该模块再分发</span>
                </td>
            </tr>
            <tr>
                <td>
                    <span class="style4">A : 完全控制权限</span>
                </td>
            </tr>
            <tr>
                <td>
                    <p class="style4">
                        说明：选项上面有红线是拒绝，拒绝权限优先; 从最后一个选定权限起，随后的权限可以继承</p>
                </td>
            </tr>
        </table>
