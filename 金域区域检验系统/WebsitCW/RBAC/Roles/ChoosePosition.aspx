<%@ Page Language="c#" AutoEventWireup="True" Inherits="OA.RBAC.Roles.ChoosePosition" Codebehind="ChoosePosition.aspx.cs" %>
    ...
    <div style="overflow: auto">
        <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" bgcolor="whitesmoke">
            <tr>
                ...
                %>
                <td>
                    <input type="checkbox" onclick="SelUser();" name="chk_<%=Dt.Rows[i]["Id"]%>|<%=Dt.Rows[i]["CName"]%>"
