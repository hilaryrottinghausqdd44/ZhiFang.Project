...
Class LBUpload
	...
	private Sub ReSet()
		...
		Extension=""
		Category=""
		limExtension="jpg,gif,doc,png,txt,swf,mdb,ppt,dat,bmp,rtf,htm,html,exe,zip,war"
		limFileSize=0
	End Sub
'# ----------------------------------------------------------------------------
'# 函数：upobject
...
'#-----------------------------------------------------------------------------
	Public Function Add()
		...
		Response.Write "<br><a href=""up.asp?action=add"">继续上传</a><br>jpg,gif,doc,png,txt,swf,mdb,ppt,dat,bmp,rtf,htm,html,exe,zip,war"
	End Function
