<%@ Language=VBScript %>
<% Option Explicit %>
<%'-#Include file="../inc/SubConfig.asp" --%> 
...
Sub DBConnBegin()
	...
	dim strConn
	strConn=ReadCNString(server.MapPath("inc/config.xml"))
	oConn.Open strConn
	'"Provider=Microsoft.Jet.OLEDB.4.0; Data Source=" & Server.MapPath("db/lbedit.mdb")
	...
	If Err.Number <> 0 Then
		...
		Response.Write ReadCNString(server.MapPath("inc/config.xml"))
