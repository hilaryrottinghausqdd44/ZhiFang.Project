...
<body style="background-color: #e1f3ff">
    ...
    <div class="prt" id="printmenu" align="left">
        ...
        <table width="98%" height="50" border="0" cellpadding="0" cellspacing="0">
            <tr height="25">
                ...
                <td>
                    办 事 处：<input type="text" id="inputBSC" onkeydown="SelectNextClient(this,2)" onpropertychange="SelectClient(this,2)"
                        runat="server" />
                    <div>
                ...
                <td>
                    姓    名：<asp:TextBox TabIndex="0" ID="txtPatientName" runat="server"></asp:TextBox>
                </td>
                
            </tr>
            <tr height="25">
                <td>
                    病 历 号：<asp:TextBox TabIndex="0" ID="txtPatientID" runat="server"></asp:TextBox>
                </td>
                <td>
                    送检医生：<asp:TextBox TabIndex="0" ID="txtDoctorName" runat="server"></asp:TextBox>
                </td><td>
                    诊    断：<asp:TextBox TabIndex="0" ID="txtMemo" runat="server"></asp:TextBox>
                </td>
            </tr>
             <tr height="25">
    ...
    <div>
        ...
        <table border="1" cellpadding="0" cellspacing="0" width="98%" class="pad" id="List_Table">
            ...
            %>
            <tr style=" font-weight:bold"><td colspan="9">合计：</td><td colspan="2"><% Response.Write(count); %></td></tr>
        </table>
        <table width="98%">
            <tr>
                <td>
