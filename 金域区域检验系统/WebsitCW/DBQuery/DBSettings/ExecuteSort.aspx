<%@ Page language="c#" AutoEventWireup="True" Inherits="OA.DBQuery.DBSettings.ExecuteSort" Codebehind="ExecuteSort.aspx.cs" %>
			...
			<table align="center">
				<tr>
					<td align="center">
						...
						<asp:Button ID="btnExecute" Text="保存" Runat="server" onclick="btnExecute_Click"></asp:Button></td>
					<td align="center">
