<%@ Page language="c#" Codebehind="digitlab_Blog_List_Pop.aspx.cs" AutoEventWireup="True" Inherits="OA.Documents.digitlab_Blog_List_Pop" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>digitlab_Blog_List_Pop</title>
        ...
        function selectx(row,index)   /**//*改变选中行的颜色还原为选中行的颜色*/
        {
            ...
            //setParent();
            //标准 id,name;id1,name1;id2,name2
														...
														<TR vAlign="top">
															<TD align="center" height="100%">
																<asp:datagrid id="myDataGrid" runat="server" Width="95%" BorderColor="#A7C4F7" AutoGenerateColumns="False"
																	...
																	PageSize="3" onselectedindexchanged="myDataGrid_SelectedIndexChanged">
																	...
																	<Columns>
																		...
																		<asp:TemplateColumn Visible="False" SortExpression="名称" HeaderText="参数">
																			...
																			<ItemTemplate>
																				id=<%# DataBinder.Eval(Container, "DataItem.id") %>&&NewsNum=<%=listcount%>&&ChaNum=<%=characount%>
																			</ItemTemplate>
																		</asp:TemplateColumn>
																		<asp:TemplateColumn SortExpression="参数" HeaderText="名称">
																			...
																			<ItemTemplate>
																				...
																				<asp:Label Runat="server" ID="labaccount" Text='<%# DataBinder.Eval(Container, "DataItem.classname") %>'/>
																			</ItemTemplate>
																		</asp:TemplateColumn>
																		<asp:TemplateColumn>
																			<HeaderStyle CssClass="hideClass"></HeaderStyle>
																			...
																			<ItemTemplate>
																				<input id='<%#"ID_" + DataBinder.Eval(Container, "DataItem.id")%>' value='<%#DataBinder.Eval(Container, "DataItem.id")%>'
																					type="text" /> <input id='<%#"NAME_" + DataBinder.Eval(Container, "DataItem.id")%>' value='<%#DataBinder.Eval(Container, "DataItem.classname")%>'
																					type="text" />
																			</ItemTemplate>
																		</asp:TemplateColumn>
																	</Columns>
