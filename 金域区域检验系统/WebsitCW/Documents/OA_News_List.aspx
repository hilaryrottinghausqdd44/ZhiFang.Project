<%@ Page language="c#" Codebehind="OA_News_List.aspx.cs" AutoEventWireup="True" Inherits="OA.Documents.OA_News_List" %>
					...
					<td>
						<table  width="100%" class="style-titletable" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td><%if (Request.QueryString["morepar"] != null){ %><a href="#" onclick="openWinPositionSizeUrl('<%=morestr%>','_blank','<%=strWinPositionSize %>');" class="style-titlemore"></a><%} %></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td align="left">
						...
						%>
							<tr>
								...
								<td nowrap><div ><a href="#" onClick="openWinPositionSize('../news/browse/<%=strOpenPage %>?id='+<%=id%>,'<%=strWinPositionSize%>','<%=id%>' );" 
