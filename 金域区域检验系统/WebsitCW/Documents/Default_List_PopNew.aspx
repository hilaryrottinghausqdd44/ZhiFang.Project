<%@ Page Language="c#" CodeBehind="Default_List_PopNew.aspx.cs" AutoEventWireup="True"
    Inherits="OA.Documents.Default_List_PopNew" %>

<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls, Version=1.0.2.226, Culture=neutral, PublicKeyToken=31bf3856ad364e35" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Default_List_PopNew</title>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table7" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
        ...
        <tr>
            <td>
                <asp:Button runat="server" Visible="false" ID="btnselect" Text="选 择" OnClick="btnselect_Click" />
                <input type="button" id="Button1" value="选 择" onclick="returnFun();">
