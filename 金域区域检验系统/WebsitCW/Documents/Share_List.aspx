<%@ Page language="c#" Codebehind="Share_List.aspx.cs" AutoEventWireup="True" Inherits="OA.Documents.Share_List" %>
	...
	<A class="code" onclick="if(window.dd &amp;&amp; dd.elements &amp;&amp; dd.elements.fateba_se.children.length > 0) dd.elements.fateba_se.detachChild('ko5_st');return false;"
		...
		<TABLE id="TableTilte" style="display:none;BORDER-TOP-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px; Z-INDEX: 101; BORDER-LEFT-COLOR: #0066ff; BORDER-BOTTOM-WIDTH: 1px; BORDER-BOTTOM-COLOR: #0066ff; WIDTH: 752px; BORDER-TOP-COLOR: #0066ff; HEIGHT: 22px; BORDER-RIGHT-WIDTH: 1px; BORDER-RIGHT-COLOR: #0066ff"
			...
			<tr>
				...
				name="Folder">
				<h4>位置: <font color=#cc6633><%=ShareEmpName%></font><input type=hidden value='<%=filePath.Replace("\\\\","\\")%>' id="idfolder"/></h4>
		...
		<TABLE id="Table1" style="BORDER-RIGHT: #ffe7d9 1px solid; BORDER-TOP: #ffe7d9 1px solid; Z-INDEX: 101; BORDER-LEFT: #ffe7d9 1px solid; WIDTH: 752px; BORDER-BOTTOM: #ffe7d9 1px solid; POSITION: relative; HEIGHT: 22px"
			...
			<TR>
				...
				<TD align="center"><FONT face="宋体"></FONT>
					<%
