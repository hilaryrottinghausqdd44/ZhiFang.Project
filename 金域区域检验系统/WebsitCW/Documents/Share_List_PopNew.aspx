...
<%@ Page language="c#" Codebehind="Share_List_PopNew.aspx.cs" AutoEventWireup="True" Inherits="OA.Documents.Share_List_PopNew" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Share_List_PopNew</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table id="Table7" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr>
					<td><input type="button" id="Button1" value="选 择" onclick="returnFun();"><asp:Button Runat="server" Visible="false" ID="btnselect" Text="选 择" onclick="btnselect_Click" />&nbsp;&nbsp;<input type="button" id="btncancel" value="取 消" onclick="window.close();">
