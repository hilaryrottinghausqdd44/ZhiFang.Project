<%@ Page Language="c#" AutoEventWireup="True"
    Inherits="OA.News.Browse.SetQueryConditionForm" Codebehind="SetQueryConditionForm.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="QueryFormWebControl" Src="../../WebControlLib/QueryFormWebControl.ascx" %>
...
<body ms_positioning="GridLayout" onload="resetWindowSize()">
    ...
    <table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
        ...
        <tr>
            <td>
                <uc1:queryformwebcontrol id="queryFormWebControl1" runat="server">
                </uc1:queryformwebcontrol>
            </td>
        </tr>
    </table>
    </form>
